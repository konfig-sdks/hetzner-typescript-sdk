...
// @ts-ignore
import { ActionsGetAllResponse } from '../models';
// @ts-ignore
import { ActionsGetByIdResponse } from '../models';
...
export const ActionsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Returns all Action objects. You can `sort` the results by using the sort URI parameter, and filter them with the `status` parameter.
         * @summary Get all Actions
         * @param {ActionsApiGetAllRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getAll(requestParameters: ActionsApiGetAllRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ActionsGetAllResponse>> {
         ...
         * Returns a specific Action object.
         * @summary Get an Action
         * @param {ActionsApiGetByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getById(requestParameters: ActionsApiGetByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ActionsGetByIdResponse>> {
...
export const ActionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAll(requestParameters: ActionsApiGetAllRequest = {}, options?: AxiosRequestConfig): AxiosPromise<ActionsGetAllResponse> {
         ...
         * @throws {RequiredError}
         */
        getById(requestParameters: ActionsApiGetByIdRequest, options?: AxiosRequestConfig): AxiosPromise<ActionsGetByIdResponse> {
...
/**
 * Request parameters for getAll operation in ActionsApi.
 * @export
 * @interface ActionsApiGetAllRequest
 */
export type ActionsApiGetAllRequest = {
    
    /**
    * Filter the actions by ID. Can be used multiple times. The response will only contain actions matching the specified IDs. 
    * @type {number}
    * @memberof ActionsApiGetAll
    */
    readonly id?: number
...
/**
 * Request parameters for getById operation in ActionsApi.
 * @export
 * @interface ActionsApiGetByIdRequest
 */
export type ActionsApiGetByIdRequest = {
    
    /**
    * ID of the Resource.
    * @type {number}
    * @memberof ActionsApiGetById
    */
    readonly id: number
...
export class ActionsApiGenerated extends BaseAPI {
     ...
     */
    public getAll(requestParameters: ActionsApiGetAllRequest = {}, options?: AxiosRequestConfig) {
        return ActionsApiFp(this.configuration).getAll(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ActionsApiGenerated
     */
    public getById(requestParameters: ActionsApiGetByIdRequest, options?: AxiosRequestConfig) {
        return ActionsApiFp(this.configuration).getById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
