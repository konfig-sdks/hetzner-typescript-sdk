...
// @ts-ignore
import { LocationsGetAllLocationsResponse } from '../models';
// @ts-ignore
import { LocationsGetLocationByIdResponse } from '../models';
...
export const LocationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getAllLocations: async (name?: string, sort?: 'id' | 'id:asc' | 'id:desc' | 'name' | 'name:asc' | 'name:desc', page?: number, perPage?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getLocationById: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const LocationsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllLocations(requestParameters: LocationsApiGetAllLocationsRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LocationsGetAllLocationsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllLocations(requestParameters.name, requestParameters.sort, requestParameters.page, requestParameters.perPage, options);
         ...
         * @throws {RequiredError}
         */
        async getLocationById(requestParameters: LocationsApiGetLocationByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LocationsGetLocationByIdResponse>> {
...
export const LocationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllLocations(requestParameters: LocationsApiGetAllLocationsRequest = {}, options?: AxiosRequestConfig): AxiosPromise<LocationsGetAllLocationsResponse> {
         ...
         * @throws {RequiredError}
         */
        getLocationById(requestParameters: LocationsApiGetLocationByIdRequest, options?: AxiosRequestConfig): AxiosPromise<LocationsGetLocationByIdResponse> {
