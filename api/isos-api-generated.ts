...
// @ts-ignore
import { IsOsGetAllResponse } from '../models';
// @ts-ignore
import { IsOsGetResponse } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * ISOsApi - axios parameter creator
 * @export
 */
export const ISOsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @throws {RequiredError}
         */
        getAll: async (name?: string, architecture?: string, includeArchitectureWildcard?: boolean, page?: number, perPage?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/isos`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            if (includeArchitectureWildcard !== undefined) {
                localVarQueryParameter['include_architecture_wildcard'] = includeArchitectureWildcard;
            }
...
/**
 * ISOsApi - functional programming interface
 * @export
 */
export const ISOsApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ISOsApiAxiosParamCreator(configuration)
    return {
        /**
         * Returns a specific ISO object.
         * @summary Get an ISO
         * @param {ISOsApiGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async get(requestParameters: ISOsApiGetRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IsOsGetResponse>> {
         ...
         * Returns all available ISO objects.
         * @summary Get all ISOs
         * @param {ISOsApiGetAllRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getAll(requestParameters: ISOsApiGetAllRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IsOsGetAllResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAll(requestParameters.name, requestParameters.architecture, requestParameters.includeArchitectureWildcard, requestParameters.page, requestParameters.perPage, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * ISOsApi - factory interface
 * @export
 */
export const ISOsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ISOsApiFp(configuration)
    return {
        /**
         * Returns a specific ISO object.
         * @summary Get an ISO
         ...
         * @throws {RequiredError}
         */
        get(requestParameters: ISOsApiGetRequest, options?: AxiosRequestConfig): AxiosPromise<IsOsGetResponse> {
         ...
         * @throws {RequiredError}
         */
        getAll(requestParameters: ISOsApiGetAllRequest = {}, options?: AxiosRequestConfig): AxiosPromise<IsOsGetAllResponse> {
...
/**
 * Request parameters for get operation in ISOsApi.
 * @export
 * @interface ISOsApiGetRequest
 */
export type ISOsApiGetRequest = {
...
/**
 * Request parameters for getAll operation in ISOsApi.
 * @export
 * @interface ISOsApiGetAllRequest
 */
export type ISOsApiGetAllRequest = {
    
    /**
    * Can be used to filter ISOs by their name. The response will only contain the ISO matching the specified name.
    * @type {string}
    * @memberof ISOsApiGetAll
    */
    ...
    * @memberof ISOsApiGetAll
    */
    readonly includeArchitectureWildcard?: boolean
...
/**
 * ISOsApiGenerated - object-oriented interface
 * @export
 * @class ISOsApiGenerated
 * @extends {BaseAPI}
 */
export class ISOsApiGenerated extends BaseAPI {
    /**
     * Returns a specific ISO object.
     * @summary Get an ISO
     * @param {ISOsApiGetRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ISOsApiGenerated
     */
    public get(requestParameters: ISOsApiGetRequest, options?: AxiosRequestConfig) {
        return ISOsApiFp(this.configuration).get(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ISOsApiGenerated
     */
    public getAll(requestParameters: ISOsApiGetAllRequest = {}, options?: AxiosRequestConfig) {
        return ISOsApiFp(this.configuration).getAll(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
