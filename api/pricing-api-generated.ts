...
// @ts-ignore
import { PricingGetAllPricesResponse } from '../models';
...
export const PricingApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllPrices(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PricingGetAllPricesResponse>> {
...
export const PricingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllPrices(options?: AxiosRequestConfig): AxiosPromise<PricingGetAllPricesResponse> {
...
/**
 * PricingApiGenerated - object-oriented interface
 * @export
 * @class PricingApiGenerated
 * @extends {BaseAPI}
 */
export class PricingApiGenerated extends BaseAPI {
    /**
     * Returns prices for all resources available on the platform. VAT and currency of the Project owner are used for calculations.  Both net and gross prices are included in the response. 
     * @summary Get all prices
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof PricingApiGenerated
     */
    public getAllPrices(options?: AxiosRequestConfig) {
        return PricingApiFp(this.configuration).getAllPrices(options).then((request) => request(this.axios, this.basePath));
    }
}
