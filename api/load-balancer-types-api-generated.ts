...
// @ts-ignore
import { LoadBalancerTypesGetAllTypesResponse } from '../models';
// @ts-ignore
import { LoadBalancerTypesGetByIdResponse } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * LoadBalancerTypesApi - axios parameter creator
 * @export
 */
export const LoadBalancerTypesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        getAllTypes: async (name?: string, page?: number, perPage?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/load_balancer_types`;
        ...
        getById: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/load_balancer_types/{id}`
...
/**
 * LoadBalancerTypesApi - functional programming interface
 * @export
 */
export const LoadBalancerTypesApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = LoadBalancerTypesApiAxiosParamCreator(configuration)
    return {
        /**
         * Gets all Load Balancer type objects.
         * @summary Get all Load Balancer Types
         * @param {LoadBalancerTypesApiGetAllTypesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getAllTypes(requestParameters: LoadBalancerTypesApiGetAllTypesRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LoadBalancerTypesGetAllTypesResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllTypes(requestParameters.name, requestParameters.page, requestParameters.perPage, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Gets a specific Load Balancer type object.
         * @summary Get a Load Balancer Type
         * @param {LoadBalancerTypesApiGetByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getById(requestParameters: LoadBalancerTypesApiGetByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LoadBalancerTypesGetByIdResponse>> {
...
/**
 * LoadBalancerTypesApi - factory interface
 * @export
 */
export const LoadBalancerTypesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = LoadBalancerTypesApiFp(configuration)
    return {
        /**
         * Gets all Load Balancer type objects.
         * @summary Get all Load Balancer Types
         ...
         * @throws {RequiredError}
         */
        getAllTypes(requestParameters: LoadBalancerTypesApiGetAllTypesRequest = {}, options?: AxiosRequestConfig): AxiosPromise<LoadBalancerTypesGetAllTypesResponse> {
            return localVarFp.getAllTypes(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Gets a specific Load Balancer type object.
         * @summary Get a Load Balancer Type
         ...
         * @throws {RequiredError}
         */
        getById(requestParameters: LoadBalancerTypesApiGetByIdRequest, options?: AxiosRequestConfig): AxiosPromise<LoadBalancerTypesGetByIdResponse> {
...
/**
 * Request parameters for getAllTypes operation in LoadBalancerTypesApi.
 * @export
 * @interface LoadBalancerTypesApiGetAllTypesRequest
 */
export type LoadBalancerTypesApiGetAllTypesRequest = {
    ...
    * @type {string}
    * @memberof LoadBalancerTypesApiGetAllTypes
    */
...
/**
 * Request parameters for getById operation in LoadBalancerTypesApi.
 * @export
 * @interface LoadBalancerTypesApiGetByIdRequest
 */
export type LoadBalancerTypesApiGetByIdRequest = {
    
    /**
    * ID of Load Balancer type
    * @type {number}
    * @memberof LoadBalancerTypesApiGetById
    */
    readonly id: number
...
/**
 * LoadBalancerTypesApiGenerated - object-oriented interface
 * @export
 * @class LoadBalancerTypesApiGenerated
 * @extends {BaseAPI}
 */
export class LoadBalancerTypesApiGenerated extends BaseAPI {
    /**
     * Gets all Load Balancer type objects.
     * @summary Get all Load Balancer Types
     * @param {LoadBalancerTypesApiGetAllTypesRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof LoadBalancerTypesApiGenerated
     */
    public getAllTypes(requestParameters: LoadBalancerTypesApiGetAllTypesRequest = {}, options?: AxiosRequestConfig) {
        return LoadBalancerTypesApiFp(this.configuration).getAllTypes(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof LoadBalancerTypesApiGenerated
     */
    public getById(requestParameters: LoadBalancerTypesApiGetByIdRequest, options?: AxiosRequestConfig) {
        return LoadBalancerTypesApiFp(this.configuration).getById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
