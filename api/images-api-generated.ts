...
// @ts-ignore
import { ImagesGetAllResponse } from '../models';
// @ts-ignore
import { ImagesGetByIdResponse } from '../models';
// @ts-ignore
import { ImagesUpdateImageByIdRequest } from '../models';
// @ts-ignore
import { ImagesUpdateImageByIdResponse } from '../models';
...
export const ImagesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        deleteImage: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {'system' | 'snapshot' | 'backup' | 'app'} [type] Can be used multiple times.
         * @param {'available' | 'creating'} [status] Can be used multiple times. The response will only contain Images matching the status.
         ...
         * @throws {RequiredError}
         */
        getAll: async (sort?: 'id' | 'id:asc' | 'id:desc' | 'name' | 'name:asc' | 'name:desc' | 'created' | 'created:asc' | 'created:desc', type?: 'system' | 'snapshot' | 'backup' | 'app', status?: 'available' | 'creating', boundTo?: string, includeDeprecated?: boolean, name?: string, labelSelector?: string, architecture?: string, page?: number, perPage?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            if (boundTo !== undefined) {
                localVarQueryParameter['bound_to'] = boundTo;
            }

            if (includeDeprecated !== undefined) {
                localVarQueryParameter['include_deprecated'] = includeDeprecated;
            }
         ...
         * @param {number} id ID of the Image
         * @param {ImagesUpdateImageByIdRequest} [imagesUpdateImageByIdRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateImageById: async (id: number, imagesUpdateImageByIdRequest?: ImagesUpdateImageByIdRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateImageById', 'id', id)
            const localVarPath = `/images/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: imagesUpdateImageByIdRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(imagesUpdateImageByIdRequest, localVarRequestOptions, configuration)
...
export const ImagesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteImage(requestParameters: ImagesApiDeleteImageRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteImage(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns all Image objects. You can select specific Image types only and sort the results by using URI parameters.
         * @summary Get all Images
         * @param {ImagesApiGetAllRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getAll(requestParameters: ImagesApiGetAllRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ImagesGetAllResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAll(requestParameters.sort, requestParameters.type, requestParameters.status, requestParameters.boundTo, requestParameters.includeDeprecated, requestParameters.name, requestParameters.labelSelector, requestParameters.architecture, requestParameters.page, requestParameters.perPage, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns a specific Image object.
         * @summary Get an Image
         * @param {ImagesApiGetByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getById(requestParameters: ImagesApiGetByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ImagesGetByIdResponse>> {
         ...
         * Updates the Image. You may change the description, convert a Backup Image to a Snapshot Image or change the Image labels. Only Images of type `snapshot` and `backup` can be updated.  Note that when updating labels, the current set of labels will be replaced with the labels provided in the request body. So, for example, if you want to add a new label, you have to provide all existing labels plus the new label in the request body. 
         * @summary Update an Image
         * @param {ImagesApiUpdateImageByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateImageById(requestParameters: ImagesApiUpdateImageByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ImagesUpdateImageByIdResponse>> {
            const imagesUpdateImageByIdRequest: ImagesUpdateImageByIdRequest = {
                description: requestParameters.description,
                labels: requestParameters.labels,
                type: requestParameters.type
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateImageById(requestParameters.id, imagesUpdateImageByIdRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const ImagesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteImage(requestParameters: ImagesApiDeleteImageRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteImage(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns all Image objects. You can select specific Image types only and sort the results by using URI parameters.
         * @summary Get all Images
         ...
         * @throws {RequiredError}
         */
        getAll(requestParameters: ImagesApiGetAllRequest = {}, options?: AxiosRequestConfig): AxiosPromise<ImagesGetAllResponse> {
         ...
         * @throws {RequiredError}
         */
        getById(requestParameters: ImagesApiGetByIdRequest, options?: AxiosRequestConfig): AxiosPromise<ImagesGetByIdResponse> {
         ...
         * @throws {RequiredError}
         */
        updateImageById(requestParameters: ImagesApiUpdateImageByIdRequest, options?: AxiosRequestConfig): AxiosPromise<ImagesUpdateImageByIdResponse> {
 ...
 */
export type ImagesApiDeleteImageRequest = {
...
/**
 * Request parameters for getAll operation in ImagesApi.
 * @export
 * @interface ImagesApiGetAllRequest
 */
export type ImagesApiGetAllRequest = {
...
/**
 * Request parameters for getById operation in ImagesApi.
 * @export
 * @interface ImagesApiGetByIdRequest
 */
export type ImagesApiGetByIdRequest = {
    
    /**
    * ID of the Image
    * @type {number}
    * @memberof ImagesApiGetById
    */
    readonly id: number
...
/**
 * Request parameters for updateImageById operation in ImagesApi.
 * @export
 * @interface ImagesApiUpdateImageByIdRequest
 */
export type ImagesApiUpdateImageByIdRequest = {
    
    /**
    * ID of the Image
    * @type {number}
    * @memberof ImagesApiUpdateImageById
    */
    readonly id: number
...
export class ImagesApiGenerated extends BaseAPI {
     ...
     */
    public deleteImage(requestParameters: ImagesApiDeleteImageRequest, options?: AxiosRequestConfig) {
        return ImagesApiFp(this.configuration).deleteImage(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ImagesApiGenerated
     */
    public getAll(requestParameters: ImagesApiGetAllRequest = {}, options?: AxiosRequestConfig) {
        return ImagesApiFp(this.configuration).getAll(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ImagesApiGenerated
     */
    public getById(requestParameters: ImagesApiGetByIdRequest, options?: AxiosRequestConfig) {
        return ImagesApiFp(this.configuration).getById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ImagesApiGenerated
     */
    public updateImageById(requestParameters: ImagesApiUpdateImageByIdRequest, options?: AxiosRequestConfig) {
        return ImagesApiFp(this.configuration).updateImageById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
