...
// @ts-ignore
import { DatacentersGetAllResponse } from '../models';
// @ts-ignore
import { DatacentersGetByIdResponse } from '../models';
...
export const DatacentersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getAll: async (name?: string, sort?: 'id' | 'id:asc' | 'id:desc' | 'name' | 'name:asc' | 'name:desc', page?: number, perPage?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
        ...
        getById: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/datacenters/{id}`
...
export const DatacentersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Returns all Datacenter objects.
         * @summary Get all Datacenters
         * @param {DatacentersApiGetAllRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getAll(requestParameters: DatacentersApiGetAllRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DatacentersGetAllResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAll(requestParameters.name, requestParameters.sort, requestParameters.page, requestParameters.perPage, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns a specific Datacenter object.
         * @summary Get a Datacenter
         * @param {DatacentersApiGetByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getById(requestParameters: DatacentersApiGetByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DatacentersGetByIdResponse>> {
...
export const DatacentersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAll(requestParameters: DatacentersApiGetAllRequest = {}, options?: AxiosRequestConfig): AxiosPromise<DatacentersGetAllResponse> {
         ...
         * @throws {RequiredError}
         */
        getById(requestParameters: DatacentersApiGetByIdRequest, options?: AxiosRequestConfig): AxiosPromise<DatacentersGetByIdResponse> {
...
/**
 * Request parameters for getAll operation in DatacentersApi.
 * @export
 * @interface DatacentersApiGetAllRequest
 */
export type DatacentersApiGetAllRequest = {
...
/**
 * Request parameters for getById operation in DatacentersApi.
 * @export
 * @interface DatacentersApiGetByIdRequest
 */
export type DatacentersApiGetByIdRequest = {
    
    /**
    * ID of Datacenter
    * @type {number}
    * @memberof DatacentersApiGetById
    */
    readonly id: number
...
/**
 * DatacentersApiGenerated - object-oriented interface
 * @export
 * @class DatacentersApiGenerated
 * @extends {BaseAPI}
 */
export class DatacentersApiGenerated extends BaseAPI {
    /**
     * Returns all Datacenter objects.
     * @summary Get all Datacenters
     * @param {DatacentersApiGetAllRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof DatacentersApiGenerated
     */
    public getAll(requestParameters: DatacentersApiGetAllRequest = {}, options?: AxiosRequestConfig) {
        return DatacentersApiFp(this.configuration).getAll(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DatacentersApiGenerated
     */
    public getById(requestParameters: DatacentersApiGetByIdRequest, options?: AxiosRequestConfig) {
        return DatacentersApiFp(this.configuration).getById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
