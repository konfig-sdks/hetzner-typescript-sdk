...
import { HetznerCustom } from "./client-custom";

export class Hetzner extends HetznerCustom {
  readonly actions: ActionsApi;
  readonly certificateActions: CertificateActionsApi;
  ...
  readonly imageActions: ImageActionsApi;
  ...
  readonly serverActions: ServerActionsApi;
  ...
  constructor(configurationParameters: ConfigurationParameters) {
    ...
    this.certificateActions = new CertificateActionsApi(configuration);
    this.certificates = new CertificatesApi(configuration);
    this.datacenters = new DatacentersApi(configuration);
    this.firewallActions = new FirewallActionsApi(configuration);
    this.firewalls = new FirewallsApi(configuration);
    this.floatingIpActions = new FloatingIpActionsApi(configuration);
    this.floatingIPs = new FloatingIPsApi(configuration);
    this.iSOs = new ISOsApi(configuration);
    this.imageActions = new ImageActionsApi(configuration);
    this.images = new ImagesApi(configuration);
    this.loadBalancerActions = new LoadBalancerActionsApi(configuration);
    this.loadBalancerTypes = new LoadBalancerTypesApi(configuration);
    this.loadBalancers = new LoadBalancersApi(configuration);
    this.locations = new LocationsApi(configuration);
    this.networkActions = new NetworkActionsApi(configuration);
    this.networks = new NetworksApi(configuration);
    this.placementGroups = new PlacementGroupsApi(configuration);
    this.pricing = new PricingApi(configuration);
    this.primaryIpActions = new PrimaryIpActionsApi(configuration);
    this.primaryIPs = new PrimaryIPsApi(configuration);
    this.sshKeys = new SshKeysApi(configuration);
    this.serverActions = new ServerActionsApi(configuration);
    this.serverTypes = new ServerTypesApi(configuration);
    this.servers = new ServersApi(configuration);
    this.volumeActions = new VolumeActionsApi(configuration);
    this.volumes = new VolumesApi(configuration);
  }
