...
import { ListMetaPropertyPagination } from './list-meta-property-pagination';

/**
 * 
 * @export
 * @interface ListMetaProperty
 */
export interface ListMetaProperty {
    /**
     * 
     * @type {ListMetaPropertyPagination}
     * @memberof ListMetaProperty
     */
    'pagination': ListMetaPropertyPagination;
}
