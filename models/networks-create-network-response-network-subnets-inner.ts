 ...
 * 
 * @export
 * @interface NetworksCreateNetworkResponseNetworkSubnetsInner
 */
export interface NetworksCreateNetworkResponseNetworkSubnetsInner {
    /**
     ...
     * @type {string}
     * @memberof NetworksCreateNetworkResponseNetworkSubnetsInner
     */
    'gateway': string;
    /**
     ...
     * @memberof NetworksCreateNetworkResponseNetworkSubnetsInner
     */
    'type': NetworksCreateNetworkResponseNetworkSubnetsInnerTypeEnum;
    /**
...
type NetworksCreateNetworkResponseNetworkSubnetsInnerTypeEnum = 'cloud' | 'server' | 'vswitch'
