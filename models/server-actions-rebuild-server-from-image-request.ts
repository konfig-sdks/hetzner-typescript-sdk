 ...
 * 
 * @export
 * @interface ServerActionsRebuildServerFromImageRequest
 */
export interface ServerActionsRebuildServerFromImageRequest {
    /**
     * ID or name of Image to rebuilt from.
     * @type {string}
     * @memberof ServerActionsRebuildServerFromImageRequest
     */
    'image': string;
}
