...
import { FirewallResource } from './firewall-resource';

/**
 * 
 * @export
 * @interface FirewallActionsApplyToResourcesRequest
 */
export interface FirewallActionsApplyToResourcesRequest {
    /**
     * Resources the Firewall should be applied to
     * @type {Array<FirewallResource>}
     * @memberof FirewallActionsApplyToResourcesRequest
     */
    'apply_to': Array<FirewallResource>;
}
