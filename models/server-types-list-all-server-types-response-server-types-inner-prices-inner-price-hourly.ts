 ...
 * @export
 * @interface ServerTypesListAllServerTypesResponseServerTypesInnerPricesInnerPriceHourly
 */
export interface ServerTypesListAllServerTypesResponseServerTypesInnerPricesInnerPriceHourly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof ServerTypesListAllServerTypesResponseServerTypesInnerPricesInnerPriceHourly
     */
    'gross': string;
    /**
     * Price without VAT
