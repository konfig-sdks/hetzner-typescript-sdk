...
import { ServerTypesGetServerTypeResponseServerType } from './server-types-get-server-type-response-server-type';

/**
 * 
 * @export
 * @interface ServerTypesGetServerTypeResponse
 */
export interface ServerTypesGetServerTypeResponse {
    /**
     * 
     * @type {ServerTypesGetServerTypeResponseServerType}
     * @memberof ServerTypesGetServerTypeResponse
     */
    'server_type': ServerTypesGetServerTypeResponseServerType;
}
