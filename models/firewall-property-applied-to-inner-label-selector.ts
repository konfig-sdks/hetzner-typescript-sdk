 ...
 * 
 * @export
 * @interface FirewallPropertyAppliedToInnerLabelSelector
 */
export interface FirewallPropertyAppliedToInnerLabelSelector {
    /**
     * Label selector
     * @type {string}
     * @memberof FirewallPropertyAppliedToInnerLabelSelector
     */
    'selector': string;
}
