...
import { ActionProperty43 } from './action-property43';

/**
 * 
 * @export
 * @interface PrimaryIpActionsAssignPrimaryIpToResourceResponse
 */
export interface PrimaryIpActionsAssignPrimaryIpToResourceResponse {
    /**
     * 
     * @type {ActionProperty43}
     * @memberof PrimaryIpActionsAssignPrimaryIpToResourceResponse
     */
    'action': ActionProperty43;
}
