 ...
 * @export
 * @interface LoadBalancersCreateLoadBalancerResponseLoadBalancerProtection
 */
export interface LoadBalancersCreateLoadBalancerResponseLoadBalancerProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancerProtection
     */
    'delete': boolean;
}
