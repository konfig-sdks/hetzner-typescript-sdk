 ...
 * @export
 * @interface ServersGetServerResponseServerPublicNetIpv4
 */
export interface ServersGetServerResponseServerPublicNetIpv4 {
    /**
     * If the IP is blocked by our anti abuse dept
     * @type {boolean}
     * @memberof ServersGetServerResponseServerPublicNetIpv4
     */
    'blocked': boolean;
    /**
