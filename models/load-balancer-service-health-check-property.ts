...
import { LoadBalancerServiceHealthCheckPropertyHttp } from './load-balancer-service-health-check-property-http';

/**
 * Service health check
 * @export
 * @interface LoadBalancerServiceHealthCheckProperty
 */
export interface LoadBalancerServiceHealthCheckProperty {
    /**
     * 
     * @type {LoadBalancerServiceHealthCheckPropertyHttp}
     * @memberof LoadBalancerServiceHealthCheckProperty
     */
    'http'?: LoadBalancerServiceHealthCheckPropertyHttp;
    /**
     ...
     * @memberof LoadBalancerServiceHealthCheckProperty
     */
    'protocol': LoadBalancerServiceHealthCheckPropertyProtocolEnum;
    /**
...
type LoadBalancerServiceHealthCheckPropertyProtocolEnum = 'tcp' | 'http'
