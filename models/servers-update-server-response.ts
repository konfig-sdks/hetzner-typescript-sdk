...
import { ServersUpdateServerResponseServer } from './servers-update-server-response-server';

/**
 * 
 * @export
 * @interface ServersUpdateServerResponse
 */
export interface ServersUpdateServerResponse {
    /**
     * 
     * @type {ServersUpdateServerResponseServer}
     * @memberof ServersUpdateServerResponse
     */
    'server'?: ServersUpdateServerResponseServer;
}
