 ...
 * @export
 * @interface PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInnerPriceHourly
 */
export interface PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInnerPriceHourly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInnerPriceHourly
     */
    'gross': string;
    /**
     * Price without VAT
