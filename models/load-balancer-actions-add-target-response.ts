...
import { ActionProperty20 } from './action-property20';

/**
 * 
 * @export
 * @interface LoadBalancerActionsAddTargetResponse
 */
export interface LoadBalancerActionsAddTargetResponse {
    /**
     * 
     * @type {ActionProperty20}
     * @memberof LoadBalancerActionsAddTargetResponse
     */
    'action': ActionProperty20;
}
