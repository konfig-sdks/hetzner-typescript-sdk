...
import { CertificatePropertyStatus } from './certificate-property-status';
import { CertificatePropertyUsedByInner } from './certificate-property-used-by-inner';
...
export interface CertificateProperty {
    ...
    /**
     * 
     * @type {CertificatePropertyStatus}
     * @memberof CertificateProperty
     */
    'status'?: CertificatePropertyStatus | null;
    /**
     ...
     * @type {Array<CertificatePropertyUsedByInner>}
     * @memberof CertificateProperty
     */
    'used_by': Array<CertificatePropertyUsedByInner>;
}

type CertificatePropertyTypeEnum = 'uploaded' | 'managed'
