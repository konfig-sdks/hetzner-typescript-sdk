...
import { FirewallsCreateFirewallRequestApplyToInnerLabelSelector } from './firewalls-create-firewall-request-apply-to-inner-label-selector';
import { FirewallsCreateFirewallRequestApplyToInnerServer } from './firewalls-create-firewall-request-apply-to-inner-server';

/**
 * 
 * @export
 * @interface FirewallsCreateFirewallRequestApplyToInner
 */
export interface FirewallsCreateFirewallRequestApplyToInner {
    /**
     * 
     * @type {FirewallsCreateFirewallRequestApplyToInnerLabelSelector}
     * @memberof FirewallsCreateFirewallRequestApplyToInner
     */
    'label_selector'?: FirewallsCreateFirewallRequestApplyToInnerLabelSelector;
    /**
     * 
     * @type {FirewallsCreateFirewallRequestApplyToInnerServer}
     * @memberof FirewallsCreateFirewallRequestApplyToInner
     */
    'server'?: FirewallsCreateFirewallRequestApplyToInnerServer;
    /**
     * Type of the resource
     * @type {string}
     * @memberof FirewallsCreateFirewallRequestApplyToInner
     */
    'type': FirewallsCreateFirewallRequestApplyToInnerTypeEnum;
}

type FirewallsCreateFirewallRequestApplyToInnerTypeEnum = 'server' | 'label_selector'
