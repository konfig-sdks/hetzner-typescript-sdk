 ...
 * 
 * @export
 * @interface VolumeActionsChangeProtectionVolumeRequest
 */
export interface VolumeActionsChangeProtectionVolumeRequest {
    /**
     * If true, prevents the Volume from being deleted
     * @type {boolean}
     * @memberof VolumeActionsChangeProtectionVolumeRequest
     */
    'delete'?: boolean;
}
