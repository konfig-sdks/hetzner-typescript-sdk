...
import { PricingGetAllPricesResponsePricingFloatingIpsInnerPricesInnerPriceMonthly } from './pricing-get-all-prices-response-pricing-floating-ips-inner-prices-inner-price-monthly';

/**
 * 
 * @export
 * @interface PricingGetAllPricesResponsePricingFloatingIpsInnerPricesInner
 */
export interface PricingGetAllPricesResponsePricingFloatingIpsInnerPricesInner {
    /**
     * Name of the Location the price is for
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingFloatingIpsInnerPricesInner
     */
    'location': string;
    /**
     * 
     * @type {PricingGetAllPricesResponsePricingFloatingIpsInnerPricesInnerPriceMonthly}
     * @memberof PricingGetAllPricesResponsePricingFloatingIpsInnerPricesInner
     */
    'price_monthly': PricingGetAllPricesResponsePricingFloatingIpsInnerPricesInnerPriceMonthly;
}
