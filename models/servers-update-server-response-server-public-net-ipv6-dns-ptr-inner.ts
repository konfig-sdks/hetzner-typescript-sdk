 ...
 * 
 * @export
 * @interface ServersUpdateServerResponseServerPublicNetIpv6DnsPtrInner
 */
export interface ServersUpdateServerResponseServerPublicNetIpv6DnsPtrInner {
    /**
     * DNS pointer for the specific IP address
     * @type {string}
     * @memberof ServersUpdateServerResponseServerPublicNetIpv6DnsPtrInner
     */
    'dns_ptr': string;
    /**
