...
import { LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInner } from './load-balancer-types-get-by-id-response-load-balancer-type-prices-inner';

/**
 * 
 * @export
 * @interface LoadBalancerTypesGetByIdResponseLoadBalancerType
 */
export interface LoadBalancerTypesGetByIdResponseLoadBalancerType {
    /**
     * Description of the Load Balancer type
     * @type {string}
     * @memberof LoadBalancerTypesGetByIdResponseLoadBalancerType
     */
    'description': string;
    /**
     ...
     * @type {Array<LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInner>}
     * @memberof LoadBalancerTypesGetByIdResponseLoadBalancerType
     */
    'prices': Array<LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInner>;
}
