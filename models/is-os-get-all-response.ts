...
import { IsOsGetAllResponseIsosInner } from './is-os-get-all-response-isos-inner';
import { ListMetaProperty18 } from './list-meta-property18';

/**
 * 
 * @export
 * @interface IsOsGetAllResponse
 */
export interface IsOsGetAllResponse {
    /**
     * 
     * @type {Array<IsOsGetAllResponseIsosInner>}
     * @memberof IsOsGetAllResponse
     */
    'isos': Array<IsOsGetAllResponseIsosInner>;
    /**
     * 
     * @type {ListMetaProperty18}
     * @memberof IsOsGetAllResponse
     */
    'meta'?: ListMetaProperty18;
}
