 ...
 * @export
 * @interface LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerTypePricesInnerPriceMonthly
 */
export interface LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerTypePricesInnerPriceMonthly {
    /**
     * Price with VAT added.
     * @type {string}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerTypePricesInnerPriceMonthly
     */
    'gross': string;
    /**
     * Price without VAT.
