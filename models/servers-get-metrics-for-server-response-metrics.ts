...
import { LoadBalancersGetMetricsResponseMetricsTimeSeriesValue } from './load-balancers-get-metrics-response-metrics-time-series-value';

/**
 * 
 * @export
 * @interface ServersGetMetricsForServerResponseMetrics
 */
export interface ServersGetMetricsForServerResponseMetrics {
    /**
     * End of period of metrics reported (in ISO-8601 format)
     * @type {string}
     * @memberof ServersGetMetricsForServerResponseMetrics
     */
    'end': string;
    /**
     ...
     * @type {{ [key: string]: LoadBalancersGetMetricsResponseMetricsTimeSeriesValue; }}
     * @memberof ServersGetMetricsForServerResponseMetrics
     */
    'time_series': { [key: string]: LoadBalancersGetMetricsResponseMetricsTimeSeriesValue; };
}
