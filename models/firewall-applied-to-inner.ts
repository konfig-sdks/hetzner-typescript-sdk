...
import { FirewallAppliedToInnerAppliedToResourcesInner } from './firewall-applied-to-inner-applied-to-resources-inner';
import { FirewallAppliedToInnerLabelSelector } from './firewall-applied-to-inner-label-selector';
import { FirewallAppliedToInnerServer } from './firewall-applied-to-inner-server';

/**
 * 
 * @export
 * @interface FirewallAppliedToInner
 */
export interface FirewallAppliedToInner {
    /**
     * 
     * @type {Array<FirewallAppliedToInnerAppliedToResourcesInner>}
     * @memberof FirewallAppliedToInner
     */
    'applied_to_resources'?: Array<FirewallAppliedToInnerAppliedToResourcesInner>;
    /**
     * 
     * @type {FirewallAppliedToInnerLabelSelector}
     * @memberof FirewallAppliedToInner
     */
    'label_selector'?: FirewallAppliedToInnerLabelSelector;
    /**
     * 
     * @type {FirewallAppliedToInnerServer}
     * @memberof FirewallAppliedToInner
     */
    'server'?: FirewallAppliedToInnerServer;
    /**
     * Type of resource referenced
     * @type {string}
     * @memberof FirewallAppliedToInner
     */
    'type': FirewallAppliedToInnerTypeEnum;
}

type FirewallAppliedToInnerTypeEnum = 'server' | 'label_selector'
