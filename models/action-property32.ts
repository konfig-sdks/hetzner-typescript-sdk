...
import { ActionProperty32Error } from './action-property32-error';
import { ActionProperty32ResourcesInner } from './action-property32-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty32
 */
export interface ActionProperty32 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty32
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty32Error}
     * @memberof ActionProperty32
     */
    'error': ActionProperty32Error | null;
    /**
     ...
     * @type {Array<ActionProperty32ResourcesInner>}
     * @memberof ActionProperty32
     */
    'resources': Array<ActionProperty32ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty32
     */
    'status': ActionProperty32StatusEnum;
}

type ActionProperty32StatusEnum = 'success' | 'running' | 'error'
