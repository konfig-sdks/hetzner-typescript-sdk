 ...
 * @export
 * @interface NetworksUpdatePropertiesResponseNetworkProtection
 */
export interface NetworksUpdatePropertiesResponseNetworkProtection {
    /**
     * If true, prevents the Network from being deleted
     * @type {boolean}
     * @memberof NetworksUpdatePropertiesResponseNetworkProtection
     */
    'delete': boolean;
}
