...
import { LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly } from './load-balancers-update-balancer-response-load-balancer-load-balancer-type-prices-inner-price-hourly';
import { LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly } from './load-balancers-update-balancer-response-load-balancer-load-balancer-type-prices-inner-price-monthly';

/**
 * 
 * @export
 * @interface LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInner
 */
export interface LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInner {
    /**
     * Name of the Location the price is for.
     * @type {string}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInner
     */
    'location': string;
    /**
     * 
     * @type {LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInner
     */
    'price_hourly': LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly;
    /**
     * 
     * @type {LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInner
     */
    'price_monthly': LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly;
}
