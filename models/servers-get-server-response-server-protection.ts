 ...
 * @export
 * @interface ServersGetServerResponseServerProtection
 */
export interface ServersGetServerResponseServerProtection {
    /**
     * If true, prevents the Server from being deleted
     * @type {boolean}
     * @memberof ServersGetServerResponseServerProtection
     */
    'delete': boolean;
    /**
