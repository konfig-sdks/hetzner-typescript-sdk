 ...
 * IP address (v4)
 * @export
 * @interface LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv4
 */
export interface LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv4 {
    /**
     * Reverse DNS PTR entry for the IPv4 address of this Load Balancer
     * @type {string}
     * @memberof LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv4
     */
    'dns_ptr'?: string | null;
    /**
