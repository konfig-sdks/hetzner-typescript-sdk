 ...
 * 
 * @export
 * @interface LoadBalancersGetByIdResponseLoadBalancerPrivateNetInner
 */
export interface LoadBalancersGetByIdResponseLoadBalancerPrivateNetInner {
    /**
     * IP address (v4) of this Load Balancer in this Network
     * @type {string}
     * @memberof LoadBalancersGetByIdResponseLoadBalancerPrivateNetInner
     */
    'ip'?: string;
    /**
     * ID of the Network
