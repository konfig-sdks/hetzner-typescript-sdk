...
import { ServersUpdateServerResponseServerPublicNetIpv6DnsPtrInner } from './servers-update-server-response-server-public-net-ipv6-dns-ptr-inner';

/**
 * IPv6 network assigned to this Server and its reverse DNS entry
 * @export
 * @interface ServersUpdateServerResponseServerPublicNetIpv6
 */
export interface ServersUpdateServerResponseServerPublicNetIpv6 {
    /**
     * If the IP is blocked by our anti abuse dept
     * @type {boolean}
     * @memberof ServersUpdateServerResponseServerPublicNetIpv6
     */
    'blocked': boolean;
    /**
     * Reverse DNS PTR entries for the IPv6 addresses of this Server
     * @type {Array<ServersUpdateServerResponseServerPublicNetIpv6DnsPtrInner>}
     * @memberof ServersUpdateServerResponseServerPublicNetIpv6
     */
    'dns_ptr': Array<ServersUpdateServerResponseServerPublicNetIpv6DnsPtrInner> | null;
    /**
