 ...
 * @export
 * @interface ServersCreateServerActionResponseServerDatacenterLocation
 */
export interface ServersCreateServerActionResponseServerDatacenterLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof ServersCreateServerActionResponseServerDatacenterLocation
     */
    'description': string;
    /**
