...
import { ActionProperty23Error } from './action-property23-error';
import { ActionProperty23ResourcesInner } from './action-property23-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty23
 */
export interface ActionProperty23 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty23
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty23Error}
     * @memberof ActionProperty23
     */
    'error': ActionProperty23Error | null;
    /**
     ...
     * @type {Array<ActionProperty23ResourcesInner>}
     * @memberof ActionProperty23
     */
    'resources': Array<ActionProperty23ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty23
     */
    'status': ActionProperty23StatusEnum;
}

type ActionProperty23StatusEnum = 'success' | 'running' | 'error'
