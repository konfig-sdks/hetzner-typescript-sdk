...
import { Action10Error } from './action10-error';
import { Action10ResourcesInner } from './action10-resources-inner';
...
export interface Action10 {
     ...
     * @type {Array<Action10ResourcesInner>}
     * @memberof Action10
     */
    'resources': Array<Action10ResourcesInner>;
    /**
     ...
     * @memberof Action10
     */
    'status': Action10StatusEnum;
}

type Action10StatusEnum = 'success' | 'running' | 'error'
