 ...
 * @export
 * @interface LoadBalancerTargetLabelSelectorProperty2
 */
export interface LoadBalancerTargetLabelSelectorProperty2 {
    /**
     * Label selector
     * @type {string}
     * @memberof LoadBalancerTargetLabelSelectorProperty2
     */
    'selector': string;
}
