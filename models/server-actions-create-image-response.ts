...
import { ActionProperty57 } from './action-property57';
import { ServerActionsCreateImageResponseImage } from './server-actions-create-image-response-image';

/**
 * 
 * @export
 * @interface ServerActionsCreateImageResponse
 */
export interface ServerActionsCreateImageResponse {
    /**
     * 
     * @type {ActionProperty57}
     * @memberof ServerActionsCreateImageResponse
     */
    'action'?: ActionProperty57;
    /**
     * 
     * @type {ServerActionsCreateImageResponseImage}
     * @memberof ServerActionsCreateImageResponse
     */
    'image'?: ServerActionsCreateImageResponseImage;
}
