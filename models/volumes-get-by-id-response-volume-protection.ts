 ...
 * @export
 * @interface VolumesGetByIdResponseVolumeProtection
 */
export interface VolumesGetByIdResponseVolumeProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof VolumesGetByIdResponseVolumeProtection
     */
    'delete': boolean;
}
