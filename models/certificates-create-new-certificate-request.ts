 ...
 * 
 * @export
 * @interface CertificatesCreateNewCertificateRequest
 */
export interface CertificatesCreateNewCertificateRequest {
    /**
     ...
     * @type {string}
     * @memberof CertificatesCreateNewCertificateRequest
     */
    'certificate'?: string;
    /**
     ...
     * @memberof CertificatesCreateNewCertificateRequest
     */
    'type'?: CertificatesCreateNewCertificateRequestTypeEnum;
}

type CertificatesCreateNewCertificateRequestTypeEnum = 'uploaded' | 'managed'
