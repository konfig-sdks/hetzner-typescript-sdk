 ...
 * @export
 * @interface ServersUpdateServerResponseServerServerTypePricesInnerPriceHourly
 */
export interface ServersUpdateServerResponseServerServerTypePricesInnerPriceHourly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof ServersUpdateServerResponseServerServerTypePricesInnerPriceHourly
     */
    'gross': string;
    /**
     * Price without VAT
