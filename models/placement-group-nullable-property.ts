 ...
 * @export
 * @interface PlacementGroupNullableProperty
 */
export interface PlacementGroupNullableProperty {
    /**
     * Array of IDs of Servers that are part of this Placement Group
     * @type {Array<number>}
     * @memberof PlacementGroupNullableProperty
     */
     ...
     * @memberof PlacementGroupNullableProperty
     */
    'type': PlacementGroupNullablePropertyTypeEnum;
}

type PlacementGroupNullablePropertyTypeEnum = 'spread'
