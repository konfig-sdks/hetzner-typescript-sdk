 ...
 * @export
 * @interface FloatingIPsGetResponseFloatingIpHomeLocation
 */
export interface FloatingIPsGetResponseFloatingIpHomeLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof FloatingIPsGetResponseFloatingIpHomeLocation
     */
    'description': string;
    /**
