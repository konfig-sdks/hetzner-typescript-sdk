 ...
 * 
 * @export
 * @interface LoadBalancerTargetHealthStatusPropertyInner9
 */
export interface LoadBalancerTargetHealthStatusPropertyInner9 {
    /**
     * 
     * @type {number}
     * @memberof LoadBalancerTargetHealthStatusPropertyInner9
     */
    'listen_port'?: number;
    /**
     * 
     ...
     * @memberof LoadBalancerTargetHealthStatusPropertyInner9
     */
    'status'?: LoadBalancerTargetHealthStatusPropertyInner9StatusEnum;
}

type LoadBalancerTargetHealthStatusPropertyInner9StatusEnum = 'healthy' | 'unhealthy' | 'unknown'
