...
import { DatacentersGetAllResponseDatacentersInner } from './datacenters-get-all-response-datacenters-inner';
import { ListMetaProperty5 } from './list-meta-property5';

/**
 * 
 * @export
 * @interface DatacentersGetAllResponse
 */
export interface DatacentersGetAllResponse {
    /**
     * 
     * @type {Array<DatacentersGetAllResponseDatacentersInner>}
     * @memberof DatacentersGetAllResponse
     */
    'datacenters': Array<DatacentersGetAllResponseDatacentersInner>;
    /**
     * 
     * @type {ListMetaProperty5}
     * @memberof DatacentersGetAllResponse
     */
    'meta': ListMetaProperty5;
    /**
