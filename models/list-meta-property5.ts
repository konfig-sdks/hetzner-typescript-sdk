...
import { ListMetaProperty5Pagination } from './list-meta-property5-pagination';

/**
 * 
 * @export
 * @interface ListMetaProperty5
 */
export interface ListMetaProperty5 {
    /**
     * 
     * @type {ListMetaProperty5Pagination}
     * @memberof ListMetaProperty5
     */
    'pagination': ListMetaProperty5Pagination;
}
