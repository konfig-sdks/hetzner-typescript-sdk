 ...
 * @export
 * @interface FirewallsCreateFirewallRequestApplyToInnerLabelSelector
 */
export interface FirewallsCreateFirewallRequestApplyToInnerLabelSelector {
    /**
     * Label selector
     * @type {string}
     * @memberof FirewallsCreateFirewallRequestApplyToInnerLabelSelector
     */
    'selector': string;
}
