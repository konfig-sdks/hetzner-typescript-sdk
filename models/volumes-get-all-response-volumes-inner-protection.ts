 ...
 * @export
 * @interface VolumesGetAllResponseVolumesInnerProtection
 */
export interface VolumesGetAllResponseVolumesInnerProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof VolumesGetAllResponseVolumesInnerProtection
     */
    'delete': boolean;
}
