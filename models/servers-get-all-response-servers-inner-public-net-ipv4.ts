 ...
 * @export
 * @interface ServersGetAllResponseServersInnerPublicNetIpv4
 */
export interface ServersGetAllResponseServersInnerPublicNetIpv4 {
    /**
     * If the IP is blocked by our anti abuse dept
     * @type {boolean}
     * @memberof ServersGetAllResponseServersInnerPublicNetIpv4
     */
    'blocked': boolean;
    /**
