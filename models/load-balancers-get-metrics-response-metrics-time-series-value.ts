...
import { LoadBalancersGetMetricsResponseMetricsTimeSeriesValueValuesInnerInner } from './load-balancers-get-metrics-response-metrics-time-series-value-values-inner-inner';

/**
 * 
 * @export
 * @interface LoadBalancersGetMetricsResponseMetricsTimeSeriesValue
 */
export interface LoadBalancersGetMetricsResponseMetricsTimeSeriesValue {
    /**
     * Metrics Timestamps with values
     * @type {Array<Array<LoadBalancersGetMetricsResponseMetricsTimeSeriesValueValuesInnerInner>>}
     * @memberof LoadBalancersGetMetricsResponseMetricsTimeSeriesValue
     */
    'values': Array<Array<LoadBalancersGetMetricsResponseMetricsTimeSeriesValueValuesInnerInner>>;
}
