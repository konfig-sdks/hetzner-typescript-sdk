 ...
 * 
 * @export
 * @interface PlacementGroupsCreateNewGroupRequest
 */
export interface PlacementGroupsCreateNewGroupRequest {
    /**
     * User-defined labels (key-value pairs)
     * @type {object}
     * @memberof PlacementGroupsCreateNewGroupRequest
     */
    'labels'?: object;
    /**
     ...
     * @memberof PlacementGroupsCreateNewGroupRequest
     */
    'type': PlacementGroupsCreateNewGroupRequestTypeEnum;
}

type PlacementGroupsCreateNewGroupRequestTypeEnum = 'spread'
