 ...
 * @export
 * @interface PricingGetAllPricesResponsePricingServerTypesInnerPricesInnerPriceMonthly
 */
export interface PricingGetAllPricesResponsePricingServerTypesInnerPricesInnerPriceMonthly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingServerTypesInnerPricesInnerPriceMonthly
     */
    'gross': string;
    /**
     * Price without VAT
