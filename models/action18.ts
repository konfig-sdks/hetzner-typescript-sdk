...
import { Action18Error } from './action18-error';
import { Action18ResourcesInner } from './action18-resources-inner';
...
export interface Action18 {
     ...
     * @type {Array<Action18ResourcesInner>}
     * @memberof Action18
     */
    'resources': Array<Action18ResourcesInner>;
    /**
     ...
     * @memberof Action18
     */
    'status': Action18StatusEnum;
}

type Action18StatusEnum = 'success' | 'running' | 'error'
