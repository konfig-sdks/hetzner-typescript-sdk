...
import { ActionProperty76Error } from './action-property76-error';
import { ActionProperty76ResourcesInner } from './action-property76-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty76
 */
export interface ActionProperty76 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty76
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty76Error}
     * @memberof ActionProperty76
     */
    'error': ActionProperty76Error | null;
    /**
     ...
     * @type {Array<ActionProperty76ResourcesInner>}
     * @memberof ActionProperty76
     */
    'resources': Array<ActionProperty76ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty76
     */
    'status': ActionProperty76StatusEnum;
}

type ActionProperty76StatusEnum = 'success' | 'running' | 'error'
