 ...
 * 
 * @export
 * @interface FirewallProperty2AppliedToInnerLabelSelector
 */
export interface FirewallProperty2AppliedToInnerLabelSelector {
    /**
     * Label selector
     * @type {string}
     * @memberof FirewallProperty2AppliedToInnerLabelSelector
     */
    'selector': string;
}
