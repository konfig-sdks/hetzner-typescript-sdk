...
import { Action8 } from './action8';
import { ListMetaProperty9 } from './list-meta-property9';

/**
 * 
 * @export
 * @interface FirewallActionsApplyToResourcesResponse
 */
export interface FirewallActionsApplyToResourcesResponse {
    /**
     * 
     * @type {Array<Action8>}
     * @memberof FirewallActionsApplyToResourcesResponse
     */
    'actions': Array<Action8>;
    /**
     * 
     * @type {ListMetaProperty9}
     * @memberof FirewallActionsApplyToResourcesResponse
     */
    'meta'?: ListMetaProperty9;
}
