...
import { PricingGetAllPricesResponsePricingFloatingIpPriceMonthly } from './pricing-get-all-prices-response-pricing-floating-ip-price-monthly';

/**
 * The cost of one Floating IP per month
 * @export
 * @interface PricingGetAllPricesResponsePricingFloatingIp
 */
export interface PricingGetAllPricesResponsePricingFloatingIp {
    /**
     * 
     * @type {PricingGetAllPricesResponsePricingFloatingIpPriceMonthly}
     * @memberof PricingGetAllPricesResponsePricingFloatingIp
     */
    'price_monthly': PricingGetAllPricesResponsePricingFloatingIpPriceMonthly;
}
