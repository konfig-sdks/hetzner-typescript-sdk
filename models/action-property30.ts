...
import { ActionProperty30Error } from './action-property30-error';
import { ActionProperty30ResourcesInner } from './action-property30-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty30
 */
export interface ActionProperty30 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty30
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty30Error}
     * @memberof ActionProperty30
     */
    'error': ActionProperty30Error | null;
    /**
     ...
     * @type {Array<ActionProperty30ResourcesInner>}
     * @memberof ActionProperty30
     */
    'resources': Array<ActionProperty30ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty30
     */
    'status': ActionProperty30StatusEnum;
}

type ActionProperty30StatusEnum = 'success' | 'running' | 'error'
