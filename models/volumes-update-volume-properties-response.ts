...
import { VolumesUpdateVolumePropertiesResponseVolume } from './volumes-update-volume-properties-response-volume';

/**
 * 
 * @export
 * @interface VolumesUpdateVolumePropertiesResponse
 */
export interface VolumesUpdateVolumePropertiesResponse {
    /**
     * 
     * @type {VolumesUpdateVolumePropertiesResponseVolume}
     * @memberof VolumesUpdateVolumePropertiesResponse
     */
    'volume': VolumesUpdateVolumePropertiesResponseVolume;
}
