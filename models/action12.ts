...
import { Action12Error } from './action12-error';
import { Action12ResourcesInner } from './action12-resources-inner';
...
export interface Action12 {
     ...
     * @type {Array<Action12ResourcesInner>}
     * @memberof Action12
     */
    'resources': Array<Action12ResourcesInner>;
    /**
     ...
     * @memberof Action12
     */
    'status': Action12StatusEnum;
}

type Action12StatusEnum = 'success' | 'running' | 'error'
