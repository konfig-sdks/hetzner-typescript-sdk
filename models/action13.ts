...
import { Action13Error } from './action13-error';
import { Action13ResourcesInner } from './action13-resources-inner';
...
export interface Action13 {
     ...
     * @type {Array<Action13ResourcesInner>}
     * @memberof Action13
     */
    'resources': Array<Action13ResourcesInner>;
    /**
     ...
     * @memberof Action13
     */
    'status': Action13StatusEnum;
}

type Action13StatusEnum = 'success' | 'running' | 'error'
