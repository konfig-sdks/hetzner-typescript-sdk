...
import { CertificateProperty1Status } from './certificate-property1-status';
import { CertificateProperty1UsedByInner } from './certificate-property1-used-by-inner';

/**
 * 
 * @export
 * @interface CertificateProperty1
 */
export interface CertificateProperty1 {
    /**
     * Certificate and chain in PEM format, in order so that each record directly certifies the one preceding
     * @type {string}
     * @memberof CertificateProperty1
     */
    ...
    /**
     * 
     * @type {CertificateProperty1Status}
     * @memberof CertificateProperty1
     */
    'status'?: CertificateProperty1Status | null;
    /**
     * Type of the Certificate
     * @type {string}
     * @memberof CertificateProperty1
     */
    'type'?: CertificateProperty1TypeEnum;
    /**
     * Resources currently using the Certificate
     * @type {Array<CertificateProperty1UsedByInner>}
     * @memberof CertificateProperty1
     */
    'used_by': Array<CertificateProperty1UsedByInner>;
}

type CertificateProperty1TypeEnum = 'uploaded' | 'managed'
