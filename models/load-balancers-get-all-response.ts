...
import { ListMetaProperty19 } from './list-meta-property19';
import { LoadBalancersGetAllResponseLoadBalancersInner } from './load-balancers-get-all-response-load-balancers-inner';

/**
 * 
 * @export
 * @interface LoadBalancersGetAllResponse
 */
export interface LoadBalancersGetAllResponse {
    /**
     * 
     * @type {Array<LoadBalancersGetAllResponseLoadBalancersInner>}
     * @memberof LoadBalancersGetAllResponse
     */
    'load_balancers': Array<LoadBalancersGetAllResponseLoadBalancersInner>;
    /**
     * 
     * @type {ListMetaProperty19}
     * @memberof LoadBalancersGetAllResponse
     */
    'meta'?: ListMetaProperty19;
}
