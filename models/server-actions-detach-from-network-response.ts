...
import { ActionProperty58 } from './action-property58';

/**
 * 
 * @export
 * @interface ServerActionsDetachFromNetworkResponse
 */
export interface ServerActionsDetachFromNetworkResponse {
    /**
     * 
     * @type {ActionProperty58}
     * @memberof ServerActionsDetachFromNetworkResponse
     */
    'action': ActionProperty58;
}
