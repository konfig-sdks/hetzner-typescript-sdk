...
import { PricingGetAllPricesResponsePricingServerTypesInnerPricesInnerPriceHourly } from './pricing-get-all-prices-response-pricing-server-types-inner-prices-inner-price-hourly';
import { PricingGetAllPricesResponsePricingServerTypesInnerPricesInnerPriceMonthly } from './pricing-get-all-prices-response-pricing-server-types-inner-prices-inner-price-monthly';

/**
 * 
 * @export
 * @interface PricingGetAllPricesResponsePricingServerTypesInnerPricesInner
 */
export interface PricingGetAllPricesResponsePricingServerTypesInnerPricesInner {
    /**
     * Name of the Location the price is for
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingServerTypesInnerPricesInner
     */
    'location': string;
    /**
     * 
     * @type {PricingGetAllPricesResponsePricingServerTypesInnerPricesInnerPriceHourly}
     * @memberof PricingGetAllPricesResponsePricingServerTypesInnerPricesInner
     */
    'price_hourly': PricingGetAllPricesResponsePricingServerTypesInnerPricesInnerPriceHourly;
    /**
     * 
     * @type {PricingGetAllPricesResponsePricingServerTypesInnerPricesInnerPriceMonthly}
     * @memberof PricingGetAllPricesResponsePricingServerTypesInnerPricesInner
     */
    'price_monthly': PricingGetAllPricesResponsePricingServerTypesInnerPricesInnerPriceMonthly;
}
