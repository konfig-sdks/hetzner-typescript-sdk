...
import { PlacementGroupNullableProperty2 } from './placement-group-nullable-property2';
import { ServersGetServerResponseServerDatacenter } from './servers-get-server-response-server-datacenter';
import { ServersGetServerResponseServerImage } from './servers-get-server-response-server-image';
import { ServersGetServerResponseServerIso } from './servers-get-server-response-server-iso';
import { ServersGetServerResponseServerPrivateNetInner } from './servers-get-server-response-server-private-net-inner';
import { ServersGetServerResponseServerProtection } from './servers-get-server-response-server-protection';
import { ServersGetServerResponseServerPublicNet } from './servers-get-server-response-server-public-net';
import { ServersGetServerResponseServerServerType } from './servers-get-server-response-server-server-type';

/**
 * 
 * @export
 * @interface ServersGetServerResponseServer
 */
export interface ServersGetServerResponseServer {
    /**
     * Time window (UTC) in which the backup will run, or null if the backups are not enabled
     * @type {string}
     * @memberof ServersGetServerResponseServer
     */
    ...
    /**
     * 
     * @type {ServersGetServerResponseServerDatacenter}
     * @memberof ServersGetServerResponseServer
     */
    ...
    /**
     * 
     * @type {ServersGetServerResponseServerImage}
     * @memberof ServersGetServerResponseServer
     */
    'image': ServersGetServerResponseServerImage | null;
    /**
    ...
    /**
     * 
     * @type {ServersGetServerResponseServerIso}
     * @memberof ServersGetServerResponseServer
     */
    'iso': ServersGetServerResponseServerIso | null;
    /**
    ...
    /**
     * 
     * @type {PlacementGroupNullableProperty2}
     * @memberof ServersGetServerResponseServer
     */
    'placement_group'?: PlacementGroupNullableProperty2 | null;
    /**
     ...
     * @type {Array<ServersGetServerResponseServerPrivateNetInner>}
     * @memberof ServersGetServerResponseServer
     */
    'private_net': Array<ServersGetServerResponseServerPrivateNetInner>;
    /**
     * 
     * @type {ServersGetServerResponseServerProtection}
     * @memberof ServersGetServerResponseServer
     */
    'protection': ServersGetServerResponseServerProtection;
    /**
     * 
     * @type {ServersGetServerResponseServerPublicNet}
     * @memberof ServersGetServerResponseServer
     */
    ...
    /**
     * 
     * @type {ServersGetServerResponseServerServerType}
     * @memberof ServersGetServerResponseServer
     */
     ...
     * @memberof ServersGetServerResponseServer
     */
    'status': ServersGetServerResponseServerStatusEnum;
    /**
...
type ServersGetServerResponseServerStatusEnum = 'running' | 'initializing' | 'starting' | 'stopping' | 'false' | 'deleting' | 'migrating' | 'rebuilding' | 'unknown'
