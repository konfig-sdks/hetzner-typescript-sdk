 ...
 * 
 * @export
 * @interface LoadBalancersUpdateBalancerResponseLoadBalancerPrivateNetInner
 */
export interface LoadBalancersUpdateBalancerResponseLoadBalancerPrivateNetInner {
    /**
     * IP address (v4) of this Load Balancer in this Network
     * @type {string}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancerPrivateNetInner
     */
    'ip'?: string;
    /**
     * ID of the Network
