 ...
 * 
 * @export
 * @interface ServersCreateServerActionRequestFirewallsInner
 */
export interface ServersCreateServerActionRequestFirewallsInner {
    /**
     * ID of the Firewall
     * @type {number}
     * @memberof ServersCreateServerActionRequestFirewallsInner
     */
    'firewall': number;
}
