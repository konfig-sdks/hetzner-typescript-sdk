 ...
 * 
 * @export
 * @interface FirewallPropertyAppliedToInnerAppliedToResourcesInnerServer
 */
export interface FirewallPropertyAppliedToInnerAppliedToResourcesInnerServer {
    /**
     * ID of the Resource. Limited to 52 bits to ensure compatibility with JSON double precision floats. 
     * @type {number}
     * @memberof FirewallPropertyAppliedToInnerAppliedToResourcesInnerServer
     */
    'id': number;
}
