 ...
 * 
 * @export
 * @interface FloatingIPsGetResponseFloatingIpDnsPtrInner
 */
export interface FloatingIPsGetResponseFloatingIpDnsPtrInner {
    /**
     * DNS pointer for the specific IP address
     * @type {string}
     * @memberof FloatingIPsGetResponseFloatingIpDnsPtrInner
     */
    'dns_ptr': string;
    /**
