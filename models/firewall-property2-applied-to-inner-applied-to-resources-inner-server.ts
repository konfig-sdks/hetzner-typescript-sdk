 ...
 * 
 * @export
 * @interface FirewallProperty2AppliedToInnerAppliedToResourcesInnerServer
 */
export interface FirewallProperty2AppliedToInnerAppliedToResourcesInnerServer {
    /**
     * ID of the Resource. Limited to 52 bits to ensure compatibility with JSON double precision floats. 
     * @type {number}
     * @memberof FirewallProperty2AppliedToInnerAppliedToResourcesInnerServer
     */
    'id': number;
}
