...
import { LoadBalancerTargetHealthStatusPropertyInner9 } from './load-balancer-target-health-status-property-inner9';
import { LoadBalancerTargetServerProperty9 } from './load-balancer-target-server-property9';

/**
 * 
 * @export
 * @interface LoadBalancerTargetTarget4
 */
export interface LoadBalancerTargetTarget4 {
    /**
     * List of health statuses of the services on this target. Only present for target types \"server\" and \"ip\".
     * @type {Array<LoadBalancerTargetHealthStatusPropertyInner9>}
     * @memberof LoadBalancerTargetTarget4
     */
    'health_status'?: Array<LoadBalancerTargetHealthStatusPropertyInner9>;
    /**
     * 
     * @type {LoadBalancerTargetServerProperty9}
     * @memberof LoadBalancerTargetTarget4
     */
    'server'?: LoadBalancerTargetServerProperty9;
    /**
