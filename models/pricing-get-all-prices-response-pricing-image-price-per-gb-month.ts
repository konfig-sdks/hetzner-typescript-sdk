 ...
 * 
 * @export
 * @interface PricingGetAllPricesResponsePricingImagePricePerGbMonth
 */
export interface PricingGetAllPricesResponsePricingImagePricePerGbMonth {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingImagePricePerGbMonth
     */
    'gross': string;
    /**
     * Price without VAT
