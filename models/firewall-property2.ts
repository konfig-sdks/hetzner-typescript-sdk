...
import { FirewallProperty2AppliedToInner } from './firewall-property2-applied-to-inner';
import { Rule5 } from './rule5';

/**
 * 
 * @export
 * @interface FirewallProperty2
 */
export interface FirewallProperty2 {
    /**
     * 
     * @type {Array<FirewallProperty2AppliedToInner>}
     * @memberof FirewallProperty2
     */
    'applied_to': Array<FirewallProperty2AppliedToInner>;
    /**
