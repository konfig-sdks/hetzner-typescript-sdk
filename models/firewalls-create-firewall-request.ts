...
import { FirewallsCreateFirewallRequestApplyToInner } from './firewalls-create-firewall-request-apply-to-inner';
import { Rule } from './rule';

/**
 * 
 * @export
 * @interface FirewallsCreateFirewallRequest
 */
export interface FirewallsCreateFirewallRequest {
    /**
     * Resources the Firewall should be applied to after creation
     * @type {Array<FirewallsCreateFirewallRequestApplyToInner>}
     * @memberof FirewallsCreateFirewallRequest
     */
    'apply_to'?: Array<FirewallsCreateFirewallRequestApplyToInner>;
    /**
