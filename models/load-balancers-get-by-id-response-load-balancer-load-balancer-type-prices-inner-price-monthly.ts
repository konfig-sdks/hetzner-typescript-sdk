 ...
 * @export
 * @interface LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly
 */
export interface LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly {
    /**
     * Price with VAT added.
     * @type {string}
     * @memberof LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly
     */
    'gross': string;
    /**
     * Price without VAT.
