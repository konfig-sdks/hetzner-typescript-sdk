...
import { ServerPublicNetFirewall3 } from './server-public-net-firewall3';
import { ServersUpdateServerResponseServerPublicNetIpv4 } from './servers-update-server-response-server-public-net-ipv4';
import { ServersUpdateServerResponseServerPublicNetIpv6 } from './servers-update-server-response-server-public-net-ipv6';

/**
 * Public network information. The Server\'s IPv4 address can be found in `public_net->ipv4->ip`
 * @export
 * @interface ServersUpdateServerResponseServerPublicNet
 */
export interface ServersUpdateServerResponseServerPublicNet {
    /**
     * Firewalls applied to the public network interface of this Server
     * @type {Array<ServerPublicNetFirewall3>}
     * @memberof ServersUpdateServerResponseServerPublicNet
     */
    'firewalls'?: Array<ServerPublicNetFirewall3>;
    /**
    ...
    /**
     * 
     * @type {ServersUpdateServerResponseServerPublicNetIpv4}
     * @memberof ServersUpdateServerResponseServerPublicNet
     */
    'ipv4': ServersUpdateServerResponseServerPublicNetIpv4 | null;
    /**
     * 
     * @type {ServersUpdateServerResponseServerPublicNetIpv6}
     * @memberof ServersUpdateServerResponseServerPublicNet
     */
    'ipv6': ServersUpdateServerResponseServerPublicNetIpv6 | null;
}
