...
import { ActionProperty34Error } from './action-property34-error';
import { ActionProperty34ResourcesInner } from './action-property34-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty34
 */
export interface ActionProperty34 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty34
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty34Error}
     * @memberof ActionProperty34
     */
    'error': ActionProperty34Error | null;
    /**
     ...
     * @type {Array<ActionProperty34ResourcesInner>}
     * @memberof ActionProperty34
     */
    'resources': Array<ActionProperty34ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty34
     */
    'status': ActionProperty34StatusEnum;
}

type ActionProperty34StatusEnum = 'success' | 'running' | 'error'
