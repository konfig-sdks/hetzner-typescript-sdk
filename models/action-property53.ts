...
import { ActionProperty53Error } from './action-property53-error';
import { ActionProperty53ResourcesInner } from './action-property53-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty53
 */
export interface ActionProperty53 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty53
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty53Error}
     * @memberof ActionProperty53
     */
    'error': ActionProperty53Error | null;
    /**
     ...
     * @type {Array<ActionProperty53ResourcesInner>}
     * @memberof ActionProperty53
     */
    'resources': Array<ActionProperty53ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty53
     */
    'status': ActionProperty53StatusEnum;
}

type ActionProperty53StatusEnum = 'success' | 'running' | 'error'
