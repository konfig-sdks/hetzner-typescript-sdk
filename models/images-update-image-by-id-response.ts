...
import { ImagesUpdateImageByIdResponseImage } from './images-update-image-by-id-response-image';

/**
 * 
 * @export
 * @interface ImagesUpdateImageByIdResponse
 */
export interface ImagesUpdateImageByIdResponse {
    /**
     * 
     * @type {ImagesUpdateImageByIdResponseImage}
     * @memberof ImagesUpdateImageByIdResponse
     */
    'image'?: ImagesUpdateImageByIdResponseImage;
}
