...
import { PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInnerPriceHourly } from './pricing-get-all-prices-response-pricing-primary-ips-inner-prices-inner-price-hourly';
import { PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly } from './pricing-get-all-prices-response-pricing-primary-ips-inner-prices-inner-price-monthly';

/**
 * 
 * @export
 * @interface PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInner
 */
export interface PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInner {
    /**
     * Name of the Location the price is for
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInner
     */
    'location': string;
    /**
     * 
     * @type {PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInnerPriceHourly}
     * @memberof PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInner
     */
    'price_hourly': PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInnerPriceHourly;
    /**
     * 
     * @type {PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly}
     * @memberof PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInner
     */
    'price_monthly': PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly;
}
