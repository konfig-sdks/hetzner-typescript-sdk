 ...
 * 
 * @export
 * @interface FloatingIPsCreateNewIpRequest
 */
export interface FloatingIPsCreateNewIpRequest {
    /**
     * 
     * @type {string}
     * @memberof FloatingIPsCreateNewIpRequest
     */
    'description'?: string;
    /**
     ...
     * @memberof FloatingIPsCreateNewIpRequest
     */
    'type': FloatingIPsCreateNewIpRequestTypeEnum;
}

type FloatingIPsCreateNewIpRequestTypeEnum = 'ipv4' | 'ipv6'
