...
import { DatacentersGetAllResponseDatacentersInnerLocation } from './datacenters-get-all-response-datacenters-inner-location';
import { DatacentersGetAllResponseDatacentersInnerServerTypes } from './datacenters-get-all-response-datacenters-inner-server-types';

/**
 * 
 * @export
 * @interface DatacentersGetAllResponseDatacentersInner
 */
export interface DatacentersGetAllResponseDatacentersInner {
    /**
     * Description of the Datacenter
     * @type {string}
     * @memberof DatacentersGetAllResponseDatacentersInner
     */
    'description': string;
    /**
    ...
    /**
     * 
     * @type {DatacentersGetAllResponseDatacentersInnerLocation}
     * @memberof DatacentersGetAllResponseDatacentersInner
     */
    'location': DatacentersGetAllResponseDatacentersInnerLocation;
    /**
    ...
    /**
     * 
     * @type {DatacentersGetAllResponseDatacentersInnerServerTypes}
     * @memberof DatacentersGetAllResponseDatacentersInner
     */
    'server_types': DatacentersGetAllResponseDatacentersInnerServerTypes;
}
