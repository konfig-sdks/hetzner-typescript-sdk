...
import { PricingGetAllPricesResponsePricingFloatingIpsInnerPricesInner } from './pricing-get-all-prices-response-pricing-floating-ips-inner-prices-inner';

/**
 * 
 * @export
 * @interface PricingGetAllPricesResponsePricingFloatingIpsInner
 */
export interface PricingGetAllPricesResponsePricingFloatingIpsInner {
    /**
     * Floating IP type costs per Location
     * @type {Array<PricingGetAllPricesResponsePricingFloatingIpsInnerPricesInner>}
     * @memberof PricingGetAllPricesResponsePricingFloatingIpsInner
     */
    'prices': Array<PricingGetAllPricesResponsePricingFloatingIpsInnerPricesInner>;
    /**
     * The type of the Floating IP
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingFloatingIpsInner
     */
    'type': PricingGetAllPricesResponsePricingFloatingIpsInnerTypeEnum;
}

type PricingGetAllPricesResponsePricingFloatingIpsInnerTypeEnum = 'ipv4' | 'ipv6'
