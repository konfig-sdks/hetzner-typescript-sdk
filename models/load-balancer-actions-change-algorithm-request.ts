 ...
 * 
 * @export
 * @interface LoadBalancerActionsChangeAlgorithmRequest
 */
export interface LoadBalancerActionsChangeAlgorithmRequest {
    /**
     * Algorithm of the Load Balancer
     * @type {string}
     * @memberof LoadBalancerActionsChangeAlgorithmRequest
     */
    'type': LoadBalancerActionsChangeAlgorithmRequestTypeEnum;
}

type LoadBalancerActionsChangeAlgorithmRequestTypeEnum = 'round_robin' | 'least_connections'
