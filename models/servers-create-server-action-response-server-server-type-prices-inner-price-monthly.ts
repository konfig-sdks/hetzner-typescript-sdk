 ...
 * @export
 * @interface ServersCreateServerActionResponseServerServerTypePricesInnerPriceMonthly
 */
export interface ServersCreateServerActionResponseServerServerTypePricesInnerPriceMonthly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof ServersCreateServerActionResponseServerServerTypePricesInnerPriceMonthly
     */
    'gross': string;
    /**
     * Price without VAT
