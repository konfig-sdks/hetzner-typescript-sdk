...
import { LoadBalancerServiceHealthCheckProperty4Http } from './load-balancer-service-health-check-property4-http';

/**
 * Service health check
 * @export
 * @interface LoadBalancerServiceHealthCheckProperty4
 */
export interface LoadBalancerServiceHealthCheckProperty4 {
    /**
     * 
     * @type {LoadBalancerServiceHealthCheckProperty4Http}
     * @memberof LoadBalancerServiceHealthCheckProperty4
     */
    'http'?: LoadBalancerServiceHealthCheckProperty4Http;
    /**
     ...
     * @memberof LoadBalancerServiceHealthCheckProperty4
     */
    'protocol': LoadBalancerServiceHealthCheckProperty4ProtocolEnum;
    /**
...
type LoadBalancerServiceHealthCheckProperty4ProtocolEnum = 'tcp' | 'http'
