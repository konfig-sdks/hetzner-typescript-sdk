 ...
 * 
 * @export
 * @interface ServerPublicNetFirewall1
 */
export interface ServerPublicNetFirewall1 {
    /**
     * ID of the Resource. Limited to 52 bits to ensure compatibility with JSON double precision floats. 
     * @type {number}
     * @memberof ServerPublicNetFirewall1
     */
    'id'?: number;
    /**
     ...
     * @memberof ServerPublicNetFirewall1
     */
    'status'?: ServerPublicNetFirewall1StatusEnum;
}

type ServerPublicNetFirewall1StatusEnum = 'applied' | 'pending'
