...
import { ActionProperty75 } from './action-property75';

/**
 * 
 * @export
 * @interface VolumeActionsGetActionByIdResponse
 */
export interface VolumeActionsGetActionByIdResponse {
    /**
     * 
     * @type {ActionProperty75}
     * @memberof VolumeActionsGetActionByIdResponse
     */
    'action': ActionProperty75;
}
