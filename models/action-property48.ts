...
import { ActionProperty48Error } from './action-property48-error';
import { ActionProperty48ResourcesInner } from './action-property48-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty48
 */
export interface ActionProperty48 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty48
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty48Error}
     * @memberof ActionProperty48
     */
    'error': ActionProperty48Error | null;
    /**
     ...
     * @type {Array<ActionProperty48ResourcesInner>}
     * @memberof ActionProperty48
     */
    'resources': Array<ActionProperty48ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty48
     */
    'status': ActionProperty48StatusEnum;
}

type ActionProperty48StatusEnum = 'success' | 'running' | 'error'
