...
import { DeprecationInfoProperty10 } from './deprecation-info-property10';

/**
 * ISO Image that is attached to this Server. Null if no ISO is attached.
 * @export
 * @interface ServersUpdateServerResponseServerIso
 */
export interface ServersUpdateServerResponseServerIso {
    /**
     * Description of the ISO
     * @type {string}
     * @memberof ServersUpdateServerResponseServerIso
     */
    'description': string;
    /**
     ...
     * @memberof ServersUpdateServerResponseServerIso
     */
    'architecture': ServersUpdateServerResponseServerIsoArchitectureEnum;
    /**
     * 
     * @type {DeprecationInfoProperty10}
     * @memberof ServersUpdateServerResponseServerIso
     */
    'deprecation': DeprecationInfoProperty10 | null;
    /**
     ...
     * @memberof ServersUpdateServerResponseServerIso
     */
    'type': ServersUpdateServerResponseServerIsoTypeEnum;
}

type ServersUpdateServerResponseServerIsoArchitectureEnum = 'x86' | 'arm'
type ServersUpdateServerResponseServerIsoTypeEnum = 'public' | 'private'
