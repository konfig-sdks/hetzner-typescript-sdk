 ...
 * @export
 * @interface ServersGetAllResponseServersInnerImageProtection
 */
export interface ServersGetAllResponseServersInnerImageProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof ServersGetAllResponseServersInnerImageProtection
     */
    'delete': boolean;
}
