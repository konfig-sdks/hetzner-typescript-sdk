...
import { ActionProperty31 } from './action-property31';

/**
 * 
 * @export
 * @interface LoadBalancerActionsUpdateServiceResponse
 */
export interface LoadBalancerActionsUpdateServiceResponse {
    /**
     * 
     * @type {ActionProperty31}
     * @memberof LoadBalancerActionsUpdateServiceResponse
     */
    'action': ActionProperty31;
}
