 ...
 * @export
 * @interface ImagesUpdateImageByIdResponseImageProtection
 */
export interface ImagesUpdateImageByIdResponseImageProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof ImagesUpdateImageByIdResponseImageProtection
     */
    'delete': boolean;
}
