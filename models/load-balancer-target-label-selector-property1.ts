 ...
 * @export
 * @interface LoadBalancerTargetLabelSelectorProperty1
 */
export interface LoadBalancerTargetLabelSelectorProperty1 {
    /**
     * Label selector
     * @type {string}
     * @memberof LoadBalancerTargetLabelSelectorProperty1
     */
    'selector': string;
}
