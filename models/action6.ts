...
import { Action6Error } from './action6-error';
import { Action6ResourcesInner } from './action6-resources-inner';
...
export interface Action6 {
     ...
     * @type {Array<Action6ResourcesInner>}
     * @memberof Action6
     */
    'resources': Array<Action6ResourcesInner>;
    /**
     ...
     * @memberof Action6
     */
    'status': Action6StatusEnum;
}

type Action6StatusEnum = 'success' | 'running' | 'error'
