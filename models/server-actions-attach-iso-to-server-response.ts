...
import { ActionProperty51 } from './action-property51';

/**
 * 
 * @export
 * @interface ServerActionsAttachIsoToServerResponse
 */
export interface ServerActionsAttachIsoToServerResponse {
    /**
     * 
     * @type {ActionProperty51}
     * @memberof ServerActionsAttachIsoToServerResponse
     */
    'action': ActionProperty51;
}
