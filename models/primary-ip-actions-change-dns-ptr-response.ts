...
import { ActionProperty44 } from './action-property44';

/**
 * 
 * @export
 * @interface PrimaryIpActionsChangeDnsPtrResponse
 */
export interface PrimaryIpActionsChangeDnsPtrResponse {
    /**
     * 
     * @type {ActionProperty44}
     * @memberof PrimaryIpActionsChangeDnsPtrResponse
     */
    'action': ActionProperty44;
}
