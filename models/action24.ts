...
import { Action24Error } from './action24-error';
import { Action24ResourcesInner } from './action24-resources-inner';
...
export interface Action24 {
     ...
     * @type {Array<Action24ResourcesInner>}
     * @memberof Action24
     */
    'resources': Array<Action24ResourcesInner>;
    /**
     ...
     * @memberof Action24
     */
    'status': Action24StatusEnum;
}

type Action24StatusEnum = 'success' | 'running' | 'error'
