...
import { ListMetaProperty9Pagination } from './list-meta-property9-pagination';

/**
 * 
 * @export
 * @interface ListMetaProperty9
 */
export interface ListMetaProperty9 {
    /**
     * 
     * @type {ListMetaProperty9Pagination}
     * @memberof ListMetaProperty9
     */
    'pagination': ListMetaProperty9Pagination;
}
