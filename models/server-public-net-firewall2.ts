 ...
 * 
 * @export
 * @interface ServerPublicNetFirewall2
 */
export interface ServerPublicNetFirewall2 {
    /**
     * ID of the Resource. Limited to 52 bits to ensure compatibility with JSON double precision floats. 
     * @type {number}
     * @memberof ServerPublicNetFirewall2
     */
    'id'?: number;
    /**
     ...
     * @memberof ServerPublicNetFirewall2
     */
    'status'?: ServerPublicNetFirewall2StatusEnum;
}

type ServerPublicNetFirewall2StatusEnum = 'applied' | 'pending'
