...
import { ListMetaProperty32 } from './list-meta-property32';
import { SshKeysGetAllSshKeysResponseSshKeysInner } from './ssh-keys-get-all-ssh-keys-response-ssh-keys-inner';

/**
 * 
 * @export
 * @interface SshKeysGetAllSshKeysResponse
 */
export interface SshKeysGetAllSshKeysResponse {
    /**
     * 
     * @type {ListMetaProperty32}
     * @memberof SshKeysGetAllSshKeysResponse
     */
    'meta'?: ListMetaProperty32;
    /**
     * 
     * @type {Array<SshKeysGetAllSshKeysResponseSshKeysInner>}
     * @memberof SshKeysGetAllSshKeysResponse
     */
    'ssh_keys': Array<SshKeysGetAllSshKeysResponseSshKeysInner>;
}
