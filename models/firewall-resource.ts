...
import { FirewallResourceLabelSelector } from './firewall-resource-label-selector';
...
export interface FirewallResource {
     ...
     * @memberof FirewallResource
     */
    'type': FirewallResourceTypeEnum;
}

type FirewallResourceTypeEnum = 'server' | 'label_selector'
