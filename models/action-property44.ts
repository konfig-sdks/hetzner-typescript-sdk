...
import { ActionProperty44Error } from './action-property44-error';
import { ActionProperty44ResourcesInner } from './action-property44-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty44
 */
export interface ActionProperty44 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty44
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty44Error}
     * @memberof ActionProperty44
     */
    'error': ActionProperty44Error | null;
    /**
     ...
     * @type {Array<ActionProperty44ResourcesInner>}
     * @memberof ActionProperty44
     */
    'resources': Array<ActionProperty44ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty44
     */
    'status': ActionProperty44StatusEnum;
}

type ActionProperty44StatusEnum = 'success' | 'running' | 'error'
