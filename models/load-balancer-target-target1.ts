...
import { LoadBalancerTargetHealthStatusPropertyInner3 } from './load-balancer-target-health-status-property-inner3';
import { LoadBalancerTargetServerProperty3 } from './load-balancer-target-server-property3';

/**
 * 
 * @export
 * @interface LoadBalancerTargetTarget1
 */
export interface LoadBalancerTargetTarget1 {
    /**
     * List of health statuses of the services on this target. Only present for target types \"server\" and \"ip\".
     * @type {Array<LoadBalancerTargetHealthStatusPropertyInner3>}
     * @memberof LoadBalancerTargetTarget1
     */
    'health_status'?: Array<LoadBalancerTargetHealthStatusPropertyInner3>;
    /**
     * 
     * @type {LoadBalancerTargetServerProperty3}
     * @memberof LoadBalancerTargetTarget1
     */
    'server'?: LoadBalancerTargetServerProperty3;
    /**
