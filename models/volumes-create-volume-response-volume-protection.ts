 ...
 * @export
 * @interface VolumesCreateVolumeResponseVolumeProtection
 */
export interface VolumesCreateVolumeResponseVolumeProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof VolumesCreateVolumeResponseVolumeProtection
     */
    'delete': boolean;
}
