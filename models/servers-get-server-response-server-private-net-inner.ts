 ...
 * 
 * @export
 * @interface ServersGetServerResponseServerPrivateNetInner
 */
export interface ServersGetServerResponseServerPrivateNetInner {
    /**
     * Additional IP addresses of the server on the network.
     * @type {Array<string>}
     * @memberof ServersGetServerResponseServerPrivateNetInner
     */
