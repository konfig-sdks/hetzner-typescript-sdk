 ...
 * 
 * @export
 * @interface LoadBalancersGetByIdResponseLoadBalancerLocation
 */
export interface LoadBalancersGetByIdResponseLoadBalancerLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof LoadBalancersGetByIdResponseLoadBalancerLocation
     */
    'description': string;
    /**
