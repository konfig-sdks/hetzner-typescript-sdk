 ...
 * @export
 * @interface DatacentersGetByIdResponseDatacenterLocation
 */
export interface DatacentersGetByIdResponseDatacenterLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof DatacentersGetByIdResponseDatacenterLocation
     */
    'description': string;
    /**
