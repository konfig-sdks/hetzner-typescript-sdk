...
import { ActionProperty65 } from './action-property65';

/**
 * 
 * @export
 * @interface ServerActionsPowerOnServerResponse
 */
export interface ServerActionsPowerOnServerResponse {
    /**
     * 
     * @type {ActionProperty65}
     * @memberof ServerActionsPowerOnServerResponse
     */
    'action': ActionProperty65;
}
