 ...
 * @export
 * @interface FloatingIpActionsAssignToServerRequest
 */
export interface FloatingIpActionsAssignToServerRequest {
    /**
     * ID of the Server the Floating IP shall be assigned to
     * @type {number}
     * @memberof FloatingIpActionsAssignToServerRequest
     */
    'server': number;
}
