 ...
 * @export
 * @interface ServersUpdateServerResponseServerDatacenterLocation
 */
export interface ServersUpdateServerResponseServerDatacenterLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof ServersUpdateServerResponseServerDatacenterLocation
     */
    'description': string;
    /**
