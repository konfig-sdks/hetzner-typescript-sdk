 ...
 * @export
 * @interface LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly
 */
export interface LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly {
    /**
     * Price with VAT added.
     * @type {string}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly
     */
    'gross': string;
    /**
     * Price without VAT.
