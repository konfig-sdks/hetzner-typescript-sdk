...
import { LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerTypePricesInner } from './load-balancers-get-all-response-load-balancers-inner-load-balancer-type-prices-inner';

/**
 * 
 * @export
 * @interface LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerType
 */
export interface LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerType {
    /**
     * Description of the Load Balancer type
     * @type {string}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerType
     */
    'description': string;
    /**
     ...
     * @type {Array<LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerTypePricesInner>}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerType
     */
    'prices': Array<LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerTypePricesInner>;
}
