...
import { DeprecationInfoProperty5 } from './deprecation-info-property5';
import { ServersGetAllResponseServersInnerServerTypePricesInner } from './servers-get-all-response-servers-inner-server-type-prices-inner';

/**
 * 
 * @export
 * @interface ServersGetAllResponseServersInnerServerType
 */
export interface ServersGetAllResponseServersInnerServerType {
    /**
     * Description of the Server type
     * @type {string}
     * @memberof ServersGetAllResponseServersInnerServerType
     */
    'description': string;
    /**
     ...
     * @memberof ServersGetAllResponseServersInnerServerType
     */
    'architecture': ServersGetAllResponseServersInnerServerTypeArchitectureEnum;
    /**
     ...
     * @memberof ServersGetAllResponseServersInnerServerType
     */
    'cpu_type': ServersGetAllResponseServersInnerServerTypeCpuTypeEnum;
    /**
    ...
    /**
     * 
     * @type {DeprecationInfoProperty5}
     * @memberof ServersGetAllResponseServersInnerServerType
     */
    'deprecation'?: DeprecationInfoProperty5 | null;
    /**
     ...
     * @type {Array<ServersGetAllResponseServersInnerServerTypePricesInner>}
     * @memberof ServersGetAllResponseServersInnerServerType
     */
    'prices': Array<ServersGetAllResponseServersInnerServerTypePricesInner>;
    /**
     * Type of Server boot drive. Local has higher speed. Network has better availability.
     * @type {string}
     * @memberof ServersGetAllResponseServersInnerServerType
     */
    'storage_type': ServersGetAllResponseServersInnerServerTypeStorageTypeEnum;
}

type ServersGetAllResponseServersInnerServerTypeArchitectureEnum = 'x86' | 'arm'
type ServersGetAllResponseServersInnerServerTypeCpuTypeEnum = 'shared' | 'dedicated'
type ServersGetAllResponseServersInnerServerTypeStorageTypeEnum = 'local' | 'network'
