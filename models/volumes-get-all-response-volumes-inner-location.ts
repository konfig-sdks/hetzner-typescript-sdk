 ...
 * @export
 * @interface VolumesGetAllResponseVolumesInnerLocation
 */
export interface VolumesGetAllResponseVolumesInnerLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof VolumesGetAllResponseVolumesInnerLocation
     */
    'description': string;
    /**
