...
import { ActionProperty35 } from './action-property35';

/**
 * 
 * @export
 * @interface NetworkActionsAddSubnetResponse
 */
export interface NetworkActionsAddSubnetResponse {
    /**
     * 
     * @type {ActionProperty35}
     * @memberof NetworkActionsAddSubnetResponse
     */
    'action': ActionProperty35;
}
