...
import { ActionProperty22Error } from './action-property22-error';
import { ActionProperty22ResourcesInner } from './action-property22-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty22
 */
export interface ActionProperty22 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty22
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty22Error}
     * @memberof ActionProperty22
     */
    'error': ActionProperty22Error | null;
    /**
     ...
     * @type {Array<ActionProperty22ResourcesInner>}
     * @memberof ActionProperty22
     */
    'resources': Array<ActionProperty22ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty22
     */
    'status': ActionProperty22StatusEnum;
}

type ActionProperty22StatusEnum = 'success' | 'running' | 'error'
