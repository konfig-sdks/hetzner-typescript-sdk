...
import { ActionProperty66Error } from './action-property66-error';
import { ActionProperty66ResourcesInner } from './action-property66-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty66
 */
export interface ActionProperty66 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty66
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty66Error}
     * @memberof ActionProperty66
     */
    'error': ActionProperty66Error | null;
    /**
     ...
     * @type {Array<ActionProperty66ResourcesInner>}
     * @memberof ActionProperty66
     */
    'resources': Array<ActionProperty66ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty66
     */
    'status': ActionProperty66StatusEnum;
}

type ActionProperty66StatusEnum = 'success' | 'running' | 'error'
