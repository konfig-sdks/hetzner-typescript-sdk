 ...
 * @export
 * @interface ServersGetServerResponseServerServerTypePricesInnerPriceMonthly
 */
export interface ServersGetServerResponseServerServerTypePricesInnerPriceMonthly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof ServersGetServerResponseServerServerTypePricesInnerPriceMonthly
     */
    'gross': string;
    /**
     * Price without VAT
