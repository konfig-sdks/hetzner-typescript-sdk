...
import { Action9 } from './action9';
import { ListMetaProperty10 } from './list-meta-property10';

/**
 * 
 * @export
 * @interface FirewallActionsRemoveFromResourcesResponse
 */
export interface FirewallActionsRemoveFromResourcesResponse {
    /**
     * 
     * @type {Array<Action9>}
     * @memberof FirewallActionsRemoveFromResourcesResponse
     */
    'actions': Array<Action9>;
    /**
     * 
     * @type {ListMetaProperty10}
     * @memberof FirewallActionsRemoveFromResourcesResponse
     */
    'meta'?: ListMetaProperty10;
}
