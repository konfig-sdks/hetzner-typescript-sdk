 ...
 * 
 * @export
 * @interface FirewallAppliedToInnerAppliedToResourcesInnerServer
 */
export interface FirewallAppliedToInnerAppliedToResourcesInnerServer {
    /**
     * ID of the Resource. Limited to 52 bits to ensure compatibility with JSON double precision floats. 
     * @type {number}
     * @memberof FirewallAppliedToInnerAppliedToResourcesInnerServer
     */
    'id': number;
}
