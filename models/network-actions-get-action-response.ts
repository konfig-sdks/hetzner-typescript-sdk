...
import { ActionProperty33 } from './action-property33';

/**
 * 
 * @export
 * @interface NetworkActionsGetActionResponse
 */
export interface NetworkActionsGetActionResponse {
    /**
     * 
     * @type {ActionProperty33}
     * @memberof NetworkActionsGetActionResponse
     */
    'action': ActionProperty33;
}
