...
import { ActionProperty48 } from './action-property48';

/**
 * 
 * @export
 * @interface ServerActionsGetActionByIdResponse
 */
export interface ServerActionsGetActionByIdResponse {
    /**
     * 
     * @type {ActionProperty48}
     * @memberof ServerActionsGetActionByIdResponse
     */
    'action': ActionProperty48;
}
