...
import { ActionProperty18Error } from './action-property18-error';
import { ActionProperty18ResourcesInner } from './action-property18-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty18
 */
export interface ActionProperty18 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty18
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty18Error}
     * @memberof ActionProperty18
     */
    'error': ActionProperty18Error | null;
    /**
     ...
     * @type {Array<ActionProperty18ResourcesInner>}
     * @memberof ActionProperty18
     */
    'resources': Array<ActionProperty18ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty18
     */
    'status': ActionProperty18StatusEnum;
}

type ActionProperty18StatusEnum = 'success' | 'running' | 'error'
