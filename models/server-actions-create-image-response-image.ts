...
import { ServerActionsCreateImageResponseImageCreatedFrom } from './server-actions-create-image-response-image-created-from';
import { ServerActionsCreateImageResponseImageProtection } from './server-actions-create-image-response-image-protection';

/**
 * 
 * @export
 * @interface ServerActionsCreateImageResponseImage
 */
export interface ServerActionsCreateImageResponseImage {
    /**
     * Description of the Image
     * @type {string}
     * @memberof ServerActionsCreateImageResponseImage
     */
    'description': string;
    /**
     ...
     * @memberof ServerActionsCreateImageResponseImage
     */
    'architecture': ServerActionsCreateImageResponseImageArchitectureEnum;
    /**
    ...
    /**
     * 
     * @type {ServerActionsCreateImageResponseImageCreatedFrom}
     * @memberof ServerActionsCreateImageResponseImage
     */
    'created_from': ServerActionsCreateImageResponseImageCreatedFrom | null;
    /**
     ...
     * @memberof ServerActionsCreateImageResponseImage
     */
    'os_flavor': ServerActionsCreateImageResponseImageOsFlavorEnum;
    /**
    ...
    /**
     * 
     * @type {ServerActionsCreateImageResponseImageProtection}
     * @memberof ServerActionsCreateImageResponseImage
     */
     ...
     * @memberof ServerActionsCreateImageResponseImage
     */
    'status': ServerActionsCreateImageResponseImageStatusEnum;
    /**
     * Type of the Image
     * @type {string}
     * @memberof ServerActionsCreateImageResponseImage
     */
    'type': ServerActionsCreateImageResponseImageTypeEnum;
}

type ServerActionsCreateImageResponseImageArchitectureEnum = 'x86' | 'arm'
type ServerActionsCreateImageResponseImageOsFlavorEnum = 'ubuntu' | 'centos' | 'debian' | 'fedora' | 'rocky' | 'alma' | 'unknown'
type ServerActionsCreateImageResponseImageStatusEnum = 'available' | 'creating' | 'unavailable'
type ServerActionsCreateImageResponseImageTypeEnum = 'system' | 'app' | 'snapshot' | 'backup' | 'temporary'
