...
import { VolumesCreateVolumeResponseVolumeLocation } from './volumes-create-volume-response-volume-location';
import { VolumesCreateVolumeResponseVolumeProtection } from './volumes-create-volume-response-volume-protection';

/**
 * 
 * @export
 * @interface VolumesCreateVolumeResponseVolume
 */
export interface VolumesCreateVolumeResponseVolume {
    /**
     * Point in time when the Resource was created (in ISO-8601 format).
     * @type {string}
     * @memberof VolumesCreateVolumeResponseVolume
     */
    'created': string;
    /**
    ...
    /**
     * 
     * @type {VolumesCreateVolumeResponseVolumeLocation}
     * @memberof VolumesCreateVolumeResponseVolume
     */
    ...
    /**
     * 
     * @type {VolumesCreateVolumeResponseVolumeProtection}
     * @memberof VolumesCreateVolumeResponseVolume
     */
     ...
     * @memberof VolumesCreateVolumeResponseVolume
     */
    'status': VolumesCreateVolumeResponseVolumeStatusEnum;
}

type VolumesCreateVolumeResponseVolumeStatusEnum = 'creating' | 'available'
