 ...
 * 
 * @export
 * @interface LocationsGetAllLocationsResponseLocationsInner
 */
export interface LocationsGetAllLocationsResponseLocationsInner {
    /**
     * Description of the Location
     * @type {string}
     * @memberof LocationsGetAllLocationsResponseLocationsInner
     */
    'description': string;
    /**
