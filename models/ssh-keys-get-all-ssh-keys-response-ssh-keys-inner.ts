 ...
 * 
 * @export
 * @interface SshKeysGetAllSshKeysResponseSshKeysInner
 */
export interface SshKeysGetAllSshKeysResponseSshKeysInner {
    /**
     * Point in time when the Resource was created (in ISO-8601 format).
     * @type {string}
     * @memberof SshKeysGetAllSshKeysResponseSshKeysInner
     */
    'created': string;
    /**
