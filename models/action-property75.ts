...
import { ActionProperty75Error } from './action-property75-error';
import { ActionProperty75ResourcesInner } from './action-property75-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty75
 */
export interface ActionProperty75 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty75
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty75Error}
     * @memberof ActionProperty75
     */
    'error': ActionProperty75Error | null;
    /**
     ...
     * @type {Array<ActionProperty75ResourcesInner>}
     * @memberof ActionProperty75
     */
    'resources': Array<ActionProperty75ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty75
     */
    'status': ActionProperty75StatusEnum;
}

type ActionProperty75StatusEnum = 'success' | 'running' | 'error'
