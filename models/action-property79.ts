...
import { ActionProperty79Error } from './action-property79-error';
import { ActionProperty79ResourcesInner } from './action-property79-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty79
 */
export interface ActionProperty79 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty79
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty79Error}
     * @memberof ActionProperty79
     */
    'error': ActionProperty79Error | null;
    /**
     ...
     * @type {Array<ActionProperty79ResourcesInner>}
     * @memberof ActionProperty79
     */
    'resources': Array<ActionProperty79ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty79
     */
    'status': ActionProperty79StatusEnum;
}

type ActionProperty79StatusEnum = 'success' | 'running' | 'error'
