...
import { PrimaryIPPropertyDatacenterLocation } from './primary-ipproperty-datacenter-location';
import { PrimaryIPPropertyDatacenterServerTypes } from './primary-ipproperty-datacenter-server-types';

/**
 * Datacenter this Primary IP is located at
 * @export
 * @interface PrimaryIPPropertyDatacenter
 */
export interface PrimaryIPPropertyDatacenter {
    /**
     * Description of the Datacenter
     * @type {string}
     * @memberof PrimaryIPPropertyDatacenter
     */
    'description': string;
    /**
    ...
    /**
     * 
     * @type {PrimaryIPPropertyDatacenterLocation}
     * @memberof PrimaryIPPropertyDatacenter
     */
    'location': PrimaryIPPropertyDatacenterLocation;
    /**
    ...
    /**
     * 
     * @type {PrimaryIPPropertyDatacenterServerTypes}
     * @memberof PrimaryIPPropertyDatacenter
     */
    'server_types': PrimaryIPPropertyDatacenterServerTypes;
}
