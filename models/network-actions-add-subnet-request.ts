 ...
 * 
 * @export
 * @interface NetworkActionsAddSubnetRequest
 */
export interface NetworkActionsAddSubnetRequest {
    /**
     ...
     * @type {string}
     * @memberof NetworkActionsAddSubnetRequest
     */
    'ip_range'?: string;
    /**
     ...
     * @memberof NetworkActionsAddSubnetRequest
     */
    'type': NetworkActionsAddSubnetRequestTypeEnum;
    /**
...
type NetworkActionsAddSubnetRequestTypeEnum = 'cloud' | 'server' | 'vswitch'
