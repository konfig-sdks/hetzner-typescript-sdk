...
import { ActionProperty21 } from './action-property21';

/**
 * 
 * @export
 * @interface LoadBalancerActionsAttachToNetworkResponse
 */
export interface LoadBalancerActionsAttachToNetworkResponse {
    /**
     * 
     * @type {ActionProperty21}
     * @memberof LoadBalancerActionsAttachToNetworkResponse
     */
    'action': ActionProperty21;
}
