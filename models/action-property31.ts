...
import { ActionProperty31Error } from './action-property31-error';
import { ActionProperty31ResourcesInner } from './action-property31-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty31
 */
export interface ActionProperty31 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty31
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty31Error}
     * @memberof ActionProperty31
     */
    'error': ActionProperty31Error | null;
    /**
     ...
     * @type {Array<ActionProperty31ResourcesInner>}
     * @memberof ActionProperty31
     */
    'resources': Array<ActionProperty31ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty31
     */
    'status': ActionProperty31StatusEnum;
}

type ActionProperty31StatusEnum = 'success' | 'running' | 'error'
