...
import { ActionNullableProperty1Error } from './action-nullable-property1-error';
import { ActionNullableProperty1ResourcesInner } from './action-nullable-property1-resources-inner';

/**
 * 
 * @export
 * @interface ActionNullableProperty1
 */
export interface ActionNullableProperty1 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionNullableProperty1
     */
    'command': string;
    /**
     * 
     * @type {ActionNullableProperty1Error}
     * @memberof ActionNullableProperty1
     */
    'error': ActionNullableProperty1Error | null;
    /**
     ...
     * @type {Array<ActionNullableProperty1ResourcesInner>}
     * @memberof ActionNullableProperty1
     */
    'resources': Array<ActionNullableProperty1ResourcesInner>;
    /**
     ...
     * @memberof ActionNullableProperty1
     */
    'status': ActionNullableProperty1StatusEnum;
}

type ActionNullableProperty1StatusEnum = 'success' | 'running' | 'error'
