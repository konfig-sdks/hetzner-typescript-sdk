...
import { ActionProperty45 } from './action-property45';

/**
 * 
 * @export
 * @interface PrimaryIpActionsChangeProtectionPrimaryIpResponse
 */
export interface PrimaryIpActionsChangeProtectionPrimaryIpResponse {
    /**
     * 
     * @type {ActionProperty45}
     * @memberof PrimaryIpActionsChangeProtectionPrimaryIpResponse
     */
    'action': ActionProperty45;
}
