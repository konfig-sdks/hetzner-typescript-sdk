...
import { FirewallProperty } from './firewall-property';

/**
 * 
 * @export
 * @interface FirewallsCreateFirewallResponse
 */
export interface FirewallsCreateFirewallResponse {
    /**
     * 
     * @type {Array<Action5>}
     * @memberof FirewallsCreateFirewallResponse
     */
    'actions'?: Array<Action5>;
    /**
     * 
     * @type {FirewallProperty}
     * @memberof FirewallsCreateFirewallResponse
     */
    'firewall'?: FirewallProperty;
}
