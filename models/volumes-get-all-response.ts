...
import { ListMetaProperty33 } from './list-meta-property33';
import { VolumesGetAllResponseVolumesInner } from './volumes-get-all-response-volumes-inner';

/**
 * 
 * @export
 * @interface VolumesGetAllResponse
 */
export interface VolumesGetAllResponse {
    /**
     * 
     * @type {ListMetaProperty33}
     * @memberof VolumesGetAllResponse
     */
    'meta'?: ListMetaProperty33;
    /**
     * 
     * @type {Array<VolumesGetAllResponseVolumesInner>}
     * @memberof VolumesGetAllResponse
     */
    'volumes': Array<VolumesGetAllResponseVolumesInner>;
}
