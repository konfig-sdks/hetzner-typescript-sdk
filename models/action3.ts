...
import { Action3Error } from './action3-error';
import { Action3ResourcesInner } from './action3-resources-inner';
...
export interface Action3 {
     ...
     * @type {Array<Action3ResourcesInner>}
     * @memberof Action3
     */
    'resources': Array<Action3ResourcesInner>;
    /**
     ...
     * @memberof Action3
     */
    'status': Action3StatusEnum;
}

type Action3StatusEnum = 'success' | 'running' | 'error'
