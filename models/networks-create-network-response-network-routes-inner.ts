 ...
 * 
 * @export
 * @interface NetworksCreateNetworkResponseNetworkRoutesInner
 */
export interface NetworksCreateNetworkResponseNetworkRoutesInner {
    /**
     ...
     * @type {string}
     * @memberof NetworksCreateNetworkResponseNetworkRoutesInner
     */
    'destination': string;
    /**
