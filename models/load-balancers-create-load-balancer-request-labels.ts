 ...
 * @export
 * @interface LoadBalancersCreateLoadBalancerRequestLabels
 */
export interface LoadBalancersCreateLoadBalancerRequestLabels {
    /**
     * New label
     * @type {string}
     * @memberof LoadBalancersCreateLoadBalancerRequestLabels
     */
    'labelkey'?: string;
}
