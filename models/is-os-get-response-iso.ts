...
import { DeprecationInfoProperty1 } from './deprecation-info-property1';

/**
 * 
 * @export
 * @interface IsOsGetResponseIso
 */
export interface IsOsGetResponseIso {
    /**
     * Description of the ISO
     * @type {string}
     * @memberof IsOsGetResponseIso
     */
    'description': string;
    /**
     ...
     * @memberof IsOsGetResponseIso
     */
    'architecture': IsOsGetResponseIsoArchitectureEnum;
    /**
     * 
     * @type {DeprecationInfoProperty1}
     * @memberof IsOsGetResponseIso
     */
    'deprecation': DeprecationInfoProperty1 | null;
    /**
     ...
     * @memberof IsOsGetResponseIso
     */
    'type': IsOsGetResponseIsoTypeEnum;
}

type IsOsGetResponseIsoArchitectureEnum = 'x86' | 'arm'
type IsOsGetResponseIsoTypeEnum = 'public' | 'private'
