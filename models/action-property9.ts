...
import { ActionProperty9Error } from './action-property9-error';
import { ActionProperty9ResourcesInner } from './action-property9-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty9
 */
export interface ActionProperty9 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty9
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty9Error}
     * @memberof ActionProperty9
     */
    'error': ActionProperty9Error | null;
    /**
     ...
     * @type {Array<ActionProperty9ResourcesInner>}
     * @memberof ActionProperty9
     */
    'resources': Array<ActionProperty9ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty9
     */
    'status': ActionProperty9StatusEnum;
}

type ActionProperty9StatusEnum = 'success' | 'running' | 'error'
