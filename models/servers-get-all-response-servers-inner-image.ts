...
import { ServersGetAllResponseServersInnerImageCreatedFrom } from './servers-get-all-response-servers-inner-image-created-from';
import { ServersGetAllResponseServersInnerImageProtection } from './servers-get-all-response-servers-inner-image-protection';

/**
 * Image the server is based on.
 * @export
 * @interface ServersGetAllResponseServersInnerImage
 */
export interface ServersGetAllResponseServersInnerImage {
    /**
     * Description of the Image
     * @type {string}
     * @memberof ServersGetAllResponseServersInnerImage
     */
    'description': string;
    /**
     ...
     * @memberof ServersGetAllResponseServersInnerImage
     */
    'architecture': ServersGetAllResponseServersInnerImageArchitectureEnum;
    /**
    ...
    /**
     * 
     * @type {ServersGetAllResponseServersInnerImageCreatedFrom}
     * @memberof ServersGetAllResponseServersInnerImage
     */
    'created_from': ServersGetAllResponseServersInnerImageCreatedFrom | null;
    /**
     ...
     * @memberof ServersGetAllResponseServersInnerImage
     */
    'os_flavor': ServersGetAllResponseServersInnerImageOsFlavorEnum;
    /**
    ...
    /**
     * 
     * @type {ServersGetAllResponseServersInnerImageProtection}
     * @memberof ServersGetAllResponseServersInnerImage
     */
    'protection': ServersGetAllResponseServersInnerImageProtection;
    /**
     ...
     * @memberof ServersGetAllResponseServersInnerImage
     */
    'status': ServersGetAllResponseServersInnerImageStatusEnum;
    /**
     * Type of the Image
     * @type {string}
     * @memberof ServersGetAllResponseServersInnerImage
     */
    'type': ServersGetAllResponseServersInnerImageTypeEnum;
}

type ServersGetAllResponseServersInnerImageArchitectureEnum = 'x86' | 'arm'
type ServersGetAllResponseServersInnerImageOsFlavorEnum = 'ubuntu' | 'centos' | 'debian' | 'fedora' | 'rocky' | 'alma' | 'unknown'
type ServersGetAllResponseServersInnerImageStatusEnum = 'available' | 'creating' | 'unavailable'
type ServersGetAllResponseServersInnerImageTypeEnum = 'system' | 'app' | 'snapshot' | 'backup' | 'temporary'
