...
import { LoadBalancerTypesGetByIdResponseLoadBalancerType } from './load-balancer-types-get-by-id-response-load-balancer-type';

/**
 * 
 * @export
 * @interface LoadBalancerTypesGetByIdResponse
 */
export interface LoadBalancerTypesGetByIdResponse {
    /**
     * 
     * @type {LoadBalancerTypesGetByIdResponseLoadBalancerType}
     * @memberof LoadBalancerTypesGetByIdResponse
     */
    'load_balancer_type'?: LoadBalancerTypesGetByIdResponseLoadBalancerType;
}
