 ...
 * 
 * @export
 * @interface NetworksCreateNetworkRequestSubnetsInner
 */
export interface NetworksCreateNetworkRequestSubnetsInner {
    /**
     ...
     * @type {string}
     * @memberof NetworksCreateNetworkRequestSubnetsInner
     */
    'ip_range'?: string;
    /**
     ...
     * @memberof NetworksCreateNetworkRequestSubnetsInner
     */
    'type': NetworksCreateNetworkRequestSubnetsInnerTypeEnum;
    /**
...
type NetworksCreateNetworkRequestSubnetsInnerTypeEnum = 'cloud' | 'server' | 'vswitch'
