...
import { ListMetaProperty3 } from './list-meta-property3';

/**
 * 
 * @export
 * @interface CertificateActionsGetAllActionsResponse
 */
export interface CertificateActionsGetAllActionsResponse {
    /**
     * 
     * @type {Array<Action3>}
     * @memberof CertificateActionsGetAllActionsResponse
     */
    'actions': Array<Action3>;
    /**
     * 
     * @type {ListMetaProperty3}
     * @memberof CertificateActionsGetAllActionsResponse
     */
    'meta'?: ListMetaProperty3;
}
