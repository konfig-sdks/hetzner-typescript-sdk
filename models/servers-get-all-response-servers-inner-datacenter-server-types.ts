 ...
 * @export
 * @interface ServersGetAllResponseServersInnerDatacenterServerTypes
 */
export interface ServersGetAllResponseServersInnerDatacenterServerTypes {
    /**
     * IDs of Server types that are supported and for which the Datacenter has enough resources left
     * @type {Array<number>}
     * @memberof ServersGetAllResponseServersInnerDatacenterServerTypes
     */
