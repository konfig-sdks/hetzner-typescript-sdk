 ...
 * 
 * @export
 * @interface FirewallProperty1AppliedToInnerAppliedToResourcesInnerServer
 */
export interface FirewallProperty1AppliedToInnerAppliedToResourcesInnerServer {
    /**
     * ID of the Resource. Limited to 52 bits to ensure compatibility with JSON double precision floats. 
     * @type {number}
     * @memberof FirewallProperty1AppliedToInnerAppliedToResourcesInnerServer
     */
    'id': number;
}
