...
import { ActionProperty64 } from './action-property64';

/**
 * 
 * @export
 * @interface ServerActionsPowerOffServerResponse
 */
export interface ServerActionsPowerOffServerResponse {
    /**
     * 
     * @type {ActionProperty64}
     * @memberof ServerActionsPowerOffServerResponse
     */
    'action': ActionProperty64;
}
