...
import { VolumesGetAllResponseVolumesInnerLocation } from './volumes-get-all-response-volumes-inner-location';
import { VolumesGetAllResponseVolumesInnerProtection } from './volumes-get-all-response-volumes-inner-protection';

/**
 * 
 * @export
 * @interface VolumesGetAllResponseVolumesInner
 */
export interface VolumesGetAllResponseVolumesInner {
    /**
     * Point in time when the Resource was created (in ISO-8601 format).
     * @type {string}
     * @memberof VolumesGetAllResponseVolumesInner
     */
    'created': string;
    /**
    ...
    /**
     * 
     * @type {VolumesGetAllResponseVolumesInnerLocation}
     * @memberof VolumesGetAllResponseVolumesInner
     */
    'location': VolumesGetAllResponseVolumesInnerLocation;
    /**
    ...
    /**
     * 
     * @type {VolumesGetAllResponseVolumesInnerProtection}
     * @memberof VolumesGetAllResponseVolumesInner
     */
    'protection': VolumesGetAllResponseVolumesInnerProtection;
    /**
     ...
     * @memberof VolumesGetAllResponseVolumesInner
     */
    'status': VolumesGetAllResponseVolumesInnerStatusEnum;
}

type VolumesGetAllResponseVolumesInnerStatusEnum = 'creating' | 'available'
