...
import { ServersGetAllResponseServersInnerPublicNetIpv6DnsPtrInner } from './servers-get-all-response-servers-inner-public-net-ipv6-dns-ptr-inner';

/**
 * IPv6 network assigned to this Server and its reverse DNS entry
 * @export
 * @interface ServersGetAllResponseServersInnerPublicNetIpv6
 */
export interface ServersGetAllResponseServersInnerPublicNetIpv6 {
    /**
     * If the IP is blocked by our anti abuse dept
     * @type {boolean}
     * @memberof ServersGetAllResponseServersInnerPublicNetIpv6
     */
    'blocked': boolean;
    /**
     * Reverse DNS PTR entries for the IPv6 addresses of this Server
     * @type {Array<ServersGetAllResponseServersInnerPublicNetIpv6DnsPtrInner>}
     * @memberof ServersGetAllResponseServersInnerPublicNetIpv6
     */
    'dns_ptr': Array<ServersGetAllResponseServersInnerPublicNetIpv6DnsPtrInner> | null;
    /**
