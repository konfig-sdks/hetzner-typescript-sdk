...
import { ActionProperty61Error } from './action-property61-error';
import { ActionProperty61ResourcesInner } from './action-property61-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty61
 */
export interface ActionProperty61 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty61
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty61Error}
     * @memberof ActionProperty61
     */
    'error': ActionProperty61Error | null;
    /**
     ...
     * @type {Array<ActionProperty61ResourcesInner>}
     * @memberof ActionProperty61
     */
    'resources': Array<ActionProperty61ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty61
     */
    'status': ActionProperty61StatusEnum;
}

type ActionProperty61StatusEnum = 'success' | 'running' | 'error'
