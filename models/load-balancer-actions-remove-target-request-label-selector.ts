 ...
 * @export
 * @interface LoadBalancerActionsRemoveTargetRequestLabelSelector
 */
export interface LoadBalancerActionsRemoveTargetRequestLabelSelector {
    /**
     * Label selector
     * @type {string}
     * @memberof LoadBalancerActionsRemoveTargetRequestLabelSelector
     */
    'selector': string;
}
