 ...
 * @export
 * @interface PlacementGroupNullableProperty1
 */
export interface PlacementGroupNullableProperty1 {
    /**
     * Array of IDs of Servers that are part of this Placement Group
     * @type {Array<number>}
     * @memberof PlacementGroupNullableProperty1
     */
     ...
     * @memberof PlacementGroupNullableProperty1
     */
    'type': PlacementGroupNullableProperty1TypeEnum;
}

type PlacementGroupNullableProperty1TypeEnum = 'spread'
