...
import { ActionProperty19Error } from './action-property19-error';
import { ActionProperty19ResourcesInner } from './action-property19-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty19
 */
export interface ActionProperty19 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty19
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty19Error}
     * @memberof ActionProperty19
     */
    'error': ActionProperty19Error | null;
    /**
     ...
     * @type {Array<ActionProperty19ResourcesInner>}
     * @memberof ActionProperty19
     */
    'resources': Array<ActionProperty19ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty19
     */
    'status': ActionProperty19StatusEnum;
}

type ActionProperty19StatusEnum = 'success' | 'running' | 'error'
