...
import { ServersGetServerResponseServerImageCreatedFrom } from './servers-get-server-response-server-image-created-from';
import { ServersGetServerResponseServerImageProtection } from './servers-get-server-response-server-image-protection';

/**
 * Image the server is based on.
 * @export
 * @interface ServersGetServerResponseServerImage
 */
export interface ServersGetServerResponseServerImage {
    /**
     * Description of the Image
     * @type {string}
     * @memberof ServersGetServerResponseServerImage
     */
    'description': string;
    /**
     ...
     * @memberof ServersGetServerResponseServerImage
     */
    'architecture': ServersGetServerResponseServerImageArchitectureEnum;
    /**
    ...
    /**
     * 
     * @type {ServersGetServerResponseServerImageCreatedFrom}
     * @memberof ServersGetServerResponseServerImage
     */
    'created_from': ServersGetServerResponseServerImageCreatedFrom | null;
    /**
     ...
     * @memberof ServersGetServerResponseServerImage
     */
    'os_flavor': ServersGetServerResponseServerImageOsFlavorEnum;
    /**
    ...
    /**
     * 
     * @type {ServersGetServerResponseServerImageProtection}
     * @memberof ServersGetServerResponseServerImage
     */
     ...
     * @memberof ServersGetServerResponseServerImage
     */
    'status': ServersGetServerResponseServerImageStatusEnum;
    /**
     * Type of the Image
     * @type {string}
     * @memberof ServersGetServerResponseServerImage
     */
    'type': ServersGetServerResponseServerImageTypeEnum;
}

type ServersGetServerResponseServerImageArchitectureEnum = 'x86' | 'arm'
type ServersGetServerResponseServerImageOsFlavorEnum = 'ubuntu' | 'centos' | 'debian' | 'fedora' | 'rocky' | 'alma' | 'unknown'
type ServersGetServerResponseServerImageStatusEnum = 'available' | 'creating' | 'unavailable'
type ServersGetServerResponseServerImageTypeEnum = 'system' | 'app' | 'snapshot' | 'backup' | 'temporary'
