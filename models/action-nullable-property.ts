...
import { ActionNullablePropertyError } from './action-nullable-property-error';
import { ActionNullablePropertyResourcesInner } from './action-nullable-property-resources-inner';

/**
 * 
 * @export
 * @interface ActionNullableProperty
 */
export interface ActionNullableProperty {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionNullableProperty
     */
    'command': string;
    /**
     * 
     * @type {ActionNullablePropertyError}
     * @memberof ActionNullableProperty
     */
    'error': ActionNullablePropertyError | null;
    /**
     ...
     * @type {Array<ActionNullablePropertyResourcesInner>}
     * @memberof ActionNullableProperty
     */
    'resources': Array<ActionNullablePropertyResourcesInner>;
    /**
     ...
     * @memberof ActionNullableProperty
     */
    'status': ActionNullablePropertyStatusEnum;
}

type ActionNullablePropertyStatusEnum = 'success' | 'running' | 'error'
