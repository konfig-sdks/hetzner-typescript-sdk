 ...
 * @export
 * @interface ImagesUpdateImageByIdResponseImageCreatedFrom
 */
export interface ImagesUpdateImageByIdResponseImageCreatedFrom {
    /**
     * ID of the Server the Image was created from
     * @type {number}
     * @memberof ImagesUpdateImageByIdResponseImageCreatedFrom
     */
    'id': number;
    /**
