 ...
 * @export
 * @interface LoadBalancerTargetLabelSelectorProperty
 */
export interface LoadBalancerTargetLabelSelectorProperty {
    /**
     * Label selector
     * @type {string}
     * @memberof LoadBalancerTargetLabelSelectorProperty
     */
    'selector': string;
}
