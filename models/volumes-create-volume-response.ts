...
import { Action23 } from './action23';
import { ActionProperty74 } from './action-property74';
import { VolumesCreateVolumeResponseVolume } from './volumes-create-volume-response-volume';

/**
 * 
 * @export
 * @interface VolumesCreateVolumeResponse
 */
export interface VolumesCreateVolumeResponse {
    /**
     * 
     * @type {ActionProperty74}
     * @memberof VolumesCreateVolumeResponse
     */
    'action': ActionProperty74;
    /**
     * 
     * @type {Array<Action23>}
     * @memberof VolumesCreateVolumeResponse
     */
    'next_actions': Array<Action23>;
    /**
     * 
     * @type {VolumesCreateVolumeResponseVolume}
     * @memberof VolumesCreateVolumeResponse
     */
