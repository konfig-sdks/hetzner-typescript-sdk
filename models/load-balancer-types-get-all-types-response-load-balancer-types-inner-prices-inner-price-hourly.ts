 ...
 * @export
 * @interface LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInnerPriceHourly
 */
export interface LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInnerPriceHourly {
    /**
     * Price with VAT added.
     * @type {string}
     * @memberof LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInnerPriceHourly
     */
    'gross': string;
    /**
     * Price without VAT.
