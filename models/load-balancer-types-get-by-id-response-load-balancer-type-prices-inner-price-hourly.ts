 ...
 * @export
 * @interface LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInnerPriceHourly
 */
export interface LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInnerPriceHourly {
    /**
     * Price with VAT added.
     * @type {string}
     * @memberof LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInnerPriceHourly
     */
    'gross': string;
    /**
     * Price without VAT.
