...
import { ActionProperty21Error } from './action-property21-error';
import { ActionProperty21ResourcesInner } from './action-property21-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty21
 */
export interface ActionProperty21 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty21
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty21Error}
     * @memberof ActionProperty21
     */
    'error': ActionProperty21Error | null;
    /**
     ...
     * @type {Array<ActionProperty21ResourcesInner>}
     * @memberof ActionProperty21
     */
    'resources': Array<ActionProperty21ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty21
     */
    'status': ActionProperty21StatusEnum;
}

type ActionProperty21StatusEnum = 'success' | 'running' | 'error'
