...
import { PricingGetAllPricesResponsePricing } from './pricing-get-all-prices-response-pricing';

/**
 * 
 * @export
 * @interface PricingGetAllPricesResponse
 */
export interface PricingGetAllPricesResponse {
    /**
     * 
     * @type {PricingGetAllPricesResponsePricing}
     * @memberof PricingGetAllPricesResponse
     */
    'pricing': PricingGetAllPricesResponsePricing;
}
