 ...
 * 
 * @export
 * @interface ServersGetAllResponseServersInnerPublicNetIpv6DnsPtrInner
 */
export interface ServersGetAllResponseServersInnerPublicNetIpv6DnsPtrInner {
    /**
     * DNS pointer for the specific IP address
     * @type {string}
     * @memberof ServersGetAllResponseServersInnerPublicNetIpv6DnsPtrInner
     */
    'dns_ptr': string;
    /**
