 ...
 * @export
 * @interface PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInnerPriceMonthly
 */
export interface PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInnerPriceMonthly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInnerPriceMonthly
     */
    'gross': string;
    /**
     * Price without VAT
