...
import { ActionProperty1 } from './action-property1';

/**
 * 
 * @export
 * @interface ActionsGetByIdResponse
 */
export interface ActionsGetByIdResponse {
    /**
     * 
     * @type {ActionProperty1}
     * @memberof ActionsGetByIdResponse
     */
    'action': ActionProperty1;
}
