 ...
 * IP address (v6)
 * @export
 * @interface LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNetIpv6
 */
export interface LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNetIpv6 {
    /**
     * Reverse DNS PTR entry for the IPv6 address of this Load Balancer
     * @type {string}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNetIpv6
     */
    'dns_ptr'?: string | null;
    /**
