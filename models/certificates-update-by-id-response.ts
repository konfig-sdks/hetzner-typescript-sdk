...
import { CertificateProperty2 } from './certificate-property2';

/**
 * 
 * @export
 * @interface CertificatesUpdateByIdResponse
 */
export interface CertificatesUpdateByIdResponse {
    /**
     * 
     * @type {CertificateProperty2}
     * @memberof CertificatesUpdateByIdResponse
     */
    'certificate': CertificateProperty2;
}
