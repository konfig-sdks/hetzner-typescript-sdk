...
import { DeprecationInfoProperty11 } from './deprecation-info-property11';
import { ServersUpdateServerResponseServerServerTypePricesInner } from './servers-update-server-response-server-server-type-prices-inner';

/**
 * 
 * @export
 * @interface ServersUpdateServerResponseServerServerType
 */
export interface ServersUpdateServerResponseServerServerType {
    /**
     * Description of the Server type
     * @type {string}
     * @memberof ServersUpdateServerResponseServerServerType
     */
    'description': string;
    /**
     ...
     * @memberof ServersUpdateServerResponseServerServerType
     */
    'architecture': ServersUpdateServerResponseServerServerTypeArchitectureEnum;
    /**
     ...
     * @memberof ServersUpdateServerResponseServerServerType
     */
    'cpu_type': ServersUpdateServerResponseServerServerTypeCpuTypeEnum;
    /**
    ...
    /**
     * 
     * @type {DeprecationInfoProperty11}
     * @memberof ServersUpdateServerResponseServerServerType
     */
    'deprecation'?: DeprecationInfoProperty11 | null;
    /**
     ...
     * @type {Array<ServersUpdateServerResponseServerServerTypePricesInner>}
     * @memberof ServersUpdateServerResponseServerServerType
     */
    'prices': Array<ServersUpdateServerResponseServerServerTypePricesInner>;
    /**
     * Type of Server boot drive. Local has higher speed. Network has better availability.
     * @type {string}
     * @memberof ServersUpdateServerResponseServerServerType
     */
    'storage_type': ServersUpdateServerResponseServerServerTypeStorageTypeEnum;
}

type ServersUpdateServerResponseServerServerTypeArchitectureEnum = 'x86' | 'arm'
type ServersUpdateServerResponseServerServerTypeCpuTypeEnum = 'shared' | 'dedicated'
type ServersUpdateServerResponseServerServerTypeStorageTypeEnum = 'local' | 'network'
