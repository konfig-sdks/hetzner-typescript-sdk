 ...
 * @export
 * @interface LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly
 */
export interface LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly {
    /**
     * Price with VAT added.
     * @type {string}
     * @memberof LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly
     */
    'gross': string;
    /**
     * Price without VAT.
