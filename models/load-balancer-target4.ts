...
import { LoadBalancerTargetHealthStatusPropertyInner8 } from './load-balancer-target-health-status-property-inner8';
import { LoadBalancerTargetIPProperty6 } from './load-balancer-target-ipproperty6';
import { LoadBalancerTargetLabelSelectorProperty4 } from './load-balancer-target-label-selector-property4';
import { LoadBalancerTargetServerProperty8 } from './load-balancer-target-server-property8';
import { LoadBalancerTargetTarget4 } from './load-balancer-target-target4';

/**
 * 
 * @export
 * @interface LoadBalancerTarget4
 */
export interface LoadBalancerTarget4 {
    /**
     * List of health statuses of the services on this target. Only present for target types \"server\" and \"ip\".
     * @type {Array<LoadBalancerTargetHealthStatusPropertyInner8>}
     * @memberof LoadBalancerTarget4
     */
    'health_status'?: Array<LoadBalancerTargetHealthStatusPropertyInner8>;
    /**
     * 
     * @type {LoadBalancerTargetIPProperty6}
     * @memberof LoadBalancerTarget4
     */
    'ip'?: LoadBalancerTargetIPProperty6;
    /**
     * 
     * @type {LoadBalancerTargetLabelSelectorProperty4}
     * @memberof LoadBalancerTarget4
     */
    'label_selector'?: LoadBalancerTargetLabelSelectorProperty4;
    /**
     * 
     * @type {LoadBalancerTargetServerProperty8}
     * @memberof LoadBalancerTarget4
     */
    'server'?: LoadBalancerTargetServerProperty8;
    /**
     * List of resolved label selector target Servers. Only present for type \"label_selector\".
     * @type {Array<LoadBalancerTargetTarget4>}
     * @memberof LoadBalancerTarget4
     */
    'targets'?: Array<LoadBalancerTargetTarget4>;
    /**
     * Type of the resource
     * @type {string}
     * @memberof LoadBalancerTarget4
     */
    'type': LoadBalancerTarget4TypeEnum;
    /**
...
type LoadBalancerTarget4TypeEnum = 'server' | 'label_selector' | 'ip'
