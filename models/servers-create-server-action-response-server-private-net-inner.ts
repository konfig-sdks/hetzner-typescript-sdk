 ...
 * 
 * @export
 * @interface ServersCreateServerActionResponseServerPrivateNetInner
 */
export interface ServersCreateServerActionResponseServerPrivateNetInner {
    /**
     * Additional IP addresses of the server on the network.
     * @type {Array<string>}
     * @memberof ServersCreateServerActionResponseServerPrivateNetInner
     */
