...
import { NetworksUpdatePropertiesResponseNetwork } from './networks-update-properties-response-network';

/**
 * 
 * @export
 * @interface NetworksUpdatePropertiesResponse
 */
export interface NetworksUpdatePropertiesResponse {
    /**
     * 
     * @type {NetworksUpdatePropertiesResponseNetwork}
     * @memberof NetworksUpdatePropertiesResponse
     */
    'network'?: NetworksUpdatePropertiesResponseNetwork;
}
