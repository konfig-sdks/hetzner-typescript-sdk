...
import { FirewallProperty1 } from './firewall-property1';

/**
 * 
 * @export
 * @interface FirewallsGetFirewallByIdResponse
 */
export interface FirewallsGetFirewallByIdResponse {
    /**
     * 
     * @type {FirewallProperty1}
     * @memberof FirewallsGetFirewallByIdResponse
     */
    'firewall': FirewallProperty1;
}
