...
import { PricingGetAllPricesResponsePricingFloatingIp } from './pricing-get-all-prices-response-pricing-floating-ip';
import { PricingGetAllPricesResponsePricingFloatingIpsInner } from './pricing-get-all-prices-response-pricing-floating-ips-inner';
import { PricingGetAllPricesResponsePricingImage } from './pricing-get-all-prices-response-pricing-image';
import { PricingGetAllPricesResponsePricingLoadBalancerTypesInner } from './pricing-get-all-prices-response-pricing-load-balancer-types-inner';
import { PricingGetAllPricesResponsePricingPrimaryIpsInner } from './pricing-get-all-prices-response-pricing-primary-ips-inner';
import { PricingGetAllPricesResponsePricingServerBackup } from './pricing-get-all-prices-response-pricing-server-backup';
import { PricingGetAllPricesResponsePricingServerTypesInner } from './pricing-get-all-prices-response-pricing-server-types-inner';
import { PricingGetAllPricesResponsePricingTraffic } from './pricing-get-all-prices-response-pricing-traffic';
import { PricingGetAllPricesResponsePricingVolume } from './pricing-get-all-prices-response-pricing-volume';

/**
 * 
 * @export
 * @interface PricingGetAllPricesResponsePricing
 */
export interface PricingGetAllPricesResponsePricing {
    /**
     * Currency the returned prices are expressed in, coded according to ISO 4217
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricing
     */
    'currency': string;
    /**
     * 
     * @type {PricingGetAllPricesResponsePricingFloatingIp}
     * @memberof PricingGetAllPricesResponsePricing
     */
    'floating_ip': PricingGetAllPricesResponsePricingFloatingIp;
    /**
     * Costs of Floating IPs types per Location and type
     * @type {Array<PricingGetAllPricesResponsePricingFloatingIpsInner>}
     * @memberof PricingGetAllPricesResponsePricing
     */
    'floating_ips': Array<PricingGetAllPricesResponsePricingFloatingIpsInner>;
    /**
     * 
     * @type {PricingGetAllPricesResponsePricingImage}
     * @memberof PricingGetAllPricesResponsePricing
     */
    'image': PricingGetAllPricesResponsePricingImage;
    /**
     * Costs of Load Balancer types per Location and type
     * @type {Array<PricingGetAllPricesResponsePricingLoadBalancerTypesInner>}
     * @memberof PricingGetAllPricesResponsePricing
     */
    'load_balancer_types': Array<PricingGetAllPricesResponsePricingLoadBalancerTypesInner>;
    /**
     * Costs of Primary IPs types per Location
     * @type {Array<PricingGetAllPricesResponsePricingPrimaryIpsInner>}
     * @memberof PricingGetAllPricesResponsePricing
     */
    'primary_ips': Array<PricingGetAllPricesResponsePricingPrimaryIpsInner>;
    /**
     * 
     * @type {PricingGetAllPricesResponsePricingServerBackup}
     * @memberof PricingGetAllPricesResponsePricing
     */
    'server_backup': PricingGetAllPricesResponsePricingServerBackup;
    /**
     * Costs of Server types per Location and type
     * @type {Array<PricingGetAllPricesResponsePricingServerTypesInner>}
     * @memberof PricingGetAllPricesResponsePricing
     */
    'server_types': Array<PricingGetAllPricesResponsePricingServerTypesInner>;
    /**
     * 
     * @type {PricingGetAllPricesResponsePricingTraffic}
     * @memberof PricingGetAllPricesResponsePricing
     */
    ...
    /**
     * 
     * @type {PricingGetAllPricesResponsePricingVolume}
     * @memberof PricingGetAllPricesResponsePricing
     */
