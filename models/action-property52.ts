...
import { ActionProperty52Error } from './action-property52-error';
import { ActionProperty52ResourcesInner } from './action-property52-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty52
 */
export interface ActionProperty52 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty52
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty52Error}
     * @memberof ActionProperty52
     */
    'error': ActionProperty52Error | null;
    /**
     ...
     * @type {Array<ActionProperty52ResourcesInner>}
     * @memberof ActionProperty52
     */
    'resources': Array<ActionProperty52ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty52
     */
    'status': ActionProperty52StatusEnum;
}

type ActionProperty52StatusEnum = 'success' | 'running' | 'error'
