...
import { ActionProperty3Error } from './action-property3-error';
import { ActionProperty3ResourcesInner } from './action-property3-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty3
 */
export interface ActionProperty3 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty3
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty3Error}
     * @memberof ActionProperty3
     */
    'error': ActionProperty3Error | null;
    /**
     ...
     * @type {Array<ActionProperty3ResourcesInner>}
     * @memberof ActionProperty3
     */
    'resources': Array<ActionProperty3ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty3
     */
    'status': ActionProperty3StatusEnum;
}

type ActionProperty3StatusEnum = 'success' | 'running' | 'error'
