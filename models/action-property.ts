...
import { ActionPropertyError } from './action-property-error';
import { ActionPropertyResourcesInner } from './action-property-resources-inner';
...
export interface ActionProperty {
     ...
     * @type {string}
     * @memberof ActionProperty
     */
    'command': string;
    /**
     * 
     * @type {ActionPropertyError}
     * @memberof ActionProperty
     */
    'error': ActionPropertyError | null;
    /**
     ...
     * @type {Array<ActionPropertyResourcesInner>}
     * @memberof ActionProperty
     */
    'resources': Array<ActionPropertyResourcesInner>;
    /**
     ...
     * @memberof ActionProperty
     */
    'status': ActionPropertyStatusEnum;
}

type ActionPropertyStatusEnum = 'success' | 'running' | 'error'
