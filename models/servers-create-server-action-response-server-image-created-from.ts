 ...
 * @export
 * @interface ServersCreateServerActionResponseServerImageCreatedFrom
 */
export interface ServersCreateServerActionResponseServerImageCreatedFrom {
    /**
     * ID of the Server the Image was created from
     * @type {number}
     * @memberof ServersCreateServerActionResponseServerImageCreatedFrom
     */
    'id': number;
    /**
