...
import { LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInnerPriceHourly } from './load-balancer-types-get-all-types-response-load-balancer-types-inner-prices-inner-price-hourly';
import { LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInnerPriceMonthly } from './load-balancer-types-get-all-types-response-load-balancer-types-inner-prices-inner-price-monthly';

/**
 * 
 * @export
 * @interface LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInner
 */
export interface LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInner {
    /**
     * Name of the Location the price is for.
     * @type {string}
     * @memberof LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInner
     */
    'location': string;
    /**
     * 
     * @type {LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInnerPriceHourly}
     * @memberof LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInner
     */
    'price_hourly': LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInnerPriceHourly;
    /**
     * 
     * @type {LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInnerPriceMonthly}
     * @memberof LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInner
     */
    'price_monthly': LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInnerPriceMonthly;
}
