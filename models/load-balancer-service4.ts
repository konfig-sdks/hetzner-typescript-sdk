...
import { LoadBalancerServiceHTTPProperty6 } from './load-balancer-service-httpproperty6';
import { LoadBalancerServiceHealthCheckProperty5 } from './load-balancer-service-health-check-property5';

/**
 * 
 * @export
 * @interface LoadBalancerService4
 */
export interface LoadBalancerService4 {
    /**
     * Port the Load Balancer will balance to
     * @type {number}
     * @memberof LoadBalancerService4
     */
    'destination_port': number;
    /**
     * 
     * @type {LoadBalancerServiceHealthCheckProperty5}
     * @memberof LoadBalancerService4
     */
    'health_check': LoadBalancerServiceHealthCheckProperty5;
    /**
     * 
     * @type {LoadBalancerServiceHTTPProperty6}
     * @memberof LoadBalancerService4
     */
    'http'?: LoadBalancerServiceHTTPProperty6;
    /**
     ...
     * @memberof LoadBalancerService4
     */
    'protocol': LoadBalancerService4ProtocolEnum;
    /**
...
type LoadBalancerService4ProtocolEnum = 'tcp' | 'http' | 'https'
