 ...
 * @export
 * @interface PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly
 */
export interface PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly
     */
    'gross': string;
    /**
     * Price without VAT
