 ...
 * @export
 * @interface LoadBalancerActionsAddTargetRequestLabelSelector
 */
export interface LoadBalancerActionsAddTargetRequestLabelSelector {
    /**
     * Label selector
     * @type {string}
     * @memberof LoadBalancerActionsAddTargetRequestLabelSelector
     */
    'selector': string;
}
