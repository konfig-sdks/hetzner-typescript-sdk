...
import { ActionProperty49Error } from './action-property49-error';
import { ActionProperty49ResourcesInner } from './action-property49-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty49
 */
export interface ActionProperty49 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty49
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty49Error}
     * @memberof ActionProperty49
     */
    'error': ActionProperty49Error | null;
    /**
     ...
     * @type {Array<ActionProperty49ResourcesInner>}
     * @memberof ActionProperty49
     */
    'resources': Array<ActionProperty49ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty49
     */
    'status': ActionProperty49StatusEnum;
}

type ActionProperty49StatusEnum = 'success' | 'running' | 'error'
