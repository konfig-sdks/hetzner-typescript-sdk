...
import { Action4Error } from './action4-error';
import { Action4ResourcesInner } from './action4-resources-inner';
...
export interface Action4 {
     ...
     * @type {Array<Action4ResourcesInner>}
     * @memberof Action4
     */
    'resources': Array<Action4ResourcesInner>;
    /**
     ...
     * @memberof Action4
     */
    'status': Action4StatusEnum;
}

type Action4StatusEnum = 'success' | 'running' | 'error'
