 ...
 * @export
 * @interface PricingGetAllPricesResponsePricingServerTypesInnerPricesInnerPriceHourly
 */
export interface PricingGetAllPricesResponsePricingServerTypesInnerPricesInnerPriceHourly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingServerTypesInnerPricesInnerPriceHourly
     */
    'gross': string;
    /**
     * Price without VAT
