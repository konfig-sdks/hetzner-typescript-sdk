 ...
 * @export
 * @interface ServersGetServerResponseServerImageProtection
 */
export interface ServersGetServerResponseServerImageProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof ServersGetServerResponseServerImageProtection
     */
    'delete': boolean;
}
