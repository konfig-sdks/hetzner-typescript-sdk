 ...
 * @export
 * @interface LoadBalancerServiceHealthCheckProperty1Http
 */
export interface LoadBalancerServiceHealthCheckProperty1Http {
    /**
     ...
     * @type {string}
     * @memberof LoadBalancerServiceHealthCheckProperty1Http
     */
    'domain': string | null;
    /**
