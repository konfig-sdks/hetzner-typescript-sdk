...
import { FirewallProperty2 } from './firewall-property2';

/**
 * 
 * @export
 * @interface FirewallsUpdateFirewallByIdResponse
 */
export interface FirewallsUpdateFirewallByIdResponse {
    /**
     * 
     * @type {FirewallProperty2}
     * @memberof FirewallsUpdateFirewallByIdResponse
     */
    'firewall': FirewallProperty2;
}
