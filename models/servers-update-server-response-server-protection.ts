 ...
 * @export
 * @interface ServersUpdateServerResponseServerProtection
 */
export interface ServersUpdateServerResponseServerProtection {
    /**
     * If true, prevents the Server from being deleted
     * @type {boolean}
     * @memberof ServersUpdateServerResponseServerProtection
     */
    'delete': boolean;
    /**
