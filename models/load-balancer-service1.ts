...
import { LoadBalancerServiceHTTPProperty3 } from './load-balancer-service-httpproperty3';
import { LoadBalancerServiceHealthCheckProperty2 } from './load-balancer-service-health-check-property2';

/**
 * 
 * @export
 * @interface LoadBalancerService1
 */
export interface LoadBalancerService1 {
    /**
     * Port the Load Balancer will balance to
     * @type {number}
     * @memberof LoadBalancerService1
     */
    'destination_port': number;
    /**
     * 
     * @type {LoadBalancerServiceHealthCheckProperty2}
     * @memberof LoadBalancerService1
     */
    'health_check': LoadBalancerServiceHealthCheckProperty2;
    /**
     * 
     * @type {LoadBalancerServiceHTTPProperty3}
     * @memberof LoadBalancerService1
     */
    'http'?: LoadBalancerServiceHTTPProperty3;
    /**
     ...
     * @memberof LoadBalancerService1
     */
    'protocol': LoadBalancerService1ProtocolEnum;
    /**
...
type LoadBalancerService1ProtocolEnum = 'tcp' | 'http' | 'https'
