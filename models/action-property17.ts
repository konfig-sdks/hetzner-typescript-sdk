...
import { ActionProperty17Error } from './action-property17-error';
import { ActionProperty17ResourcesInner } from './action-property17-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty17
 */
export interface ActionProperty17 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty17
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty17Error}
     * @memberof ActionProperty17
     */
    'error': ActionProperty17Error | null;
    /**
     ...
     * @type {Array<ActionProperty17ResourcesInner>}
     * @memberof ActionProperty17
     */
    'resources': Array<ActionProperty17ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty17
     */
    'status': ActionProperty17StatusEnum;
}

type ActionProperty17StatusEnum = 'success' | 'running' | 'error'
