 ...
 * @export
 * @interface NetworksCreateNetworkResponseNetworkProtection
 */
export interface NetworksCreateNetworkResponseNetworkProtection {
    /**
     * If true, prevents the Network from being deleted
     * @type {boolean}
     * @memberof NetworksCreateNetworkResponseNetworkProtection
     */
    'delete': boolean;
}
