...
import { DeprecationInfoProperty } from './deprecation-info-property';

/**
 * 
 * @export
 * @interface IsOsGetAllResponseIsosInner
 */
export interface IsOsGetAllResponseIsosInner {
    /**
     * Description of the ISO
     * @type {string}
     * @memberof IsOsGetAllResponseIsosInner
     */
    'description': string;
    /**
     ...
     * @memberof IsOsGetAllResponseIsosInner
     */
    'architecture': IsOsGetAllResponseIsosInnerArchitectureEnum;
    /**
     * 
     * @type {DeprecationInfoProperty}
     * @memberof IsOsGetAllResponseIsosInner
     */
    'deprecation': DeprecationInfoProperty | null;
    /**
     ...
     * @memberof IsOsGetAllResponseIsosInner
     */
    'type': IsOsGetAllResponseIsosInnerTypeEnum;
}

type IsOsGetAllResponseIsosInnerArchitectureEnum = 'x86' | 'arm'
type IsOsGetAllResponseIsosInnerTypeEnum = 'public' | 'private'
