...
import { LoadBalancerService2 } from './load-balancer-service2';
import { LoadBalancerTarget2 } from './load-balancer-target2';
import { LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType } from './load-balancers-create-load-balancer-response-load-balancer-load-balancer-type';
import { LoadBalancersCreateLoadBalancerResponseLoadBalancerLocation } from './load-balancers-create-load-balancer-response-load-balancer-location';
import { LoadBalancersCreateLoadBalancerResponseLoadBalancerPrivateNetInner } from './load-balancers-create-load-balancer-response-load-balancer-private-net-inner';
import { LoadBalancersCreateLoadBalancerResponseLoadBalancerProtection } from './load-balancers-create-load-balancer-response-load-balancer-protection';
import { LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNet } from './load-balancers-create-load-balancer-response-load-balancer-public-net';
 ...
 * 
 * @export
 * @interface LoadBalancersCreateLoadBalancerResponseLoadBalancer
 */
export interface LoadBalancersCreateLoadBalancerResponseLoadBalancer {
    /**
     * 
     * @type {LoadBalancersGetAllResponseLoadBalancersInnerAlgorithm}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancer
     */
    ...
    /**
     * 
     * @type {LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancer
     */
    'load_balancer_type': LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType;
    /**
     * 
     * @type {LoadBalancersCreateLoadBalancerResponseLoadBalancerLocation}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancer
     */
     ...
     * @type {Array<LoadBalancersCreateLoadBalancerResponseLoadBalancerPrivateNetInner>}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancer
     */
    'private_net': Array<LoadBalancersCreateLoadBalancerResponseLoadBalancerPrivateNetInner>;
    /**
     * 
     * @type {LoadBalancersCreateLoadBalancerResponseLoadBalancerProtection}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancer
     */
    'protection': LoadBalancersCreateLoadBalancerResponseLoadBalancerProtection;
    /**
     * 
     * @type {LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNet}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancer
     */
     ...
     * @type {Array<LoadBalancerService2>}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancer
     */
    'services': Array<LoadBalancerService2>;
    /**
     * List of targets that belong to this Load Balancer
     * @type {Array<LoadBalancerTarget2>}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancer
     */
    'targets': Array<LoadBalancerTarget2>;
}
