...
import { ServerPublicNetFirewall2 } from './server-public-net-firewall2';
import { ServersGetServerResponseServerPublicNetIpv4 } from './servers-get-server-response-server-public-net-ipv4';
import { ServersGetServerResponseServerPublicNetIpv6 } from './servers-get-server-response-server-public-net-ipv6';

/**
 * Public network information. The Server\'s IPv4 address can be found in `public_net->ipv4->ip`
 * @export
 * @interface ServersGetServerResponseServerPublicNet
 */
export interface ServersGetServerResponseServerPublicNet {
    /**
     * Firewalls applied to the public network interface of this Server
     * @type {Array<ServerPublicNetFirewall2>}
     * @memberof ServersGetServerResponseServerPublicNet
     */
    'firewalls'?: Array<ServerPublicNetFirewall2>;
    /**
    ...
    /**
     * 
     * @type {ServersGetServerResponseServerPublicNetIpv4}
     * @memberof ServersGetServerResponseServerPublicNet
     */
    'ipv4': ServersGetServerResponseServerPublicNetIpv4 | null;
    /**
     * 
     * @type {ServersGetServerResponseServerPublicNetIpv6}
     * @memberof ServersGetServerResponseServerPublicNet
     */
    'ipv6': ServersGetServerResponseServerPublicNetIpv6 | null;
}
