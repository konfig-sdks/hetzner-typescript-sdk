...
import { FirewallProperty1AppliedToInnerAppliedToResourcesInnerServer } from './firewall-property1-applied-to-inner-applied-to-resources-inner-server';

/**
 * 
 * @export
 * @interface FirewallProperty1AppliedToInnerAppliedToResourcesInner
 */
export interface FirewallProperty1AppliedToInnerAppliedToResourcesInner {
    /**
     * 
     * @type {FirewallProperty1AppliedToInnerAppliedToResourcesInnerServer}
     * @memberof FirewallProperty1AppliedToInnerAppliedToResourcesInner
     */
    'server'?: FirewallProperty1AppliedToInnerAppliedToResourcesInnerServer;
    /**
     * Type of resource referenced
     * @type {string}
     * @memberof FirewallProperty1AppliedToInnerAppliedToResourcesInner
     */
    'type'?: FirewallProperty1AppliedToInnerAppliedToResourcesInnerTypeEnum;
}

type FirewallProperty1AppliedToInnerAppliedToResourcesInnerTypeEnum = 'server'
