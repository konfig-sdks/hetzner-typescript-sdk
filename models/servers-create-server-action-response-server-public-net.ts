...
import { ServerPublicNetFirewall1 } from './server-public-net-firewall1';
import { ServersCreateServerActionResponseServerPublicNetIpv4 } from './servers-create-server-action-response-server-public-net-ipv4';
import { ServersCreateServerActionResponseServerPublicNetIpv6 } from './servers-create-server-action-response-server-public-net-ipv6';

/**
 * Public network information. The Server\'s IPv4 address can be found in `public_net->ipv4->ip`
 * @export
 * @interface ServersCreateServerActionResponseServerPublicNet
 */
export interface ServersCreateServerActionResponseServerPublicNet {
    /**
     * Firewalls applied to the public network interface of this Server
     * @type {Array<ServerPublicNetFirewall1>}
     * @memberof ServersCreateServerActionResponseServerPublicNet
     */
    'firewalls'?: Array<ServerPublicNetFirewall1>;
    /**
    ...
    /**
     * 
     * @type {ServersCreateServerActionResponseServerPublicNetIpv4}
     * @memberof ServersCreateServerActionResponseServerPublicNet
     */
    'ipv4': ServersCreateServerActionResponseServerPublicNetIpv4 | null;
    /**
     * 
     * @type {ServersCreateServerActionResponseServerPublicNetIpv6}
     * @memberof ServersCreateServerActionResponseServerPublicNet
     */
    'ipv6': ServersCreateServerActionResponseServerPublicNetIpv6 | null;
}
