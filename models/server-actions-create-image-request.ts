...
import { ServerActionsCreateImageRequestLabels } from './server-actions-create-image-request-labels';

/**
 * 
 * @export
 * @interface ServerActionsCreateImageRequest
 */
export interface ServerActionsCreateImageRequest {
    /**
     * Description of the Image, will be auto-generated if not set
     * @type {string}
     * @memberof ServerActionsCreateImageRequest
     */
    'description'?: string;
    /**
     * 
     * @type {ServerActionsCreateImageRequestLabels}
     * @memberof ServerActionsCreateImageRequest
     */
    'labels'?: ServerActionsCreateImageRequestLabels;
    /**
     * Type of Image to create.
     * @type {string}
     * @memberof ServerActionsCreateImageRequest
     */
    'type'?: ServerActionsCreateImageRequestTypeEnum;
}

type ServerActionsCreateImageRequestTypeEnum = 'snapshot' | 'backup'
