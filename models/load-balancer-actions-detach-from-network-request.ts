 ...
 * 
 * @export
 * @interface LoadBalancerActionsDetachFromNetworkRequest
 */
export interface LoadBalancerActionsDetachFromNetworkRequest {
    /**
     * ID of an existing network to detach the Load Balancer from
     * @type {number}
     * @memberof LoadBalancerActionsDetachFromNetworkRequest
     */
    'network': number;
}
