 ...
 * @export
 * @interface LoadBalancerServiceHealthCheckProperty3Http
 */
export interface LoadBalancerServiceHealthCheckProperty3Http {
    /**
     ...
     * @type {string}
     * @memberof LoadBalancerServiceHealthCheckProperty3Http
     */
    'domain': string | null;
    /**
