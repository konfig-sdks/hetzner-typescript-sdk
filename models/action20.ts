...
import { Action20Error } from './action20-error';
import { Action20ResourcesInner } from './action20-resources-inner';
...
export interface Action20 {
     ...
     * @type {Array<Action20ResourcesInner>}
     * @memberof Action20
     */
    'resources': Array<Action20ResourcesInner>;
    /**
     ...
     * @memberof Action20
     */
    'status': Action20StatusEnum;
}

type Action20StatusEnum = 'success' | 'running' | 'error'
