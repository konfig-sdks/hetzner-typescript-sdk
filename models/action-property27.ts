...
import { ActionProperty27Error } from './action-property27-error';
import { ActionProperty27ResourcesInner } from './action-property27-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty27
 */
export interface ActionProperty27 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty27
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty27Error}
     * @memberof ActionProperty27
     */
    'error': ActionProperty27Error | null;
    /**
     ...
     * @type {Array<ActionProperty27ResourcesInner>}
     * @memberof ActionProperty27
     */
    'resources': Array<ActionProperty27ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty27
     */
    'status': ActionProperty27StatusEnum;
}

type ActionProperty27StatusEnum = 'success' | 'running' | 'error'
