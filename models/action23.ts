...
import { Action23Error } from './action23-error';
import { Action23ResourcesInner } from './action23-resources-inner';
...
export interface Action23 {
     ...
     * @type {Array<Action23ResourcesInner>}
     * @memberof Action23
     */
    'resources': Array<Action23ResourcesInner>;
    /**
     ...
     * @memberof Action23
     */
    'status': Action23StatusEnum;
}

type Action23StatusEnum = 'success' | 'running' | 'error'
