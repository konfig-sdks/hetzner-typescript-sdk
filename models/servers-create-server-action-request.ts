...
import { ServersCreateServerActionRequestFirewallsInner } from './servers-create-server-action-request-firewalls-inner';
import { ServersCreateServerActionRequestPublicNet } from './servers-create-server-action-request-public-net';

/**
 * 
 * @export
 * @interface ServersCreateServerActionRequest
 */
export interface ServersCreateServerActionRequest {
    /**
     * Auto-mount Volumes after attach
     * @type {boolean}
     * @memberof ServersCreateServerActionRequest
     */
    'automount'?: boolean;
    /**
     ...
     * @type {Array<ServersCreateServerActionRequestFirewallsInner>}
     * @memberof ServersCreateServerActionRequest
     */
    'firewalls'?: Array<ServersCreateServerActionRequestFirewallsInner>;
    /**
    ...
    /**
     * 
     * @type {ServersCreateServerActionRequestPublicNet}
     * @memberof ServersCreateServerActionRequest
     */
    'public_net'?: ServersCreateServerActionRequestPublicNet;
    /**
