 ...
 * 
 * @export
 * @interface LoadBalancerActionsDeleteServiceRequest
 */
export interface LoadBalancerActionsDeleteServiceRequest {
    /**
     * The listen port of the service you want to delete
     * @type {number}
     * @memberof LoadBalancerActionsDeleteServiceRequest
     */
    'listen_port': number;
}
