...
import { ActionProperty79 } from './action-property79';

/**
 * 
 * @export
 * @interface VolumeActionsChangeSizeResponse
 */
export interface VolumeActionsChangeSizeResponse {
    /**
     * 
     * @type {ActionProperty79}
     * @memberof VolumeActionsChangeSizeResponse
     */
    'action': ActionProperty79;
}
