...
import { ActionProperty14 } from './action-property14';

/**
 * 
 * @export
 * @interface ImageActionsGetActionByIdResponse
 */
export interface ImageActionsGetActionByIdResponse {
    /**
     * 
     * @type {ActionProperty14}
     * @memberof ImageActionsGetActionByIdResponse
     */
    'action': ActionProperty14;
}
