 ...
 * IP address (v6)
 * @export
 * @interface LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv6
 */
export interface LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv6 {
    /**
     * Reverse DNS PTR entry for the IPv6 address of this Load Balancer
     * @type {string}
     * @memberof LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv6
     */
    'dns_ptr'?: string | null;
    /**
