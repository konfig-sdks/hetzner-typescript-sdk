 ...
 * 
 * @export
 * @interface LoadBalancerTargetHealthStatusPropertyInner
 */
export interface LoadBalancerTargetHealthStatusPropertyInner {
    /**
     * 
     * @type {number}
     * @memberof LoadBalancerTargetHealthStatusPropertyInner
     */
    'listen_port'?: number;
    /**
     * 
     ...
     * @memberof LoadBalancerTargetHealthStatusPropertyInner
     */
    'status'?: LoadBalancerTargetHealthStatusPropertyInnerStatusEnum;
}

type LoadBalancerTargetHealthStatusPropertyInnerStatusEnum = 'healthy' | 'unhealthy' | 'unknown'
