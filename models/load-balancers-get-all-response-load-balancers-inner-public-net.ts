...
import { LoadBalancersGetAllResponseLoadBalancersInnerPublicNetIpv4 } from './load-balancers-get-all-response-load-balancers-inner-public-net-ipv4';
import { LoadBalancersGetAllResponseLoadBalancersInnerPublicNetIpv6 } from './load-balancers-get-all-response-load-balancers-inner-public-net-ipv6';

/**
 * Public network information
 * @export
 * @interface LoadBalancersGetAllResponseLoadBalancersInnerPublicNet
 */
export interface LoadBalancersGetAllResponseLoadBalancersInnerPublicNet {
    /**
     * Public Interface enabled or not
     * @type {boolean}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInnerPublicNet
     */
    'enabled': boolean;
    /**
     * 
     * @type {LoadBalancersGetAllResponseLoadBalancersInnerPublicNetIpv4}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInnerPublicNet
     */
    'ipv4': LoadBalancersGetAllResponseLoadBalancersInnerPublicNetIpv4;
    /**
     * 
     * @type {LoadBalancersGetAllResponseLoadBalancersInnerPublicNetIpv6}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInnerPublicNet
     */
    'ipv6': LoadBalancersGetAllResponseLoadBalancersInnerPublicNetIpv6;
}
