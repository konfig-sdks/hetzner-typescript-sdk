...
import { DatacentersGetByIdResponseDatacenter } from './datacenters-get-by-id-response-datacenter';

/**
 * 
 * @export
 * @interface DatacentersGetByIdResponse
 */
export interface DatacentersGetByIdResponse {
    /**
     * 
     * @type {DatacentersGetByIdResponseDatacenter}
     * @memberof DatacentersGetByIdResponse
     */
    'datacenter': DatacentersGetByIdResponseDatacenter;
}
