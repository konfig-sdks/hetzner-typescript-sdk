...
import { ImagesUpdateImageByIdResponseImageCreatedFrom } from './images-update-image-by-id-response-image-created-from';
import { ImagesUpdateImageByIdResponseImageProtection } from './images-update-image-by-id-response-image-protection';

/**
 * 
 * @export
 * @interface ImagesUpdateImageByIdResponseImage
 */
export interface ImagesUpdateImageByIdResponseImage {
    /**
     * Description of the Image
     * @type {string}
     * @memberof ImagesUpdateImageByIdResponseImage
     */
    'description': string;
    /**
     ...
     * @memberof ImagesUpdateImageByIdResponseImage
     */
    'architecture': ImagesUpdateImageByIdResponseImageArchitectureEnum;
    /**
    ...
    /**
     * 
     * @type {ImagesUpdateImageByIdResponseImageCreatedFrom}
     * @memberof ImagesUpdateImageByIdResponseImage
     */
    'created_from': ImagesUpdateImageByIdResponseImageCreatedFrom | null;
    /**
     ...
     * @memberof ImagesUpdateImageByIdResponseImage
     */
    'os_flavor': ImagesUpdateImageByIdResponseImageOsFlavorEnum;
    /**
    ...
    /**
     * 
     * @type {ImagesUpdateImageByIdResponseImageProtection}
     * @memberof ImagesUpdateImageByIdResponseImage
     */
     ...
     * @memberof ImagesUpdateImageByIdResponseImage
     */
    'status': ImagesUpdateImageByIdResponseImageStatusEnum;
    /**
     * Type of the Image
     * @type {string}
     * @memberof ImagesUpdateImageByIdResponseImage
     */
    'type': ImagesUpdateImageByIdResponseImageTypeEnum;
}

type ImagesUpdateImageByIdResponseImageArchitectureEnum = 'x86' | 'arm'
type ImagesUpdateImageByIdResponseImageOsFlavorEnum = 'ubuntu' | 'centos' | 'debian' | 'fedora' | 'rocky' | 'alma' | 'unknown'
type ImagesUpdateImageByIdResponseImageStatusEnum = 'available' | 'creating' | 'unavailable'
type ImagesUpdateImageByIdResponseImageTypeEnum = 'system' | 'app' | 'snapshot' | 'backup' | 'temporary'
