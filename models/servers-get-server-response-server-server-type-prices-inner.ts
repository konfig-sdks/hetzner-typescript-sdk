...
import { ServersGetServerResponseServerServerTypePricesInnerPriceHourly } from './servers-get-server-response-server-server-type-prices-inner-price-hourly';
import { ServersGetServerResponseServerServerTypePricesInnerPriceMonthly } from './servers-get-server-response-server-server-type-prices-inner-price-monthly';

/**
 * 
 * @export
 * @interface ServersGetServerResponseServerServerTypePricesInner
 */
export interface ServersGetServerResponseServerServerTypePricesInner {
    /**
     * Name of the Location the price is for
     * @type {string}
     * @memberof ServersGetServerResponseServerServerTypePricesInner
     */
    'location': string;
    /**
     * 
     * @type {ServersGetServerResponseServerServerTypePricesInnerPriceHourly}
     * @memberof ServersGetServerResponseServerServerTypePricesInner
     */
    'price_hourly': ServersGetServerResponseServerServerTypePricesInnerPriceHourly;
    /**
     * 
     * @type {ServersGetServerResponseServerServerTypePricesInnerPriceMonthly}
     * @memberof ServersGetServerResponseServerServerTypePricesInner
     */
    'price_monthly': ServersGetServerResponseServerServerTypePricesInnerPriceMonthly;
}
