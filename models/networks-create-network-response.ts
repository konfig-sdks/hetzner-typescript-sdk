...
import { NetworksCreateNetworkResponseNetwork } from './networks-create-network-response-network';

/**
 * 
 * @export
 * @interface NetworksCreateNetworkResponse
 */
export interface NetworksCreateNetworkResponse {
    /**
     * 
     * @type {NetworksCreateNetworkResponseNetwork}
     * @memberof NetworksCreateNetworkResponse
     */
    'network'?: NetworksCreateNetworkResponseNetwork;
}
