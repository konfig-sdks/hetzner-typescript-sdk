...
import { LoadBalancerServiceHealthCheckProperty2Http } from './load-balancer-service-health-check-property2-http';

/**
 * Service health check
 * @export
 * @interface LoadBalancerServiceHealthCheckProperty2
 */
export interface LoadBalancerServiceHealthCheckProperty2 {
    /**
     * 
     * @type {LoadBalancerServiceHealthCheckProperty2Http}
     * @memberof LoadBalancerServiceHealthCheckProperty2
     */
    'http'?: LoadBalancerServiceHealthCheckProperty2Http;
    /**
     ...
     * @memberof LoadBalancerServiceHealthCheckProperty2
     */
    'protocol': LoadBalancerServiceHealthCheckProperty2ProtocolEnum;
    /**
...
type LoadBalancerServiceHealthCheckProperty2ProtocolEnum = 'tcp' | 'http'
