 ...
 * @export
 * @interface LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly
 */
export interface LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly {
    /**
     * Price with VAT added.
     * @type {string}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly
     */
    'gross': string;
    /**
     * Price without VAT.
