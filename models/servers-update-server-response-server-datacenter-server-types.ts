 ...
 * @export
 * @interface ServersUpdateServerResponseServerDatacenterServerTypes
 */
export interface ServersUpdateServerResponseServerDatacenterServerTypes {
    /**
     * IDs of Server types that are supported and for which the Datacenter has enough resources left
     * @type {Array<number>}
     * @memberof ServersUpdateServerResponseServerDatacenterServerTypes
     */
