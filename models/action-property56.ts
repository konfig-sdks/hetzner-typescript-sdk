...
import { ActionProperty56Error } from './action-property56-error';
import { ActionProperty56ResourcesInner } from './action-property56-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty56
 */
export interface ActionProperty56 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty56
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty56Error}
     * @memberof ActionProperty56
     */
    'error': ActionProperty56Error | null;
    /**
     ...
     * @type {Array<ActionProperty56ResourcesInner>}
     * @memberof ActionProperty56
     */
    'resources': Array<ActionProperty56ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty56
     */
    'status': ActionProperty56StatusEnum;
}

type ActionProperty56StatusEnum = 'success' | 'running' | 'error'
