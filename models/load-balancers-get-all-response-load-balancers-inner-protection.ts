 ...
 * @export
 * @interface LoadBalancersGetAllResponseLoadBalancersInnerProtection
 */
export interface LoadBalancersGetAllResponseLoadBalancersInnerProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInnerProtection
     */
    'delete': boolean;
}
