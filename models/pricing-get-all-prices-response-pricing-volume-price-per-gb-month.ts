 ...
 * 
 * @export
 * @interface PricingGetAllPricesResponsePricingVolumePricePerGbMonth
 */
export interface PricingGetAllPricesResponsePricingVolumePricePerGbMonth {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingVolumePricePerGbMonth
     */
    'gross': string;
    /**
     * Price without VAT
