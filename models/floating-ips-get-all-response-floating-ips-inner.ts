...
import { FloatingIPsGetAllResponseFloatingIpsInnerDnsPtrInner } from './floating-ips-get-all-response-floating-ips-inner-dns-ptr-inner';
import { FloatingIPsGetAllResponseFloatingIpsInnerHomeLocation } from './floating-ips-get-all-response-floating-ips-inner-home-location';
import { FloatingIPsGetAllResponseFloatingIpsInnerProtection } from './floating-ips-get-all-response-floating-ips-inner-protection';

/**
 * 
 * @export
 * @interface FloatingIPsGetAllResponseFloatingIpsInner
 */
export interface FloatingIPsGetAllResponseFloatingIpsInner {
    /**
     * Description of the Resource.
     * @type {string}
     * @memberof FloatingIPsGetAllResponseFloatingIpsInner
     */
     ...
     * @type {Array<FloatingIPsGetAllResponseFloatingIpsInnerDnsPtrInner>}
     * @memberof FloatingIPsGetAllResponseFloatingIpsInner
     */
    'dns_ptr': Array<FloatingIPsGetAllResponseFloatingIpsInnerDnsPtrInner>;
    /**
     * 
     * @type {FloatingIPsGetAllResponseFloatingIpsInnerHomeLocation}
     * @memberof FloatingIPsGetAllResponseFloatingIpsInner
     */
    'home_location': FloatingIPsGetAllResponseFloatingIpsInnerHomeLocation;
    /**
    ...
    /**
     * 
     * @type {FloatingIPsGetAllResponseFloatingIpsInnerProtection}
     * @memberof FloatingIPsGetAllResponseFloatingIpsInner
     */
    'protection': FloatingIPsGetAllResponseFloatingIpsInnerProtection;
    /**
     ...
     * @memberof FloatingIPsGetAllResponseFloatingIpsInner
     */
    'type': FloatingIPsGetAllResponseFloatingIpsInnerTypeEnum;
}

type FloatingIPsGetAllResponseFloatingIpsInnerTypeEnum = 'ipv4' | 'ipv6'
