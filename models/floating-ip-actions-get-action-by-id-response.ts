...
import { ActionProperty8 } from './action-property8';

/**
 * 
 * @export
 * @interface FloatingIpActionsGetActionByIdResponse
 */
export interface FloatingIpActionsGetActionByIdResponse {
    /**
     * 
     * @type {ActionProperty8}
     * @memberof FloatingIpActionsGetActionByIdResponse
     */
    'action': ActionProperty8;
}
