...
import { ActionProperty59 } from './action-property59';

/**
 * 
 * @export
 * @interface ServerActionsDetachIsoFromServerResponse
 */
export interface ServerActionsDetachIsoFromServerResponse {
    /**
     * 
     * @type {ActionProperty59}
     * @memberof ServerActionsDetachIsoFromServerResponse
     */
    'action': ActionProperty59;
}
