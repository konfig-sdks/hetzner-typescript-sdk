...
import { ActionProperty8Error } from './action-property8-error';
import { ActionProperty8ResourcesInner } from './action-property8-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty8
 */
export interface ActionProperty8 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty8
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty8Error}
     * @memberof ActionProperty8
     */
    'error': ActionProperty8Error | null;
    /**
     ...
     * @type {Array<ActionProperty8ResourcesInner>}
     * @memberof ActionProperty8
     */
    'resources': Array<ActionProperty8ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty8
     */
    'status': ActionProperty8StatusEnum;
}

type ActionProperty8StatusEnum = 'success' | 'running' | 'error'
