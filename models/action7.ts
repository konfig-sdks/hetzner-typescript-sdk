...
import { Action7Error } from './action7-error';
import { Action7ResourcesInner } from './action7-resources-inner';
...
export interface Action7 {
     ...
     * @type {Array<Action7ResourcesInner>}
     * @memberof Action7
     */
    'resources': Array<Action7ResourcesInner>;
    /**
     ...
     * @memberof Action7
     */
    'status': Action7StatusEnum;
}

type Action7StatusEnum = 'success' | 'running' | 'error'
