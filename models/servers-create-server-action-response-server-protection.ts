 ...
 * @export
 * @interface ServersCreateServerActionResponseServerProtection
 */
export interface ServersCreateServerActionResponseServerProtection {
    /**
     * If true, prevents the Server from being deleted
     * @type {boolean}
     * @memberof ServersCreateServerActionResponseServerProtection
     */
    'delete': boolean;
    /**
