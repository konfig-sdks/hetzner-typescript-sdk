 ...
 * 
 * @export
 * @interface FloatingIPsUpdateDescriptionLabelsResponseFloatingIpDnsPtrInner
 */
export interface FloatingIPsUpdateDescriptionLabelsResponseFloatingIpDnsPtrInner {
    /**
     * DNS pointer for the specific IP address
     * @type {string}
     * @memberof FloatingIPsUpdateDescriptionLabelsResponseFloatingIpDnsPtrInner
     */
    'dns_ptr': string;
    /**
