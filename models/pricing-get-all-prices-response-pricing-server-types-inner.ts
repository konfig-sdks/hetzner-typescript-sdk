...
import { PricingGetAllPricesResponsePricingServerTypesInnerPricesInner } from './pricing-get-all-prices-response-pricing-server-types-inner-prices-inner';

/**
 * 
 * @export
 * @interface PricingGetAllPricesResponsePricingServerTypesInner
 */
export interface PricingGetAllPricesResponsePricingServerTypesInner {
    /**
     * ID of the Server type the price is for
     * @type {number}
     * @memberof PricingGetAllPricesResponsePricingServerTypesInner
     */
    'id': number;
    /**
     ...
     * @type {Array<PricingGetAllPricesResponsePricingServerTypesInnerPricesInner>}
     * @memberof PricingGetAllPricesResponsePricingServerTypesInner
     */
    'prices': Array<PricingGetAllPricesResponsePricingServerTypesInnerPricesInner>;
}
