...
import { Action19Error } from './action19-error';
import { Action19ResourcesInner } from './action19-resources-inner';
...
export interface Action19 {
     ...
     * @type {Array<Action19ResourcesInner>}
     * @memberof Action19
     */
    'resources': Array<Action19ResourcesInner>;
    /**
     ...
     * @memberof Action19
     */
    'status': Action19StatusEnum;
}

type Action19StatusEnum = 'success' | 'running' | 'error'
