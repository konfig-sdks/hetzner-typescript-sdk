...
import { ActionProperty24Error } from './action-property24-error';
import { ActionProperty24ResourcesInner } from './action-property24-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty24
 */
export interface ActionProperty24 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty24
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty24Error}
     * @memberof ActionProperty24
     */
    'error': ActionProperty24Error | null;
    /**
     ...
     * @type {Array<ActionProperty24ResourcesInner>}
     * @memberof ActionProperty24
     */
    'resources': Array<ActionProperty24ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty24
     */
    'status': ActionProperty24StatusEnum;
}

type ActionProperty24StatusEnum = 'success' | 'running' | 'error'
