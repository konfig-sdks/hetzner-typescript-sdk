...
import { NetworksCreateNetworkRequestLabels } from './networks-create-network-request-labels';
import { NetworksCreateNetworkRequestRoutesInner } from './networks-create-network-request-routes-inner';
import { NetworksCreateNetworkRequestSubnetsInner } from './networks-create-network-request-subnets-inner';

/**
 * 
 * @export
 * @interface NetworksCreateNetworkRequest
 */
export interface NetworksCreateNetworkRequest {
    /**
     ...
     * @type {boolean}
     * @memberof NetworksCreateNetworkRequest
     */
    ...
    /**
     * 
     * @type {NetworksCreateNetworkRequestLabels}
     * @memberof NetworksCreateNetworkRequest
     */
    'labels'?: NetworksCreateNetworkRequestLabels;
    /**
     * Name of the network
     * @type {string}
     * @memberof NetworksCreateNetworkRequest
     ...
     * @type {Array<NetworksCreateNetworkRequestRoutesInner>}
     * @memberof NetworksCreateNetworkRequest
     */
    'routes'?: Array<NetworksCreateNetworkRequestRoutesInner>;
    /**
     * Array of subnets allocated.
     * @type {Array<NetworksCreateNetworkRequestSubnetsInner>}
     * @memberof NetworksCreateNetworkRequest
     */
    'subnets'?: Array<NetworksCreateNetworkRequestSubnetsInner>;
}
