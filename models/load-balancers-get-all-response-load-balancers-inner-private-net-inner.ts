 ...
 * 
 * @export
 * @interface LoadBalancersGetAllResponseLoadBalancersInnerPrivateNetInner
 */
export interface LoadBalancersGetAllResponseLoadBalancersInnerPrivateNetInner {
    /**
     * IP address (v4) of this Load Balancer in this Network
     * @type {string}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInnerPrivateNetInner
     */
    'ip'?: string;
    /**
     * ID of the Network
