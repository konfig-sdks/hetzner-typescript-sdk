...
import { ActionProperty67Error } from './action-property67-error';
import { ActionProperty67ResourcesInner } from './action-property67-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty67
 */
export interface ActionProperty67 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty67
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty67Error}
     * @memberof ActionProperty67
     */
    'error': ActionProperty67Error | null;
    /**
     ...
     * @type {Array<ActionProperty67ResourcesInner>}
     * @memberof ActionProperty67
     */
    'resources': Array<ActionProperty67ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty67
     */
    'status': ActionProperty67StatusEnum;
}

type ActionProperty67StatusEnum = 'success' | 'running' | 'error'
