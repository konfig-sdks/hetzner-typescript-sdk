...
import { ActionProperty25Error } from './action-property25-error';
import { ActionProperty25ResourcesInner } from './action-property25-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty25
 */
export interface ActionProperty25 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty25
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty25Error}
     * @memberof ActionProperty25
     */
    'error': ActionProperty25Error | null;
    /**
     ...
     * @type {Array<ActionProperty25ResourcesInner>}
     * @memberof ActionProperty25
     */
    'resources': Array<ActionProperty25ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty25
     */
    'status': ActionProperty25StatusEnum;
}

type ActionProperty25StatusEnum = 'success' | 'running' | 'error'
