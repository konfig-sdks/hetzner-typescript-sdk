...
import { FloatingIPsGetAllResponseFloatingIpsInner } from './floating-ips-get-all-response-floating-ips-inner';
import { ListMetaProperty12 } from './list-meta-property12';

/**
 * 
 * @export
 * @interface FloatingIPsGetAllResponse
 */
export interface FloatingIPsGetAllResponse {
    /**
     * 
     * @type {Array<FloatingIPsGetAllResponseFloatingIpsInner>}
     * @memberof FloatingIPsGetAllResponse
     */
    'floating_ips': Array<FloatingIPsGetAllResponseFloatingIpsInner>;
    /**
     * 
     * @type {ListMetaProperty12}
     * @memberof FloatingIPsGetAllResponse
     */
    'meta'?: ListMetaProperty12;
}
