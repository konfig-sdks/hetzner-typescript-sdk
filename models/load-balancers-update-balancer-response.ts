...
import { LoadBalancersUpdateBalancerResponseLoadBalancer } from './load-balancers-update-balancer-response-load-balancer';

/**
 * 
 * @export
 * @interface LoadBalancersUpdateBalancerResponse
 */
export interface LoadBalancersUpdateBalancerResponse {
    /**
     * 
     * @type {LoadBalancersUpdateBalancerResponseLoadBalancer}
     * @memberof LoadBalancersUpdateBalancerResponse
     */
    'load_balancer': LoadBalancersUpdateBalancerResponseLoadBalancer;
}
