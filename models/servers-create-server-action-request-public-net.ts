 ...
 * @export
 * @interface ServersCreateServerActionRequestPublicNet
 */
export interface ServersCreateServerActionRequestPublicNet {
    /**
     * Attach an IPv4 on the public NIC. If false, no IPv4 address will be attached.
     * @type {boolean}
     * @memberof ServersCreateServerActionRequestPublicNet
     */
    'enable_ipv4'?: boolean;
    /**
