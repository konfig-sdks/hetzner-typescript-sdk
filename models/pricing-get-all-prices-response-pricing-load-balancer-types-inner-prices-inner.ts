...
import { PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly } from './pricing-get-all-prices-response-pricing-load-balancer-types-inner-prices-inner-price-hourly';
import { PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInnerPriceMonthly } from './pricing-get-all-prices-response-pricing-load-balancer-types-inner-prices-inner-price-monthly';

/**
 * 
 * @export
 * @interface PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInner
 */
export interface PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInner {
    /**
     * Name of the Location the price is for
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInner
     */
    'location': string;
    /**
     * 
     * @type {PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly}
     * @memberof PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInner
     */
    'price_hourly': PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInnerPriceHourly;
    /**
     * 
     * @type {PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInnerPriceMonthly}
     * @memberof PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInner
     */
    'price_monthly': PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInnerPriceMonthly;
}
