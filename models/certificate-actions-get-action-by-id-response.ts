...
import { ActionProperty4 } from './action-property4';

/**
 * 
 * @export
 * @interface CertificateActionsGetActionByIdResponse
 */
export interface CertificateActionsGetActionByIdResponse {
    /**
     * 
     * @type {ActionProperty4}
     * @memberof CertificateActionsGetActionByIdResponse
     */
    'action': ActionProperty4;
}
