...
import { ServersGetMetricsForServerResponseMetrics } from './servers-get-metrics-for-server-response-metrics';

/**
 * 
 * @export
 * @interface ServersGetMetricsForServerResponse
 */
export interface ServersGetMetricsForServerResponse {
    /**
     * 
     * @type {ServersGetMetricsForServerResponseMetrics}
     * @memberof ServersGetMetricsForServerResponse
     */
    'metrics': ServersGetMetricsForServerResponseMetrics;
}
