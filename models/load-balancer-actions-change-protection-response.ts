...
import { ActionProperty24 } from './action-property24';

/**
 * 
 * @export
 * @interface LoadBalancerActionsChangeProtectionResponse
 */
export interface LoadBalancerActionsChangeProtectionResponse {
    /**
     * 
     * @type {ActionProperty24}
     * @memberof LoadBalancerActionsChangeProtectionResponse
     */
    'action': ActionProperty24;
}
