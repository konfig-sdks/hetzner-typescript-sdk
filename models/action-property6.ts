...
import { ActionProperty6Error } from './action-property6-error';
import { ActionProperty6ResourcesInner } from './action-property6-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty6
 */
export interface ActionProperty6 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty6
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty6Error}
     * @memberof ActionProperty6
     */
    'error': ActionProperty6Error | null;
    /**
     ...
     * @type {Array<ActionProperty6ResourcesInner>}
     * @memberof ActionProperty6
     */
    'resources': Array<ActionProperty6ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty6
     */
    'status': ActionProperty6StatusEnum;
}

type ActionProperty6StatusEnum = 'success' | 'running' | 'error'
