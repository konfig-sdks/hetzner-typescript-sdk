...
import { ActionProperty5 } from './action-property5';

/**
 * 
 * @export
 * @interface FirewallActionsGetActionByIdResponse
 */
export interface FirewallActionsGetActionByIdResponse {
    /**
     * 
     * @type {ActionProperty5}
     * @memberof FirewallActionsGetActionByIdResponse
     */
    'action': ActionProperty5;
}
