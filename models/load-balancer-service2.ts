...
import { LoadBalancerServiceHTTPProperty4 } from './load-balancer-service-httpproperty4';
import { LoadBalancerServiceHealthCheckProperty3 } from './load-balancer-service-health-check-property3';

/**
 * 
 * @export
 * @interface LoadBalancerService2
 */
export interface LoadBalancerService2 {
    /**
     * Port the Load Balancer will balance to
     * @type {number}
     * @memberof LoadBalancerService2
     */
    'destination_port': number;
    /**
     * 
     * @type {LoadBalancerServiceHealthCheckProperty3}
     * @memberof LoadBalancerService2
     */
    'health_check': LoadBalancerServiceHealthCheckProperty3;
    /**
     * 
     * @type {LoadBalancerServiceHTTPProperty4}
     * @memberof LoadBalancerService2
     */
    'http'?: LoadBalancerServiceHTTPProperty4;
    /**
     ...
     * @memberof LoadBalancerService2
     */
    'protocol': LoadBalancerService2ProtocolEnum;
    /**
...
type LoadBalancerService2ProtocolEnum = 'tcp' | 'http' | 'https'
