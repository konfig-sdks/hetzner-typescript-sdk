 ...
 * 
 * @export
 * @interface PricingGetAllPricesResponsePricingTrafficPricePerTb
 */
export interface PricingGetAllPricesResponsePricingTrafficPricePerTb {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingTrafficPricePerTb
     */
    'gross': string;
    /**
     * Price without VAT
