 ...
 * @export
 * @interface ServersCreateServerActionResponseServerDatacenterServerTypes
 */
export interface ServersCreateServerActionResponseServerDatacenterServerTypes {
    /**
     * IDs of Server types that are supported and for which the Datacenter has enough resources left
     * @type {Array<number>}
     * @memberof ServersCreateServerActionResponseServerDatacenterServerTypes
     */
