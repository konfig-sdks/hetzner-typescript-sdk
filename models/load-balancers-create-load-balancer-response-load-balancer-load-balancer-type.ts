...
import { LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInner } from './load-balancers-create-load-balancer-response-load-balancer-load-balancer-type-prices-inner';

/**
 * 
 * @export
 * @interface LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType
 */
export interface LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType {
    /**
     * Description of the Load Balancer type
     * @type {string}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType
     */
    'description': string;
    /**
     ...
     * @type {Array<LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInner>}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType
     */
    'prices': Array<LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInner>;
}
