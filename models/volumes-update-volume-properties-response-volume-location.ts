 ...
 * @export
 * @interface VolumesUpdateVolumePropertiesResponseVolumeLocation
 */
export interface VolumesUpdateVolumePropertiesResponseVolumeLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof VolumesUpdateVolumePropertiesResponseVolumeLocation
     */
    'description': string;
    /**
