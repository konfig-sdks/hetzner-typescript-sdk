...
import { Action14Error } from './action14-error';
import { Action14ResourcesInner } from './action14-resources-inner';
...
export interface Action14 {
     ...
     * @type {Array<Action14ResourcesInner>}
     * @memberof Action14
     */
    'resources': Array<Action14ResourcesInner>;
    /**
     ...
     * @memberof Action14
     */
    'status': Action14StatusEnum;
}

type Action14StatusEnum = 'success' | 'running' | 'error'
