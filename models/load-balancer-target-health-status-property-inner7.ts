 ...
 * 
 * @export
 * @interface LoadBalancerTargetHealthStatusPropertyInner7
 */
export interface LoadBalancerTargetHealthStatusPropertyInner7 {
    /**
     * 
     * @type {number}
     * @memberof LoadBalancerTargetHealthStatusPropertyInner7
     */
    'listen_port'?: number;
    /**
     * 
     ...
     * @memberof LoadBalancerTargetHealthStatusPropertyInner7
     */
    'status'?: LoadBalancerTargetHealthStatusPropertyInner7StatusEnum;
}

type LoadBalancerTargetHealthStatusPropertyInner7StatusEnum = 'healthy' | 'unhealthy' | 'unknown'
