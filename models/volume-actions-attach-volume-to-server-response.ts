...
import { ActionProperty76 } from './action-property76';

/**
 * 
 * @export
 * @interface VolumeActionsAttachVolumeToServerResponse
 */
export interface VolumeActionsAttachVolumeToServerResponse {
    /**
     * 
     * @type {ActionProperty76}
     * @memberof VolumeActionsAttachVolumeToServerResponse
     */
    'action': ActionProperty76;
}
