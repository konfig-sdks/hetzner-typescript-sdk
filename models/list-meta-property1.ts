...
import { ListMetaProperty1Pagination } from './list-meta-property1-pagination';

/**
 * 
 * @export
 * @interface ListMetaProperty1
 */
export interface ListMetaProperty1 {
    /**
     * 
     * @type {ListMetaProperty1Pagination}
     * @memberof ListMetaProperty1
     */
    'pagination': ListMetaProperty1Pagination;
}
