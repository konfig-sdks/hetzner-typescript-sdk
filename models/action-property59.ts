...
import { ActionProperty59Error } from './action-property59-error';
import { ActionProperty59ResourcesInner } from './action-property59-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty59
 */
export interface ActionProperty59 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty59
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty59Error}
     * @memberof ActionProperty59
     */
    'error': ActionProperty59Error | null;
    /**
     ...
     * @type {Array<ActionProperty59ResourcesInner>}
     * @memberof ActionProperty59
     */
    'resources': Array<ActionProperty59ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty59
     */
    'status': ActionProperty59StatusEnum;
}

type ActionProperty59StatusEnum = 'success' | 'running' | 'error'
