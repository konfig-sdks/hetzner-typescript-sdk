 ...
 * IP address (v6)
 * @export
 * @interface LoadBalancersGetAllResponseLoadBalancersInnerPublicNetIpv6
 */
export interface LoadBalancersGetAllResponseLoadBalancersInnerPublicNetIpv6 {
    /**
     * Reverse DNS PTR entry for the IPv6 address of this Load Balancer
     * @type {string}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInnerPublicNetIpv6
     */
    'dns_ptr'?: string | null;
    /**
