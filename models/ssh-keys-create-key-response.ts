...
import { SshKeysCreateKeyResponseSshKey } from './ssh-keys-create-key-response-ssh-key';

/**
 * 
 * @export
 * @interface SshKeysCreateKeyResponse
 */
export interface SshKeysCreateKeyResponse {
    /**
     * 
     * @type {SshKeysCreateKeyResponseSshKey}
     * @memberof SshKeysCreateKeyResponse
     */
    'ssh_key': SshKeysCreateKeyResponseSshKey;
}
