...
import { CertificatePropertyStatusError } from './certificate-property-status-error';

/**
 * Current status of a type `managed` Certificate, always *null* for type `uploaded` Certificates
 * @export
 * @interface CertificatePropertyStatus
 */
export interface CertificatePropertyStatus {
    /**
     * 
     * @type {CertificatePropertyStatusError}
     * @memberof CertificatePropertyStatus
     */
    'error'?: CertificatePropertyStatusError | null;
    /**
     * Status of the issuance process of the Certificate
     * @type {string}
     * @memberof CertificatePropertyStatus
     */
    'issuance'?: CertificatePropertyStatusIssuanceEnum;
    /**
     * Status of the renewal process of the Certificate.
     * @type {string}
     * @memberof CertificatePropertyStatus
     */
    'renewal'?: CertificatePropertyStatusRenewalEnum;
}

type CertificatePropertyStatusIssuanceEnum = 'pending' | 'completed' | 'failed'
type CertificatePropertyStatusRenewalEnum = 'scheduled' | 'pending' | 'failed' | 'unavailable'
