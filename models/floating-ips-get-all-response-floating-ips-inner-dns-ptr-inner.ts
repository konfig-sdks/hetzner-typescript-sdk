 ...
 * 
 * @export
 * @interface FloatingIPsGetAllResponseFloatingIpsInnerDnsPtrInner
 */
export interface FloatingIPsGetAllResponseFloatingIpsInnerDnsPtrInner {
    /**
     * DNS pointer for the specific IP address
     * @type {string}
     * @memberof FloatingIPsGetAllResponseFloatingIpsInnerDnsPtrInner
     */
    'dns_ptr': string;
    /**
