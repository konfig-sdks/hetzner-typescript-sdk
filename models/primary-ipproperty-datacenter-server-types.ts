 ...
 * @export
 * @interface PrimaryIPPropertyDatacenterServerTypes
 */
export interface PrimaryIPPropertyDatacenterServerTypes {
    /**
     * IDs of Server types that are supported and for which the Datacenter has enough resources left
     * @type {Array<number>}
     * @memberof PrimaryIPPropertyDatacenterServerTypes
     */
