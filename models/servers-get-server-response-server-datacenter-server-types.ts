 ...
 * @export
 * @interface ServersGetServerResponseServerDatacenterServerTypes
 */
export interface ServersGetServerResponseServerDatacenterServerTypes {
    /**
     * IDs of Server types that are supported and for which the Datacenter has enough resources left
     * @type {Array<number>}
     * @memberof ServersGetServerResponseServerDatacenterServerTypes
     */
