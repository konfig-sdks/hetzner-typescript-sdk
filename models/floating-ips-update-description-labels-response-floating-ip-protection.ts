 ...
 * @export
 * @interface FloatingIPsUpdateDescriptionLabelsResponseFloatingIpProtection
 */
export interface FloatingIPsUpdateDescriptionLabelsResponseFloatingIpProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof FloatingIPsUpdateDescriptionLabelsResponseFloatingIpProtection
     */
    'delete': boolean;
}
