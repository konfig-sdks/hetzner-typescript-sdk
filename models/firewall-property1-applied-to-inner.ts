...
import { FirewallProperty1AppliedToInnerAppliedToResourcesInner } from './firewall-property1-applied-to-inner-applied-to-resources-inner';
import { FirewallProperty1AppliedToInnerLabelSelector } from './firewall-property1-applied-to-inner-label-selector';
import { FirewallProperty1AppliedToInnerServer } from './firewall-property1-applied-to-inner-server';

/**
 * 
 * @export
 * @interface FirewallProperty1AppliedToInner
 */
export interface FirewallProperty1AppliedToInner {
    /**
     * 
     * @type {Array<FirewallProperty1AppliedToInnerAppliedToResourcesInner>}
     * @memberof FirewallProperty1AppliedToInner
     */
    'applied_to_resources'?: Array<FirewallProperty1AppliedToInnerAppliedToResourcesInner>;
    /**
     * 
     * @type {FirewallProperty1AppliedToInnerLabelSelector}
     * @memberof FirewallProperty1AppliedToInner
     */
    'label_selector'?: FirewallProperty1AppliedToInnerLabelSelector;
    /**
     * 
     * @type {FirewallProperty1AppliedToInnerServer}
     * @memberof FirewallProperty1AppliedToInner
     */
    'server'?: FirewallProperty1AppliedToInnerServer;
    /**
     * Type of resource referenced
     * @type {string}
     * @memberof FirewallProperty1AppliedToInner
     */
    'type': FirewallProperty1AppliedToInnerTypeEnum;
}

type FirewallProperty1AppliedToInnerTypeEnum = 'server' | 'label_selector'
