...
import { ListMetaProperty1 } from './list-meta-property1';

/**
 * 
 * @export
 * @interface ActionsGetAllResponse
 */
export interface ActionsGetAllResponse {
    /**
     * 
     * @type {Array<Action2>}
     * @memberof ActionsGetAllResponse
     */
    'actions': Array<Action2>;
    /**
     * 
     * @type {ListMetaProperty1}
     * @memberof ActionsGetAllResponse
     */
    'meta'?: ListMetaProperty1;
}
