 ...
 * @export
 * @interface ServersCreateServerActionResponseServerPublicNetIpv4
 */
export interface ServersCreateServerActionResponseServerPublicNetIpv4 {
    /**
     * If the IP is blocked by our anti abuse dept
     * @type {boolean}
     * @memberof ServersCreateServerActionResponseServerPublicNetIpv4
     */
    'blocked': boolean;
    /**
