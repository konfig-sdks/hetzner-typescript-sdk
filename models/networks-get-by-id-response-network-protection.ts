 ...
 * @export
 * @interface NetworksGetByIdResponseNetworkProtection
 */
export interface NetworksGetByIdResponseNetworkProtection {
    /**
     * If true, prevents the Network from being deleted
     * @type {boolean}
     * @memberof NetworksGetByIdResponseNetworkProtection
     */
    'delete': boolean;
}
