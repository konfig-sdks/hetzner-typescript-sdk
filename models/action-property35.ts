...
import { ActionProperty35Error } from './action-property35-error';
import { ActionProperty35ResourcesInner } from './action-property35-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty35
 */
export interface ActionProperty35 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty35
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty35Error}
     * @memberof ActionProperty35
     */
    'error': ActionProperty35Error | null;
    /**
     ...
     * @type {Array<ActionProperty35ResourcesInner>}
     * @memberof ActionProperty35
     */
    'resources': Array<ActionProperty35ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty35
     */
    'status': ActionProperty35StatusEnum;
}

type ActionProperty35StatusEnum = 'success' | 'running' | 'error'
