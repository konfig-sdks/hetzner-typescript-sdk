...
import { LoadBalancerServiceHTTPProperty } from './load-balancer-service-httpproperty';
import { LoadBalancerServiceHealthCheckProperty } from './load-balancer-service-health-check-property';
...
export interface LoadBalancerService {
     ...
     * @type {number}
     * @memberof LoadBalancerService
     */
    'destination_port': number;
    /**
     * 
     * @type {LoadBalancerServiceHealthCheckProperty}
     * @memberof LoadBalancerService
     */
    'health_check': LoadBalancerServiceHealthCheckProperty;
    /**
     * 
     * @type {LoadBalancerServiceHTTPProperty}
     * @memberof LoadBalancerService
     */
    'http'?: LoadBalancerServiceHTTPProperty;
    /**
     ...
     * @memberof LoadBalancerService
     */
    'protocol': LoadBalancerServiceProtocolEnum;
    /**
...
type LoadBalancerServiceProtocolEnum = 'tcp' | 'http' | 'https'
