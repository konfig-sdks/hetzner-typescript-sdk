...
import { DeprecationInfoProperty4 } from './deprecation-info-property4';

/**
 * ISO Image that is attached to this Server. Null if no ISO is attached.
 * @export
 * @interface ServersGetAllResponseServersInnerIso
 */
export interface ServersGetAllResponseServersInnerIso {
    /**
     * Description of the ISO
     * @type {string}
     * @memberof ServersGetAllResponseServersInnerIso
     */
    'description': string;
    /**
     ...
     * @memberof ServersGetAllResponseServersInnerIso
     */
    'architecture': ServersGetAllResponseServersInnerIsoArchitectureEnum;
    /**
     * 
     * @type {DeprecationInfoProperty4}
     * @memberof ServersGetAllResponseServersInnerIso
     */
    'deprecation': DeprecationInfoProperty4 | null;
    /**
     ...
     * @memberof ServersGetAllResponseServersInnerIso
     */
    'type': ServersGetAllResponseServersInnerIsoTypeEnum;
}

type ServersGetAllResponseServersInnerIsoArchitectureEnum = 'x86' | 'arm'
type ServersGetAllResponseServersInnerIsoTypeEnum = 'public' | 'private'
