...
import { ActionProperty61 } from './action-property61';

/**
 * 
 * @export
 * @interface ServerActionsDisableRescueModeResponse
 */
export interface ServerActionsDisableRescueModeResponse {
    /**
     * 
     * @type {ActionProperty61}
     * @memberof ServerActionsDisableRescueModeResponse
     */
    'action': ActionProperty61;
}
