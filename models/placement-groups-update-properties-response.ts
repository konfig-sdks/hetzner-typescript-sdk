...
import { PlacementGroupProperty2 } from './placement-group-property2';

/**
 * 
 * @export
 * @interface PlacementGroupsUpdatePropertiesResponse
 */
export interface PlacementGroupsUpdatePropertiesResponse {
    /**
     * 
     * @type {PlacementGroupProperty2}
     * @memberof PlacementGroupsUpdatePropertiesResponse
     */
    'placement_group': PlacementGroupProperty2;
}
