...
import { ListMetaProperty22 } from './list-meta-property22';
import { LocationsGetAllLocationsResponseLocationsInner } from './locations-get-all-locations-response-locations-inner';

/**
 * 
 * @export
 * @interface LocationsGetAllLocationsResponse
 */
export interface LocationsGetAllLocationsResponse {
    /**
     * 
     * @type {Array<LocationsGetAllLocationsResponseLocationsInner>}
     * @memberof LocationsGetAllLocationsResponse
     */
    'locations': Array<LocationsGetAllLocationsResponseLocationsInner>;
    /**
     * 
     * @type {ListMetaProperty22}
     * @memberof LocationsGetAllLocationsResponse
     */
    'meta': ListMetaProperty22;
}
