...
import { ListMetaProperty3Pagination } from './list-meta-property3-pagination';

/**
 * 
 * @export
 * @interface ListMetaProperty3
 */
export interface ListMetaProperty3 {
    /**
     * 
     * @type {ListMetaProperty3Pagination}
     * @memberof ListMetaProperty3
     */
    'pagination': ListMetaProperty3Pagination;
}
