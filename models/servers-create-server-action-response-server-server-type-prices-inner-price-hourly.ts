 ...
 * @export
 * @interface ServersCreateServerActionResponseServerServerTypePricesInnerPriceHourly
 */
export interface ServersCreateServerActionResponseServerServerTypePricesInnerPriceHourly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof ServersCreateServerActionResponseServerServerTypePricesInnerPriceHourly
     */
    'gross': string;
    /**
     * Price without VAT
