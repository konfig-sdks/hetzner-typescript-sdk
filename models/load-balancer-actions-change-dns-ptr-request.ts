 ...
 * 
 * @export
 * @interface LoadBalancerActionsChangeDnsPtrRequest
 */
export interface LoadBalancerActionsChangeDnsPtrRequest {
    /**
     * Hostname to set as a reverse DNS PTR entry
     * @type {string}
     * @memberof LoadBalancerActionsChangeDnsPtrRequest
     */
    'dns_ptr': string | null;
    /**
