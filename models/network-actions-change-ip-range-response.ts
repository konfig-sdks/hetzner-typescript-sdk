...
import { ActionProperty36 } from './action-property36';

/**
 * 
 * @export
 * @interface NetworkActionsChangeIpRangeResponse
 */
export interface NetworkActionsChangeIpRangeResponse {
    /**
     * 
     * @type {ActionProperty36}
     * @memberof NetworkActionsChangeIpRangeResponse
     */
    'action': ActionProperty36;
}
