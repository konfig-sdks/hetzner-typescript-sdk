...
import { ImagesGetAllResponseImagesInner } from './images-get-all-response-images-inner';
import { ListMetaProperty15 } from './list-meta-property15';

/**
 * 
 * @export
 * @interface ImagesGetAllResponse
 */
export interface ImagesGetAllResponse {
    /**
     * 
     * @type {Array<ImagesGetAllResponseImagesInner>}
     * @memberof ImagesGetAllResponse
     */
    'images': Array<ImagesGetAllResponseImagesInner>;
    /**
     * 
     * @type {ListMetaProperty15}
     * @memberof ImagesGetAllResponse
     */
    'meta'?: ListMetaProperty15;
}
