 ...
 * 
 * @export
 * @interface LoadBalancersGetMetricsResponseMetrics
 */
export interface LoadBalancersGetMetricsResponseMetrics {
    /**
     * End of period of metrics reported (in ISO-8601 format)
     * @type {string}
     * @memberof LoadBalancersGetMetricsResponseMetrics
     */
    'end': string;
    /**
