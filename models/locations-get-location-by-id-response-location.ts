 ...
 * 
 * @export
 * @interface LocationsGetLocationByIdResponseLocation
 */
export interface LocationsGetLocationByIdResponseLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof LocationsGetLocationByIdResponseLocation
     */
    'description': string;
    /**
