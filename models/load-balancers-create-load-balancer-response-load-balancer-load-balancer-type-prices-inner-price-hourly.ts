 ...
 * @export
 * @interface LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly
 */
export interface LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly {
    /**
     * Price with VAT added.
     * @type {string}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly
     */
    'gross': string;
    /**
     * Price without VAT.
