...
import { ActionProperty46Error } from './action-property46-error';
import { ActionProperty46ResourcesInner } from './action-property46-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty46
 */
export interface ActionProperty46 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty46
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty46Error}
     * @memberof ActionProperty46
     */
    'error': ActionProperty46Error | null;
    /**
     ...
     * @type {Array<ActionProperty46ResourcesInner>}
     * @memberof ActionProperty46
     */
    'resources': Array<ActionProperty46ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty46
     */
    'status': ActionProperty46StatusEnum;
}

type ActionProperty46StatusEnum = 'success' | 'running' | 'error'
