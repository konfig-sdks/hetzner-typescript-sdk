...
import { DeprecationInfoProperty6 } from './deprecation-info-property6';

/**
 * ISO Image that is attached to this Server. Null if no ISO is attached.
 * @export
 * @interface ServersCreateServerActionResponseServerIso
 */
export interface ServersCreateServerActionResponseServerIso {
    /**
     * Description of the ISO
     * @type {string}
     * @memberof ServersCreateServerActionResponseServerIso
     */
    'description': string;
    /**
     ...
     * @memberof ServersCreateServerActionResponseServerIso
     */
    'architecture': ServersCreateServerActionResponseServerIsoArchitectureEnum;
    /**
     * 
     * @type {DeprecationInfoProperty6}
     * @memberof ServersCreateServerActionResponseServerIso
     */
    'deprecation': DeprecationInfoProperty6 | null;
    /**
     ...
     * @memberof ServersCreateServerActionResponseServerIso
     */
    'type': ServersCreateServerActionResponseServerIsoTypeEnum;
}

type ServersCreateServerActionResponseServerIsoArchitectureEnum = 'x86' | 'arm'
type ServersCreateServerActionResponseServerIsoTypeEnum = 'public' | 'private'
