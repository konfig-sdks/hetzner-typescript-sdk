 ...
 * @export
 * @interface NetworksGetAllResponseNetworksInnerProtection
 */
export interface NetworksGetAllResponseNetworksInnerProtection {
    /**
     * If true, prevents the Network from being deleted
     * @type {boolean}
     * @memberof NetworksGetAllResponseNetworksInnerProtection
     */
    'delete': boolean;
}
