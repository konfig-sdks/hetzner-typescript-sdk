...
import { PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInner } from './pricing-get-all-prices-response-pricing-primary-ips-inner-prices-inner';

/**
 * 
 * @export
 * @interface PricingGetAllPricesResponsePricingPrimaryIpsInner
 */
export interface PricingGetAllPricesResponsePricingPrimaryIpsInner {
    /**
     * Primary IP type costs per Location
     * @type {Array<PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInner>}
     * @memberof PricingGetAllPricesResponsePricingPrimaryIpsInner
     */
    'prices': Array<PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInner>;
    /**
     * The type of the Primary IP
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingPrimaryIpsInner
     */
    'type': PricingGetAllPricesResponsePricingPrimaryIpsInnerTypeEnum;
}

type PricingGetAllPricesResponsePricingPrimaryIpsInnerTypeEnum = 'ipv4' | 'ipv6'
