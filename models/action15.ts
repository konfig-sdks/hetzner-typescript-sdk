...
import { Action15Error } from './action15-error';
import { Action15ResourcesInner } from './action15-resources-inner';
...
export interface Action15 {
     ...
     * @type {Array<Action15ResourcesInner>}
     * @memberof Action15
     */
    'resources': Array<Action15ResourcesInner>;
    /**
     ...
     * @memberof Action15
     */
    'status': Action15StatusEnum;
}

type Action15StatusEnum = 'success' | 'running' | 'error'
