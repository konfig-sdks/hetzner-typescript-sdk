 ...
 * @export
 * @interface LoadBalancerTargetLabelSelectorProperty3
 */
export interface LoadBalancerTargetLabelSelectorProperty3 {
    /**
     * Label selector
     * @type {string}
     * @memberof LoadBalancerTargetLabelSelectorProperty3
     */
    'selector': string;
}
