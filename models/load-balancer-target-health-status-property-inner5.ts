 ...
 * 
 * @export
 * @interface LoadBalancerTargetHealthStatusPropertyInner5
 */
export interface LoadBalancerTargetHealthStatusPropertyInner5 {
    /**
     * 
     * @type {number}
     * @memberof LoadBalancerTargetHealthStatusPropertyInner5
     */
    'listen_port'?: number;
    /**
     * 
     ...
     * @memberof LoadBalancerTargetHealthStatusPropertyInner5
     */
    'status'?: LoadBalancerTargetHealthStatusPropertyInner5StatusEnum;
}

type LoadBalancerTargetHealthStatusPropertyInner5StatusEnum = 'healthy' | 'unhealthy' | 'unknown'
