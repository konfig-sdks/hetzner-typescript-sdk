...
import { NetworksCreateNetworkResponseNetworkProtection } from './networks-create-network-response-network-protection';
import { NetworksCreateNetworkResponseNetworkRoutesInner } from './networks-create-network-response-network-routes-inner';
import { NetworksCreateNetworkResponseNetworkSubnetsInner } from './networks-create-network-response-network-subnets-inner';

/**
 * 
 * @export
 * @interface NetworksCreateNetworkResponseNetwork
 */
export interface NetworksCreateNetworkResponseNetwork {
    /**
     * Array of IDs of Servers attached to this Network
     * @type {Array<number>}
     * @memberof NetworksCreateNetworkResponseNetwork
     */
    ...
    /**
     * 
     * @type {NetworksCreateNetworkResponseNetworkProtection}
     * @memberof NetworksCreateNetworkResponseNetwork
     */
    'protection': NetworksCreateNetworkResponseNetworkProtection;
    /**
     * Array of routes set in this Network
     * @type {Array<NetworksCreateNetworkResponseNetworkRoutesInner>}
     * @memberof NetworksCreateNetworkResponseNetwork
     */
    'routes': Array<NetworksCreateNetworkResponseNetworkRoutesInner>;
    /**
     * Array subnets allocated in this Network
     * @type {Array<NetworksCreateNetworkResponseNetworkSubnetsInner>}
     * @memberof NetworksCreateNetworkResponseNetwork
     */
    'subnets': Array<NetworksCreateNetworkResponseNetworkSubnetsInner>;
}
