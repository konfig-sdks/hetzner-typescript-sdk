...
import { ServerTypesListAllServerTypesResponseServerTypesInner } from './server-types-list-all-server-types-response-server-types-inner';

/**
 * 
 * @export
 * @interface ServerTypesListAllServerTypesResponse
 */
export interface ServerTypesListAllServerTypesResponse {
    /**
     * 
     * @type {Array<ServerTypesListAllServerTypesResponseServerTypesInner>}
     * @memberof ServerTypesListAllServerTypesResponse
     */
    'server_types': Array<ServerTypesListAllServerTypesResponseServerTypesInner>;
}
