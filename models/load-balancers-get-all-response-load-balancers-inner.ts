...
import { LoadBalancerService1 } from './load-balancer-service1';
import { LoadBalancerTarget1 } from './load-balancer-target1';
import { LoadBalancersGetAllResponseLoadBalancersInnerAlgorithm } from './load-balancers-get-all-response-load-balancers-inner-algorithm';
import { LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerType } from './load-balancers-get-all-response-load-balancers-inner-load-balancer-type';
import { LoadBalancersGetAllResponseLoadBalancersInnerLocation } from './load-balancers-get-all-response-load-balancers-inner-location';
import { LoadBalancersGetAllResponseLoadBalancersInnerPrivateNetInner } from './load-balancers-get-all-response-load-balancers-inner-private-net-inner';
import { LoadBalancersGetAllResponseLoadBalancersInnerProtection } from './load-balancers-get-all-response-load-balancers-inner-protection';
import { LoadBalancersGetAllResponseLoadBalancersInnerPublicNet } from './load-balancers-get-all-response-load-balancers-inner-public-net';

/**
 * 
 * @export
 * @interface LoadBalancersGetAllResponseLoadBalancersInner
 */
export interface LoadBalancersGetAllResponseLoadBalancersInner {
    /**
     * 
     * @type {LoadBalancersGetAllResponseLoadBalancersInnerAlgorithm}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInner
     */
    'algorithm': LoadBalancersGetAllResponseLoadBalancersInnerAlgorithm;
    /**
    ...
    /**
     * 
     * @type {LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerType}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInner
     */
    'load_balancer_type': LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerType;
    /**
     * 
     * @type {LoadBalancersGetAllResponseLoadBalancersInnerLocation}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInner
     */
    'location': LoadBalancersGetAllResponseLoadBalancersInnerLocation;
    /**
     ...
     * @type {Array<LoadBalancersGetAllResponseLoadBalancersInnerPrivateNetInner>}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInner
     */
    'private_net': Array<LoadBalancersGetAllResponseLoadBalancersInnerPrivateNetInner>;
    /**
     * 
     * @type {LoadBalancersGetAllResponseLoadBalancersInnerProtection}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInner
     */
    'protection': LoadBalancersGetAllResponseLoadBalancersInnerProtection;
    /**
     * 
     * @type {LoadBalancersGetAllResponseLoadBalancersInnerPublicNet}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInner
     */
    'public_net': LoadBalancersGetAllResponseLoadBalancersInnerPublicNet;
    /**
     * List of services that belong to this Load Balancer
     * @type {Array<LoadBalancerService1>}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInner
     */
    'services': Array<LoadBalancerService1>;
    /**
     * List of targets that belong to this Load Balancer
     * @type {Array<LoadBalancerTarget1>}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInner
     */
    'targets': Array<LoadBalancerTarget1>;
}
