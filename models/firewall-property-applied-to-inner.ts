...
import { FirewallPropertyAppliedToInnerAppliedToResourcesInner } from './firewall-property-applied-to-inner-applied-to-resources-inner';
import { FirewallPropertyAppliedToInnerLabelSelector } from './firewall-property-applied-to-inner-label-selector';
import { FirewallPropertyAppliedToInnerServer } from './firewall-property-applied-to-inner-server';

/**
 * 
 * @export
 * @interface FirewallPropertyAppliedToInner
 */
export interface FirewallPropertyAppliedToInner {
    /**
     * 
     * @type {Array<FirewallPropertyAppliedToInnerAppliedToResourcesInner>}
     * @memberof FirewallPropertyAppliedToInner
     */
    'applied_to_resources'?: Array<FirewallPropertyAppliedToInnerAppliedToResourcesInner>;
    /**
     * 
     * @type {FirewallPropertyAppliedToInnerLabelSelector}
     * @memberof FirewallPropertyAppliedToInner
     */
    'label_selector'?: FirewallPropertyAppliedToInnerLabelSelector;
    /**
     * 
     * @type {FirewallPropertyAppliedToInnerServer}
     * @memberof FirewallPropertyAppliedToInner
     */
    'server'?: FirewallPropertyAppliedToInnerServer;
    /**
     * Type of resource referenced
     * @type {string}
     * @memberof FirewallPropertyAppliedToInner
     */
    'type': FirewallPropertyAppliedToInnerTypeEnum;
}

type FirewallPropertyAppliedToInnerTypeEnum = 'server' | 'label_selector'
