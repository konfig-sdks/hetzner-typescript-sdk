...
import { ActionProperty57Error } from './action-property57-error';
import { ActionProperty57ResourcesInner } from './action-property57-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty57
 */
export interface ActionProperty57 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty57
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty57Error}
     * @memberof ActionProperty57
     */
    'error': ActionProperty57Error | null;
    /**
     ...
     * @type {Array<ActionProperty57ResourcesInner>}
     * @memberof ActionProperty57
     */
    'resources': Array<ActionProperty57ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty57
     */
    'status': ActionProperty57StatusEnum;
}

type ActionProperty57StatusEnum = 'success' | 'running' | 'error'
