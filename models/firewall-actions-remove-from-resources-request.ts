...
import { FirewallResource1 } from './firewall-resource1';

/**
 * 
 * @export
 * @interface FirewallActionsRemoveFromResourcesRequest
 */
export interface FirewallActionsRemoveFromResourcesRequest {
    /**
     * Resources the Firewall should be removed from
     * @type {Array<FirewallResource1>}
     * @memberof FirewallActionsRemoveFromResourcesRequest
     */
    'remove_from': Array<FirewallResource1>;
}
