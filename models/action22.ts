...
import { Action22Error } from './action22-error';
import { Action22ResourcesInner } from './action22-resources-inner';
...
export interface Action22 {
     ...
     * @type {Array<Action22ResourcesInner>}
     * @memberof Action22
     */
    'resources': Array<Action22ResourcesInner>;
    /**
     ...
     * @memberof Action22
     */
    'status': Action22StatusEnum;
}

type Action22StatusEnum = 'success' | 'running' | 'error'
