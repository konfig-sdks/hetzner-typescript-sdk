 ...
 * @export
 * @interface LoadBalancersUpdateBalancerResponseLoadBalancerProtection
 */
export interface LoadBalancersUpdateBalancerResponseLoadBalancerProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancerProtection
     */
    'delete': boolean;
}
