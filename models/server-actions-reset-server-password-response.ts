...
import { ActionProperty71 } from './action-property71';

/**
 * 
 * @export
 * @interface ServerActionsResetServerPasswordResponse
 */
export interface ServerActionsResetServerPasswordResponse {
    /**
     * 
     * @type {ActionProperty71}
     * @memberof ServerActionsResetServerPasswordResponse
     */
    'action'?: ActionProperty71;
    /**
