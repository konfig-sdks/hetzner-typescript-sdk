...
import { ActionProperty77 } from './action-property77';

/**
 * 
 * @export
 * @interface VolumeActionsChangeProtectionVolumeResponse
 */
export interface VolumeActionsChangeProtectionVolumeResponse {
    /**
     * 
     * @type {ActionProperty77}
     * @memberof VolumeActionsChangeProtectionVolumeResponse
     */
    'action': ActionProperty77;
}
