...
import { DeprecationInfoProperty9 } from './deprecation-info-property9';
import { ServersGetServerResponseServerServerTypePricesInner } from './servers-get-server-response-server-server-type-prices-inner';

/**
 * 
 * @export
 * @interface ServersGetServerResponseServerServerType
 */
export interface ServersGetServerResponseServerServerType {
    /**
     * Description of the Server type
     * @type {string}
     * @memberof ServersGetServerResponseServerServerType
     */
    'description': string;
    /**
     ...
     * @memberof ServersGetServerResponseServerServerType
     */
    'architecture': ServersGetServerResponseServerServerTypeArchitectureEnum;
    /**
     ...
     * @memberof ServersGetServerResponseServerServerType
     */
    'cpu_type': ServersGetServerResponseServerServerTypeCpuTypeEnum;
    /**
    ...
    /**
     * 
     * @type {DeprecationInfoProperty9}
     * @memberof ServersGetServerResponseServerServerType
     */
    'deprecation'?: DeprecationInfoProperty9 | null;
    /**
     ...
     * @type {Array<ServersGetServerResponseServerServerTypePricesInner>}
     * @memberof ServersGetServerResponseServerServerType
     */
    'prices': Array<ServersGetServerResponseServerServerTypePricesInner>;
    /**
     * Type of Server boot drive. Local has higher speed. Network has better availability.
     * @type {string}
     * @memberof ServersGetServerResponseServerServerType
     */
    'storage_type': ServersGetServerResponseServerServerTypeStorageTypeEnum;
}

type ServersGetServerResponseServerServerTypeArchitectureEnum = 'x86' | 'arm'
type ServersGetServerResponseServerServerTypeCpuTypeEnum = 'shared' | 'dedicated'
type ServersGetServerResponseServerServerTypeStorageTypeEnum = 'local' | 'network'
