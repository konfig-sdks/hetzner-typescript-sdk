...
import { NetworksUpdatePropertiesRequestLabels } from './networks-update-properties-request-labels';

/**
 * 
 * @export
 * @interface NetworksUpdatePropertiesRequest
 */
export interface NetworksUpdatePropertiesRequest {
    /**
     ...
     * @type {boolean}
     * @memberof NetworksUpdatePropertiesRequest
     */
    'expose_routes_to_vswitch'?: boolean;
    /**
     * 
     * @type {NetworksUpdatePropertiesRequestLabels}
     * @memberof NetworksUpdatePropertiesRequest
     */
    'labels'?: NetworksUpdatePropertiesRequestLabels;
    /**
     * New network name
     * @type {string}
     * @memberof NetworksUpdatePropertiesRequest
