 ...
 * @export
 * @interface PricingGetAllPricesResponsePricingFloatingIpsInnerPricesInnerPriceMonthly
 */
export interface PricingGetAllPricesResponsePricingFloatingIpsInnerPricesInnerPriceMonthly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingFloatingIpsInnerPricesInnerPriceMonthly
     */
    'gross': string;
    /**
     * Price without VAT
