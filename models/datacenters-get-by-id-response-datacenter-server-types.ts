 ...
 * @export
 * @interface DatacentersGetByIdResponseDatacenterServerTypes
 */
export interface DatacentersGetByIdResponseDatacenterServerTypes {
    /**
     * IDs of Server types that are supported and for which the Datacenter has enough resources left
     * @type {Array<number>}
     * @memberof DatacentersGetByIdResponseDatacenterServerTypes
     */
