...
import { ActionProperty69 } from './action-property69';

/**
 * 
 * @export
 * @interface ServerActionsRequestConsoleResponse
 */
export interface ServerActionsRequestConsoleResponse {
    /**
     * 
     * @type {ActionProperty69}
     * @memberof ServerActionsRequestConsoleResponse
     */
    'action': ActionProperty69;
    /**
