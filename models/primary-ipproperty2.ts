...
import { PrimaryIPProperty2Datacenter } from './primary-ipproperty2-datacenter';
import { PrimaryIPProperty2DnsPtrInner } from './primary-ipproperty2-dns-ptr-inner';
import { PrimaryIPProperty2Protection } from './primary-ipproperty2-protection';

/**
 * 
 * @export
 * @interface PrimaryIPProperty2
 */
export interface PrimaryIPProperty2 {
    /**
     * ID of the resource the Primary IP is assigned to, null if it is not assigned at all
     * @type {number}
     * @memberof PrimaryIPProperty2
     */
     ...
     * @memberof PrimaryIPProperty2
     */
    'assignee_type': PrimaryIPProperty2AssigneeTypeEnum;
    /**
    ...
    /**
     * 
     * @type {PrimaryIPProperty2Datacenter}
     * @memberof PrimaryIPProperty2
     */
    'datacenter': PrimaryIPProperty2Datacenter;
    /**
     * Array of reverse DNS entries
     * @type {Array<PrimaryIPProperty2DnsPtrInner>}
     * @memberof PrimaryIPProperty2
     */
    'dns_ptr': Array<PrimaryIPProperty2DnsPtrInner>;
    /**
    ...
    /**
     * 
     * @type {PrimaryIPProperty2Protection}
     * @memberof PrimaryIPProperty2
     */
    'protection': PrimaryIPProperty2Protection;
    /**
     * Type of the Primary IP
     * @type {string}
     * @memberof PrimaryIPProperty2
     */
    'type': PrimaryIPProperty2TypeEnum;
}

type PrimaryIPProperty2AssigneeTypeEnum = 'server'
type PrimaryIPProperty2TypeEnum = 'ipv4' | 'ipv6'
