...
import { ServerPublicNetFirewall } from './server-public-net-firewall';
import { ServersGetAllResponseServersInnerPublicNetIpv4 } from './servers-get-all-response-servers-inner-public-net-ipv4';
import { ServersGetAllResponseServersInnerPublicNetIpv6 } from './servers-get-all-response-servers-inner-public-net-ipv6';

/**
 * Public network information. The Server\'s IPv4 address can be found in `public_net->ipv4->ip`
 * @export
 * @interface ServersGetAllResponseServersInnerPublicNet
 */
export interface ServersGetAllResponseServersInnerPublicNet {
    /**
     * Firewalls applied to the public network interface of this Server
     * @type {Array<ServerPublicNetFirewall>}
     * @memberof ServersGetAllResponseServersInnerPublicNet
     */
    ...
    /**
     * 
     * @type {ServersGetAllResponseServersInnerPublicNetIpv4}
     * @memberof ServersGetAllResponseServersInnerPublicNet
     */
    'ipv4': ServersGetAllResponseServersInnerPublicNetIpv4 | null;
    /**
     * 
     * @type {ServersGetAllResponseServersInnerPublicNetIpv6}
     * @memberof ServersGetAllResponseServersInnerPublicNet
     */
    'ipv6': ServersGetAllResponseServersInnerPublicNetIpv6 | null;
}
