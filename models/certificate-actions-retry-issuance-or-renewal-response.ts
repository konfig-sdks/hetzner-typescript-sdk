...
import { ActionProperty3 } from './action-property3';

/**
 * 
 * @export
 * @interface CertificateActionsRetryIssuanceOrRenewalResponse
 */
export interface CertificateActionsRetryIssuanceOrRenewalResponse {
    /**
     * 
     * @type {ActionProperty3}
     * @memberof CertificateActionsRetryIssuanceOrRenewalResponse
     */
    'action': ActionProperty3;
}
