...
import { LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv4 } from './load-balancers-update-balancer-response-load-balancer-public-net-ipv4';
import { LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv6 } from './load-balancers-update-balancer-response-load-balancer-public-net-ipv6';

/**
 * Public network information
 * @export
 * @interface LoadBalancersUpdateBalancerResponseLoadBalancerPublicNet
 */
export interface LoadBalancersUpdateBalancerResponseLoadBalancerPublicNet {
    /**
     * Public Interface enabled or not
     * @type {boolean}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancerPublicNet
     */
    'enabled': boolean;
    /**
     * 
     * @type {LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv4}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancerPublicNet
     */
    'ipv4': LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv4;
    /**
     * 
     * @type {LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv6}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancerPublicNet
     */
