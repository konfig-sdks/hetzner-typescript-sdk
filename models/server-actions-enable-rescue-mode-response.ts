...
import { ActionProperty63 } from './action-property63';

/**
 * 
 * @export
 * @interface ServerActionsEnableRescueModeResponse
 */
export interface ServerActionsEnableRescueModeResponse {
    /**
     * 
     * @type {ActionProperty63}
     * @memberof ServerActionsEnableRescueModeResponse
     */
    'action'?: ActionProperty63;
    /**
