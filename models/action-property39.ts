...
import { ActionProperty39Error } from './action-property39-error';
import { ActionProperty39ResourcesInner } from './action-property39-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty39
 */
export interface ActionProperty39 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty39
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty39Error}
     * @memberof ActionProperty39
     */
    'error': ActionProperty39Error | null;
    /**
     ...
     * @type {Array<ActionProperty39ResourcesInner>}
     * @memberof ActionProperty39
     */
    'resources': Array<ActionProperty39ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty39
     */
    'status': ActionProperty39StatusEnum;
}

type ActionProperty39StatusEnum = 'success' | 'running' | 'error'
