...
import { ActionProperty56 } from './action-property56';

/**
 * 
 * @export
 * @interface ServerActionsChangeServerTypeResponse
 */
export interface ServerActionsChangeServerTypeResponse {
    /**
     * 
     * @type {ActionProperty56}
     * @memberof ServerActionsChangeServerTypeResponse
     */
    'action': ActionProperty56;
}
