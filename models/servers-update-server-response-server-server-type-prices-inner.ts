...
import { ServersUpdateServerResponseServerServerTypePricesInnerPriceHourly } from './servers-update-server-response-server-server-type-prices-inner-price-hourly';
import { ServersUpdateServerResponseServerServerTypePricesInnerPriceMonthly } from './servers-update-server-response-server-server-type-prices-inner-price-monthly';

/**
 * 
 * @export
 * @interface ServersUpdateServerResponseServerServerTypePricesInner
 */
export interface ServersUpdateServerResponseServerServerTypePricesInner {
    /**
     * Name of the Location the price is for
     * @type {string}
     * @memberof ServersUpdateServerResponseServerServerTypePricesInner
     */
    'location': string;
    /**
     * 
     * @type {ServersUpdateServerResponseServerServerTypePricesInnerPriceHourly}
     * @memberof ServersUpdateServerResponseServerServerTypePricesInner
     */
    'price_hourly': ServersUpdateServerResponseServerServerTypePricesInnerPriceHourly;
    /**
     * 
     * @type {ServersUpdateServerResponseServerServerTypePricesInnerPriceMonthly}
     * @memberof ServersUpdateServerResponseServerServerTypePricesInner
     */
    'price_monthly': ServersUpdateServerResponseServerServerTypePricesInnerPriceMonthly;
}
