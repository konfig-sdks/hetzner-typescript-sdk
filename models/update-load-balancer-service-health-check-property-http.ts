 ...
 * @export
 * @interface UpdateLoadBalancerServiceHealthCheckPropertyHttp
 */
export interface UpdateLoadBalancerServiceHealthCheckPropertyHttp {
    /**
     ...
     * @type {string}
     * @memberof UpdateLoadBalancerServiceHealthCheckPropertyHttp
     */
    'domain'?: string | null;
    /**
