...
import { PrimaryIPDatacenterLocation } from './primary-ipdatacenter-location';
import { PrimaryIPDatacenterServerTypes } from './primary-ipdatacenter-server-types';

/**
 * Datacenter this Primary IP is located at
 * @export
 * @interface PrimaryIPDatacenter
 */
export interface PrimaryIPDatacenter {
    /**
     * Description of the Datacenter
     * @type {string}
     * @memberof PrimaryIPDatacenter
     */
    'description': string;
    /**
    ...
    /**
     * 
     * @type {PrimaryIPDatacenterLocation}
     * @memberof PrimaryIPDatacenter
     */
    'location': PrimaryIPDatacenterLocation;
    /**
    ...
    /**
     * 
     * @type {PrimaryIPDatacenterServerTypes}
     * @memberof PrimaryIPDatacenter
     */
    'server_types': PrimaryIPDatacenterServerTypes;
}
