...
import { UpdateLoadBalancerServiceHealthCheckPropertyHttp } from './update-load-balancer-service-health-check-property-http';

/**
 * Service health check
 * @export
 * @interface UpdateLoadBalancerServiceHealthCheckProperty
 */
export interface UpdateLoadBalancerServiceHealthCheckProperty {
    /**
     * 
     * @type {UpdateLoadBalancerServiceHealthCheckPropertyHttp}
     * @memberof UpdateLoadBalancerServiceHealthCheckProperty
     */
    'http'?: UpdateLoadBalancerServiceHealthCheckPropertyHttp;
    /**
     ...
     * @memberof UpdateLoadBalancerServiceHealthCheckProperty
     */
    'protocol'?: UpdateLoadBalancerServiceHealthCheckPropertyProtocolEnum;
    /**
...
type UpdateLoadBalancerServiceHealthCheckPropertyProtocolEnum = 'tcp' | 'http'
