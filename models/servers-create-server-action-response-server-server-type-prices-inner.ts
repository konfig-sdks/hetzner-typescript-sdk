...
import { ServersCreateServerActionResponseServerServerTypePricesInnerPriceHourly } from './servers-create-server-action-response-server-server-type-prices-inner-price-hourly';
import { ServersCreateServerActionResponseServerServerTypePricesInnerPriceMonthly } from './servers-create-server-action-response-server-server-type-prices-inner-price-monthly';

/**
 * 
 * @export
 * @interface ServersCreateServerActionResponseServerServerTypePricesInner
 */
export interface ServersCreateServerActionResponseServerServerTypePricesInner {
    /**
     * Name of the Location the price is for
     * @type {string}
     * @memberof ServersCreateServerActionResponseServerServerTypePricesInner
     */
    'location': string;
    /**
     * 
     * @type {ServersCreateServerActionResponseServerServerTypePricesInnerPriceHourly}
     * @memberof ServersCreateServerActionResponseServerServerTypePricesInner
     */
    'price_hourly': ServersCreateServerActionResponseServerServerTypePricesInnerPriceHourly;
    /**
     * 
     * @type {ServersCreateServerActionResponseServerServerTypePricesInnerPriceMonthly}
     * @memberof ServersCreateServerActionResponseServerServerTypePricesInner
     */
    'price_monthly': ServersCreateServerActionResponseServerServerTypePricesInnerPriceMonthly;
}
