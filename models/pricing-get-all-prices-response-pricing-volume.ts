...
import { PricingGetAllPricesResponsePricingVolumePricePerGbMonth } from './pricing-get-all-prices-response-pricing-volume-price-per-gb-month';

/**
 * The cost of Volume per GB/month
 * @export
 * @interface PricingGetAllPricesResponsePricingVolume
 */
export interface PricingGetAllPricesResponsePricingVolume {
    /**
     * 
     * @type {PricingGetAllPricesResponsePricingVolumePricePerGbMonth}
     * @memberof PricingGetAllPricesResponsePricingVolume
     */
    'price_per_gb_month': PricingGetAllPricesResponsePricingVolumePricePerGbMonth;
}
