...
import { ActionProperty65Error } from './action-property65-error';
import { ActionProperty65ResourcesInner } from './action-property65-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty65
 */
export interface ActionProperty65 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty65
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty65Error}
     * @memberof ActionProperty65
     */
    'error': ActionProperty65Error | null;
    /**
     ...
     * @type {Array<ActionProperty65ResourcesInner>}
     * @memberof ActionProperty65
     */
    'resources': Array<ActionProperty65ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty65
     */
    'status': ActionProperty65StatusEnum;
}

type ActionProperty65StatusEnum = 'success' | 'running' | 'error'
