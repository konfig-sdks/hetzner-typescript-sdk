...
import { ActionProperty5Error } from './action-property5-error';
import { ActionProperty5ResourcesInner } from './action-property5-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty5
 */
export interface ActionProperty5 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty5
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty5Error}
     * @memberof ActionProperty5
     */
    'error': ActionProperty5Error | null;
    /**
     ...
     * @type {Array<ActionProperty5ResourcesInner>}
     * @memberof ActionProperty5
     */
    'resources': Array<ActionProperty5ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty5
     */
    'status': ActionProperty5StatusEnum;
}

type ActionProperty5StatusEnum = 'success' | 'running' | 'error'
