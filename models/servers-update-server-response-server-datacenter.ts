...
import { ServersUpdateServerResponseServerDatacenterLocation } from './servers-update-server-response-server-datacenter-location';
import { ServersUpdateServerResponseServerDatacenterServerTypes } from './servers-update-server-response-server-datacenter-server-types';

/**
 * Datacenter this Resource is located at
 * @export
 * @interface ServersUpdateServerResponseServerDatacenter
 */
export interface ServersUpdateServerResponseServerDatacenter {
    /**
     * Description of the Datacenter
     * @type {string}
     * @memberof ServersUpdateServerResponseServerDatacenter
     */
    'description': string;
    /**
    ...
    /**
     * 
     * @type {ServersUpdateServerResponseServerDatacenterLocation}
     * @memberof ServersUpdateServerResponseServerDatacenter
     */
    ...
    /**
     * 
     * @type {ServersUpdateServerResponseServerDatacenterServerTypes}
     * @memberof ServersUpdateServerResponseServerDatacenter
     */
