...
import { ActionProperty38Error } from './action-property38-error';
import { ActionProperty38ResourcesInner } from './action-property38-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty38
 */
export interface ActionProperty38 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty38
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty38Error}
     * @memberof ActionProperty38
     */
    'error': ActionProperty38Error | null;
    /**
     ...
     * @type {Array<ActionProperty38ResourcesInner>}
     * @memberof ActionProperty38
     */
    'resources': Array<ActionProperty38ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty38
     */
    'status': ActionProperty38StatusEnum;
}

type ActionProperty38StatusEnum = 'success' | 'running' | 'error'
