...
import { FirewallProperty1AppliedToInner } from './firewall-property1-applied-to-inner';
import { Rule4 } from './rule4';

/**
 * 
 * @export
 * @interface FirewallProperty1
 */
export interface FirewallProperty1 {
    /**
     * 
     * @type {Array<FirewallProperty1AppliedToInner>}
     * @memberof FirewallProperty1
     */
    'applied_to': Array<FirewallProperty1AppliedToInner>;
    /**
