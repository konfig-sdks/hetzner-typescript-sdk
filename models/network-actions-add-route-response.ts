...
import { ActionProperty34 } from './action-property34';

/**
 * 
 * @export
 * @interface NetworkActionsAddRouteResponse
 */
export interface NetworkActionsAddRouteResponse {
    /**
     * 
     * @type {ActionProperty34}
     * @memberof NetworkActionsAddRouteResponse
     */
    'action': ActionProperty34;
}
