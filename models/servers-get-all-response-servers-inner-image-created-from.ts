 ...
 * @export
 * @interface ServersGetAllResponseServersInnerImageCreatedFrom
 */
export interface ServersGetAllResponseServersInnerImageCreatedFrom {
    /**
     * ID of the Server the Image was created from
     * @type {number}
     * @memberof ServersGetAllResponseServersInnerImageCreatedFrom
     */
    'id': number;
    /**
