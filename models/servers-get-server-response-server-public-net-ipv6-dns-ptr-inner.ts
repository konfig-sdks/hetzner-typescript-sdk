 ...
 * 
 * @export
 * @interface ServersGetServerResponseServerPublicNetIpv6DnsPtrInner
 */
export interface ServersGetServerResponseServerPublicNetIpv6DnsPtrInner {
    /**
     * DNS pointer for the specific IP address
     * @type {string}
     * @memberof ServersGetServerResponseServerPublicNetIpv6DnsPtrInner
     */
    'dns_ptr': string;
    /**
