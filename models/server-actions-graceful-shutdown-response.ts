...
import { ActionProperty72 } from './action-property72';

/**
 * 
 * @export
 * @interface ServerActionsGracefulShutdownResponse
 */
export interface ServerActionsGracefulShutdownResponse {
    /**
     * 
     * @type {ActionProperty72}
     * @memberof ServerActionsGracefulShutdownResponse
     */
    'action': ActionProperty72;
}
