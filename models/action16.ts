...
import { Action16Error } from './action16-error';
import { Action16ResourcesInner } from './action16-resources-inner';
...
export interface Action16 {
     ...
     * @type {Array<Action16ResourcesInner>}
     * @memberof Action16
     */
    'resources': Array<Action16ResourcesInner>;
    /**
     ...
     * @memberof Action16
     */
    'status': Action16StatusEnum;
}

type Action16StatusEnum = 'success' | 'running' | 'error'
