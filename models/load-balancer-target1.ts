...
import { LoadBalancerTargetHealthStatusPropertyInner2 } from './load-balancer-target-health-status-property-inner2';
import { LoadBalancerTargetIPProperty3 } from './load-balancer-target-ipproperty3';
import { LoadBalancerTargetLabelSelectorProperty1 } from './load-balancer-target-label-selector-property1';
import { LoadBalancerTargetServerProperty2 } from './load-balancer-target-server-property2';
import { LoadBalancerTargetTarget1 } from './load-balancer-target-target1';

/**
 * 
 * @export
 * @interface LoadBalancerTarget1
 */
export interface LoadBalancerTarget1 {
    /**
     * List of health statuses of the services on this target. Only present for target types \"server\" and \"ip\".
     * @type {Array<LoadBalancerTargetHealthStatusPropertyInner2>}
     * @memberof LoadBalancerTarget1
     */
    'health_status'?: Array<LoadBalancerTargetHealthStatusPropertyInner2>;
    /**
     * 
     * @type {LoadBalancerTargetIPProperty3}
     * @memberof LoadBalancerTarget1
     */
    'ip'?: LoadBalancerTargetIPProperty3;
    /**
     * 
     * @type {LoadBalancerTargetLabelSelectorProperty1}
     * @memberof LoadBalancerTarget1
     */
    'label_selector'?: LoadBalancerTargetLabelSelectorProperty1;
    /**
     * 
     * @type {LoadBalancerTargetServerProperty2}
     * @memberof LoadBalancerTarget1
     */
    'server'?: LoadBalancerTargetServerProperty2;
    /**
     * List of resolved label selector target Servers. Only present for type \"label_selector\".
     * @type {Array<LoadBalancerTargetTarget1>}
     * @memberof LoadBalancerTarget1
     */
    'targets'?: Array<LoadBalancerTargetTarget1>;
    /**
     * Type of the resource
     * @type {string}
     * @memberof LoadBalancerTarget1
     */
    'type': LoadBalancerTarget1TypeEnum;
    /**
...
type LoadBalancerTarget1TypeEnum = 'server' | 'label_selector' | 'ip'
