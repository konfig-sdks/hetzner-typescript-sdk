 ...
 * @export
 * @interface LoadBalancersGetAllResponseLoadBalancersInnerAlgorithm
 */
export interface LoadBalancersGetAllResponseLoadBalancersInnerAlgorithm {
    /**
     * Type of the algorithm
     * @type {string}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInnerAlgorithm
     */
    'type': LoadBalancersGetAllResponseLoadBalancersInnerAlgorithmTypeEnum;
}

type LoadBalancersGetAllResponseLoadBalancersInnerAlgorithmTypeEnum = 'round_robin' | 'least_connections'
