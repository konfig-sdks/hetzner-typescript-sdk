 ...
 * 
 * @export
 * @interface VolumeActionsAttachVolumeToServerRequest
 */
export interface VolumeActionsAttachVolumeToServerRequest {
    /**
     * Auto-mount the Volume after attaching it
     * @type {boolean}
     * @memberof VolumeActionsAttachVolumeToServerRequest
     */
    'automount'?: boolean;
    /**
