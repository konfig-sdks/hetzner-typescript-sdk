 ...
 * 
 * @export
 * @interface ServersUpdateServerResponseServerPrivateNetInner
 */
export interface ServersUpdateServerResponseServerPrivateNetInner {
    /**
     * Additional IP addresses of the server on the network.
     * @type {Array<string>}
     * @memberof ServersUpdateServerResponseServerPrivateNetInner
     */
