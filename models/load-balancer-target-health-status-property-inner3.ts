 ...
 * 
 * @export
 * @interface LoadBalancerTargetHealthStatusPropertyInner3
 */
export interface LoadBalancerTargetHealthStatusPropertyInner3 {
    /**
     * 
     * @type {number}
     * @memberof LoadBalancerTargetHealthStatusPropertyInner3
     */
    'listen_port'?: number;
    /**
     * 
     ...
     * @memberof LoadBalancerTargetHealthStatusPropertyInner3
     */
    'status'?: LoadBalancerTargetHealthStatusPropertyInner3StatusEnum;
}

type LoadBalancerTargetHealthStatusPropertyInner3StatusEnum = 'healthy' | 'unhealthy' | 'unknown'
