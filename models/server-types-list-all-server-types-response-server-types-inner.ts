...
import { DeprecationInfoProperty2 } from './deprecation-info-property2';
import { ServerTypesListAllServerTypesResponseServerTypesInnerPricesInner } from './server-types-list-all-server-types-response-server-types-inner-prices-inner';

/**
 * 
 * @export
 * @interface ServerTypesListAllServerTypesResponseServerTypesInner
 */
export interface ServerTypesListAllServerTypesResponseServerTypesInner {
    /**
     * Description of the Server type
     * @type {string}
     * @memberof ServerTypesListAllServerTypesResponseServerTypesInner
     */
    'description': string;
    /**
     ...
     * @memberof ServerTypesListAllServerTypesResponseServerTypesInner
     */
    'architecture': ServerTypesListAllServerTypesResponseServerTypesInnerArchitectureEnum;
    /**
     ...
     * @memberof ServerTypesListAllServerTypesResponseServerTypesInner
     */
    'cpu_type': ServerTypesListAllServerTypesResponseServerTypesInnerCpuTypeEnum;
    /**
    ...
    /**
     * 
     * @type {DeprecationInfoProperty2}
     * @memberof ServerTypesListAllServerTypesResponseServerTypesInner
     */
    'deprecation'?: DeprecationInfoProperty2 | null;
    /**
     ...
     * @type {Array<ServerTypesListAllServerTypesResponseServerTypesInnerPricesInner>}
     * @memberof ServerTypesListAllServerTypesResponseServerTypesInner
     */
    'prices': Array<ServerTypesListAllServerTypesResponseServerTypesInnerPricesInner>;
    /**
     * Type of Server boot drive. Local has higher speed. Network has better availability.
     * @type {string}
     * @memberof ServerTypesListAllServerTypesResponseServerTypesInner
     */
    'storage_type': ServerTypesListAllServerTypesResponseServerTypesInnerStorageTypeEnum;
}

type ServerTypesListAllServerTypesResponseServerTypesInnerArchitectureEnum = 'x86' | 'arm'
type ServerTypesListAllServerTypesResponseServerTypesInnerCpuTypeEnum = 'shared' | 'dedicated'
type ServerTypesListAllServerTypesResponseServerTypesInnerStorageTypeEnum = 'local' | 'network'
