...
import { Action8Error } from './action8-error';
import { Action8ResourcesInner } from './action8-resources-inner';
...
export interface Action8 {
     ...
     * @type {Array<Action8ResourcesInner>}
     * @memberof Action8
     */
    'resources': Array<Action8ResourcesInner>;
    /**
     ...
     * @memberof Action8
     */
    'status': Action8StatusEnum;
}

type Action8StatusEnum = 'success' | 'running' | 'error'
