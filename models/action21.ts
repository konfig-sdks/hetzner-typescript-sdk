...
import { Action21Error } from './action21-error';
import { Action21ResourcesInner } from './action21-resources-inner';
...
export interface Action21 {
     ...
     * @type {Array<Action21ResourcesInner>}
     * @memberof Action21
     */
    'resources': Array<Action21ResourcesInner>;
    /**
     ...
     * @memberof Action21
     */
    'status': Action21StatusEnum;
}

type Action21StatusEnum = 'success' | 'running' | 'error'
