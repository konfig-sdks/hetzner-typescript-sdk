...
import { ActionNullableProperty } from './action-nullable-property';
import { CertificateProperty } from './certificate-property';

/**
 * 
 * @export
 * @interface CertificatesCreateNewCertificateResponse
 */
export interface CertificatesCreateNewCertificateResponse {
    /**
     * 
     * @type {ActionNullableProperty}
     * @memberof CertificatesCreateNewCertificateResponse
     */
    'action'?: ActionNullableProperty | null;
    /**
     * 
