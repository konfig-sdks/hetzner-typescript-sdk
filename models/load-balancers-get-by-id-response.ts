...
import { LoadBalancersGetByIdResponseLoadBalancer } from './load-balancers-get-by-id-response-load-balancer';

/**
 * 
 * @export
 * @interface LoadBalancersGetByIdResponse
 */
export interface LoadBalancersGetByIdResponse {
    /**
     * 
     * @type {LoadBalancersGetByIdResponseLoadBalancer}
     * @memberof LoadBalancersGetByIdResponse
     */
    'load_balancer': LoadBalancersGetByIdResponseLoadBalancer;
}
