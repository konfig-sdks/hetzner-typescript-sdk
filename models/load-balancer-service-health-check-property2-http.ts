 ...
 * @export
 * @interface LoadBalancerServiceHealthCheckProperty2Http
 */
export interface LoadBalancerServiceHealthCheckProperty2Http {
    /**
     ...
     * @type {string}
     * @memberof LoadBalancerServiceHealthCheckProperty2Http
     */
    'domain': string | null;
    /**
