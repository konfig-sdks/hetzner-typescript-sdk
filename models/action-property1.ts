...
import { ActionProperty1Error } from './action-property1-error';
import { ActionProperty1ResourcesInner } from './action-property1-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty1
 */
export interface ActionProperty1 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty1
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty1Error}
     * @memberof ActionProperty1
     */
    'error': ActionProperty1Error | null;
    /**
     ...
     * @type {Array<ActionProperty1ResourcesInner>}
     * @memberof ActionProperty1
     */
    'resources': Array<ActionProperty1ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty1
     */
    'status': ActionProperty1StatusEnum;
}

type ActionProperty1StatusEnum = 'success' | 'running' | 'error'
