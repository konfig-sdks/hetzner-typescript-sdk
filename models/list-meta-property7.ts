...
import { ListMetaProperty7Pagination } from './list-meta-property7-pagination';

/**
 * 
 * @export
 * @interface ListMetaProperty7
 */
export interface ListMetaProperty7 {
    /**
     * 
     * @type {ListMetaProperty7Pagination}
     * @memberof ListMetaProperty7
     */
    'pagination': ListMetaProperty7Pagination;
}
