...
import { Action5Error } from './action5-error';
import { Action5ResourcesInner } from './action5-resources-inner';
...
export interface Action5 {
     ...
     * @type {Array<Action5ResourcesInner>}
     * @memberof Action5
     */
    'resources': Array<Action5ResourcesInner>;
    /**
     ...
     * @memberof Action5
     */
    'status': Action5StatusEnum;
}

type Action5StatusEnum = 'success' | 'running' | 'error'
