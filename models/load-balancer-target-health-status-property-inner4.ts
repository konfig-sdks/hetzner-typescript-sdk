 ...
 * 
 * @export
 * @interface LoadBalancerTargetHealthStatusPropertyInner4
 */
export interface LoadBalancerTargetHealthStatusPropertyInner4 {
    /**
     * 
     * @type {number}
     * @memberof LoadBalancerTargetHealthStatusPropertyInner4
     */
    'listen_port'?: number;
    /**
     * 
     ...
     * @memberof LoadBalancerTargetHealthStatusPropertyInner4
     */
    'status'?: LoadBalancerTargetHealthStatusPropertyInner4StatusEnum;
}

type LoadBalancerTargetHealthStatusPropertyInner4StatusEnum = 'healthy' | 'unhealthy' | 'unknown'
