...
/**
 * @type LoadBalancersGetMetricsResponseMetricsTimeSeriesValueValuesInnerInner
 * @export
 */
export type LoadBalancersGetMetricsResponseMetricsTimeSeriesValueValuesInnerInner = number | string;
