...
import { ActionProperty15 } from './action-property15';

/**
 * 
 * @export
 * @interface ImageActionsChangeProtectionResponse
 */
export interface ImageActionsChangeProtectionResponse {
    /**
     * 
     * @type {ActionProperty15}
     * @memberof ImageActionsChangeProtectionResponse
     */
    'action': ActionProperty15;
}
