...
import { IsOsGetResponseIso } from './is-os-get-response-iso';

/**
 * 
 * @export
 * @interface IsOsGetResponse
 */
export interface IsOsGetResponse {
    /**
     * 
     * @type {IsOsGetResponseIso}
     * @memberof IsOsGetResponse
     */
    'iso': IsOsGetResponseIso;
}
