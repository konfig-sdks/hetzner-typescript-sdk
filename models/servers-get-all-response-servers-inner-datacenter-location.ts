 ...
 * @export
 * @interface ServersGetAllResponseServersInnerDatacenterLocation
 */
export interface ServersGetAllResponseServersInnerDatacenterLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof ServersGetAllResponseServersInnerDatacenterLocation
     */
    'description': string;
    /**
