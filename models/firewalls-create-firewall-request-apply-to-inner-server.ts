 ...
 * @export
 * @interface FirewallsCreateFirewallRequestApplyToInnerServer
 */
export interface FirewallsCreateFirewallRequestApplyToInnerServer {
    /**
     * ID of the Server
     * @type {number}
     * @memberof FirewallsCreateFirewallRequestApplyToInnerServer
     */
    'id': number;
}
