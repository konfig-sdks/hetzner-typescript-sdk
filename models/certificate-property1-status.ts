...
import { CertificateProperty1StatusError } from './certificate-property1-status-error';

/**
 * Current status of a type `managed` Certificate, always *null* for type `uploaded` Certificates
 * @export
 * @interface CertificateProperty1Status
 */
export interface CertificateProperty1Status {
    /**
     * 
     * @type {CertificateProperty1StatusError}
     * @memberof CertificateProperty1Status
     */
    'error'?: CertificateProperty1StatusError | null;
    /**
     * Status of the issuance process of the Certificate
     * @type {string}
     * @memberof CertificateProperty1Status
     */
    'issuance'?: CertificateProperty1StatusIssuanceEnum;
    /**
     * Status of the renewal process of the Certificate.
     * @type {string}
     * @memberof CertificateProperty1Status
     */
    'renewal'?: CertificateProperty1StatusRenewalEnum;
}

type CertificateProperty1StatusIssuanceEnum = 'pending' | 'completed' | 'failed'
type CertificateProperty1StatusRenewalEnum = 'scheduled' | 'pending' | 'failed' | 'unavailable'
