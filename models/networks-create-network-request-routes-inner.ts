 ...
 * 
 * @export
 * @interface NetworksCreateNetworkRequestRoutesInner
 */
export interface NetworksCreateNetworkRequestRoutesInner {
    /**
     ...
     * @type {string}
     * @memberof NetworksCreateNetworkRequestRoutesInner
     */
    'destination': string;
    /**
