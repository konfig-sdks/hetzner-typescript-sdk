...
import { ActionProperty69Error } from './action-property69-error';
import { ActionProperty69ResourcesInner } from './action-property69-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty69
 */
export interface ActionProperty69 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty69
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty69Error}
     * @memberof ActionProperty69
     */
    'error': ActionProperty69Error | null;
    /**
     ...
     * @type {Array<ActionProperty69ResourcesInner>}
     * @memberof ActionProperty69
     */
    'resources': Array<ActionProperty69ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty69
     */
    'status': ActionProperty69StatusEnum;
}

type ActionProperty69StatusEnum = 'success' | 'running' | 'error'
