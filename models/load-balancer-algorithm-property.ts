 ...
 * @export
 * @interface LoadBalancerAlgorithmProperty
 */
export interface LoadBalancerAlgorithmProperty {
    /**
     * Type of the algorithm.
     * @type {string}
     * @memberof LoadBalancerAlgorithmProperty
     */
    'type': LoadBalancerAlgorithmPropertyTypeEnum;
}

type LoadBalancerAlgorithmPropertyTypeEnum = 'round_robin' | 'least_connections'
