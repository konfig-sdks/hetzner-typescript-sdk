...
import { LoadBalancerActionsAddTargetRequestLabelSelector } from './load-balancer-actions-add-target-request-label-selector';
import { LoadBalancerActionsAddTargetRequestServer } from './load-balancer-actions-add-target-request-server';
import { LoadBalancerTargetIPProperty1 } from './load-balancer-target-ipproperty1';

/**
 * 
 * @export
 * @interface LoadBalancerActionsAddTargetRequest
 */
export interface LoadBalancerActionsAddTargetRequest {
    /**
     * 
     * @type {LoadBalancerTargetIPProperty1}
     * @memberof LoadBalancerActionsAddTargetRequest
     */
    'ip'?: LoadBalancerTargetIPProperty1;
    /**
     * 
     * @type {LoadBalancerActionsAddTargetRequestLabelSelector}
     * @memberof LoadBalancerActionsAddTargetRequest
     */
    'label_selector'?: LoadBalancerActionsAddTargetRequestLabelSelector;
    /**
     * 
     * @type {LoadBalancerActionsAddTargetRequestServer}
     * @memberof LoadBalancerActionsAddTargetRequest
     */
    'server'?: LoadBalancerActionsAddTargetRequestServer;
    /**
     * Type of the resource
     * @type {string}
     * @memberof LoadBalancerActionsAddTargetRequest
     */
    'type': LoadBalancerActionsAddTargetRequestTypeEnum;
    /**
...
type LoadBalancerActionsAddTargetRequestTypeEnum = 'server' | 'label_selector' | 'ip'
