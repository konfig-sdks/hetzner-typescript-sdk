 ...
 * @export
 * @interface LoadBalancerActionsAddTargetRequestServer
 */
export interface LoadBalancerActionsAddTargetRequestServer {
    /**
     * ID of the Server
     * @type {number}
     * @memberof LoadBalancerActionsAddTargetRequestServer
     */
    'id': number;
}
