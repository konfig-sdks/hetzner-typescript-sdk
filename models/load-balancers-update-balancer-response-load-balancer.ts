...
import { LoadBalancerService4 } from './load-balancer-service4';
import { LoadBalancerTarget4 } from './load-balancer-target4';
...
import { LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType } from './load-balancers-update-balancer-response-load-balancer-load-balancer-type';
import { LoadBalancersUpdateBalancerResponseLoadBalancerLocation } from './load-balancers-update-balancer-response-load-balancer-location';
import { LoadBalancersUpdateBalancerResponseLoadBalancerPrivateNetInner } from './load-balancers-update-balancer-response-load-balancer-private-net-inner';
import { LoadBalancersUpdateBalancerResponseLoadBalancerProtection } from './load-balancers-update-balancer-response-load-balancer-protection';
import { LoadBalancersUpdateBalancerResponseLoadBalancerPublicNet } from './load-balancers-update-balancer-response-load-balancer-public-net';

/**
 * 
 * @export
 * @interface LoadBalancersUpdateBalancerResponseLoadBalancer
 */
export interface LoadBalancersUpdateBalancerResponseLoadBalancer {
    /**
     * 
     * @type {LoadBalancersGetAllResponseLoadBalancersInnerAlgorithm}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancer
     */
    ...
    /**
     * 
     * @type {LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancer
     */
    'load_balancer_type': LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType;
    /**
     * 
     * @type {LoadBalancersUpdateBalancerResponseLoadBalancerLocation}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancer
     */
     ...
     * @type {Array<LoadBalancersUpdateBalancerResponseLoadBalancerPrivateNetInner>}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancer
     */
    'private_net': Array<LoadBalancersUpdateBalancerResponseLoadBalancerPrivateNetInner>;
    /**
     * 
     * @type {LoadBalancersUpdateBalancerResponseLoadBalancerProtection}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancer
     */
    'protection': LoadBalancersUpdateBalancerResponseLoadBalancerProtection;
    /**
     * 
     * @type {LoadBalancersUpdateBalancerResponseLoadBalancerPublicNet}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancer
     */
    'public_net': LoadBalancersUpdateBalancerResponseLoadBalancerPublicNet;
    /**
     * List of services that belong to this Load Balancer
     * @type {Array<LoadBalancerService4>}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancer
     */
    'services': Array<LoadBalancerService4>;
    /**
     * List of targets that belong to this Load Balancer
     * @type {Array<LoadBalancerTarget4>}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancer
     */
    'targets': Array<LoadBalancerTarget4>;
}
