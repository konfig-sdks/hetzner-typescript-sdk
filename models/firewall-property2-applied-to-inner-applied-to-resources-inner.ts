...
import { FirewallProperty2AppliedToInnerAppliedToResourcesInnerServer } from './firewall-property2-applied-to-inner-applied-to-resources-inner-server';

/**
 * 
 * @export
 * @interface FirewallProperty2AppliedToInnerAppliedToResourcesInner
 */
export interface FirewallProperty2AppliedToInnerAppliedToResourcesInner {
    /**
     * 
     * @type {FirewallProperty2AppliedToInnerAppliedToResourcesInnerServer}
     * @memberof FirewallProperty2AppliedToInnerAppliedToResourcesInner
     */
    'server'?: FirewallProperty2AppliedToInnerAppliedToResourcesInnerServer;
    /**
     * Type of resource referenced
     * @type {string}
     * @memberof FirewallProperty2AppliedToInnerAppliedToResourcesInner
     */
    'type'?: FirewallProperty2AppliedToInnerAppliedToResourcesInnerTypeEnum;
}

type FirewallProperty2AppliedToInnerAppliedToResourcesInnerTypeEnum = 'server'
