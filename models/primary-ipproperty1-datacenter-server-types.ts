 ...
 * @export
 * @interface PrimaryIPProperty1DatacenterServerTypes
 */
export interface PrimaryIPProperty1DatacenterServerTypes {
    /**
     * IDs of Server types that are supported and for which the Datacenter has enough resources left
     * @type {Array<number>}
     * @memberof PrimaryIPProperty1DatacenterServerTypes
     */
