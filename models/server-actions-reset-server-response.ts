...
import { ActionProperty70 } from './action-property70';

/**
 * 
 * @export
 * @interface ServerActionsResetServerResponse
 */
export interface ServerActionsResetServerResponse {
    /**
     * 
     * @type {ActionProperty70}
     * @memberof ServerActionsResetServerResponse
     */
    'action': ActionProperty70;
}
