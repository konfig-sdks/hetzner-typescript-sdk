...
import { FloatingIPsUpdateDescriptionLabelsResponseFloatingIpDnsPtrInner } from './floating-ips-update-description-labels-response-floating-ip-dns-ptr-inner';
import { FloatingIPsUpdateDescriptionLabelsResponseFloatingIpHomeLocation } from './floating-ips-update-description-labels-response-floating-ip-home-location';
import { FloatingIPsUpdateDescriptionLabelsResponseFloatingIpProtection } from './floating-ips-update-description-labels-response-floating-ip-protection';

/**
 * 
 * @export
 * @interface FloatingIPsUpdateDescriptionLabelsResponseFloatingIp
 */
export interface FloatingIPsUpdateDescriptionLabelsResponseFloatingIp {
    /**
     * Description of the Resource.
     * @type {string}
     * @memberof FloatingIPsUpdateDescriptionLabelsResponseFloatingIp
     */
     ...
     * @type {Array<FloatingIPsUpdateDescriptionLabelsResponseFloatingIpDnsPtrInner>}
     * @memberof FloatingIPsUpdateDescriptionLabelsResponseFloatingIp
     */
    'dns_ptr': Array<FloatingIPsUpdateDescriptionLabelsResponseFloatingIpDnsPtrInner>;
    /**
     * 
     * @type {FloatingIPsUpdateDescriptionLabelsResponseFloatingIpHomeLocation}
     * @memberof FloatingIPsUpdateDescriptionLabelsResponseFloatingIp
     */
    ...
    /**
     * 
     * @type {FloatingIPsUpdateDescriptionLabelsResponseFloatingIpProtection}
     * @memberof FloatingIPsUpdateDescriptionLabelsResponseFloatingIp
     */
     ...
     * @memberof FloatingIPsUpdateDescriptionLabelsResponseFloatingIp
     */
    'type': FloatingIPsUpdateDescriptionLabelsResponseFloatingIpTypeEnum;
}

type FloatingIPsUpdateDescriptionLabelsResponseFloatingIpTypeEnum = 'ipv4' | 'ipv6'
