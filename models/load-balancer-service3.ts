...
import { LoadBalancerServiceHTTPProperty5 } from './load-balancer-service-httpproperty5';
import { LoadBalancerServiceHealthCheckProperty4 } from './load-balancer-service-health-check-property4';

/**
 * 
 * @export
 * @interface LoadBalancerService3
 */
export interface LoadBalancerService3 {
    /**
     * Port the Load Balancer will balance to
     * @type {number}
     * @memberof LoadBalancerService3
     */
    'destination_port': number;
    /**
     * 
     * @type {LoadBalancerServiceHealthCheckProperty4}
     * @memberof LoadBalancerService3
     */
    'health_check': LoadBalancerServiceHealthCheckProperty4;
    /**
     * 
     * @type {LoadBalancerServiceHTTPProperty5}
     * @memberof LoadBalancerService3
     */
    'http'?: LoadBalancerServiceHTTPProperty5;
    /**
     ...
     * @memberof LoadBalancerService3
     */
    'protocol': LoadBalancerService3ProtocolEnum;
    /**
...
type LoadBalancerService3ProtocolEnum = 'tcp' | 'http' | 'https'
