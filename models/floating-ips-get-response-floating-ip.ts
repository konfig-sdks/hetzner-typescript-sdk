...
import { FloatingIPsGetResponseFloatingIpDnsPtrInner } from './floating-ips-get-response-floating-ip-dns-ptr-inner';
import { FloatingIPsGetResponseFloatingIpHomeLocation } from './floating-ips-get-response-floating-ip-home-location';
import { FloatingIPsGetResponseFloatingIpProtection } from './floating-ips-get-response-floating-ip-protection';

/**
 * 
 * @export
 * @interface FloatingIPsGetResponseFloatingIp
 */
export interface FloatingIPsGetResponseFloatingIp {
    /**
     * Description of the Resource.
     * @type {string}
     * @memberof FloatingIPsGetResponseFloatingIp
     */
     ...
     * @type {Array<FloatingIPsGetResponseFloatingIpDnsPtrInner>}
     * @memberof FloatingIPsGetResponseFloatingIp
     */
    'dns_ptr': Array<FloatingIPsGetResponseFloatingIpDnsPtrInner>;
    /**
     * 
     * @type {FloatingIPsGetResponseFloatingIpHomeLocation}
     * @memberof FloatingIPsGetResponseFloatingIp
     */
    ...
    /**
     * 
     * @type {FloatingIPsGetResponseFloatingIpProtection}
     * @memberof FloatingIPsGetResponseFloatingIp
     */
     ...
     * @memberof FloatingIPsGetResponseFloatingIp
     */
    'type': FloatingIPsGetResponseFloatingIpTypeEnum;
}

type FloatingIPsGetResponseFloatingIpTypeEnum = 'ipv4' | 'ipv6'
