 ...
 * @export
 * @interface LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly
 */
export interface LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly {
    /**
     * Price with VAT added.
     * @type {string}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly
     */
    'gross': string;
    /**
     * Price without VAT.
