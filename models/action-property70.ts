...
import { ActionProperty70Error } from './action-property70-error';
import { ActionProperty70ResourcesInner } from './action-property70-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty70
 */
export interface ActionProperty70 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty70
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty70Error}
     * @memberof ActionProperty70
     */
    'error': ActionProperty70Error | null;
    /**
     ...
     * @type {Array<ActionProperty70ResourcesInner>}
     * @memberof ActionProperty70
     */
    'resources': Array<ActionProperty70ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty70
     */
    'status': ActionProperty70StatusEnum;
}

type ActionProperty70StatusEnum = 'success' | 'running' | 'error'
