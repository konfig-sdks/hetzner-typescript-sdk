 ...
 * @export
 * @interface FloatingIPsCreateNewIpResponseFloatingIpProtection
 */
export interface FloatingIPsCreateNewIpResponseFloatingIpProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof FloatingIPsCreateNewIpResponseFloatingIpProtection
     */
    'delete': boolean;
}
