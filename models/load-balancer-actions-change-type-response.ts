...
import { ActionProperty25 } from './action-property25';

/**
 * 
 * @export
 * @interface LoadBalancerActionsChangeTypeResponse
 */
export interface LoadBalancerActionsChangeTypeResponse {
    /**
     * 
     * @type {ActionProperty25}
     * @memberof LoadBalancerActionsChangeTypeResponse
     */
    'action': ActionProperty25;
}
