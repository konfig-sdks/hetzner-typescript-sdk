...
import { Action25Error } from './action25-error';
import { Action25ResourcesInner } from './action25-resources-inner';
...
export interface Action25 {
     ...
     * @type {Array<Action25ResourcesInner>}
     * @memberof Action25
     */
    'resources': Array<Action25ResourcesInner>;
    /**
     ...
     * @memberof Action25
     */
    'status': Action25StatusEnum;
}

type Action25StatusEnum = 'success' | 'running' | 'error'
