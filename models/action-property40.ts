...
import { ActionProperty40Error } from './action-property40-error';
import { ActionProperty40ResourcesInner } from './action-property40-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty40
 */
export interface ActionProperty40 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty40
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty40Error}
     * @memberof ActionProperty40
     */
    'error': ActionProperty40Error | null;
    /**
     ...
     * @type {Array<ActionProperty40ResourcesInner>}
     * @memberof ActionProperty40
     */
    'resources': Array<ActionProperty40ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty40
     */
    'status': ActionProperty40StatusEnum;
}

type ActionProperty40StatusEnum = 'success' | 'running' | 'error'
