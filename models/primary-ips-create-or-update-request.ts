 ...
 * 
 * @export
 * @interface PrimaryIPsCreateOrUpdateRequest
 */
export interface PrimaryIPsCreateOrUpdateRequest {
    /**
     * ID of the resource the Primary IP should be assigned to. Omitted if it should not be assigned.
     * @type {number}
     * @memberof PrimaryIPsCreateOrUpdateRequest
     */
    'assignee_id'?: number;
    /**
     ...
     * @memberof PrimaryIPsCreateOrUpdateRequest
     */
    'assignee_type': PrimaryIPsCreateOrUpdateRequestAssigneeTypeEnum;
    /**
     ...
     * @memberof PrimaryIPsCreateOrUpdateRequest
     */
    'type': PrimaryIPsCreateOrUpdateRequestTypeEnum;
}

type PrimaryIPsCreateOrUpdateRequestAssigneeTypeEnum = 'server'
type PrimaryIPsCreateOrUpdateRequestTypeEnum = 'ipv4' | 'ipv6'
