 ...
 * 
 * @export
 * @interface LoadBalancersCreateLoadBalancerResponseLoadBalancerLocation
 */
export interface LoadBalancersCreateLoadBalancerResponseLoadBalancerLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancerLocation
     */
    'description': string;
    /**
