 ...
 * @export
 * @interface ServersUpdateServerResponseServerImageProtection
 */
export interface ServersUpdateServerResponseServerImageProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof ServersUpdateServerResponseServerImageProtection
     */
    'delete': boolean;
}
