 ...
 * 
 * @export
 * @interface LoadBalancerTargetHealthStatusPropertyInner2
 */
export interface LoadBalancerTargetHealthStatusPropertyInner2 {
    /**
     * 
     * @type {number}
     * @memberof LoadBalancerTargetHealthStatusPropertyInner2
     */
    'listen_port'?: number;
    /**
     * 
     ...
     * @memberof LoadBalancerTargetHealthStatusPropertyInner2
     */
    'status'?: LoadBalancerTargetHealthStatusPropertyInner2StatusEnum;
}

type LoadBalancerTargetHealthStatusPropertyInner2StatusEnum = 'healthy' | 'unhealthy' | 'unknown'
