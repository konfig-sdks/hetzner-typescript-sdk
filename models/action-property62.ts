...
import { ActionProperty62Error } from './action-property62-error';
import { ActionProperty62ResourcesInner } from './action-property62-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty62
 */
export interface ActionProperty62 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty62
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty62Error}
     * @memberof ActionProperty62
     */
    'error': ActionProperty62Error | null;
    /**
     ...
     * @type {Array<ActionProperty62ResourcesInner>}
     * @memberof ActionProperty62
     */
    'resources': Array<ActionProperty62ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty62
     */
    'status': ActionProperty62StatusEnum;
}

type ActionProperty62StatusEnum = 'success' | 'running' | 'error'
