...
import { LoadBalancerServiceHealthCheckProperty1Http } from './load-balancer-service-health-check-property1-http';

/**
 * Service health check
 * @export
 * @interface LoadBalancerServiceHealthCheckProperty1
 */
export interface LoadBalancerServiceHealthCheckProperty1 {
    /**
     * 
     * @type {LoadBalancerServiceHealthCheckProperty1Http}
     * @memberof LoadBalancerServiceHealthCheckProperty1
     */
    'http'?: LoadBalancerServiceHealthCheckProperty1Http;
    /**
     ...
     * @memberof LoadBalancerServiceHealthCheckProperty1
     */
    'protocol': LoadBalancerServiceHealthCheckProperty1ProtocolEnum;
    /**
...
type LoadBalancerServiceHealthCheckProperty1ProtocolEnum = 'tcp' | 'http'
