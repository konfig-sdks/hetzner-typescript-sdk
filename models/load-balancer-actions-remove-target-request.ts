...
import { LoadBalancerActionsRemoveTargetRequestLabelSelector } from './load-balancer-actions-remove-target-request-label-selector';
import { LoadBalancerActionsRemoveTargetRequestServer } from './load-balancer-actions-remove-target-request-server';
import { LoadBalancerTargetIPProperty2 } from './load-balancer-target-ipproperty2';

/**
 * 
 * @export
 * @interface LoadBalancerActionsRemoveTargetRequest
 */
export interface LoadBalancerActionsRemoveTargetRequest {
    /**
     * 
     * @type {LoadBalancerTargetIPProperty2}
     * @memberof LoadBalancerActionsRemoveTargetRequest
     */
    'ip'?: LoadBalancerTargetIPProperty2;
    /**
     * 
     * @type {LoadBalancerActionsRemoveTargetRequestLabelSelector}
     * @memberof LoadBalancerActionsRemoveTargetRequest
     */
    'label_selector'?: LoadBalancerActionsRemoveTargetRequestLabelSelector;
    /**
     * 
     * @type {LoadBalancerActionsRemoveTargetRequestServer}
     * @memberof LoadBalancerActionsRemoveTargetRequest
     */
    'server'?: LoadBalancerActionsRemoveTargetRequestServer;
    /**
     * Type of the resource
     * @type {string}
     * @memberof LoadBalancerActionsRemoveTargetRequest
     */
    'type': LoadBalancerActionsRemoveTargetRequestTypeEnum;
}

type LoadBalancerActionsRemoveTargetRequestTypeEnum = 'server' | 'label_selector' | 'ip'
