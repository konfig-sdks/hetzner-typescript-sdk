...
import { ActionProperty42 } from './action-property42';

/**
 * 
 * @export
 * @interface PrimaryIpActionsGetActionByIdResponse
 */
export interface PrimaryIpActionsGetActionByIdResponse {
    /**
     * 
     * @type {ActionProperty42}
     * @memberof PrimaryIpActionsGetActionByIdResponse
     */
    'action': ActionProperty42;
}
