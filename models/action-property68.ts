...
import { ActionProperty68Error } from './action-property68-error';
import { ActionProperty68ResourcesInner } from './action-property68-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty68
 */
export interface ActionProperty68 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty68
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty68Error}
     * @memberof ActionProperty68
     */
    'error': ActionProperty68Error | null;
    /**
     ...
     * @type {Array<ActionProperty68ResourcesInner>}
     * @memberof ActionProperty68
     */
    'resources': Array<ActionProperty68ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty68
     */
    'status': ActionProperty68StatusEnum;
}

type ActionProperty68StatusEnum = 'success' | 'running' | 'error'
