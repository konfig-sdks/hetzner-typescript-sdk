 ...
 * @export
 * @interface FloatingIPsGetAllResponseFloatingIpsInnerProtection
 */
export interface FloatingIPsGetAllResponseFloatingIpsInnerProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof FloatingIPsGetAllResponseFloatingIpsInnerProtection
     */
    'delete': boolean;
}
