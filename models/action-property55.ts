...
import { ActionProperty55Error } from './action-property55-error';
import { ActionProperty55ResourcesInner } from './action-property55-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty55
 */
export interface ActionProperty55 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty55
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty55Error}
     * @memberof ActionProperty55
     */
    'error': ActionProperty55Error | null;
    /**
     ...
     * @type {Array<ActionProperty55ResourcesInner>}
     * @memberof ActionProperty55
     */
    'resources': Array<ActionProperty55ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty55
     */
    'status': ActionProperty55StatusEnum;
}

type ActionProperty55StatusEnum = 'success' | 'running' | 'error'
