 ...
 * @export
 * @interface VolumesUpdateVolumePropertiesResponseVolumeProtection
 */
export interface VolumesUpdateVolumePropertiesResponseVolumeProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof VolumesUpdateVolumePropertiesResponseVolumeProtection
     */
    'delete': boolean;
}
