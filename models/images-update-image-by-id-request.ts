 ...
 * 
 * @export
 * @interface ImagesUpdateImageByIdRequest
 */
export interface ImagesUpdateImageByIdRequest {
    /**
     * New description of Image
     * @type {string}
     * @memberof ImagesUpdateImageByIdRequest
     */
    'description'?: string;
    /**
     ...
     * @memberof ImagesUpdateImageByIdRequest
     */
    'type'?: ImagesUpdateImageByIdRequestTypeEnum;
}

type ImagesUpdateImageByIdRequestTypeEnum = 'snapshot'
