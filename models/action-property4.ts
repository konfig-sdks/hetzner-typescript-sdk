...
import { ActionProperty4Error } from './action-property4-error';
import { ActionProperty4ResourcesInner } from './action-property4-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty4
 */
export interface ActionProperty4 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty4
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty4Error}
     * @memberof ActionProperty4
     */
    'error': ActionProperty4Error | null;
    /**
     ...
     * @type {Array<ActionProperty4ResourcesInner>}
     * @memberof ActionProperty4
     */
    'resources': Array<ActionProperty4ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty4
     */
    'status': ActionProperty4StatusEnum;
}

type ActionProperty4StatusEnum = 'success' | 'running' | 'error'
