...
import { ListMetaProperty6Pagination } from './list-meta-property6-pagination';

/**
 * 
 * @export
 * @interface ListMetaProperty6
 */
export interface ListMetaProperty6 {
    /**
     * 
     * @type {ListMetaProperty6Pagination}
     * @memberof ListMetaProperty6
     */
    'pagination': ListMetaProperty6Pagination;
}
