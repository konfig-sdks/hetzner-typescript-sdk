...
import { ImagesGetAllResponseImagesInnerCreatedFrom } from './images-get-all-response-images-inner-created-from';
import { ImagesGetAllResponseImagesInnerProtection } from './images-get-all-response-images-inner-protection';

/**
 * 
 * @export
 * @interface ImagesGetAllResponseImagesInner
 */
export interface ImagesGetAllResponseImagesInner {
    /**
     * Description of the Image
     * @type {string}
     * @memberof ImagesGetAllResponseImagesInner
     */
    'description': string;
    /**
     ...
     * @memberof ImagesGetAllResponseImagesInner
     */
    'architecture': ImagesGetAllResponseImagesInnerArchitectureEnum;
    /**
    ...
    /**
     * 
     * @type {ImagesGetAllResponseImagesInnerCreatedFrom}
     * @memberof ImagesGetAllResponseImagesInner
     */
    'created_from': ImagesGetAllResponseImagesInnerCreatedFrom | null;
    /**
     ...
     * @memberof ImagesGetAllResponseImagesInner
     */
    'os_flavor': ImagesGetAllResponseImagesInnerOsFlavorEnum;
    /**
    ...
    /**
     * 
     * @type {ImagesGetAllResponseImagesInnerProtection}
     * @memberof ImagesGetAllResponseImagesInner
     */
    'protection': ImagesGetAllResponseImagesInnerProtection;
    /**
     ...
     * @memberof ImagesGetAllResponseImagesInner
     */
    'status': ImagesGetAllResponseImagesInnerStatusEnum;
    /**
     * Type of the Image
     * @type {string}
     * @memberof ImagesGetAllResponseImagesInner
     */
    'type': ImagesGetAllResponseImagesInnerTypeEnum;
}

type ImagesGetAllResponseImagesInnerArchitectureEnum = 'x86' | 'arm'
type ImagesGetAllResponseImagesInnerOsFlavorEnum = 'ubuntu' | 'centos' | 'debian' | 'fedora' | 'rocky' | 'alma' | 'unknown'
type ImagesGetAllResponseImagesInnerStatusEnum = 'available' | 'creating' | 'unavailable'
type ImagesGetAllResponseImagesInnerTypeEnum = 'system' | 'app' | 'snapshot' | 'backup' | 'temporary'
