 ...
 * @export
 * @interface DatacentersGetAllResponseDatacentersInnerLocation
 */
export interface DatacentersGetAllResponseDatacentersInnerLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof DatacentersGetAllResponseDatacentersInnerLocation
     */
    'description': string;
    /**
