 ...
 * @export
 * @interface ServersCreateServerActionResponseServerImageProtection
 */
export interface ServersCreateServerActionResponseServerImageProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof ServersCreateServerActionResponseServerImageProtection
     */
    'delete': boolean;
}
