...
import { SshKeysUpdateKeyResponseSshKey } from './ssh-keys-update-key-response-ssh-key';

/**
 * 
 * @export
 * @interface SshKeysUpdateKeyResponse
 */
export interface SshKeysUpdateKeyResponse {
    /**
     * 
     * @type {SshKeysUpdateKeyResponseSshKey}
     * @memberof SshKeysUpdateKeyResponse
     */
    'ssh_key': SshKeysUpdateKeyResponseSshKey;
}
