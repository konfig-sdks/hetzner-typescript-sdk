...
import { LoadBalancerTargetHealthStatusPropertyInner } from './load-balancer-target-health-status-property-inner';
import { LoadBalancerTargetIPProperty } from './load-balancer-target-ipproperty';
import { LoadBalancerTargetLabelSelectorProperty } from './load-balancer-target-label-selector-property';
import { LoadBalancerTargetServerProperty } from './load-balancer-target-server-property';
import { LoadBalancerTargetTarget } from './load-balancer-target-target';
...
export interface LoadBalancerTarget {
     ...
     * @type {Array<LoadBalancerTargetHealthStatusPropertyInner>}
     * @memberof LoadBalancerTarget
     */
    'health_status'?: Array<LoadBalancerTargetHealthStatusPropertyInner>;
    /**
     * 
     * @type {LoadBalancerTargetIPProperty}
     * @memberof LoadBalancerTarget
     */
    'ip'?: LoadBalancerTargetIPProperty;
    /**
     * 
     * @type {LoadBalancerTargetLabelSelectorProperty}
     * @memberof LoadBalancerTarget
     */
    'label_selector'?: LoadBalancerTargetLabelSelectorProperty;
    /**
     * 
     * @type {LoadBalancerTargetServerProperty}
     * @memberof LoadBalancerTarget
     */
    'server'?: LoadBalancerTargetServerProperty;
    /**
     * List of resolved label selector target Servers. Only present for type \"label_selector\".
     * @type {Array<LoadBalancerTargetTarget>}
     * @memberof LoadBalancerTarget
     */
     ...
     * @memberof LoadBalancerTarget
     */
    'type': LoadBalancerTargetTypeEnum;
    /**
...
type LoadBalancerTargetTypeEnum = 'server' | 'label_selector' | 'ip'
