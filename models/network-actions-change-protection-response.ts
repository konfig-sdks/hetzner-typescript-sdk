...
import { ActionProperty37 } from './action-property37';

/**
 * 
 * @export
 * @interface NetworkActionsChangeProtectionResponse
 */
export interface NetworkActionsChangeProtectionResponse {
    /**
     * 
     * @type {ActionProperty37}
     * @memberof NetworkActionsChangeProtectionResponse
     */
    'action': ActionProperty37;
}
