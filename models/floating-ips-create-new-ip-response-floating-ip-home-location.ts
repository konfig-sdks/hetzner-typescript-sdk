 ...
 * @export
 * @interface FloatingIPsCreateNewIpResponseFloatingIpHomeLocation
 */
export interface FloatingIPsCreateNewIpResponseFloatingIpHomeLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof FloatingIPsCreateNewIpResponseFloatingIpHomeLocation
     */
    'description': string;
    /**
