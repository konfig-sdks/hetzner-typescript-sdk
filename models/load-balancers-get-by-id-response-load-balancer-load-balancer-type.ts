...
import { LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInner } from './load-balancers-get-by-id-response-load-balancer-load-balancer-type-prices-inner';

/**
 * 
 * @export
 * @interface LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType
 */
export interface LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType {
    /**
     * Description of the Load Balancer type
     * @type {string}
     * @memberof LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType
     */
    'description': string;
    /**
     ...
     * @type {Array<LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInner>}
     * @memberof LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType
     */
    'prices': Array<LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInner>;
}
