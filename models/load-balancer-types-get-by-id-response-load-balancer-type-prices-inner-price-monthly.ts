 ...
 * @export
 * @interface LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInnerPriceMonthly
 */
export interface LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInnerPriceMonthly {
    /**
     * Price with VAT added.
     * @type {string}
     * @memberof LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInnerPriceMonthly
     */
    'gross': string;
    /**
     * Price without VAT.
