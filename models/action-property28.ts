...
import { ActionProperty28Error } from './action-property28-error';
import { ActionProperty28ResourcesInner } from './action-property28-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty28
 */
export interface ActionProperty28 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty28
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty28Error}
     * @memberof ActionProperty28
     */
    'error': ActionProperty28Error | null;
    /**
     ...
     * @type {Array<ActionProperty28ResourcesInner>}
     * @memberof ActionProperty28
     */
    'resources': Array<ActionProperty28ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty28
     */
    'status': ActionProperty28StatusEnum;
}

type ActionProperty28StatusEnum = 'success' | 'running' | 'error'
