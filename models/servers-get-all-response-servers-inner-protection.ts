 ...
 * @export
 * @interface ServersGetAllResponseServersInnerProtection
 */
export interface ServersGetAllResponseServersInnerProtection {
    /**
     * If true, prevents the Server from being deleted
     * @type {boolean}
     * @memberof ServersGetAllResponseServersInnerProtection
     */
    'delete': boolean;
    /**
