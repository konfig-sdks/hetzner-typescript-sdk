...
import { ActionProperty14Error } from './action-property14-error';
import { ActionProperty14ResourcesInner } from './action-property14-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty14
 */
export interface ActionProperty14 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty14
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty14Error}
     * @memberof ActionProperty14
     */
    'error': ActionProperty14Error | null;
    /**
     ...
     * @type {Array<ActionProperty14ResourcesInner>}
     * @memberof ActionProperty14
     */
    'resources': Array<ActionProperty14ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty14
     */
    'status': ActionProperty14StatusEnum;
}

type ActionProperty14StatusEnum = 'success' | 'running' | 'error'
