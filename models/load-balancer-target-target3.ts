...
import { LoadBalancerTargetHealthStatusPropertyInner7 } from './load-balancer-target-health-status-property-inner7';
import { LoadBalancerTargetServerProperty7 } from './load-balancer-target-server-property7';

/**
 * 
 * @export
 * @interface LoadBalancerTargetTarget3
 */
export interface LoadBalancerTargetTarget3 {
    /**
     * List of health statuses of the services on this target. Only present for target types \"server\" and \"ip\".
     * @type {Array<LoadBalancerTargetHealthStatusPropertyInner7>}
     * @memberof LoadBalancerTargetTarget3
     */
    'health_status'?: Array<LoadBalancerTargetHealthStatusPropertyInner7>;
    /**
     * 
     * @type {LoadBalancerTargetServerProperty7}
     * @memberof LoadBalancerTargetTarget3
     */
    'server'?: LoadBalancerTargetServerProperty7;
    /**
