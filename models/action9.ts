...
import { Action9Error } from './action9-error';
import { Action9ResourcesInner } from './action9-resources-inner';
...
export interface Action9 {
     ...
     * @type {Array<Action9ResourcesInner>}
     * @memberof Action9
     */
    'resources': Array<Action9ResourcesInner>;
    /**
     ...
     * @memberof Action9
     */
    'status': Action9StatusEnum;
}

type Action9StatusEnum = 'success' | 'running' | 'error'
