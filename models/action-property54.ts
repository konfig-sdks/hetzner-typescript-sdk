...
import { ActionProperty54Error } from './action-property54-error';
import { ActionProperty54ResourcesInner } from './action-property54-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty54
 */
export interface ActionProperty54 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty54
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty54Error}
     * @memberof ActionProperty54
     */
    'error': ActionProperty54Error | null;
    /**
     ...
     * @type {Array<ActionProperty54ResourcesInner>}
     * @memberof ActionProperty54
     */
    'resources': Array<ActionProperty54ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty54
     */
    'status': ActionProperty54StatusEnum;
}

type ActionProperty54StatusEnum = 'success' | 'running' | 'error'
