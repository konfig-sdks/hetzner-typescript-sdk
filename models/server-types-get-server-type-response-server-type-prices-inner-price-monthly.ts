 ...
 * @export
 * @interface ServerTypesGetServerTypeResponseServerTypePricesInnerPriceMonthly
 */
export interface ServerTypesGetServerTypeResponseServerTypePricesInnerPriceMonthly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof ServerTypesGetServerTypeResponseServerTypePricesInnerPriceMonthly
     */
    'gross': string;
    /**
     * Price without VAT
