...
import { CertificateProperty2Status } from './certificate-property2-status';
import { CertificateProperty2UsedByInner } from './certificate-property2-used-by-inner';

/**
 * 
 * @export
 * @interface CertificateProperty2
 */
export interface CertificateProperty2 {
    /**
     * Certificate and chain in PEM format, in order so that each record directly certifies the one preceding
     * @type {string}
     * @memberof CertificateProperty2
     */
    ...
    /**
     * 
     * @type {CertificateProperty2Status}
     * @memberof CertificateProperty2
     */
    'status'?: CertificateProperty2Status | null;
    /**
     * Type of the Certificate
     * @type {string}
     * @memberof CertificateProperty2
     */
    'type'?: CertificateProperty2TypeEnum;
    /**
     * Resources currently using the Certificate
     * @type {Array<CertificateProperty2UsedByInner>}
     * @memberof CertificateProperty2
     */
    'used_by': Array<CertificateProperty2UsedByInner>;
}

type CertificateProperty2TypeEnum = 'uploaded' | 'managed'
