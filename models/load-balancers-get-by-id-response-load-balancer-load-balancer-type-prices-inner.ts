...
import { LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly } from './load-balancers-get-by-id-response-load-balancer-load-balancer-type-prices-inner-price-hourly';
import { LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly } from './load-balancers-get-by-id-response-load-balancer-load-balancer-type-prices-inner-price-monthly';

/**
 * 
 * @export
 * @interface LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInner
 */
export interface LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInner {
    /**
     * Name of the Location the price is for.
     * @type {string}
     * @memberof LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInner
     */
    'location': string;
    /**
     * 
     * @type {LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly}
     * @memberof LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInner
     */
    'price_hourly': LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly;
    /**
     * 
     * @type {LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly}
     * @memberof LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInner
     */
    'price_monthly': LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly;
}
