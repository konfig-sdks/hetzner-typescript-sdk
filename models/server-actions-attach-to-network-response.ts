...
import { ActionProperty52 } from './action-property52';

/**
 * 
 * @export
 * @interface ServerActionsAttachToNetworkResponse
 */
export interface ServerActionsAttachToNetworkResponse {
    /**
     * 
     * @type {ActionProperty52}
     * @memberof ServerActionsAttachToNetworkResponse
     */
    'action': ActionProperty52;
}
