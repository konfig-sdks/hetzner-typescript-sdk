...
import { LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv4 } from './load-balancers-get-by-id-response-load-balancer-public-net-ipv4';
import { LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv6 } from './load-balancers-get-by-id-response-load-balancer-public-net-ipv6';

/**
 * Public network information
 * @export
 * @interface LoadBalancersGetByIdResponseLoadBalancerPublicNet
 */
export interface LoadBalancersGetByIdResponseLoadBalancerPublicNet {
    /**
     * Public Interface enabled or not
     * @type {boolean}
     * @memberof LoadBalancersGetByIdResponseLoadBalancerPublicNet
     */
    'enabled': boolean;
    /**
     * 
     * @type {LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv4}
     * @memberof LoadBalancersGetByIdResponseLoadBalancerPublicNet
     */
    'ipv4': LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv4;
    /**
     * 
     * @type {LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv6}
     * @memberof LoadBalancersGetByIdResponseLoadBalancerPublicNet
     */
