 ...
 * @export
 * @interface LoadBalancerTargetLabelSelectorProperty4
 */
export interface LoadBalancerTargetLabelSelectorProperty4 {
    /**
     * Label selector
     * @type {string}
     * @memberof LoadBalancerTargetLabelSelectorProperty4
     */
    'selector': string;
}
