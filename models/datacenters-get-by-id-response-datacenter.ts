...
import { DatacentersGetByIdResponseDatacenterLocation } from './datacenters-get-by-id-response-datacenter-location';
import { DatacentersGetByIdResponseDatacenterServerTypes } from './datacenters-get-by-id-response-datacenter-server-types';

/**
 * 
 * @export
 * @interface DatacentersGetByIdResponseDatacenter
 */
export interface DatacentersGetByIdResponseDatacenter {
    /**
     * Description of the Datacenter
     * @type {string}
     * @memberof DatacentersGetByIdResponseDatacenter
     */
    'description': string;
    /**
    ...
    /**
     * 
     * @type {DatacentersGetByIdResponseDatacenterLocation}
     * @memberof DatacentersGetByIdResponseDatacenter
     */
    ...
    /**
     * 
     * @type {DatacentersGetByIdResponseDatacenterServerTypes}
     * @memberof DatacentersGetByIdResponseDatacenter
     */
