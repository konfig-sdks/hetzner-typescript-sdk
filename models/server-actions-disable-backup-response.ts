...
import { ActionProperty60 } from './action-property60';

/**
 * 
 * @export
 * @interface ServerActionsDisableBackupResponse
 */
export interface ServerActionsDisableBackupResponse {
    /**
     * 
     * @type {ActionProperty60}
     * @memberof ServerActionsDisableBackupResponse
     */
    'action': ActionProperty60;
}
