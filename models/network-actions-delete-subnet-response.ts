...
import { ActionProperty39 } from './action-property39';

/**
 * 
 * @export
 * @interface NetworkActionsDeleteSubnetResponse
 */
export interface NetworkActionsDeleteSubnetResponse {
    /**
     * 
     * @type {ActionProperty39}
     * @memberof NetworkActionsDeleteSubnetResponse
     */
    'action': ActionProperty39;
}
