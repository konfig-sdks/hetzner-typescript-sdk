...
import { Action20 } from './action20';
import { ActionProperty47 } from './action-property47';
import { ServersCreateServerActionResponseServer } from './servers-create-server-action-response-server';

/**
 * 
 * @export
 * @interface ServersCreateServerActionResponse
 */
export interface ServersCreateServerActionResponse {
    /**
     * 
     * @type {ActionProperty47}
     * @memberof ServersCreateServerActionResponse
     */
    'action': ActionProperty47;
    /**
     * 
     * @type {Array<Action20>}
     * @memberof ServersCreateServerActionResponse
     */
    'next_actions': Array<Action20>;
    /**
    ...
    /**
     * 
     * @type {ServersCreateServerActionResponseServer}
     * @memberof ServersCreateServerActionResponse
     */
