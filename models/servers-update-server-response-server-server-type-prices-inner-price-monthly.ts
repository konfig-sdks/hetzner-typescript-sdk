 ...
 * @export
 * @interface ServersUpdateServerResponseServerServerTypePricesInnerPriceMonthly
 */
export interface ServersUpdateServerResponseServerServerTypePricesInnerPriceMonthly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof ServersUpdateServerResponseServerServerTypePricesInnerPriceMonthly
     */
    'gross': string;
    /**
     * Price without VAT
