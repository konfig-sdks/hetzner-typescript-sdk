 ...
 * @export
 * @interface LoadBalancerServiceHealthCheckProperty4Http
 */
export interface LoadBalancerServiceHealthCheckProperty4Http {
    /**
     ...
     * @type {string}
     * @memberof LoadBalancerServiceHealthCheckProperty4Http
     */
    'domain': string | null;
    /**
