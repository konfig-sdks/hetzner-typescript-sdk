...
import { ActionProperty26 } from './action-property26';

/**
 * 
 * @export
 * @interface LoadBalancerActionsDeleteServiceResponse
 */
export interface LoadBalancerActionsDeleteServiceResponse {
    /**
     * 
     * @type {ActionProperty26}
     * @memberof LoadBalancerActionsDeleteServiceResponse
     */
    'action': ActionProperty26;
}
