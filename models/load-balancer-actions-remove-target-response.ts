...
import { ActionProperty30 } from './action-property30';

/**
 * 
 * @export
 * @interface LoadBalancerActionsRemoveTargetResponse
 */
export interface LoadBalancerActionsRemoveTargetResponse {
    /**
     * 
     * @type {ActionProperty30}
     * @memberof LoadBalancerActionsRemoveTargetResponse
     */
    'action': ActionProperty30;
}
