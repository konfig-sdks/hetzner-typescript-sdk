...
import { LoadBalancerServiceHTTPProperty1 } from './load-balancer-service-httpproperty1';
import { LoadBalancerServiceHealthCheckProperty1 } from './load-balancer-service-health-check-property1';

/**
 * 
 * @export
 * @interface LoadBalancerActionsAddServiceRequest
 */
export interface LoadBalancerActionsAddServiceRequest {
    /**
     * Port the Load Balancer will balance to
     * @type {number}
     * @memberof LoadBalancerActionsAddServiceRequest
     */
    'destination_port': number;
    /**
     * 
     * @type {LoadBalancerServiceHealthCheckProperty1}
     * @memberof LoadBalancerActionsAddServiceRequest
     */
    'health_check': LoadBalancerServiceHealthCheckProperty1;
    /**
     * 
     * @type {LoadBalancerServiceHTTPProperty1}
     * @memberof LoadBalancerActionsAddServiceRequest
     */
    'http'?: LoadBalancerServiceHTTPProperty1;
    /**
     ...
     * @memberof LoadBalancerActionsAddServiceRequest
     */
    'protocol': LoadBalancerActionsAddServiceRequestProtocolEnum;
    /**
...
type LoadBalancerActionsAddServiceRequestProtocolEnum = 'tcp' | 'http' | 'https'
