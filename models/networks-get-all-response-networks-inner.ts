...
import { NetworksGetAllResponseNetworksInnerProtection } from './networks-get-all-response-networks-inner-protection';
import { NetworksGetAllResponseNetworksInnerRoutesInner } from './networks-get-all-response-networks-inner-routes-inner';
import { NetworksGetAllResponseNetworksInnerSubnetsInner } from './networks-get-all-response-networks-inner-subnets-inner';

/**
 * 
 * @export
 * @interface NetworksGetAllResponseNetworksInner
 */
export interface NetworksGetAllResponseNetworksInner {
    /**
     * Array of IDs of Servers attached to this Network
     * @type {Array<number>}
     * @memberof NetworksGetAllResponseNetworksInner
     */
    ...
    /**
     * 
     * @type {NetworksGetAllResponseNetworksInnerProtection}
     * @memberof NetworksGetAllResponseNetworksInner
     */
    'protection': NetworksGetAllResponseNetworksInnerProtection;
    /**
     * Array of routes set in this Network
     * @type {Array<NetworksGetAllResponseNetworksInnerRoutesInner>}
     * @memberof NetworksGetAllResponseNetworksInner
     */
    'routes': Array<NetworksGetAllResponseNetworksInnerRoutesInner>;
    /**
     * Array subnets allocated in this Network
     * @type {Array<NetworksGetAllResponseNetworksInnerSubnetsInner>}
     * @memberof NetworksGetAllResponseNetworksInner
     */
    'subnets': Array<NetworksGetAllResponseNetworksInnerSubnetsInner>;
}
