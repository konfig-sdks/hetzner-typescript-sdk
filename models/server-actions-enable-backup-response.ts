...
import { ActionProperty62 } from './action-property62';

/**
 * 
 * @export
 * @interface ServerActionsEnableBackupResponse
 */
export interface ServerActionsEnableBackupResponse {
    /**
     * 
     * @type {ActionProperty62}
     * @memberof ServerActionsEnableBackupResponse
     */
    'action': ActionProperty62;
}
