...
import { SshKeysGetByIdResponseSshKey } from './ssh-keys-get-by-id-response-ssh-key';

/**
 * 
 * @export
 * @interface SshKeysGetByIdResponse
 */
export interface SshKeysGetByIdResponse {
    /**
     * 
     * @type {SshKeysGetByIdResponseSshKey}
     * @memberof SshKeysGetByIdResponse
     */
    'ssh_key': SshKeysGetByIdResponseSshKey;
}
