...
import { ActionProperty10 } from './action-property10';

/**
 * 
 * @export
 * @interface FloatingIpActionsChangeDnsPtrResponse
 */
export interface FloatingIpActionsChangeDnsPtrResponse {
    /**
     * 
     * @type {ActionProperty10}
     * @memberof FloatingIpActionsChangeDnsPtrResponse
     */
    'action': ActionProperty10;
}
