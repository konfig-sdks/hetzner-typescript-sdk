...
import { ActionProperty18 } from './action-property18';

/**
 * 
 * @export
 * @interface LoadBalancerActionsGetSpecificActionResponse
 */
export interface LoadBalancerActionsGetSpecificActionResponse {
    /**
     * 
     * @type {ActionProperty18}
     * @memberof LoadBalancerActionsGetSpecificActionResponse
     */
    'action': ActionProperty18;
}
