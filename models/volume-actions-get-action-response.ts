...
import { ActionProperty80 } from './action-property80';

/**
 * 
 * @export
 * @interface VolumeActionsGetActionResponse
 */
export interface VolumeActionsGetActionResponse {
    /**
     * 
     * @type {ActionProperty80}
     * @memberof VolumeActionsGetActionResponse
     */
    'action': ActionProperty80;
}
