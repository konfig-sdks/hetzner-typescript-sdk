 ...
 * 
 * @export
 * @interface ServersCreateServerActionResponseServerPublicNetIpv6DnsPtrInner
 */
export interface ServersCreateServerActionResponseServerPublicNetIpv6DnsPtrInner {
    /**
     * DNS pointer for the specific IP address
     * @type {string}
     * @memberof ServersCreateServerActionResponseServerPublicNetIpv6DnsPtrInner
     */
    'dns_ptr': string;
    /**
