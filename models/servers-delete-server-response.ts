...
import { ActionProperty49 } from './action-property49';

/**
 * 
 * @export
 * @interface ServersDeleteServerResponse
 */
export interface ServersDeleteServerResponse {
    /**
     * 
     * @type {ActionProperty49}
     * @memberof ServersDeleteServerResponse
     */
    'action'?: ActionProperty49;
}
