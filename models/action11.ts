...
import { Action11Error } from './action11-error';
import { Action11ResourcesInner } from './action11-resources-inner';
...
export interface Action11 {
     ...
     * @type {Array<Action11ResourcesInner>}
     * @memberof Action11
     */
    'resources': Array<Action11ResourcesInner>;
    /**
     ...
     * @memberof Action11
     */
    'status': Action11StatusEnum;
}

type Action11StatusEnum = 'success' | 'running' | 'error'
