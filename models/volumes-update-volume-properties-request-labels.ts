 ...
 * @export
 * @interface VolumesUpdateVolumePropertiesRequestLabels
 */
export interface VolumesUpdateVolumePropertiesRequestLabels {
    /**
     * 
     * @type {string}
     * @memberof VolumesUpdateVolumePropertiesRequestLabels
     */
    'labelkey'?: string;
}
