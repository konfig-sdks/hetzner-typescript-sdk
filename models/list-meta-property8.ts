...
import { ListMetaProperty8Pagination } from './list-meta-property8-pagination';

/**
 * 
 * @export
 * @interface ListMetaProperty8
 */
export interface ListMetaProperty8 {
    /**
     * 
     * @type {ListMetaProperty8Pagination}
     * @memberof ListMetaProperty8
     */
    'pagination': ListMetaProperty8Pagination;
}
