...
import { ServersGetAllResponseServersInnerServerTypePricesInnerPriceHourly } from './servers-get-all-response-servers-inner-server-type-prices-inner-price-hourly';
import { ServersGetAllResponseServersInnerServerTypePricesInnerPriceMonthly } from './servers-get-all-response-servers-inner-server-type-prices-inner-price-monthly';

/**
 * 
 * @export
 * @interface ServersGetAllResponseServersInnerServerTypePricesInner
 */
export interface ServersGetAllResponseServersInnerServerTypePricesInner {
    /**
     * Name of the Location the price is for
     * @type {string}
     * @memberof ServersGetAllResponseServersInnerServerTypePricesInner
     */
    'location': string;
    /**
     * 
     * @type {ServersGetAllResponseServersInnerServerTypePricesInnerPriceHourly}
     * @memberof ServersGetAllResponseServersInnerServerTypePricesInner
     */
    'price_hourly': ServersGetAllResponseServersInnerServerTypePricesInnerPriceHourly;
    /**
     * 
     * @type {ServersGetAllResponseServersInnerServerTypePricesInnerPriceMonthly}
     * @memberof ServersGetAllResponseServersInnerServerTypePricesInner
     */
    'price_monthly': ServersGetAllResponseServersInnerServerTypePricesInnerPriceMonthly;
}
