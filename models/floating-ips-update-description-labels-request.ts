 ...
 * 
 * @export
 * @interface FloatingIPsUpdateDescriptionLabelsRequest
 */
export interface FloatingIPsUpdateDescriptionLabelsRequest {
    /**
     * New Description to set
     * @type {string}
     * @memberof FloatingIPsUpdateDescriptionLabelsRequest
     */
    'description'?: string;
    /**
