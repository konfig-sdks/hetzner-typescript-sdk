...
import { ActionProperty63Error } from './action-property63-error';
import { ActionProperty63ResourcesInner } from './action-property63-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty63
 */
export interface ActionProperty63 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty63
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty63Error}
     * @memberof ActionProperty63
     */
    'error': ActionProperty63Error | null;
    /**
     ...
     * @type {Array<ActionProperty63ResourcesInner>}
     * @memberof ActionProperty63
     */
    'resources': Array<ActionProperty63ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty63
     */
    'status': ActionProperty63StatusEnum;
}

type ActionProperty63StatusEnum = 'success' | 'running' | 'error'
