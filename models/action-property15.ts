...
import { ActionProperty15Error } from './action-property15-error';
import { ActionProperty15ResourcesInner } from './action-property15-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty15
 */
export interface ActionProperty15 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty15
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty15Error}
     * @memberof ActionProperty15
     */
    'error': ActionProperty15Error | null;
    /**
     ...
     * @type {Array<ActionProperty15ResourcesInner>}
     * @memberof ActionProperty15
     */
    'resources': Array<ActionProperty15ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty15
     */
    'status': ActionProperty15StatusEnum;
}

type ActionProperty15StatusEnum = 'success' | 'running' | 'error'
