...
import { ListMetaProperty6 } from './list-meta-property6';

/**
 * 
 * @export
 * @interface FirewallsListAllResponse
 */
export interface FirewallsListAllResponse {
    /**
     * 
     * @type {Array<Firewall>}
     * @memberof FirewallsListAllResponse
     */
    'firewalls': Array<Firewall>;
    /**
     * 
     * @type {ListMetaProperty6}
     * @memberof FirewallsListAllResponse
     */
    'meta'?: ListMetaProperty6;
}
