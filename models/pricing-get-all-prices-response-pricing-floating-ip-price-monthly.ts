 ...
 * 
 * @export
 * @interface PricingGetAllPricesResponsePricingFloatingIpPriceMonthly
 */
export interface PricingGetAllPricesResponsePricingFloatingIpPriceMonthly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingFloatingIpPriceMonthly
     */
    'gross': string;
    /**
     * Price without VAT
