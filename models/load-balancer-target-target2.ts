...
import { LoadBalancerTargetHealthStatusPropertyInner5 } from './load-balancer-target-health-status-property-inner5';
import { LoadBalancerTargetServerProperty5 } from './load-balancer-target-server-property5';

/**
 * 
 * @export
 * @interface LoadBalancerTargetTarget2
 */
export interface LoadBalancerTargetTarget2 {
    /**
     * List of health statuses of the services on this target. Only present for target types \"server\" and \"ip\".
     * @type {Array<LoadBalancerTargetHealthStatusPropertyInner5>}
     * @memberof LoadBalancerTargetTarget2
     */
    'health_status'?: Array<LoadBalancerTargetHealthStatusPropertyInner5>;
    /**
     * 
     * @type {LoadBalancerTargetServerProperty5}
     * @memberof LoadBalancerTargetTarget2
     */
    'server'?: LoadBalancerTargetServerProperty5;
    /**
