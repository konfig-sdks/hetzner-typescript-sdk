...
import { ActionProperty72Error } from './action-property72-error';
import { ActionProperty72ResourcesInner } from './action-property72-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty72
 */
export interface ActionProperty72 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty72
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty72Error}
     * @memberof ActionProperty72
     */
    'error': ActionProperty72Error | null;
    /**
     ...
     * @type {Array<ActionProperty72ResourcesInner>}
     * @memberof ActionProperty72
     */
    'resources': Array<ActionProperty72ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty72
     */
    'status': ActionProperty72StatusEnum;
}

type ActionProperty72StatusEnum = 'success' | 'running' | 'error'
