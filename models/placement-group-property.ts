 ...
 * 
 * @export
 * @interface PlacementGroupProperty
 */
export interface PlacementGroupProperty {
    /**
     * Array of IDs of Servers that are part of this Placement Group
     * @type {Array<number>}
     * @memberof PlacementGroupProperty
     */
     ...
     * @memberof PlacementGroupProperty
     */
    'type': PlacementGroupPropertyTypeEnum;
}

type PlacementGroupPropertyTypeEnum = 'spread'
