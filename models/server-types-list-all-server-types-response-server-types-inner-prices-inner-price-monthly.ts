 ...
 * @export
 * @interface ServerTypesListAllServerTypesResponseServerTypesInnerPricesInnerPriceMonthly
 */
export interface ServerTypesListAllServerTypesResponseServerTypesInnerPricesInnerPriceMonthly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof ServerTypesListAllServerTypesResponseServerTypesInnerPricesInnerPriceMonthly
     */
    'gross': string;
    /**
     * Price without VAT
