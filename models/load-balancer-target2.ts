...
import { LoadBalancerTargetHealthStatusPropertyInner4 } from './load-balancer-target-health-status-property-inner4';
import { LoadBalancerTargetIPProperty4 } from './load-balancer-target-ipproperty4';
import { LoadBalancerTargetLabelSelectorProperty2 } from './load-balancer-target-label-selector-property2';
import { LoadBalancerTargetServerProperty4 } from './load-balancer-target-server-property4';
import { LoadBalancerTargetTarget2 } from './load-balancer-target-target2';

/**
 * 
 * @export
 * @interface LoadBalancerTarget2
 */
export interface LoadBalancerTarget2 {
    /**
     * List of health statuses of the services on this target. Only present for target types \"server\" and \"ip\".
     * @type {Array<LoadBalancerTargetHealthStatusPropertyInner4>}
     * @memberof LoadBalancerTarget2
     */
    'health_status'?: Array<LoadBalancerTargetHealthStatusPropertyInner4>;
    /**
     * 
     * @type {LoadBalancerTargetIPProperty4}
     * @memberof LoadBalancerTarget2
     */
    'ip'?: LoadBalancerTargetIPProperty4;
    /**
     * 
     * @type {LoadBalancerTargetLabelSelectorProperty2}
     * @memberof LoadBalancerTarget2
     */
    'label_selector'?: LoadBalancerTargetLabelSelectorProperty2;
    /**
     * 
     * @type {LoadBalancerTargetServerProperty4}
     * @memberof LoadBalancerTarget2
     */
    'server'?: LoadBalancerTargetServerProperty4;
    /**
     * List of resolved label selector target Servers. Only present for type \"label_selector\".
     * @type {Array<LoadBalancerTargetTarget2>}
     * @memberof LoadBalancerTarget2
     */
    'targets'?: Array<LoadBalancerTargetTarget2>;
    /**
     * Type of the resource
     * @type {string}
     * @memberof LoadBalancerTarget2
     */
    'type': LoadBalancerTarget2TypeEnum;
    /**
...
type LoadBalancerTarget2TypeEnum = 'server' | 'label_selector' | 'ip'
