...
import { PrimaryIPPropertyDatacenter } from './primary-ipproperty-datacenter';
import { PrimaryIPPropertyDnsPtrInner } from './primary-ipproperty-dns-ptr-inner';
import { PrimaryIPPropertyProtection } from './primary-ipproperty-protection';

/**
 * 
 * @export
 * @interface PrimaryIPProperty
 */
export interface PrimaryIPProperty {
    /**
     * ID of the resource the Primary IP is assigned to, null if it is not assigned at all
     * @type {number}
     * @memberof PrimaryIPProperty
     */
     ...
     * @memberof PrimaryIPProperty
     */
    'assignee_type': PrimaryIPPropertyAssigneeTypeEnum;
    /**
    ...
    /**
     * 
     * @type {PrimaryIPPropertyDatacenter}
     * @memberof PrimaryIPProperty
     */
    'datacenter': PrimaryIPPropertyDatacenter;
    /**
     * Array of reverse DNS entries
     * @type {Array<PrimaryIPPropertyDnsPtrInner>}
     * @memberof PrimaryIPProperty
     */
    'dns_ptr': Array<PrimaryIPPropertyDnsPtrInner>;
    /**
    ...
    /**
     * 
     * @type {PrimaryIPPropertyProtection}
     * @memberof PrimaryIPProperty
     */
    'protection': PrimaryIPPropertyProtection;
    /**
     * Type of the Primary IP
     * @type {string}
     * @memberof PrimaryIPProperty
     */
    'type': PrimaryIPPropertyTypeEnum;
}

type PrimaryIPPropertyAssigneeTypeEnum = 'server'
type PrimaryIPPropertyTypeEnum = 'ipv4' | 'ipv6'
