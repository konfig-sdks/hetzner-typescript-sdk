 ...
 * 
 * @export
 * @interface LoadBalancerTargetHealthStatusPropertyInner8
 */
export interface LoadBalancerTargetHealthStatusPropertyInner8 {
    /**
     * 
     * @type {number}
     * @memberof LoadBalancerTargetHealthStatusPropertyInner8
     */
    'listen_port'?: number;
    /**
     * 
     ...
     * @memberof LoadBalancerTargetHealthStatusPropertyInner8
     */
    'status'?: LoadBalancerTargetHealthStatusPropertyInner8StatusEnum;
}

type LoadBalancerTargetHealthStatusPropertyInner8StatusEnum = 'healthy' | 'unhealthy' | 'unknown'
