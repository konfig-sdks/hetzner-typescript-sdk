...
import { PrimaryIPDatacenter } from './primary-ipdatacenter';
import { PrimaryIPDnsPtrInner } from './primary-ipdns-ptr-inner';
import { PrimaryIPProtection } from './primary-ipprotection';
...
export interface PrimaryIP {
     ...
     * @memberof PrimaryIP
     */
    'assignee_type': PrimaryIPAssigneeTypeEnum;
    /**
    ...
    /**
     * 
     * @type {PrimaryIPDatacenter}
     * @memberof PrimaryIP
     */
    'datacenter': PrimaryIPDatacenter;
    /**
     * Array of reverse DNS entries
     * @type {Array<PrimaryIPDnsPtrInner>}
     * @memberof PrimaryIP
     */
    'dns_ptr': Array<PrimaryIPDnsPtrInner>;
    /**
     ...
     * @memberof PrimaryIP
     */
    'type': PrimaryIPTypeEnum;
}

type PrimaryIPAssigneeTypeEnum = 'server'
type PrimaryIPTypeEnum = 'ipv4' | 'ipv6'
