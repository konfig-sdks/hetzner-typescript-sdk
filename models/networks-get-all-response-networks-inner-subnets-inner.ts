 ...
 * 
 * @export
 * @interface NetworksGetAllResponseNetworksInnerSubnetsInner
 */
export interface NetworksGetAllResponseNetworksInnerSubnetsInner {
    /**
     ...
     * @type {string}
     * @memberof NetworksGetAllResponseNetworksInnerSubnetsInner
     */
    'gateway': string;
    /**
     ...
     * @memberof NetworksGetAllResponseNetworksInnerSubnetsInner
     */
    'type': NetworksGetAllResponseNetworksInnerSubnetsInnerTypeEnum;
    /**
...
type NetworksGetAllResponseNetworksInnerSubnetsInnerTypeEnum = 'cloud' | 'server' | 'vswitch'
