...
import { ServersUpdateServerResponseServerImageCreatedFrom } from './servers-update-server-response-server-image-created-from';
import { ServersUpdateServerResponseServerImageProtection } from './servers-update-server-response-server-image-protection';

/**
 * Image the server is based on.
 * @export
 * @interface ServersUpdateServerResponseServerImage
 */
export interface ServersUpdateServerResponseServerImage {
    /**
     * Description of the Image
     * @type {string}
     * @memberof ServersUpdateServerResponseServerImage
     */
    'description': string;
    /**
     ...
     * @memberof ServersUpdateServerResponseServerImage
     */
    'architecture': ServersUpdateServerResponseServerImageArchitectureEnum;
    /**
    ...
    /**
     * 
     * @type {ServersUpdateServerResponseServerImageCreatedFrom}
     * @memberof ServersUpdateServerResponseServerImage
     */
    'created_from': ServersUpdateServerResponseServerImageCreatedFrom | null;
    /**
     ...
     * @memberof ServersUpdateServerResponseServerImage
     */
    'os_flavor': ServersUpdateServerResponseServerImageOsFlavorEnum;
    /**
    ...
    /**
     * 
     * @type {ServersUpdateServerResponseServerImageProtection}
     * @memberof ServersUpdateServerResponseServerImage
     */
     ...
     * @memberof ServersUpdateServerResponseServerImage
     */
    'status': ServersUpdateServerResponseServerImageStatusEnum;
    /**
     * Type of the Image
     * @type {string}
     * @memberof ServersUpdateServerResponseServerImage
     */
    'type': ServersUpdateServerResponseServerImageTypeEnum;
}

type ServersUpdateServerResponseServerImageArchitectureEnum = 'x86' | 'arm'
type ServersUpdateServerResponseServerImageOsFlavorEnum = 'ubuntu' | 'centos' | 'debian' | 'fedora' | 'rocky' | 'alma' | 'unknown'
type ServersUpdateServerResponseServerImageStatusEnum = 'available' | 'creating' | 'unavailable'
type ServersUpdateServerResponseServerImageTypeEnum = 'system' | 'app' | 'snapshot' | 'backup' | 'temporary'
