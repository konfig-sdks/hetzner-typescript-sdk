...
import { ActionProperty78 } from './action-property78';

/**
 * 
 * @export
 * @interface VolumeActionsDetachVolumeFromServerResponse
 */
export interface VolumeActionsDetachVolumeFromServerResponse {
    /**
     * 
     * @type {ActionProperty78}
     * @memberof VolumeActionsDetachVolumeFromServerResponse
     */
    'action': ActionProperty78;
}
