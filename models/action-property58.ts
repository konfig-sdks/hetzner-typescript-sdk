...
import { ActionProperty58Error } from './action-property58-error';
import { ActionProperty58ResourcesInner } from './action-property58-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty58
 */
export interface ActionProperty58 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty58
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty58Error}
     * @memberof ActionProperty58
     */
    'error': ActionProperty58Error | null;
    /**
     ...
     * @type {Array<ActionProperty58ResourcesInner>}
     * @memberof ActionProperty58
     */
    'resources': Array<ActionProperty58ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty58
     */
    'status': ActionProperty58StatusEnum;
}

type ActionProperty58StatusEnum = 'success' | 'running' | 'error'
