...
import { ActionProperty51Error } from './action-property51-error';
import { ActionProperty51ResourcesInner } from './action-property51-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty51
 */
export interface ActionProperty51 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty51
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty51Error}
     * @memberof ActionProperty51
     */
    'error': ActionProperty51Error | null;
    /**
     ...
     * @type {Array<ActionProperty51ResourcesInner>}
     * @memberof ActionProperty51
     */
    'resources': Array<ActionProperty51ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty51
     */
    'status': ActionProperty51StatusEnum;
}

type ActionProperty51StatusEnum = 'success' | 'running' | 'error'
