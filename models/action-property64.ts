...
import { ActionProperty64Error } from './action-property64-error';
import { ActionProperty64ResourcesInner } from './action-property64-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty64
 */
export interface ActionProperty64 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty64
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty64Error}
     * @memberof ActionProperty64
     */
    'error': ActionProperty64Error | null;
    /**
     ...
     * @type {Array<ActionProperty64ResourcesInner>}
     * @memberof ActionProperty64
     */
    'resources': Array<ActionProperty64ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty64
     */
    'status': ActionProperty64StatusEnum;
}

type ActionProperty64StatusEnum = 'success' | 'running' | 'error'
