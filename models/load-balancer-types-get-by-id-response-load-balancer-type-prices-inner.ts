...
import { LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInnerPriceHourly } from './load-balancer-types-get-by-id-response-load-balancer-type-prices-inner-price-hourly';
import { LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInnerPriceMonthly } from './load-balancer-types-get-by-id-response-load-balancer-type-prices-inner-price-monthly';

/**
 * 
 * @export
 * @interface LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInner
 */
export interface LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInner {
    /**
     * Name of the Location the price is for.
     * @type {string}
     * @memberof LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInner
     */
    'location': string;
    /**
     * 
     * @type {LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInnerPriceHourly}
     * @memberof LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInner
     */
    'price_hourly': LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInnerPriceHourly;
    /**
     * 
     * @type {LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInnerPriceMonthly}
     * @memberof LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInner
     */
    'price_monthly': LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInnerPriceMonthly;
}
