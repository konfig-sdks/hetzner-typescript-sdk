...
import { ActionProperty66 } from './action-property66';

/**
 * 
 * @export
 * @interface ServerActionsSoftRebootServerResponse
 */
export interface ServerActionsSoftRebootServerResponse {
    /**
     * 
     * @type {ActionProperty66}
     * @memberof ServerActionsSoftRebootServerResponse
     */
    'action': ActionProperty66;
}
