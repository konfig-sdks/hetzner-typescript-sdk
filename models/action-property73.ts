...
import { ActionProperty73Error } from './action-property73-error';
import { ActionProperty73ResourcesInner } from './action-property73-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty73
 */
export interface ActionProperty73 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty73
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty73Error}
     * @memberof ActionProperty73
     */
    'error': ActionProperty73Error | null;
    /**
     ...
     * @type {Array<ActionProperty73ResourcesInner>}
     * @memberof ActionProperty73
     */
    'resources': Array<ActionProperty73ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty73
     */
    'status': ActionProperty73StatusEnum;
}

type ActionProperty73StatusEnum = 'success' | 'running' | 'error'
