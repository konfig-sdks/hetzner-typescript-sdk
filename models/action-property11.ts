...
import { ActionProperty11Error } from './action-property11-error';
import { ActionProperty11ResourcesInner } from './action-property11-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty11
 */
export interface ActionProperty11 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty11
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty11Error}
     * @memberof ActionProperty11
     */
    'error': ActionProperty11Error | null;
    /**
     ...
     * @type {Array<ActionProperty11ResourcesInner>}
     * @memberof ActionProperty11
     */
    'resources': Array<ActionProperty11ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty11
     */
    'status': ActionProperty11StatusEnum;
}

type ActionProperty11StatusEnum = 'success' | 'running' | 'error'
