 ...
 * 
 * @export
 * @interface LoadBalancerTargetHealthStatusPropertyInner1
 */
export interface LoadBalancerTargetHealthStatusPropertyInner1 {
    /**
     * 
     * @type {number}
     * @memberof LoadBalancerTargetHealthStatusPropertyInner1
     */
    'listen_port'?: number;
    /**
     * 
     ...
     * @memberof LoadBalancerTargetHealthStatusPropertyInner1
     */
    'status'?: LoadBalancerTargetHealthStatusPropertyInner1StatusEnum;
}

type LoadBalancerTargetHealthStatusPropertyInner1StatusEnum = 'healthy' | 'unhealthy' | 'unknown'
