...
import { ActionProperty27 } from './action-property27';

/**
 * 
 * @export
 * @interface LoadBalancerActionsDetachFromNetworkResponse
 */
export interface LoadBalancerActionsDetachFromNetworkResponse {
    /**
     * 
     * @type {ActionProperty27}
     * @memberof LoadBalancerActionsDetachFromNetworkResponse
     */
    'action': ActionProperty27;
}
