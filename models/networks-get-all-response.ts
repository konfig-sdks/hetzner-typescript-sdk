...
import { ListMetaProperty23 } from './list-meta-property23';
import { NetworksGetAllResponseNetworksInner } from './networks-get-all-response-networks-inner';

/**
 * 
 * @export
 * @interface NetworksGetAllResponse
 */
export interface NetworksGetAllResponse {
    /**
     * 
     * @type {ListMetaProperty23}
     * @memberof NetworksGetAllResponse
     */
    'meta'?: ListMetaProperty23;
    /**
     * 
     * @type {Array<NetworksGetAllResponseNetworksInner>}
     * @memberof NetworksGetAllResponse
     */
    'networks': Array<NetworksGetAllResponseNetworksInner>;
}
