...
import { LocationsGetLocationByIdResponseLocation } from './locations-get-location-by-id-response-location';

/**
 * 
 * @export
 * @interface LocationsGetLocationByIdResponse
 */
export interface LocationsGetLocationByIdResponse {
    /**
     * 
     * @type {LocationsGetLocationByIdResponseLocation}
     * @memberof LocationsGetLocationByIdResponse
     */
    'location': LocationsGetLocationByIdResponseLocation;
}
