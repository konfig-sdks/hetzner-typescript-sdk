...
import { ActionProperty53 } from './action-property53';

/**
 * 
 * @export
 * @interface ServerActionsChangeAliasIpsResponse
 */
export interface ServerActionsChangeAliasIpsResponse {
    /**
     * 
     * @type {ActionProperty53}
     * @memberof ServerActionsChangeAliasIpsResponse
     */
    'action': ActionProperty53;
}
