...
import { ActionProperty29 } from './action-property29';

/**
 * 
 * @export
 * @interface LoadBalancerActionsEnablePublicInterfaceResponse
 */
export interface LoadBalancerActionsEnablePublicInterfaceResponse {
    /**
     * 
     * @type {ActionProperty29}
     * @memberof LoadBalancerActionsEnablePublicInterfaceResponse
     */
    'action': ActionProperty29;
}
