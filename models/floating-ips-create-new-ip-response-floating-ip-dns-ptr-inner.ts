 ...
 * 
 * @export
 * @interface FloatingIPsCreateNewIpResponseFloatingIpDnsPtrInner
 */
export interface FloatingIPsCreateNewIpResponseFloatingIpDnsPtrInner {
    /**
     * DNS pointer for the specific IP address
     * @type {string}
     * @memberof FloatingIPsCreateNewIpResponseFloatingIpDnsPtrInner
     */
    'dns_ptr': string;
    /**
