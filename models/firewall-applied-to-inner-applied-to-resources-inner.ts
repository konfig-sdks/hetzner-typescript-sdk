...
import { FirewallAppliedToInnerAppliedToResourcesInnerServer } from './firewall-applied-to-inner-applied-to-resources-inner-server';

/**
 * 
 * @export
 * @interface FirewallAppliedToInnerAppliedToResourcesInner
 */
export interface FirewallAppliedToInnerAppliedToResourcesInner {
    /**
     * 
     * @type {FirewallAppliedToInnerAppliedToResourcesInnerServer}
     * @memberof FirewallAppliedToInnerAppliedToResourcesInner
     */
     ...
     * @memberof FirewallAppliedToInnerAppliedToResourcesInner
     */
    'type'?: FirewallAppliedToInnerAppliedToResourcesInnerTypeEnum;
}

type FirewallAppliedToInnerAppliedToResourcesInnerTypeEnum = 'server'
