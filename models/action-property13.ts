...
import { ActionProperty13Error } from './action-property13-error';
import { ActionProperty13ResourcesInner } from './action-property13-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty13
 */
export interface ActionProperty13 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty13
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty13Error}
     * @memberof ActionProperty13
     */
    'error': ActionProperty13Error | null;
    /**
     ...
     * @type {Array<ActionProperty13ResourcesInner>}
     * @memberof ActionProperty13
     */
    'resources': Array<ActionProperty13ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty13
     */
    'status': ActionProperty13StatusEnum;
}

type ActionProperty13StatusEnum = 'success' | 'running' | 'error'
