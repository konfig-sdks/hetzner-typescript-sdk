...
import { LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly } from './load-balancers-create-load-balancer-response-load-balancer-load-balancer-type-prices-inner-price-hourly';
import { LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly } from './load-balancers-create-load-balancer-response-load-balancer-load-balancer-type-prices-inner-price-monthly';

/**
 * 
 * @export
 * @interface LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInner
 */
export interface LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInner {
    /**
     * Name of the Location the price is for.
     * @type {string}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInner
     */
    'location': string;
    /**
     * 
     * @type {LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInner
     */
    'price_hourly': LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceHourly;
    /**
     * 
     * @type {LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInner
     */
    'price_monthly': LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInnerPriceMonthly;
}
