 ...
 * @export
 * @interface LoadBalancerActionsRemoveTargetRequestServer
 */
export interface LoadBalancerActionsRemoveTargetRequestServer {
    /**
     * ID of the Server
     * @type {number}
     * @memberof LoadBalancerActionsRemoveTargetRequestServer
     */
    'id': number;
}
