...
import { FloatingIPsUpdateDescriptionLabelsResponseFloatingIp } from './floating-ips-update-description-labels-response-floating-ip';

/**
 * 
 * @export
 * @interface FloatingIPsUpdateDescriptionLabelsResponse
 */
export interface FloatingIPsUpdateDescriptionLabelsResponse {
    /**
     * 
     * @type {FloatingIPsUpdateDescriptionLabelsResponseFloatingIp}
     * @memberof FloatingIPsUpdateDescriptionLabelsResponse
     */
    'floating_ip': FloatingIPsUpdateDescriptionLabelsResponseFloatingIp;
}
