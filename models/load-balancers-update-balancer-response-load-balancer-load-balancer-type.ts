...
import { LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInner } from './load-balancers-update-balancer-response-load-balancer-load-balancer-type-prices-inner';

/**
 * 
 * @export
 * @interface LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType
 */
export interface LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType {
    /**
     * Description of the Load Balancer type
     * @type {string}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType
     */
    'description': string;
    /**
     ...
     * @type {Array<LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInner>}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType
     */
    'prices': Array<LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInner>;
}
