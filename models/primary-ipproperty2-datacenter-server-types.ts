 ...
 * @export
 * @interface PrimaryIPProperty2DatacenterServerTypes
 */
export interface PrimaryIPProperty2DatacenterServerTypes {
    /**
     * IDs of Server types that are supported and for which the Datacenter has enough resources left
     * @type {Array<number>}
     * @memberof PrimaryIPProperty2DatacenterServerTypes
     */
