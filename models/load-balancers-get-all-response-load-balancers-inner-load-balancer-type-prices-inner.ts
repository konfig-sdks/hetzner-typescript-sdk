...
import { LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerTypePricesInnerPriceHourly } from './load-balancers-get-all-response-load-balancers-inner-load-balancer-type-prices-inner-price-hourly';
import { LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerTypePricesInnerPriceMonthly } from './load-balancers-get-all-response-load-balancers-inner-load-balancer-type-prices-inner-price-monthly';

/**
 * 
 * @export
 * @interface LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerTypePricesInner
 */
export interface LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerTypePricesInner {
    /**
     * Name of the Location the price is for.
     * @type {string}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerTypePricesInner
     */
    'location': string;
    /**
     * 
     * @type {LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerTypePricesInnerPriceHourly}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerTypePricesInner
     */
    'price_hourly': LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerTypePricesInnerPriceHourly;
    /**
     * 
     * @type {LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerTypePricesInnerPriceMonthly}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerTypePricesInner
     */
    'price_monthly': LoadBalancersGetAllResponseLoadBalancersInnerLoadBalancerTypePricesInnerPriceMonthly;
}
