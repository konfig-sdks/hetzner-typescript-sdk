...
import { ServersCreateServerActionResponseServerDatacenterLocation } from './servers-create-server-action-response-server-datacenter-location';
import { ServersCreateServerActionResponseServerDatacenterServerTypes } from './servers-create-server-action-response-server-datacenter-server-types';

/**
 * Datacenter this Resource is located at
 * @export
 * @interface ServersCreateServerActionResponseServerDatacenter
 */
export interface ServersCreateServerActionResponseServerDatacenter {
    /**
     * Description of the Datacenter
     * @type {string}
     * @memberof ServersCreateServerActionResponseServerDatacenter
     */
    'description': string;
    /**
    ...
    /**
     * 
     * @type {ServersCreateServerActionResponseServerDatacenterLocation}
     * @memberof ServersCreateServerActionResponseServerDatacenter
     */
    ...
    /**
     * 
     * @type {ServersCreateServerActionResponseServerDatacenterServerTypes}
     * @memberof ServersCreateServerActionResponseServerDatacenter
     */
