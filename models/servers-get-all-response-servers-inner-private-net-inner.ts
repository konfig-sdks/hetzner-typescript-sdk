 ...
 * 
 * @export
 * @interface ServersGetAllResponseServersInnerPrivateNetInner
 */
export interface ServersGetAllResponseServersInnerPrivateNetInner {
    /**
     * Additional IP addresses of the server on the network.
     * @type {Array<string>}
     * @memberof ServersGetAllResponseServersInnerPrivateNetInner
     */
