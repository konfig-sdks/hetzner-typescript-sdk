...
import { ListMetaProperty2Pagination } from './list-meta-property2-pagination';

/**
 * 
 * @export
 * @interface ListMetaProperty2
 */
export interface ListMetaProperty2 {
    /**
     * 
     * @type {ListMetaProperty2Pagination}
     * @memberof ListMetaProperty2
     */
    'pagination': ListMetaProperty2Pagination;
}
