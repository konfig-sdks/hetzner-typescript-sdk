 ...
 * @export
 * @interface PricingGetAllPricesResponsePricingServerBackup
 */
export interface PricingGetAllPricesResponsePricingServerBackup {
    /**
     * Percentage by how much the base price will increase
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingServerBackup
     */
    'percentage': string;
}
