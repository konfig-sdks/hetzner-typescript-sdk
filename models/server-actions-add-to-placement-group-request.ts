 ...
 * 
 * @export
 * @interface ServerActionsAddToPlacementGroupRequest
 */
export interface ServerActionsAddToPlacementGroupRequest {
    /**
     * ID of Placement Group the Server should be added to
     * @type {number}
     * @memberof ServerActionsAddToPlacementGroupRequest
     */
