 ...
 * @export
 * @interface PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly
 */
export interface PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof PricingGetAllPricesResponsePricingPrimaryIpsInnerPricesInnerPriceMonthly
     */
    'gross': string;
    /**
     * Price without VAT
