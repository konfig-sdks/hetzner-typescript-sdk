...
import { ActionProperty9 } from './action-property9';

/**
 * 
 * @export
 * @interface FloatingIpActionsAssignToServerResponse
 */
export interface FloatingIpActionsAssignToServerResponse {
    /**
     * 
     * @type {ActionProperty9}
     * @memberof FloatingIpActionsAssignToServerResponse
     */
    'action': ActionProperty9;
}
