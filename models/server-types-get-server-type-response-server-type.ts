...
import { DeprecationInfoProperty3 } from './deprecation-info-property3';
import { ServerTypesGetServerTypeResponseServerTypePricesInner } from './server-types-get-server-type-response-server-type-prices-inner';

/**
 * 
 * @export
 * @interface ServerTypesGetServerTypeResponseServerType
 */
export interface ServerTypesGetServerTypeResponseServerType {
    /**
     * Description of the Server type
     * @type {string}
     * @memberof ServerTypesGetServerTypeResponseServerType
     */
    'description': string;
    /**
     ...
     * @memberof ServerTypesGetServerTypeResponseServerType
     */
    'architecture': ServerTypesGetServerTypeResponseServerTypeArchitectureEnum;
    /**
     ...
     * @memberof ServerTypesGetServerTypeResponseServerType
     */
    'cpu_type': ServerTypesGetServerTypeResponseServerTypeCpuTypeEnum;
    /**
    ...
    /**
     * 
     * @type {DeprecationInfoProperty3}
     * @memberof ServerTypesGetServerTypeResponseServerType
     */
    'deprecation'?: DeprecationInfoProperty3 | null;
    /**
     ...
     * @type {Array<ServerTypesGetServerTypeResponseServerTypePricesInner>}
     * @memberof ServerTypesGetServerTypeResponseServerType
     */
    'prices': Array<ServerTypesGetServerTypeResponseServerTypePricesInner>;
    /**
     * Type of Server boot drive. Local has higher speed. Network has better availability.
     * @type {string}
     * @memberof ServerTypesGetServerTypeResponseServerType
     */
    'storage_type': ServerTypesGetServerTypeResponseServerTypeStorageTypeEnum;
}

type ServerTypesGetServerTypeResponseServerTypeArchitectureEnum = 'x86' | 'arm'
type ServerTypesGetServerTypeResponseServerTypeCpuTypeEnum = 'shared' | 'dedicated'
type ServerTypesGetServerTypeResponseServerTypeStorageTypeEnum = 'local' | 'network'
