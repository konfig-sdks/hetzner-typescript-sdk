...
import { ActionProperty78Error } from './action-property78-error';
import { ActionProperty78ResourcesInner } from './action-property78-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty78
 */
export interface ActionProperty78 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty78
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty78Error}
     * @memberof ActionProperty78
     */
    'error': ActionProperty78Error | null;
    /**
     ...
     * @type {Array<ActionProperty78ResourcesInner>}
     * @memberof ActionProperty78
     */
    'resources': Array<ActionProperty78ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty78
     */
    'status': ActionProperty78StatusEnum;
}

type ActionProperty78StatusEnum = 'success' | 'running' | 'error'
