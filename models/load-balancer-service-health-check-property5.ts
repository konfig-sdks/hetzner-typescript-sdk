...
import { LoadBalancerServiceHealthCheckProperty5Http } from './load-balancer-service-health-check-property5-http';

/**
 * Service health check
 * @export
 * @interface LoadBalancerServiceHealthCheckProperty5
 */
export interface LoadBalancerServiceHealthCheckProperty5 {
    /**
     * 
     * @type {LoadBalancerServiceHealthCheckProperty5Http}
     * @memberof LoadBalancerServiceHealthCheckProperty5
     */
    'http'?: LoadBalancerServiceHealthCheckProperty5Http;
    /**
     ...
     * @memberof LoadBalancerServiceHealthCheckProperty5
     */
    'protocol': LoadBalancerServiceHealthCheckProperty5ProtocolEnum;
    /**
...
type LoadBalancerServiceHealthCheckProperty5ProtocolEnum = 'tcp' | 'http'
