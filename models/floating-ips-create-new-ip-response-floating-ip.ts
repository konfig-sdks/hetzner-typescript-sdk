...
import { FloatingIPsCreateNewIpResponseFloatingIpDnsPtrInner } from './floating-ips-create-new-ip-response-floating-ip-dns-ptr-inner';
import { FloatingIPsCreateNewIpResponseFloatingIpHomeLocation } from './floating-ips-create-new-ip-response-floating-ip-home-location';
import { FloatingIPsCreateNewIpResponseFloatingIpProtection } from './floating-ips-create-new-ip-response-floating-ip-protection';

/**
 * 
 * @export
 * @interface FloatingIPsCreateNewIpResponseFloatingIp
 */
export interface FloatingIPsCreateNewIpResponseFloatingIp {
    /**
     * Description of the Resource.
     * @type {string}
     * @memberof FloatingIPsCreateNewIpResponseFloatingIp
     */
     ...
     * @type {Array<FloatingIPsCreateNewIpResponseFloatingIpDnsPtrInner>}
     * @memberof FloatingIPsCreateNewIpResponseFloatingIp
     */
    'dns_ptr': Array<FloatingIPsCreateNewIpResponseFloatingIpDnsPtrInner>;
    /**
     * 
     * @type {FloatingIPsCreateNewIpResponseFloatingIpHomeLocation}
     * @memberof FloatingIPsCreateNewIpResponseFloatingIp
     */
    ...
    /**
     * 
     * @type {FloatingIPsCreateNewIpResponseFloatingIpProtection}
     * @memberof FloatingIPsCreateNewIpResponseFloatingIp
     */
     ...
     * @memberof FloatingIPsCreateNewIpResponseFloatingIp
     */
    'type': FloatingIPsCreateNewIpResponseFloatingIpTypeEnum;
}

type FloatingIPsCreateNewIpResponseFloatingIpTypeEnum = 'ipv4' | 'ipv6'
