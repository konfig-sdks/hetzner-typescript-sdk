...
import { ActionProperty2Error } from './action-property2-error';
import { ActionProperty2ResourcesInner } from './action-property2-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty2
 */
export interface ActionProperty2 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty2
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty2Error}
     * @memberof ActionProperty2
     */
    'error': ActionProperty2Error | null;
    /**
     ...
     * @type {Array<ActionProperty2ResourcesInner>}
     * @memberof ActionProperty2
     */
    'resources': Array<ActionProperty2ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty2
     */
    'status': ActionProperty2StatusEnum;
}

type ActionProperty2StatusEnum = 'success' | 'running' | 'error'
