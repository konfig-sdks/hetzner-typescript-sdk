...
import { LoadBalancersGetMetricsResponseMetrics } from './load-balancers-get-metrics-response-metrics';

/**
 * 
 * @export
 * @interface LoadBalancersGetMetricsResponse
 */
export interface LoadBalancersGetMetricsResponse {
    /**
     * 
     * @type {LoadBalancersGetMetricsResponseMetrics}
     * @memberof LoadBalancersGetMetricsResponse
     */
    'metrics': LoadBalancersGetMetricsResponseMetrics;
}
