...
import { PrimaryIPProperty1 } from './primary-ipproperty1';

/**
 * 
 * @export
 * @interface PrimaryIPsGetByIdResponse
 */
export interface PrimaryIPsGetByIdResponse {
    /**
     * 
     * @type {PrimaryIPProperty1}
     * @memberof PrimaryIPsGetByIdResponse
     */
    'primary_ip': PrimaryIPProperty1;
}
