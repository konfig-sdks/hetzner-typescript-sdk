...
import { FirewallProperty2AppliedToInnerAppliedToResourcesInner } from './firewall-property2-applied-to-inner-applied-to-resources-inner';
import { FirewallProperty2AppliedToInnerLabelSelector } from './firewall-property2-applied-to-inner-label-selector';
import { FirewallProperty2AppliedToInnerServer } from './firewall-property2-applied-to-inner-server';

/**
 * 
 * @export
 * @interface FirewallProperty2AppliedToInner
 */
export interface FirewallProperty2AppliedToInner {
    /**
     * 
     * @type {Array<FirewallProperty2AppliedToInnerAppliedToResourcesInner>}
     * @memberof FirewallProperty2AppliedToInner
     */
    'applied_to_resources'?: Array<FirewallProperty2AppliedToInnerAppliedToResourcesInner>;
    /**
     * 
     * @type {FirewallProperty2AppliedToInnerLabelSelector}
     * @memberof FirewallProperty2AppliedToInner
     */
    'label_selector'?: FirewallProperty2AppliedToInnerLabelSelector;
    /**
     * 
     * @type {FirewallProperty2AppliedToInnerServer}
     * @memberof FirewallProperty2AppliedToInner
     */
    'server'?: FirewallProperty2AppliedToInnerServer;
    /**
     * Type of resource referenced
     * @type {string}
     * @memberof FirewallProperty2AppliedToInner
     */
    'type': FirewallProperty2AppliedToInnerTypeEnum;
}

type FirewallProperty2AppliedToInnerTypeEnum = 'server' | 'label_selector'
