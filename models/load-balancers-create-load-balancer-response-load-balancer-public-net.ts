...
import { LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNetIpv4 } from './load-balancers-create-load-balancer-response-load-balancer-public-net-ipv4';
import { LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNetIpv6 } from './load-balancers-create-load-balancer-response-load-balancer-public-net-ipv6';

/**
 * Public network information
 * @export
 * @interface LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNet
 */
export interface LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNet {
    /**
     * Public Interface enabled or not
     * @type {boolean}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNet
     */
    'enabled': boolean;
    /**
     * 
     * @type {LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNetIpv4}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNet
     */
    'ipv4': LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNetIpv4;
    /**
     * 
     * @type {LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNetIpv6}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNet
     */
