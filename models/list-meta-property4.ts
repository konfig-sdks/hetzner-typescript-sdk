...
import { ListMetaProperty4Pagination } from './list-meta-property4-pagination';

/**
 * 
 * @export
 * @interface ListMetaProperty4
 */
export interface ListMetaProperty4 {
    /**
     * 
     * @type {ListMetaProperty4Pagination}
     * @memberof ListMetaProperty4
     */
    'pagination': ListMetaProperty4Pagination;
}
