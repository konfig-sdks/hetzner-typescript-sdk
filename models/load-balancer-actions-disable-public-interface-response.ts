...
import { ActionProperty28 } from './action-property28';

/**
 * 
 * @export
 * @interface LoadBalancerActionsDisablePublicInterfaceResponse
 */
export interface LoadBalancerActionsDisablePublicInterfaceResponse {
    /**
     * 
     * @type {ActionProperty28}
     * @memberof LoadBalancerActionsDisablePublicInterfaceResponse
     */
    'action': ActionProperty28;
}
