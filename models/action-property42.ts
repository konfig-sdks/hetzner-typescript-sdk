...
import { ActionProperty42Error } from './action-property42-error';
import { ActionProperty42ResourcesInner } from './action-property42-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty42
 */
export interface ActionProperty42 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty42
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty42Error}
     * @memberof ActionProperty42
     */
    'error': ActionProperty42Error | null;
    /**
     ...
     * @type {Array<ActionProperty42ResourcesInner>}
     * @memberof ActionProperty42
     */
    'resources': Array<ActionProperty42ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty42
     */
    'status': ActionProperty42StatusEnum;
}

type ActionProperty42StatusEnum = 'success' | 'running' | 'error'
