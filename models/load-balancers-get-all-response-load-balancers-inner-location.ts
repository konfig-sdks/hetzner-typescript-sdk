 ...
 * 
 * @export
 * @interface LoadBalancersGetAllResponseLoadBalancersInnerLocation
 */
export interface LoadBalancersGetAllResponseLoadBalancersInnerLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInnerLocation
     */
    'description': string;
    /**
