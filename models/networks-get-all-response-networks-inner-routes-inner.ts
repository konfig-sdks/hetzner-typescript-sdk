 ...
 * 
 * @export
 * @interface NetworksGetAllResponseNetworksInnerRoutesInner
 */
export interface NetworksGetAllResponseNetworksInnerRoutesInner {
    /**
     ...
     * @type {string}
     * @memberof NetworksGetAllResponseNetworksInnerRoutesInner
     */
    'destination': string;
    /**
