 ...
 * @export
 * @interface ImagesGetAllResponseImagesInnerProtection
 */
export interface ImagesGetAllResponseImagesInnerProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof ImagesGetAllResponseImagesInnerProtection
     */
    'delete': boolean;
}
