...
import { ListMetaProperty29 } from './list-meta-property29';
import { ServersGetAllResponseServersInner } from './servers-get-all-response-servers-inner';

/**
 * 
 * @export
 * @interface ServersGetAllResponse
 */
export interface ServersGetAllResponse {
    /**
     * 
     * @type {Array<ServersGetAllResponseServersInner>}
     * @memberof ServersGetAllResponse
     */
    'servers': Array<ServersGetAllResponseServersInner>;
    /**
     * 
     * @type {ListMetaProperty29}
     * @memberof ServersGetAllResponse
     */
    'meta'?: ListMetaProperty29;
}
