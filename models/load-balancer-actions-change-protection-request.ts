 ...
 * 
 * @export
 * @interface LoadBalancerActionsChangeProtectionRequest
 */
export interface LoadBalancerActionsChangeProtectionRequest {
    /**
     * If true, prevents the Load Balancer from being deleted
     * @type {boolean}
     * @memberof LoadBalancerActionsChangeProtectionRequest
     */
    'delete'?: boolean;
}
