...
import { VolumesUpdateVolumePropertiesRequestLabels } from './volumes-update-volume-properties-request-labels';

/**
 * 
 * @export
 * @interface VolumesUpdateVolumePropertiesRequest
 */
export interface VolumesUpdateVolumePropertiesRequest {
    /**
     * 
     * @type {VolumesUpdateVolumePropertiesRequestLabels}
     * @memberof VolumesUpdateVolumePropertiesRequest
     */
    'labels'?: VolumesUpdateVolumePropertiesRequestLabels;
    /**
     * New Volume name
     * @type {string}
     * @memberof VolumesUpdateVolumePropertiesRequest
