...
import { ActionProperty46 } from './action-property46';

/**
 * 
 * @export
 * @interface PrimaryIpActionsUnassignPrimaryIpResponse
 */
export interface PrimaryIpActionsUnassignPrimaryIpResponse {
    /**
     * 
     * @type {ActionProperty46}
     * @memberof PrimaryIpActionsUnassignPrimaryIpResponse
     */
    'action': ActionProperty46;
}
