...
import { ActionProperty74Error } from './action-property74-error';
import { ActionProperty74ResourcesInner } from './action-property74-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty74
 */
export interface ActionProperty74 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty74
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty74Error}
     * @memberof ActionProperty74
     */
    'error': ActionProperty74Error | null;
    /**
     ...
     * @type {Array<ActionProperty74ResourcesInner>}
     * @memberof ActionProperty74
     */
    'resources': Array<ActionProperty74ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty74
     */
    'status': ActionProperty74StatusEnum;
}

type ActionProperty74StatusEnum = 'success' | 'running' | 'error'
