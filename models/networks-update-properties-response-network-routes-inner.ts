 ...
 * 
 * @export
 * @interface NetworksUpdatePropertiesResponseNetworkRoutesInner
 */
export interface NetworksUpdatePropertiesResponseNetworkRoutesInner {
    /**
     ...
     * @type {string}
     * @memberof NetworksUpdatePropertiesResponseNetworkRoutesInner
     */
    'destination': string;
    /**
