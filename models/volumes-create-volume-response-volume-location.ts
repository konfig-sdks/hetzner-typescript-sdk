 ...
 * @export
 * @interface VolumesCreateVolumeResponseVolumeLocation
 */
export interface VolumesCreateVolumeResponseVolumeLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof VolumesCreateVolumeResponseVolumeLocation
     */
    'description': string;
    /**
