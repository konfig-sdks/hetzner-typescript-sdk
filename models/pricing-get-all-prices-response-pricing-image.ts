...
import { PricingGetAllPricesResponsePricingImagePricePerGbMonth } from './pricing-get-all-prices-response-pricing-image-price-per-gb-month';

/**
 * The cost of Image per GB/month
 * @export
 * @interface PricingGetAllPricesResponsePricingImage
 */
export interface PricingGetAllPricesResponsePricingImage {
    /**
     * 
     * @type {PricingGetAllPricesResponsePricingImagePricePerGbMonth}
     * @memberof PricingGetAllPricesResponsePricingImage
     */
    'price_per_gb_month': PricingGetAllPricesResponsePricingImagePricePerGbMonth;
}
