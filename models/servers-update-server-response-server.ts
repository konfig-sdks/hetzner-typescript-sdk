...
import { PlacementGroupNullableProperty3 } from './placement-group-nullable-property3';
import { ServersUpdateServerResponseServerDatacenter } from './servers-update-server-response-server-datacenter';
import { ServersUpdateServerResponseServerImage } from './servers-update-server-response-server-image';
import { ServersUpdateServerResponseServerIso } from './servers-update-server-response-server-iso';
import { ServersUpdateServerResponseServerPrivateNetInner } from './servers-update-server-response-server-private-net-inner';
import { ServersUpdateServerResponseServerProtection } from './servers-update-server-response-server-protection';
import { ServersUpdateServerResponseServerPublicNet } from './servers-update-server-response-server-public-net';
import { ServersUpdateServerResponseServerServerType } from './servers-update-server-response-server-server-type';

/**
 * 
 * @export
 * @interface ServersUpdateServerResponseServer
 */
export interface ServersUpdateServerResponseServer {
    /**
     * Time window (UTC) in which the backup will run, or null if the backups are not enabled
     * @type {string}
     * @memberof ServersUpdateServerResponseServer
     */
    ...
    /**
     * 
     * @type {ServersUpdateServerResponseServerDatacenter}
     * @memberof ServersUpdateServerResponseServer
     */
    ...
    /**
     * 
     * @type {ServersUpdateServerResponseServerImage}
     * @memberof ServersUpdateServerResponseServer
     */
    'image': ServersUpdateServerResponseServerImage | null;
    /**
    ...
    /**
     * 
     * @type {ServersUpdateServerResponseServerIso}
     * @memberof ServersUpdateServerResponseServer
     */
    'iso': ServersUpdateServerResponseServerIso | null;
    /**
    ...
    /**
     * 
     * @type {PlacementGroupNullableProperty3}
     * @memberof ServersUpdateServerResponseServer
     */
    'placement_group'?: PlacementGroupNullableProperty3 | null;
    /**
     ...
     * @type {Array<ServersUpdateServerResponseServerPrivateNetInner>}
     * @memberof ServersUpdateServerResponseServer
     */
    'private_net': Array<ServersUpdateServerResponseServerPrivateNetInner>;
    /**
     * 
     * @type {ServersUpdateServerResponseServerProtection}
     * @memberof ServersUpdateServerResponseServer
     */
    'protection': ServersUpdateServerResponseServerProtection;
    /**
     * 
     * @type {ServersUpdateServerResponseServerPublicNet}
     * @memberof ServersUpdateServerResponseServer
     */
    ...
    /**
     * 
     * @type {ServersUpdateServerResponseServerServerType}
     * @memberof ServersUpdateServerResponseServer
     */
     ...
     * @memberof ServersUpdateServerResponseServer
     */
    'status': ServersUpdateServerResponseServerStatusEnum;
    /**
...
type ServersUpdateServerResponseServerStatusEnum = 'running' | 'initializing' | 'starting' | 'stopping' | 'false' | 'deleting' | 'migrating' | 'rebuilding' | 'unknown'
