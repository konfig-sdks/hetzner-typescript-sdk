...
import { ActionProperty20Error } from './action-property20-error';
import { ActionProperty20ResourcesInner } from './action-property20-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty20
 */
export interface ActionProperty20 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty20
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty20Error}
     * @memberof ActionProperty20
     */
    'error': ActionProperty20Error | null;
    /**
     ...
     * @type {Array<ActionProperty20ResourcesInner>}
     * @memberof ActionProperty20
     */
    'resources': Array<ActionProperty20ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty20
     */
    'status': ActionProperty20StatusEnum;
}

type ActionProperty20StatusEnum = 'success' | 'running' | 'error'
