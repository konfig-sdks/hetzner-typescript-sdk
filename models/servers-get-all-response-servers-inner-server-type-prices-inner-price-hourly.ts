 ...
 * @export
 * @interface ServersGetAllResponseServersInnerServerTypePricesInnerPriceHourly
 */
export interface ServersGetAllResponseServersInnerServerTypePricesInnerPriceHourly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof ServersGetAllResponseServersInnerServerTypePricesInnerPriceHourly
     */
    'gross': string;
    /**
     * Price without VAT
