...
import { PrimaryIPProperty1DatacenterLocation } from './primary-ipproperty1-datacenter-location';
import { PrimaryIPProperty1DatacenterServerTypes } from './primary-ipproperty1-datacenter-server-types';

/**
 * Datacenter this Primary IP is located at
 * @export
 * @interface PrimaryIPProperty1Datacenter
 */
export interface PrimaryIPProperty1Datacenter {
    /**
     * Description of the Datacenter
     * @type {string}
     * @memberof PrimaryIPProperty1Datacenter
     */
    'description': string;
    /**
    ...
    /**
     * 
     * @type {PrimaryIPProperty1DatacenterLocation}
     * @memberof PrimaryIPProperty1Datacenter
     */
    'location': PrimaryIPProperty1DatacenterLocation;
    /**
    ...
    /**
     * 
     * @type {PrimaryIPProperty1DatacenterServerTypes}
     * @memberof PrimaryIPProperty1Datacenter
     */
    'server_types': PrimaryIPProperty1DatacenterServerTypes;
}
