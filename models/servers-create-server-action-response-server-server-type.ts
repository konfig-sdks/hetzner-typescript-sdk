...
import { DeprecationInfoProperty7 } from './deprecation-info-property7';
import { ServersCreateServerActionResponseServerServerTypePricesInner } from './servers-create-server-action-response-server-server-type-prices-inner';

/**
 * 
 * @export
 * @interface ServersCreateServerActionResponseServerServerType
 */
export interface ServersCreateServerActionResponseServerServerType {
    /**
     * Description of the Server type
     * @type {string}
     * @memberof ServersCreateServerActionResponseServerServerType
     */
    'description': string;
    /**
     ...
     * @memberof ServersCreateServerActionResponseServerServerType
     */
    'architecture': ServersCreateServerActionResponseServerServerTypeArchitectureEnum;
    /**
     ...
     * @memberof ServersCreateServerActionResponseServerServerType
     */
    'cpu_type': ServersCreateServerActionResponseServerServerTypeCpuTypeEnum;
    /**
    ...
    /**
     * 
     * @type {DeprecationInfoProperty7}
     * @memberof ServersCreateServerActionResponseServerServerType
     */
    'deprecation'?: DeprecationInfoProperty7 | null;
    /**
     ...
     * @type {Array<ServersCreateServerActionResponseServerServerTypePricesInner>}
     * @memberof ServersCreateServerActionResponseServerServerType
     */
    'prices': Array<ServersCreateServerActionResponseServerServerTypePricesInner>;
    /**
     * Type of Server boot drive. Local has higher speed. Network has better availability.
     * @type {string}
     * @memberof ServersCreateServerActionResponseServerServerType
     */
    'storage_type': ServersCreateServerActionResponseServerServerTypeStorageTypeEnum;
}

type ServersCreateServerActionResponseServerServerTypeArchitectureEnum = 'x86' | 'arm'
type ServersCreateServerActionResponseServerServerTypeCpuTypeEnum = 'shared' | 'dedicated'
type ServersCreateServerActionResponseServerServerTypeStorageTypeEnum = 'local' | 'network'
