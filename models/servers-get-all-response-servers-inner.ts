...
import { PlacementGroupNullableProperty } from './placement-group-nullable-property';
import { ServersGetAllResponseServersInnerDatacenter } from './servers-get-all-response-servers-inner-datacenter';
import { ServersGetAllResponseServersInnerImage } from './servers-get-all-response-servers-inner-image';
import { ServersGetAllResponseServersInnerIso } from './servers-get-all-response-servers-inner-iso';
import { ServersGetAllResponseServersInnerPrivateNetInner } from './servers-get-all-response-servers-inner-private-net-inner';
import { ServersGetAllResponseServersInnerProtection } from './servers-get-all-response-servers-inner-protection';
import { ServersGetAllResponseServersInnerPublicNet } from './servers-get-all-response-servers-inner-public-net';
import { ServersGetAllResponseServersInnerServerType } from './servers-get-all-response-servers-inner-server-type';

/**
 * 
 * @export
 * @interface ServersGetAllResponseServersInner
 */
export interface ServersGetAllResponseServersInner {
    /**
     * Time window (UTC) in which the backup will run, or null if the backups are not enabled
     * @type {string}
     * @memberof ServersGetAllResponseServersInner
     */
    ...
    /**
     * 
     * @type {ServersGetAllResponseServersInnerDatacenter}
     * @memberof ServersGetAllResponseServersInner
     */
    'datacenter': ServersGetAllResponseServersInnerDatacenter;
    /**
    ...
    /**
     * 
     * @type {ServersGetAllResponseServersInnerImage}
     * @memberof ServersGetAllResponseServersInner
     */
    'image': ServersGetAllResponseServersInnerImage | null;
    /**
    ...
    /**
     * 
     * @type {ServersGetAllResponseServersInnerIso}
     * @memberof ServersGetAllResponseServersInner
     */
    'iso': ServersGetAllResponseServersInnerIso | null;
    /**
    ...
    /**
     * 
     * @type {PlacementGroupNullableProperty}
     * @memberof ServersGetAllResponseServersInner
     */
    'placement_group'?: PlacementGroupNullableProperty | null;
    /**
     ...
     * @type {Array<ServersGetAllResponseServersInnerPrivateNetInner>}
     * @memberof ServersGetAllResponseServersInner
     */
    'private_net': Array<ServersGetAllResponseServersInnerPrivateNetInner>;
    /**
     * 
     * @type {ServersGetAllResponseServersInnerProtection}
     * @memberof ServersGetAllResponseServersInner
     */
    'protection': ServersGetAllResponseServersInnerProtection;
    /**
     * 
     * @type {ServersGetAllResponseServersInnerPublicNet}
     * @memberof ServersGetAllResponseServersInner
     */
    'public_net': ServersGetAllResponseServersInnerPublicNet;
    /**
    ...
    /**
     * 
     * @type {ServersGetAllResponseServersInnerServerType}
     * @memberof ServersGetAllResponseServersInner
     */
    'server_type': ServersGetAllResponseServersInnerServerType;
    /**
     * Status of the Server
     * @type {string}
     * @memberof ServersGetAllResponseServersInner
     */
    'status': ServersGetAllResponseServersInnerStatusEnum;
    /**
...
type ServersGetAllResponseServersInnerStatusEnum = 'running' | 'initializing' | 'starting' | 'stopping' | 'false' | 'deleting' | 'migrating' | 'rebuilding' | 'unknown'
