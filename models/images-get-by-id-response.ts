...
import { ImagesGetByIdResponseImage } from './images-get-by-id-response-image';

/**
 * 
 * @export
 * @interface ImagesGetByIdResponse
 */
export interface ImagesGetByIdResponse {
    /**
     * 
     * @type {ImagesGetByIdResponseImage}
     * @memberof ImagesGetByIdResponse
     */
    'image'?: ImagesGetByIdResponseImage;
}
