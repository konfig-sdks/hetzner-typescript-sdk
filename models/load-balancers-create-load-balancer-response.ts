...
import { ActionProperty17 } from './action-property17';
import { LoadBalancersCreateLoadBalancerResponseLoadBalancer } from './load-balancers-create-load-balancer-response-load-balancer';

/**
 * 
 * @export
 * @interface LoadBalancersCreateLoadBalancerResponse
 */
export interface LoadBalancersCreateLoadBalancerResponse {
    /**
     * 
     * @type {ActionProperty17}
     * @memberof LoadBalancersCreateLoadBalancerResponse
     */
    'action': ActionProperty17;
    /**
     * 
     * @type {LoadBalancersCreateLoadBalancerResponseLoadBalancer}
     * @memberof LoadBalancersCreateLoadBalancerResponse
     */
