...
import { ActionProperty10Error } from './action-property10-error';
import { ActionProperty10ResourcesInner } from './action-property10-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty10
 */
export interface ActionProperty10 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty10
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty10Error}
     * @memberof ActionProperty10
     */
    'error': ActionProperty10Error | null;
    /**
     ...
     * @type {Array<ActionProperty10ResourcesInner>}
     * @memberof ActionProperty10
     */
    'resources': Array<ActionProperty10ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty10
     */
    'status': ActionProperty10StatusEnum;
}

type ActionProperty10StatusEnum = 'success' | 'running' | 'error'
