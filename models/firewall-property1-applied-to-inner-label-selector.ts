 ...
 * 
 * @export
 * @interface FirewallProperty1AppliedToInnerLabelSelector
 */
export interface FirewallProperty1AppliedToInnerLabelSelector {
    /**
     * Label selector
     * @type {string}
     * @memberof FirewallProperty1AppliedToInnerLabelSelector
     */
    'selector': string;
}
