 ...
 * @export
 * @interface ImagesGetAllResponseImagesInnerCreatedFrom
 */
export interface ImagesGetAllResponseImagesInnerCreatedFrom {
    /**
     * ID of the Server the Image was created from
     * @type {number}
     * @memberof ImagesGetAllResponseImagesInnerCreatedFrom
     */
    'id': number;
    /**
