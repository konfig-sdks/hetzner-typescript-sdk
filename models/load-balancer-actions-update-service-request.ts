...
import { LoadBalancerServiceHTTPProperty2 } from './load-balancer-service-httpproperty2';
import { UpdateLoadBalancerServiceHealthCheckProperty } from './update-load-balancer-service-health-check-property';

/**
 * 
 * @export
 * @interface LoadBalancerActionsUpdateServiceRequest
 */
export interface LoadBalancerActionsUpdateServiceRequest {
    /**
     * Port the Load Balancer will balance to
     * @type {number}
     * @memberof LoadBalancerActionsUpdateServiceRequest
     */
    'destination_port'?: number;
    /**
     * 
     * @type {UpdateLoadBalancerServiceHealthCheckProperty}
     * @memberof LoadBalancerActionsUpdateServiceRequest
     */
    'health_check'?: UpdateLoadBalancerServiceHealthCheckProperty;
    /**
     * 
     * @type {LoadBalancerServiceHTTPProperty2}
     * @memberof LoadBalancerActionsUpdateServiceRequest
     */
    'http'?: LoadBalancerServiceHTTPProperty2;
    /**
     ...
     * @memberof LoadBalancerActionsUpdateServiceRequest
     */
    'protocol'?: LoadBalancerActionsUpdateServiceRequestProtocolEnum;
    /**
...
type LoadBalancerActionsUpdateServiceRequestProtocolEnum = 'tcp' | 'http' | 'https'
