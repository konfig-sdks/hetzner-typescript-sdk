 ...
 * @export
 * @interface ServersUpdateServerResponseServerPublicNetIpv4
 */
export interface ServersUpdateServerResponseServerPublicNetIpv4 {
    /**
     * If the IP is blocked by our anti abuse dept
     * @type {boolean}
     * @memberof ServersUpdateServerResponseServerPublicNetIpv4
     */
    'blocked': boolean;
    /**
