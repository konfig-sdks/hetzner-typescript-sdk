...
import { ActionProperty80Error } from './action-property80-error';
import { ActionProperty80ResourcesInner } from './action-property80-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty80
 */
export interface ActionProperty80 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty80
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty80Error}
     * @memberof ActionProperty80
     */
    'error': ActionProperty80Error | null;
    /**
     ...
     * @type {Array<ActionProperty80ResourcesInner>}
     * @memberof ActionProperty80
     */
    'resources': Array<ActionProperty80ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty80
     */
    'status': ActionProperty80StatusEnum;
}

type ActionProperty80StatusEnum = 'success' | 'running' | 'error'
