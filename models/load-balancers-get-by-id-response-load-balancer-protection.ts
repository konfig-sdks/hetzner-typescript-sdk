 ...
 * @export
 * @interface LoadBalancersGetByIdResponseLoadBalancerProtection
 */
export interface LoadBalancersGetByIdResponseLoadBalancerProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof LoadBalancersGetByIdResponseLoadBalancerProtection
     */
    'delete': boolean;
}
