 ...
 * IP address (v6)
 * @export
 * @interface LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv6
 */
export interface LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv6 {
    /**
     * Reverse DNS PTR entry for the IPv6 address of this Load Balancer
     * @type {string}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv6
     */
    'dns_ptr'?: string | null;
    /**
