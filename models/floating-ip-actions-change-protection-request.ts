 ...
 * 
 * @export
 * @interface FloatingIpActionsChangeProtectionRequest
 */
export interface FloatingIpActionsChangeProtectionRequest {
    /**
     * If true, prevents the Floating IP from being deleted
     * @type {boolean}
     * @memberof FloatingIpActionsChangeProtectionRequest
     */
    'delete'?: boolean;
}
