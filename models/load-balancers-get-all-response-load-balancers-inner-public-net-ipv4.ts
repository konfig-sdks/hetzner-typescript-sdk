 ...
 * IP address (v4)
 * @export
 * @interface LoadBalancersGetAllResponseLoadBalancersInnerPublicNetIpv4
 */
export interface LoadBalancersGetAllResponseLoadBalancersInnerPublicNetIpv4 {
    /**
     * Reverse DNS PTR entry for the IPv4 address of this Load Balancer
     * @type {string}
     * @memberof LoadBalancersGetAllResponseLoadBalancersInnerPublicNetIpv4
     */
    'dns_ptr'?: string | null;
    /**
