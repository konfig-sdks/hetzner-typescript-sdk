 ...
 * 
 * @export
 * @interface LoadBalancersUpdateBalancerResponseLoadBalancerLocation
 */
export interface LoadBalancersUpdateBalancerResponseLoadBalancerLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancerLocation
     */
    'description': string;
    /**
