 ...
 * 
 * @export
 * @interface NetworksGetByIdResponseNetworkRoutesInner
 */
export interface NetworksGetByIdResponseNetworkRoutesInner {
    /**
     ...
     * @type {string}
     * @memberof NetworksGetByIdResponseNetworkRoutesInner
     */
    'destination': string;
    /**
