 ...
 * 
 * @export
 * @interface LoadBalancersCreateLoadBalancerResponseLoadBalancerPrivateNetInner
 */
export interface LoadBalancersCreateLoadBalancerResponseLoadBalancerPrivateNetInner {
    /**
     * IP address (v4) of this Load Balancer in this Network
     * @type {string}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancerPrivateNetInner
     */
    'ip'?: string;
    /**
     * ID of the Network
