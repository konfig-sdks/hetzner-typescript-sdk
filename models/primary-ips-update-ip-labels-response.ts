...
import { PrimaryIPProperty2 } from './primary-ipproperty2';

/**
 * 
 * @export
 * @interface PrimaryIPsUpdateIpLabelsResponse
 */
export interface PrimaryIPsUpdateIpLabelsResponse {
    /**
     * 
     * @type {PrimaryIPProperty2}
     * @memberof PrimaryIPsUpdateIpLabelsResponse
     */
    'primary_ip': PrimaryIPProperty2;
}
