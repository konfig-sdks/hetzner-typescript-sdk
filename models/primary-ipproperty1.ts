...
import { PrimaryIPProperty1Datacenter } from './primary-ipproperty1-datacenter';
import { PrimaryIPProperty1DnsPtrInner } from './primary-ipproperty1-dns-ptr-inner';
import { PrimaryIPProperty1Protection } from './primary-ipproperty1-protection';

/**
 * 
 * @export
 * @interface PrimaryIPProperty1
 */
export interface PrimaryIPProperty1 {
    /**
     * ID of the resource the Primary IP is assigned to, null if it is not assigned at all
     * @type {number}
     * @memberof PrimaryIPProperty1
     */
     ...
     * @memberof PrimaryIPProperty1
     */
    'assignee_type': PrimaryIPProperty1AssigneeTypeEnum;
    /**
    ...
    /**
     * 
     * @type {PrimaryIPProperty1Datacenter}
     * @memberof PrimaryIPProperty1
     */
    'datacenter': PrimaryIPProperty1Datacenter;
    /**
     * Array of reverse DNS entries
     * @type {Array<PrimaryIPProperty1DnsPtrInner>}
     * @memberof PrimaryIPProperty1
     */
    'dns_ptr': Array<PrimaryIPProperty1DnsPtrInner>;
    /**
    ...
    /**
     * 
     * @type {PrimaryIPProperty1Protection}
     * @memberof PrimaryIPProperty1
     */
    'protection': PrimaryIPProperty1Protection;
    /**
     * Type of the Primary IP
     * @type {string}
     * @memberof PrimaryIPProperty1
     */
    'type': PrimaryIPProperty1TypeEnum;
}

type PrimaryIPProperty1AssigneeTypeEnum = 'server'
type PrimaryIPProperty1TypeEnum = 'ipv4' | 'ipv6'
