...
import { ActionProperty67 } from './action-property67';

/**
 * 
 * @export
 * @interface ServerActionsRebuildServerFromImageResponse
 */
export interface ServerActionsRebuildServerFromImageResponse {
    /**
     * 
     * @type {ActionProperty67}
     * @memberof ServerActionsRebuildServerFromImageResponse
     */
    'action'?: ActionProperty67;
    /**
