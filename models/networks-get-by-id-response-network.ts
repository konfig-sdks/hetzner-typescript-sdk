...
import { NetworksGetByIdResponseNetworkProtection } from './networks-get-by-id-response-network-protection';
import { NetworksGetByIdResponseNetworkRoutesInner } from './networks-get-by-id-response-network-routes-inner';
import { NetworksGetByIdResponseNetworkSubnetsInner } from './networks-get-by-id-response-network-subnets-inner';

/**
 * 
 * @export
 * @interface NetworksGetByIdResponseNetwork
 */
export interface NetworksGetByIdResponseNetwork {
    /**
     * Array of IDs of Servers attached to this Network
     * @type {Array<number>}
     * @memberof NetworksGetByIdResponseNetwork
     */
    ...
    /**
     * 
     * @type {NetworksGetByIdResponseNetworkProtection}
     * @memberof NetworksGetByIdResponseNetwork
     */
    'protection': NetworksGetByIdResponseNetworkProtection;
    /**
     * Array of routes set in this Network
     * @type {Array<NetworksGetByIdResponseNetworkRoutesInner>}
     * @memberof NetworksGetByIdResponseNetwork
     */
    'routes': Array<NetworksGetByIdResponseNetworkRoutesInner>;
    /**
     * Array subnets allocated in this Network
     * @type {Array<NetworksGetByIdResponseNetworkSubnetsInner>}
     * @memberof NetworksGetByIdResponseNetwork
     */
    'subnets': Array<NetworksGetByIdResponseNetworkSubnetsInner>;
}
