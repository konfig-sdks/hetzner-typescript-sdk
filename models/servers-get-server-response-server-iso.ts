...
import { DeprecationInfoProperty8 } from './deprecation-info-property8';

/**
 * ISO Image that is attached to this Server. Null if no ISO is attached.
 * @export
 * @interface ServersGetServerResponseServerIso
 */
export interface ServersGetServerResponseServerIso {
    /**
     * Description of the ISO
     * @type {string}
     * @memberof ServersGetServerResponseServerIso
     */
    'description': string;
    /**
     ...
     * @memberof ServersGetServerResponseServerIso
     */
    'architecture': ServersGetServerResponseServerIsoArchitectureEnum;
    /**
     * 
     * @type {DeprecationInfoProperty8}
     * @memberof ServersGetServerResponseServerIso
     */
    'deprecation': DeprecationInfoProperty8 | null;
    /**
     ...
     * @memberof ServersGetServerResponseServerIso
     */
    'type': ServersGetServerResponseServerIsoTypeEnum;
}

type ServersGetServerResponseServerIsoArchitectureEnum = 'x86' | 'arm'
type ServersGetServerResponseServerIsoTypeEnum = 'public' | 'private'
