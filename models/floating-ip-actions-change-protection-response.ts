...
import { ActionProperty11 } from './action-property11';

/**
 * 
 * @export
 * @interface FloatingIpActionsChangeProtectionResponse
 */
export interface FloatingIpActionsChangeProtectionResponse {
    /**
     * 
     * @type {ActionProperty11}
     * @memberof FloatingIpActionsChangeProtectionResponse
     */
    'action': ActionProperty11;
}
