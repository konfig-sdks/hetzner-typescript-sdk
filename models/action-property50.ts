...
import { ActionProperty50Error } from './action-property50-error';
import { ActionProperty50ResourcesInner } from './action-property50-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty50
 */
export interface ActionProperty50 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty50
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty50Error}
     * @memberof ActionProperty50
     */
    'error': ActionProperty50Error | null;
    /**
     ...
     * @type {Array<ActionProperty50ResourcesInner>}
     * @memberof ActionProperty50
     */
    'resources': Array<ActionProperty50ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty50
     */
    'status': ActionProperty50StatusEnum;
}

type ActionProperty50StatusEnum = 'success' | 'running' | 'error'
