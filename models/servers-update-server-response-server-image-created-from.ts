 ...
 * @export
 * @interface ServersUpdateServerResponseServerImageCreatedFrom
 */
export interface ServersUpdateServerResponseServerImageCreatedFrom {
    /**
     * ID of the Server the Image was created from
     * @type {number}
     * @memberof ServersUpdateServerResponseServerImageCreatedFrom
     */
    'id': number;
    /**
