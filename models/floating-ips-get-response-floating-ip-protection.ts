 ...
 * @export
 * @interface FloatingIPsGetResponseFloatingIpProtection
 */
export interface FloatingIPsGetResponseFloatingIpProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof FloatingIPsGetResponseFloatingIpProtection
     */
    'delete': boolean;
}
