...
import { ActionProperty41Error } from './action-property41-error';
import { ActionProperty41ResourcesInner } from './action-property41-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty41
 */
export interface ActionProperty41 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty41
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty41Error}
     * @memberof ActionProperty41
     */
    'error': ActionProperty41Error | null;
    /**
     ...
     * @type {Array<ActionProperty41ResourcesInner>}
     * @memberof ActionProperty41
     */
    'resources': Array<ActionProperty41ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty41
     */
    'status': ActionProperty41StatusEnum;
}

type ActionProperty41StatusEnum = 'success' | 'running' | 'error'
