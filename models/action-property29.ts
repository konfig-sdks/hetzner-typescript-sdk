...
import { ActionProperty29Error } from './action-property29-error';
import { ActionProperty29ResourcesInner } from './action-property29-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty29
 */
export interface ActionProperty29 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty29
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty29Error}
     * @memberof ActionProperty29
     */
    'error': ActionProperty29Error | null;
    /**
     ...
     * @type {Array<ActionProperty29ResourcesInner>}
     * @memberof ActionProperty29
     */
    'resources': Array<ActionProperty29ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty29
     */
    'status': ActionProperty29StatusEnum;
}

type ActionProperty29StatusEnum = 'success' | 'running' | 'error'
