 ...
 * 
 * @export
 * @interface NetworksGetByIdResponseNetworkSubnetsInner
 */
export interface NetworksGetByIdResponseNetworkSubnetsInner {
    /**
     ...
     * @type {string}
     * @memberof NetworksGetByIdResponseNetworkSubnetsInner
     */
    'gateway': string;
    /**
     ...
     * @memberof NetworksGetByIdResponseNetworkSubnetsInner
     */
    'type': NetworksGetByIdResponseNetworkSubnetsInnerTypeEnum;
    /**
...
type NetworksGetByIdResponseNetworkSubnetsInnerTypeEnum = 'cloud' | 'server' | 'vswitch'
