...
import { ActionProperty22 } from './action-property22';

/**
 * 
 * @export
 * @interface LoadBalancerActionsChangeAlgorithmResponse
 */
export interface LoadBalancerActionsChangeAlgorithmResponse {
    /**
     * 
     * @type {ActionProperty22}
     * @memberof LoadBalancerActionsChangeAlgorithmResponse
     */
    'action': ActionProperty22;
}
