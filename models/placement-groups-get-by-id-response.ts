...
import { PlacementGroupProperty1 } from './placement-group-property1';

/**
 * 
 * @export
 * @interface PlacementGroupsGetByIdResponse
 */
export interface PlacementGroupsGetByIdResponse {
    /**
     * 
     * @type {PlacementGroupProperty1}
     * @memberof PlacementGroupsGetByIdResponse
     */
    'placement_group': PlacementGroupProperty1;
}
