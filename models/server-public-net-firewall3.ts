 ...
 * 
 * @export
 * @interface ServerPublicNetFirewall3
 */
export interface ServerPublicNetFirewall3 {
    /**
     * ID of the Resource. Limited to 52 bits to ensure compatibility with JSON double precision floats. 
     * @type {number}
     * @memberof ServerPublicNetFirewall3
     */
    'id'?: number;
    /**
     ...
     * @memberof ServerPublicNetFirewall3
     */
    'status'?: ServerPublicNetFirewall3StatusEnum;
}

type ServerPublicNetFirewall3StatusEnum = 'applied' | 'pending'
