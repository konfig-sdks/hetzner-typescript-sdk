 ...
 * @export
 * @interface ServerActionsCreateImageResponseImageProtection
 */
export interface ServerActionsCreateImageResponseImageProtection {
    /**
     * Prevent the Resource from being deleted.
     * @type {boolean}
     * @memberof ServerActionsCreateImageResponseImageProtection
     */
    'delete': boolean;
}
