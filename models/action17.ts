...
import { Action17Error } from './action17-error';
import { Action17ResourcesInner } from './action17-resources-inner';
...
export interface Action17 {
     ...
     * @type {Array<Action17ResourcesInner>}
     * @memberof Action17
     */
    'resources': Array<Action17ResourcesInner>;
    /**
     ...
     * @memberof Action17
     */
    'status': Action17StatusEnum;
}

type Action17StatusEnum = 'success' | 'running' | 'error'
