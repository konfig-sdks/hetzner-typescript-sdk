...
import { ActionProperty12Error } from './action-property12-error';
import { ActionProperty12ResourcesInner } from './action-property12-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty12
 */
export interface ActionProperty12 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty12
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty12Error}
     * @memberof ActionProperty12
     */
    'error': ActionProperty12Error | null;
    /**
     ...
     * @type {Array<ActionProperty12ResourcesInner>}
     * @memberof ActionProperty12
     */
    'resources': Array<ActionProperty12ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty12
     */
    'status': ActionProperty12StatusEnum;
}

type ActionProperty12StatusEnum = 'success' | 'running' | 'error'
