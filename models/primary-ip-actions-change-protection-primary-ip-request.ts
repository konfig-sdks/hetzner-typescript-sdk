 ...
 * 
 * @export
 * @interface PrimaryIpActionsChangeProtectionPrimaryIpRequest
 */
export interface PrimaryIpActionsChangeProtectionPrimaryIpRequest {
    /**
     * If true, prevents the Primary IP from being deleted
     * @type {boolean}
     * @memberof PrimaryIpActionsChangeProtectionPrimaryIpRequest
     */
    'delete'?: boolean;
}
