...
import { ActionNullableProperty1 } from './action-nullable-property1';
import { PlacementGroupProperty } from './placement-group-property';

/**
 * 
 * @export
 * @interface PlacementGroupsCreateNewGroupResponse
 */
export interface PlacementGroupsCreateNewGroupResponse {
    /**
     * 
     * @type {ActionNullableProperty1}
     * @memberof PlacementGroupsCreateNewGroupResponse
     */
    'action'?: ActionNullableProperty1 | null;
    /**
     * 
     * @type {PlacementGroupProperty}
     * @memberof PlacementGroupsCreateNewGroupResponse
     */
    'placement_group': PlacementGroupProperty;
}
