...
import { LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner } from './load-balancer-types-get-all-types-response-load-balancer-types-inner';

/**
 * 
 * @export
 * @interface LoadBalancerTypesGetAllTypesResponse
 */
export interface LoadBalancerTypesGetAllTypesResponse {
    /**
     * 
     * @type {Array<LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner>}
     * @memberof LoadBalancerTypesGetAllTypesResponse
     */
    'load_balancer_types': Array<LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner>;
}
