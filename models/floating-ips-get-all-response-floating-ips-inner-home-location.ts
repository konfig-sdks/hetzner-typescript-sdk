 ...
 * @export
 * @interface FloatingIPsGetAllResponseFloatingIpsInnerHomeLocation
 */
export interface FloatingIPsGetAllResponseFloatingIpsInnerHomeLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof FloatingIPsGetAllResponseFloatingIpsInnerHomeLocation
     */
    'description': string;
    /**
