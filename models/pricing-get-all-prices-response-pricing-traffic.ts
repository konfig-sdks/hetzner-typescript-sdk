...
import { PricingGetAllPricesResponsePricingTrafficPricePerTb } from './pricing-get-all-prices-response-pricing-traffic-price-per-tb';

/**
 * The cost of additional traffic per TB
 * @export
 * @interface PricingGetAllPricesResponsePricingTraffic
 */
export interface PricingGetAllPricesResponsePricingTraffic {
    /**
     * 
     * @type {PricingGetAllPricesResponsePricingTrafficPricePerTb}
     * @memberof PricingGetAllPricesResponsePricingTraffic
     */
    'price_per_tb': PricingGetAllPricesResponsePricingTrafficPricePerTb;
}
