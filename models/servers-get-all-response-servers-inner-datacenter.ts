...
import { ServersGetAllResponseServersInnerDatacenterLocation } from './servers-get-all-response-servers-inner-datacenter-location';
import { ServersGetAllResponseServersInnerDatacenterServerTypes } from './servers-get-all-response-servers-inner-datacenter-server-types';

/**
 * Datacenter this Resource is located at
 * @export
 * @interface ServersGetAllResponseServersInnerDatacenter
 */
export interface ServersGetAllResponseServersInnerDatacenter {
    /**
     * Description of the Datacenter
     * @type {string}
     * @memberof ServersGetAllResponseServersInnerDatacenter
     */
    'description': string;
    /**
    ...
    /**
     * 
     * @type {ServersGetAllResponseServersInnerDatacenterLocation}
     * @memberof ServersGetAllResponseServersInnerDatacenter
     */
    'location': ServersGetAllResponseServersInnerDatacenterLocation;
    /**
    ...
    /**
     * 
     * @type {ServersGetAllResponseServersInnerDatacenterServerTypes}
     * @memberof ServersGetAllResponseServersInnerDatacenter
     */
    'server_types': ServersGetAllResponseServersInnerDatacenterServerTypes;
}
