 ...
 * 
 * @export
 * @interface PrimaryIpActionsAssignPrimaryIpToResourceRequest
 */
export interface PrimaryIpActionsAssignPrimaryIpToResourceRequest {
    /**
     * ID of a resource of type `assignee_type`
     * @type {number}
     * @memberof PrimaryIpActionsAssignPrimaryIpToResourceRequest
     */
    'assignee_id': number;
    /**
     ...
     * @memberof PrimaryIpActionsAssignPrimaryIpToResourceRequest
     */
    'assignee_type': PrimaryIpActionsAssignPrimaryIpToResourceRequestAssigneeTypeEnum;
}

type PrimaryIpActionsAssignPrimaryIpToResourceRequestAssigneeTypeEnum = 'server'
