...
import { ActionProperty36Error } from './action-property36-error';
import { ActionProperty36ResourcesInner } from './action-property36-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty36
 */
export interface ActionProperty36 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty36
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty36Error}
     * @memberof ActionProperty36
     */
    'error': ActionProperty36Error | null;
    /**
     ...
     * @type {Array<ActionProperty36ResourcesInner>}
     * @memberof ActionProperty36
     */
    'resources': Array<ActionProperty36ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty36
     */
    'status': ActionProperty36StatusEnum;
}

type ActionProperty36StatusEnum = 'success' | 'running' | 'error'
