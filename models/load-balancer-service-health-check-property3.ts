...
import { LoadBalancerServiceHealthCheckProperty3Http } from './load-balancer-service-health-check-property3-http';

/**
 * Service health check
 * @export
 * @interface LoadBalancerServiceHealthCheckProperty3
 */
export interface LoadBalancerServiceHealthCheckProperty3 {
    /**
     * 
     * @type {LoadBalancerServiceHealthCheckProperty3Http}
     * @memberof LoadBalancerServiceHealthCheckProperty3
     */
    'http'?: LoadBalancerServiceHealthCheckProperty3Http;
    /**
     ...
     * @memberof LoadBalancerServiceHealthCheckProperty3
     */
    'protocol': LoadBalancerServiceHealthCheckProperty3ProtocolEnum;
    /**
...
type LoadBalancerServiceHealthCheckProperty3ProtocolEnum = 'tcp' | 'http'
