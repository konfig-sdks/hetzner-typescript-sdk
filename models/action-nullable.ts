...
import { ActionNullableError } from './action-nullable-error';
import { ActionNullableResourcesInner } from './action-nullable-resources-inner';

/**
 * 
 * @export
 * @interface ActionNullable
 */
export interface ActionNullable {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionNullable
     */
    'command': string;
    /**
     * 
     * @type {ActionNullableError}
     * @memberof ActionNullable
     */
    'error': ActionNullableError | null;
    /**
     ...
     * @type {Array<ActionNullableResourcesInner>}
     * @memberof ActionNullable
     */
    'resources': Array<ActionNullableResourcesInner>;
    /**
     ...
     * @memberof ActionNullable
     */
    'status': ActionNullableStatusEnum;
}

type ActionNullableStatusEnum = 'success' | 'running' | 'error'
