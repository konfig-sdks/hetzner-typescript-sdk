...
import { ActionProperty68 } from './action-property68';

/**
 * 
 * @export
 * @interface ServerActionsRemoveFromPlacementGroupResponse
 */
export interface ServerActionsRemoveFromPlacementGroupResponse {
    /**
     * 
     * @type {ActionProperty68}
     * @memberof ServerActionsRemoveFromPlacementGroupResponse
     */
    'action': ActionProperty68;
}
