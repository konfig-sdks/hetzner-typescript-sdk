 ...
 * @export
 * @interface ServersGetServerResponseServerDatacenterLocation
 */
export interface ServersGetServerResponseServerDatacenterLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof ServersGetServerResponseServerDatacenterLocation
     */
    'description': string;
    /**
