...
import { ActionProperty50 } from './action-property50';

/**
 * 
 * @export
 * @interface ServerActionsAddToPlacementGroupResponse
 */
export interface ServerActionsAddToPlacementGroupResponse {
    /**
     * 
     * @type {ActionProperty50}
     * @memberof ServerActionsAddToPlacementGroupResponse
     */
    'action': ActionProperty50;
}
