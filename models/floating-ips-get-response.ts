...
import { FloatingIPsGetResponseFloatingIp } from './floating-ips-get-response-floating-ip';

/**
 * 
 * @export
 * @interface FloatingIPsGetResponse
 */
export interface FloatingIPsGetResponse {
    /**
     * 
     * @type {FloatingIPsGetResponseFloatingIp}
     * @memberof FloatingIPsGetResponse
     */
    'floating_ip': FloatingIPsGetResponseFloatingIp;
}
