...
import { PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInner } from './pricing-get-all-prices-response-pricing-load-balancer-types-inner-prices-inner';

/**
 * 
 * @export
 * @interface PricingGetAllPricesResponsePricingLoadBalancerTypesInner
 */
export interface PricingGetAllPricesResponsePricingLoadBalancerTypesInner {
    /**
     * ID of the Load Balancer type the price is for
     * @type {number}
     * @memberof PricingGetAllPricesResponsePricingLoadBalancerTypesInner
     */
    'id': number;
    /**
     ...
     * @type {Array<PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInner>}
     * @memberof PricingGetAllPricesResponsePricingLoadBalancerTypesInner
     */
    'prices': Array<PricingGetAllPricesResponsePricingLoadBalancerTypesInnerPricesInner>;
}
