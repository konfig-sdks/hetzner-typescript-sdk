...
import { ActionProperty60Error } from './action-property60-error';
import { ActionProperty60ResourcesInner } from './action-property60-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty60
 */
export interface ActionProperty60 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty60
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty60Error}
     * @memberof ActionProperty60
     */
    'error': ActionProperty60Error | null;
    /**
     ...
     * @type {Array<ActionProperty60ResourcesInner>}
     * @memberof ActionProperty60
     */
    'resources': Array<ActionProperty60ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty60
     */
    'status': ActionProperty60StatusEnum;
}

type ActionProperty60StatusEnum = 'success' | 'running' | 'error'
