...
import { ServerTypesListAllServerTypesResponseServerTypesInnerPricesInnerPriceHourly } from './server-types-list-all-server-types-response-server-types-inner-prices-inner-price-hourly';
import { ServerTypesListAllServerTypesResponseServerTypesInnerPricesInnerPriceMonthly } from './server-types-list-all-server-types-response-server-types-inner-prices-inner-price-monthly';

/**
 * 
 * @export
 * @interface ServerTypesListAllServerTypesResponseServerTypesInnerPricesInner
 */
export interface ServerTypesListAllServerTypesResponseServerTypesInnerPricesInner {
    /**
     * Name of the Location the price is for
     * @type {string}
     * @memberof ServerTypesListAllServerTypesResponseServerTypesInnerPricesInner
     */
    'location': string;
    /**
     * 
     * @type {ServerTypesListAllServerTypesResponseServerTypesInnerPricesInnerPriceHourly}
     * @memberof ServerTypesListAllServerTypesResponseServerTypesInnerPricesInner
     */
    'price_hourly': ServerTypesListAllServerTypesResponseServerTypesInnerPricesInnerPriceHourly;
    /**
     * 
     * @type {ServerTypesListAllServerTypesResponseServerTypesInnerPricesInnerPriceMonthly}
     * @memberof ServerTypesListAllServerTypesResponseServerTypesInnerPricesInner
     */
    'price_monthly': ServerTypesListAllServerTypesResponseServerTypesInnerPricesInnerPriceMonthly;
}
