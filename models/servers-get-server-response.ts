...
import { ServersGetServerResponseServer } from './servers-get-server-response-server';

/**
 * 
 * @export
 * @interface ServersGetServerResponse
 */
export interface ServersGetServerResponse {
    /**
     * 
     * @type {ServersGetServerResponseServer}
     * @memberof ServersGetServerResponse
     */
    'server'?: ServersGetServerResponseServer;
}
