 ...
 * @export
 * @interface LoadBalancerServiceHealthCheckProperty5Http
 */
export interface LoadBalancerServiceHealthCheckProperty5Http {
    /**
     ...
     * @type {string}
     * @memberof LoadBalancerServiceHealthCheckProperty5Http
     */
    'domain': string | null;
    /**
