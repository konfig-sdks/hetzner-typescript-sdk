 ...
 * @export
 * @interface LoadBalancerServiceHealthCheckPropertyHttp
 */
export interface LoadBalancerServiceHealthCheckPropertyHttp {
    /**
     ...
     * @type {string}
     * @memberof LoadBalancerServiceHealthCheckPropertyHttp
     */
    'domain': string | null;
    /**
