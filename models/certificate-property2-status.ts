...
import { CertificateProperty2StatusError } from './certificate-property2-status-error';

/**
 * Current status of a type `managed` Certificate, always *null* for type `uploaded` Certificates
 * @export
 * @interface CertificateProperty2Status
 */
export interface CertificateProperty2Status {
    /**
     * 
     * @type {CertificateProperty2StatusError}
     * @memberof CertificateProperty2Status
     */
    'error'?: CertificateProperty2StatusError | null;
    /**
     * Status of the issuance process of the Certificate
     * @type {string}
     * @memberof CertificateProperty2Status
     */
    'issuance'?: CertificateProperty2StatusIssuanceEnum;
    /**
     * Status of the renewal process of the Certificate.
     * @type {string}
     * @memberof CertificateProperty2Status
     */
    'renewal'?: CertificateProperty2StatusRenewalEnum;
}

type CertificateProperty2StatusIssuanceEnum = 'pending' | 'completed' | 'failed'
type CertificateProperty2StatusRenewalEnum = 'scheduled' | 'pending' | 'failed' | 'unavailable'
