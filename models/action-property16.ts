...
import { ActionProperty16Error } from './action-property16-error';
import { ActionProperty16ResourcesInner } from './action-property16-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty16
 */
export interface ActionProperty16 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty16
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty16Error}
     * @memberof ActionProperty16
     */
    'error': ActionProperty16Error | null;
    /**
     ...
     * @type {Array<ActionProperty16ResourcesInner>}
     * @memberof ActionProperty16
     */
    'resources': Array<ActionProperty16ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty16
     */
    'status': ActionProperty16StatusEnum;
}

type ActionProperty16StatusEnum = 'success' | 'running' | 'error'
