...
import { ServersGetServerResponseServerPublicNetIpv6DnsPtrInner } from './servers-get-server-response-server-public-net-ipv6-dns-ptr-inner';

/**
 * IPv6 network assigned to this Server and its reverse DNS entry
 * @export
 * @interface ServersGetServerResponseServerPublicNetIpv6
 */
export interface ServersGetServerResponseServerPublicNetIpv6 {
    /**
     * If the IP is blocked by our anti abuse dept
     * @type {boolean}
     * @memberof ServersGetServerResponseServerPublicNetIpv6
     */
    'blocked': boolean;
    /**
     * Reverse DNS PTR entries for the IPv6 addresses of this Server
     * @type {Array<ServersGetServerResponseServerPublicNetIpv6DnsPtrInner>}
     * @memberof ServersGetServerResponseServerPublicNetIpv6
     */
    'dns_ptr': Array<ServersGetServerResponseServerPublicNetIpv6DnsPtrInner> | null;
    /**
