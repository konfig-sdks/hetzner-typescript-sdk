...
import { ServersCreateServerActionResponseServerImageCreatedFrom } from './servers-create-server-action-response-server-image-created-from';
import { ServersCreateServerActionResponseServerImageProtection } from './servers-create-server-action-response-server-image-protection';

/**
 * Image the server is based on.
 * @export
 * @interface ServersCreateServerActionResponseServerImage
 */
export interface ServersCreateServerActionResponseServerImage {
    /**
     * Description of the Image
     * @type {string}
     * @memberof ServersCreateServerActionResponseServerImage
     */
    'description': string;
    /**
     ...
     * @memberof ServersCreateServerActionResponseServerImage
     */
    'architecture': ServersCreateServerActionResponseServerImageArchitectureEnum;
    /**
    ...
    /**
     * 
     * @type {ServersCreateServerActionResponseServerImageCreatedFrom}
     * @memberof ServersCreateServerActionResponseServerImage
     */
    'created_from': ServersCreateServerActionResponseServerImageCreatedFrom | null;
    /**
     ...
     * @memberof ServersCreateServerActionResponseServerImage
     */
    'os_flavor': ServersCreateServerActionResponseServerImageOsFlavorEnum;
    /**
    ...
    /**
     * 
     * @type {ServersCreateServerActionResponseServerImageProtection}
     * @memberof ServersCreateServerActionResponseServerImage
     */
     ...
     * @memberof ServersCreateServerActionResponseServerImage
     */
    'status': ServersCreateServerActionResponseServerImageStatusEnum;
    /**
     * Type of the Image
     * @type {string}
     * @memberof ServersCreateServerActionResponseServerImage
     */
    'type': ServersCreateServerActionResponseServerImageTypeEnum;
}

type ServersCreateServerActionResponseServerImageArchitectureEnum = 'x86' | 'arm'
type ServersCreateServerActionResponseServerImageOsFlavorEnum = 'ubuntu' | 'centos' | 'debian' | 'fedora' | 'rocky' | 'alma' | 'unknown'
type ServersCreateServerActionResponseServerImageStatusEnum = 'available' | 'creating' | 'unavailable'
type ServersCreateServerActionResponseServerImageTypeEnum = 'system' | 'app' | 'snapshot' | 'backup' | 'temporary'
