 ...
 * 
 * @export
 * @interface PlacementGroupsUpdatePropertiesRequest
 */
export interface PlacementGroupsUpdatePropertiesRequest {
    /**
     * User-defined labels (key-value pairs)
     * @type {object}
     * @memberof PlacementGroupsUpdatePropertiesRequest
     */
    'labels'?: object;
    /**
