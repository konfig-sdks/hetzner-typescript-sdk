 ...
 * @export
 * @interface ServerActionsCreateImageResponseImageCreatedFrom
 */
export interface ServerActionsCreateImageResponseImageCreatedFrom {
    /**
     * ID of the Server the Image was created from
     * @type {number}
     * @memberof ServerActionsCreateImageResponseImageCreatedFrom
     */
    'id': number;
    /**
