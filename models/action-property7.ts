...
import { ActionProperty7Error } from './action-property7-error';
import { ActionProperty7ResourcesInner } from './action-property7-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty7
 */
export interface ActionProperty7 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty7
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty7Error}
     * @memberof ActionProperty7
     */
    'error': ActionProperty7Error | null;
    /**
     ...
     * @type {Array<ActionProperty7ResourcesInner>}
     * @memberof ActionProperty7
     */
    'resources': Array<ActionProperty7ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty7
     */
    'status': ActionProperty7StatusEnum;
}

type ActionProperty7StatusEnum = 'success' | 'running' | 'error'
