...
import { ActionProperty19 } from './action-property19';

/**
 * 
 * @export
 * @interface LoadBalancerActionsAddServiceResponse
 */
export interface LoadBalancerActionsAddServiceResponse {
    /**
     * 
     * @type {ActionProperty19}
     * @memberof LoadBalancerActionsAddServiceResponse
     */
    'action': ActionProperty19;
}
