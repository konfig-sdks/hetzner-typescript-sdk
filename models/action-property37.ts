...
import { ActionProperty37Error } from './action-property37-error';
import { ActionProperty37ResourcesInner } from './action-property37-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty37
 */
export interface ActionProperty37 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty37
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty37Error}
     * @memberof ActionProperty37
     */
    'error': ActionProperty37Error | null;
    /**
     ...
     * @type {Array<ActionProperty37ResourcesInner>}
     * @memberof ActionProperty37
     */
    'resources': Array<ActionProperty37ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty37
     */
    'status': ActionProperty37StatusEnum;
}

type ActionProperty37StatusEnum = 'success' | 'running' | 'error'
