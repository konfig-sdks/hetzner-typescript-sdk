...
import { ActionProperty38 } from './action-property38';

/**
 * 
 * @export
 * @interface NetworkActionsDeleteRouteResponse
 */
export interface NetworkActionsDeleteRouteResponse {
    /**
     * 
     * @type {ActionProperty38}
     * @memberof NetworkActionsDeleteRouteResponse
     */
    'action': ActionProperty38;
}
