...
import { Action2Error } from './action2-error';
import { Action2ResourcesInner } from './action2-resources-inner';
...
export interface Action2 {
     ...
     * @type {Array<Action2ResourcesInner>}
     * @memberof Action2
     */
    'resources': Array<Action2ResourcesInner>;
    /**
     ...
     * @memberof Action2
     */
    'status': Action2StatusEnum;
}

type Action2StatusEnum = 'success' | 'running' | 'error'
