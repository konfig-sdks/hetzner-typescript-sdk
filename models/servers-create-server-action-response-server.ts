...
import { PlacementGroupNullableProperty1 } from './placement-group-nullable-property1';
import { ServersCreateServerActionResponseServerDatacenter } from './servers-create-server-action-response-server-datacenter';
import { ServersCreateServerActionResponseServerImage } from './servers-create-server-action-response-server-image';
import { ServersCreateServerActionResponseServerIso } from './servers-create-server-action-response-server-iso';
import { ServersCreateServerActionResponseServerPrivateNetInner } from './servers-create-server-action-response-server-private-net-inner';
import { ServersCreateServerActionResponseServerProtection } from './servers-create-server-action-response-server-protection';
import { ServersCreateServerActionResponseServerPublicNet } from './servers-create-server-action-response-server-public-net';
import { ServersCreateServerActionResponseServerServerType } from './servers-create-server-action-response-server-server-type';

/**
 * 
 * @export
 * @interface ServersCreateServerActionResponseServer
 */
export interface ServersCreateServerActionResponseServer {
    /**
     * Time window (UTC) in which the backup will run, or null if the backups are not enabled
     * @type {string}
     * @memberof ServersCreateServerActionResponseServer
     */
    ...
    /**
     * 
     * @type {ServersCreateServerActionResponseServerDatacenter}
     * @memberof ServersCreateServerActionResponseServer
     */
    ...
    /**
     * 
     * @type {ServersCreateServerActionResponseServerImage}
     * @memberof ServersCreateServerActionResponseServer
     */
    'image': ServersCreateServerActionResponseServerImage | null;
    /**
    ...
    /**
     * 
     * @type {ServersCreateServerActionResponseServerIso}
     * @memberof ServersCreateServerActionResponseServer
     */
    'iso': ServersCreateServerActionResponseServerIso | null;
    /**
    ...
    /**
     * 
     * @type {PlacementGroupNullableProperty1}
     * @memberof ServersCreateServerActionResponseServer
     */
    'placement_group'?: PlacementGroupNullableProperty1 | null;
    /**
     ...
     * @type {Array<ServersCreateServerActionResponseServerPrivateNetInner>}
     * @memberof ServersCreateServerActionResponseServer
     */
    'private_net': Array<ServersCreateServerActionResponseServerPrivateNetInner>;
    /**
     * 
     * @type {ServersCreateServerActionResponseServerProtection}
     * @memberof ServersCreateServerActionResponseServer
     */
    'protection': ServersCreateServerActionResponseServerProtection;
    /**
     * 
     * @type {ServersCreateServerActionResponseServerPublicNet}
     * @memberof ServersCreateServerActionResponseServer
     */
    ...
    /**
     * 
     * @type {ServersCreateServerActionResponseServerServerType}
     * @memberof ServersCreateServerActionResponseServer
     */
     ...
     * @memberof ServersCreateServerActionResponseServer
     */
    'status': ServersCreateServerActionResponseServerStatusEnum;
    /**
...
type ServersCreateServerActionResponseServerStatusEnum = 'running' | 'initializing' | 'starting' | 'stopping' | 'false' | 'deleting' | 'migrating' | 'rebuilding' | 'unknown'
