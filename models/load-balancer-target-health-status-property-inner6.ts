 ...
 * 
 * @export
 * @interface LoadBalancerTargetHealthStatusPropertyInner6
 */
export interface LoadBalancerTargetHealthStatusPropertyInner6 {
    /**
     * 
     * @type {number}
     * @memberof LoadBalancerTargetHealthStatusPropertyInner6
     */
    'listen_port'?: number;
    /**
     * 
     ...
     * @memberof LoadBalancerTargetHealthStatusPropertyInner6
     */
    'status'?: LoadBalancerTargetHealthStatusPropertyInner6StatusEnum;
}

type LoadBalancerTargetHealthStatusPropertyInner6StatusEnum = 'healthy' | 'unhealthy' | 'unknown'
