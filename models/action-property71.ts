...
import { ActionProperty71Error } from './action-property71-error';
import { ActionProperty71ResourcesInner } from './action-property71-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty71
 */
export interface ActionProperty71 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty71
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty71Error}
     * @memberof ActionProperty71
     */
    'error': ActionProperty71Error | null;
    /**
     ...
     * @type {Array<ActionProperty71ResourcesInner>}
     * @memberof ActionProperty71
     */
    'resources': Array<ActionProperty71ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty71
     */
    'status': ActionProperty71StatusEnum;
}

type ActionProperty71StatusEnum = 'success' | 'running' | 'error'
