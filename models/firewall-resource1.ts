...
import { FirewallResource1LabelSelector } from './firewall-resource1-label-selector';
import { FirewallResourceServer } from './firewall-resource-server';

/**
 * 
 * @export
 * @interface FirewallResource1
 */
export interface FirewallResource1 {
    /**
     * 
     * @type {FirewallResource1LabelSelector}
     * @memberof FirewallResource1
     */
    'label_selector'?: FirewallResource1LabelSelector;
    /**
     * 
     ...
     * @memberof FirewallResource1
     */
    'type': FirewallResource1TypeEnum;
}

type FirewallResource1TypeEnum = 'server' | 'label_selector'
