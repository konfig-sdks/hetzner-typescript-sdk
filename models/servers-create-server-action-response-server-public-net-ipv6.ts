...
import { ServersCreateServerActionResponseServerPublicNetIpv6DnsPtrInner } from './servers-create-server-action-response-server-public-net-ipv6-dns-ptr-inner';

/**
 * IPv6 network assigned to this Server and its reverse DNS entry
 * @export
 * @interface ServersCreateServerActionResponseServerPublicNetIpv6
 */
export interface ServersCreateServerActionResponseServerPublicNetIpv6 {
    /**
     * If the IP is blocked by our anti abuse dept
     * @type {boolean}
     * @memberof ServersCreateServerActionResponseServerPublicNetIpv6
     */
    'blocked': boolean;
    /**
     * Reverse DNS PTR entries for the IPv6 addresses of this Server
     * @type {Array<ServersCreateServerActionResponseServerPublicNetIpv6DnsPtrInner>}
     * @memberof ServersCreateServerActionResponseServerPublicNetIpv6
     */
    'dns_ptr': Array<ServersCreateServerActionResponseServerPublicNetIpv6DnsPtrInner> | null;
    /**
