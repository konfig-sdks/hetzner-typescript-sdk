...
import { LoadBalancerTargetHealthStatusPropertyInner1 } from './load-balancer-target-health-status-property-inner1';
import { LoadBalancerTargetServerProperty1 } from './load-balancer-target-server-property1';

/**
 * 
 * @export
 * @interface LoadBalancerTargetTarget
 */
export interface LoadBalancerTargetTarget {
     ...
     * @type {Array<LoadBalancerTargetHealthStatusPropertyInner1>}
     * @memberof LoadBalancerTargetTarget
     */
    'health_status'?: Array<LoadBalancerTargetHealthStatusPropertyInner1>;
    /**
     * 
     * @type {LoadBalancerTargetServerProperty1}
     * @memberof LoadBalancerTargetTarget
     */
    'server'?: LoadBalancerTargetServerProperty1;
    /**
