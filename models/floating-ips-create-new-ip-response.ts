...
import { ActionProperty7 } from './action-property7';
import { FloatingIPsCreateNewIpResponseFloatingIp } from './floating-ips-create-new-ip-response-floating-ip';

/**
 * 
 * @export
 * @interface FloatingIPsCreateNewIpResponse
 */
export interface FloatingIPsCreateNewIpResponse {
    /**
     * 
     * @type {ActionProperty7}
     * @memberof FloatingIPsCreateNewIpResponse
     */
    'action'?: ActionProperty7;
    /**
     * 
     * @type {FloatingIPsCreateNewIpResponseFloatingIp}
     * @memberof FloatingIPsCreateNewIpResponse
     */
