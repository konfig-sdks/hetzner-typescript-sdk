...
import { VolumesGetByIdResponseVolumeLocation } from './volumes-get-by-id-response-volume-location';
import { VolumesGetByIdResponseVolumeProtection } from './volumes-get-by-id-response-volume-protection';

/**
 * 
 * @export
 * @interface VolumesGetByIdResponseVolume
 */
export interface VolumesGetByIdResponseVolume {
    /**
     * Point in time when the Resource was created (in ISO-8601 format).
     * @type {string}
     * @memberof VolumesGetByIdResponseVolume
     */
    'created': string;
    /**
    ...
    /**
     * 
     * @type {VolumesGetByIdResponseVolumeLocation}
     * @memberof VolumesGetByIdResponseVolume
     */
    ...
    /**
     * 
     * @type {VolumesGetByIdResponseVolumeProtection}
     * @memberof VolumesGetByIdResponseVolume
     */
     ...
     * @memberof VolumesGetByIdResponseVolume
     */
    'status': VolumesGetByIdResponseVolumeStatusEnum;
}

type VolumesGetByIdResponseVolumeStatusEnum = 'creating' | 'available'
