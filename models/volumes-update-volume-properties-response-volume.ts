...
import { VolumesUpdateVolumePropertiesResponseVolumeLocation } from './volumes-update-volume-properties-response-volume-location';
import { VolumesUpdateVolumePropertiesResponseVolumeProtection } from './volumes-update-volume-properties-response-volume-protection';

/**
 * 
 * @export
 * @interface VolumesUpdateVolumePropertiesResponseVolume
 */
export interface VolumesUpdateVolumePropertiesResponseVolume {
    /**
     * Point in time when the Resource was created (in ISO-8601 format).
     * @type {string}
     * @memberof VolumesUpdateVolumePropertiesResponseVolume
     */
    'created': string;
    /**
    ...
    /**
     * 
     * @type {VolumesUpdateVolumePropertiesResponseVolumeLocation}
     * @memberof VolumesUpdateVolumePropertiesResponseVolume
     */
    ...
    /**
     * 
     * @type {VolumesUpdateVolumePropertiesResponseVolumeProtection}
     * @memberof VolumesUpdateVolumePropertiesResponseVolume
     */
     ...
     * @memberof VolumesUpdateVolumePropertiesResponseVolume
     */
    'status': VolumesUpdateVolumePropertiesResponseVolumeStatusEnum;
}

type VolumesUpdateVolumePropertiesResponseVolumeStatusEnum = 'creating' | 'available'
