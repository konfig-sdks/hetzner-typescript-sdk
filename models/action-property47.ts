...
import { ActionProperty47Error } from './action-property47-error';
import { ActionProperty47ResourcesInner } from './action-property47-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty47
 */
export interface ActionProperty47 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty47
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty47Error}
     * @memberof ActionProperty47
     */
    'error': ActionProperty47Error | null;
    /**
     ...
     * @type {Array<ActionProperty47ResourcesInner>}
     * @memberof ActionProperty47
     */
    'resources': Array<ActionProperty47ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty47
     */
    'status': ActionProperty47StatusEnum;
}

type ActionProperty47StatusEnum = 'success' | 'running' | 'error'
