 ...
 * IP address (v4)
 * @export
 * @interface LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNetIpv4
 */
export interface LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNetIpv4 {
    /**
     * Reverse DNS PTR entry for the IPv4 address of this Load Balancer
     * @type {string}
     * @memberof LoadBalancersCreateLoadBalancerResponseLoadBalancerPublicNetIpv4
     */
    'dns_ptr'?: string | null;
    /**
