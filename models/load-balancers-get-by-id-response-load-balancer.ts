...
import { LoadBalancerService3 } from './load-balancer-service3';
import { LoadBalancerTarget3 } from './load-balancer-target3';
...
import { LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType } from './load-balancers-get-by-id-response-load-balancer-load-balancer-type';
import { LoadBalancersGetByIdResponseLoadBalancerLocation } from './load-balancers-get-by-id-response-load-balancer-location';
import { LoadBalancersGetByIdResponseLoadBalancerPrivateNetInner } from './load-balancers-get-by-id-response-load-balancer-private-net-inner';
import { LoadBalancersGetByIdResponseLoadBalancerProtection } from './load-balancers-get-by-id-response-load-balancer-protection';
import { LoadBalancersGetByIdResponseLoadBalancerPublicNet } from './load-balancers-get-by-id-response-load-balancer-public-net';

/**
 * 
 * @export
 * @interface LoadBalancersGetByIdResponseLoadBalancer
 */
export interface LoadBalancersGetByIdResponseLoadBalancer {
    /**
     * 
     * @type {LoadBalancersGetAllResponseLoadBalancersInnerAlgorithm}
     * @memberof LoadBalancersGetByIdResponseLoadBalancer
     */
    ...
    /**
     * 
     * @type {LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType}
     * @memberof LoadBalancersGetByIdResponseLoadBalancer
     */
    'load_balancer_type': LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType;
    /**
     * 
     * @type {LoadBalancersGetByIdResponseLoadBalancerLocation}
     * @memberof LoadBalancersGetByIdResponseLoadBalancer
     */
     ...
     * @type {Array<LoadBalancersGetByIdResponseLoadBalancerPrivateNetInner>}
     * @memberof LoadBalancersGetByIdResponseLoadBalancer
     */
    'private_net': Array<LoadBalancersGetByIdResponseLoadBalancerPrivateNetInner>;
    /**
     * 
     * @type {LoadBalancersGetByIdResponseLoadBalancerProtection}
     * @memberof LoadBalancersGetByIdResponseLoadBalancer
     */
    'protection': LoadBalancersGetByIdResponseLoadBalancerProtection;
    /**
     * 
     * @type {LoadBalancersGetByIdResponseLoadBalancerPublicNet}
     * @memberof LoadBalancersGetByIdResponseLoadBalancer
     */
    'public_net': LoadBalancersGetByIdResponseLoadBalancerPublicNet;
    /**
     * List of services that belong to this Load Balancer
     * @type {Array<LoadBalancerService3>}
     * @memberof LoadBalancersGetByIdResponseLoadBalancer
     */
    'services': Array<LoadBalancerService3>;
    /**
     * List of targets that belong to this Load Balancer
     * @type {Array<LoadBalancerTarget3>}
     * @memberof LoadBalancersGetByIdResponseLoadBalancer
     */
    'targets': Array<LoadBalancerTarget3>;
}
