...
import { ActionResourcesInner } from './action-resources-inner';
...
export interface Action {
     ...
     * @type {Array<ActionResourcesInner>}
     * @memberof Action
     */
    'resources': Array<ActionResourcesInner>;
    /**
...
type ActionStatusEnum = 'success' | 'running' | 'error'
