 ...
 * @export
 * @interface ServersGetAllResponseServersInnerServerTypePricesInnerPriceMonthly
 */
export interface ServersGetAllResponseServersInnerServerTypePricesInnerPriceMonthly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof ServersGetAllResponseServersInnerServerTypePricesInnerPriceMonthly
     */
    'gross': string;
    /**
     * Price without VAT
