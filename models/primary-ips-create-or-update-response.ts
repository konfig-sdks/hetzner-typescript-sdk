...
import { ActionProperty41 } from './action-property41';
import { PrimaryIPProperty } from './primary-ipproperty';

/**
 * 
 * @export
 * @interface PrimaryIPsCreateOrUpdateResponse
 */
export interface PrimaryIPsCreateOrUpdateResponse {
    /**
     * 
     * @type {ActionProperty41}
     * @memberof PrimaryIPsCreateOrUpdateResponse
     */
    'action'?: ActionProperty41;
    /**
     * 
     * @type {PrimaryIPProperty}
     * @memberof PrimaryIPsCreateOrUpdateResponse
     */
    'primary_ip': PrimaryIPProperty;
}
