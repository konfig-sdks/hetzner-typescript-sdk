...
import { CertificateProperty1 } from './certificate-property1';

/**
 * 
 * @export
 * @interface CertificatesGetByIdResponse
 */
export interface CertificatesGetByIdResponse {
    /**
     * 
     * @type {CertificateProperty1}
     * @memberof CertificatesGetByIdResponse
     */
    'certificate': CertificateProperty1;
}
