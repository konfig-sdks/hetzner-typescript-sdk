 ...
 * @export
 * @interface ServersGetServerResponseServerServerTypePricesInnerPriceHourly
 */
export interface ServersGetServerResponseServerServerTypePricesInnerPriceHourly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof ServersGetServerResponseServerServerTypePricesInnerPriceHourly
     */
    'gross': string;
    /**
     * Price without VAT
