...
import { NetworksGetByIdResponseNetwork } from './networks-get-by-id-response-network';

/**
 * 
 * @export
 * @interface NetworksGetByIdResponse
 */
export interface NetworksGetByIdResponse {
    /**
     * 
     * @type {NetworksGetByIdResponseNetwork}
     * @memberof NetworksGetByIdResponse
     */
    'network'?: NetworksGetByIdResponseNetwork;
}
