...
import { ActionProperty33Error } from './action-property33-error';
import { ActionProperty33ResourcesInner } from './action-property33-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty33
 */
export interface ActionProperty33 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty33
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty33Error}
     * @memberof ActionProperty33
     */
    'error': ActionProperty33Error | null;
    /**
     ...
     * @type {Array<ActionProperty33ResourcesInner>}
     * @memberof ActionProperty33
     */
    'resources': Array<ActionProperty33ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty33
     */
    'status': ActionProperty33StatusEnum;
}

type ActionProperty33StatusEnum = 'success' | 'running' | 'error'
