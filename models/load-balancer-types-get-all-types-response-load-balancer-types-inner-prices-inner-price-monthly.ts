 ...
 * @export
 * @interface LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInnerPriceMonthly
 */
export interface LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInnerPriceMonthly {
    /**
     * Price with VAT added.
     * @type {string}
     * @memberof LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInnerPriceMonthly
     */
    'gross': string;
    /**
     * Price without VAT.
