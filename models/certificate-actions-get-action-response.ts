...
import { ActionProperty2 } from './action-property2';

/**
 * 
 * @export
 * @interface CertificateActionsGetActionResponse
 */
export interface CertificateActionsGetActionResponse {
    /**
     * 
     * @type {ActionProperty2}
     * @memberof CertificateActionsGetActionResponse
     */
    'action': ActionProperty2;
}
