...
import { FirewallPropertyAppliedToInnerAppliedToResourcesInnerServer } from './firewall-property-applied-to-inner-applied-to-resources-inner-server';

/**
 * 
 * @export
 * @interface FirewallPropertyAppliedToInnerAppliedToResourcesInner
 */
export interface FirewallPropertyAppliedToInnerAppliedToResourcesInner {
    /**
     * 
     * @type {FirewallPropertyAppliedToInnerAppliedToResourcesInnerServer}
     * @memberof FirewallPropertyAppliedToInnerAppliedToResourcesInner
     */
    'server'?: FirewallPropertyAppliedToInnerAppliedToResourcesInnerServer;
    /**
     * Type of resource referenced
     * @type {string}
     * @memberof FirewallPropertyAppliedToInnerAppliedToResourcesInner
     */
    'type'?: FirewallPropertyAppliedToInnerAppliedToResourcesInnerTypeEnum;
}

type FirewallPropertyAppliedToInnerAppliedToResourcesInnerTypeEnum = 'server'
