 ...
 * 
 * @export
 * @interface LoadBalancerActionsAttachToNetworkRequest
 */
export interface LoadBalancerActionsAttachToNetworkRequest {
    /**
     ...
     * @type {string}
     * @memberof LoadBalancerActionsAttachToNetworkRequest
     */
    'ip'?: string;
    /**
