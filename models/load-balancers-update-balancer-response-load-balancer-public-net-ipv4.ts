 ...
 * IP address (v4)
 * @export
 * @interface LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv4
 */
export interface LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv4 {
    /**
     * Reverse DNS PTR entry for the IPv4 address of this Load Balancer
     * @type {string}
     * @memberof LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv4
     */
    'dns_ptr'?: string | null;
    /**
