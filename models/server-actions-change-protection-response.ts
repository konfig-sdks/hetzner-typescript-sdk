...
import { ActionProperty55 } from './action-property55';

/**
 * 
 * @export
 * @interface ServerActionsChangeProtectionResponse
 */
export interface ServerActionsChangeProtectionResponse {
    /**
     * 
     * @type {ActionProperty55}
     * @memberof ServerActionsChangeProtectionResponse
     */
    'action': ActionProperty55;
}
