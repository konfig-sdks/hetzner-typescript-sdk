...
import { VolumesGetByIdResponseVolume } from './volumes-get-by-id-response-volume';

/**
 * 
 * @export
 * @interface VolumesGetByIdResponse
 */
export interface VolumesGetByIdResponse {
    /**
     * 
     * @type {VolumesGetByIdResponseVolume}
     * @memberof VolumesGetByIdResponse
     */
    'volume': VolumesGetByIdResponseVolume;
}
