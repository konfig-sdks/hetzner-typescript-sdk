...
import { LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInner } from './load-balancer-types-get-all-types-response-load-balancer-types-inner-prices-inner';

/**
 * 
 * @export
 * @interface LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner
 */
export interface LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner {
    /**
     * Description of the Load Balancer type
     * @type {string}
     * @memberof LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner
     */
    'description': string;
    /**
     ...
     * @type {Array<LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInner>}
     * @memberof LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner
     */
    'prices': Array<LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInner>;
}
