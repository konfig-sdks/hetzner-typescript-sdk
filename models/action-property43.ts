...
import { ActionProperty43Error } from './action-property43-error';
import { ActionProperty43ResourcesInner } from './action-property43-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty43
 */
export interface ActionProperty43 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty43
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty43Error}
     * @memberof ActionProperty43
     */
    'error': ActionProperty43Error | null;
    /**
     ...
     * @type {Array<ActionProperty43ResourcesInner>}
     * @memberof ActionProperty43
     */
    'resources': Array<ActionProperty43ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty43
     */
    'status': ActionProperty43StatusEnum;
}

type ActionProperty43StatusEnum = 'success' | 'running' | 'error'
