...
import { ActionProperty26Error } from './action-property26-error';
import { ActionProperty26ResourcesInner } from './action-property26-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty26
 */
export interface ActionProperty26 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty26
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty26Error}
     * @memberof ActionProperty26
     */
    'error': ActionProperty26Error | null;
    /**
     ...
     * @type {Array<ActionProperty26ResourcesInner>}
     * @memberof ActionProperty26
     */
    'resources': Array<ActionProperty26ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty26
     */
    'status': ActionProperty26StatusEnum;
}

type ActionProperty26StatusEnum = 'success' | 'running' | 'error'
