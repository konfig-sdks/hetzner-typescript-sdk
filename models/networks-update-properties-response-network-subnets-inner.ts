 ...
 * 
 * @export
 * @interface NetworksUpdatePropertiesResponseNetworkSubnetsInner
 */
export interface NetworksUpdatePropertiesResponseNetworkSubnetsInner {
    /**
     ...
     * @type {string}
     * @memberof NetworksUpdatePropertiesResponseNetworkSubnetsInner
     */
    'gateway': string;
    /**
     ...
     * @memberof NetworksUpdatePropertiesResponseNetworkSubnetsInner
     */
    'type': NetworksUpdatePropertiesResponseNetworkSubnetsInnerTypeEnum;
    /**
...
type NetworksUpdatePropertiesResponseNetworkSubnetsInnerTypeEnum = 'cloud' | 'server' | 'vswitch'
