...
import { ImagesGetByIdResponseImageCreatedFrom } from './images-get-by-id-response-image-created-from';
import { ImagesGetByIdResponseImageProtection } from './images-get-by-id-response-image-protection';

/**
 * 
 * @export
 * @interface ImagesGetByIdResponseImage
 */
export interface ImagesGetByIdResponseImage {
    /**
     * Description of the Image
     * @type {string}
     * @memberof ImagesGetByIdResponseImage
     */
    'description': string;
    /**
     ...
     * @memberof ImagesGetByIdResponseImage
     */
    'architecture': ImagesGetByIdResponseImageArchitectureEnum;
    /**
    ...
    /**
     * 
     * @type {ImagesGetByIdResponseImageCreatedFrom}
     * @memberof ImagesGetByIdResponseImage
     */
    'created_from': ImagesGetByIdResponseImageCreatedFrom | null;
    /**
     ...
     * @memberof ImagesGetByIdResponseImage
     */
    'os_flavor': ImagesGetByIdResponseImageOsFlavorEnum;
    /**
    ...
    /**
     * 
     * @type {ImagesGetByIdResponseImageProtection}
     * @memberof ImagesGetByIdResponseImage
     */
     ...
     * @memberof ImagesGetByIdResponseImage
     */
    'status': ImagesGetByIdResponseImageStatusEnum;
    /**
     * Type of the Image
     * @type {string}
     * @memberof ImagesGetByIdResponseImage
     */
    'type': ImagesGetByIdResponseImageTypeEnum;
}

type ImagesGetByIdResponseImageArchitectureEnum = 'x86' | 'arm'
type ImagesGetByIdResponseImageOsFlavorEnum = 'ubuntu' | 'centos' | 'debian' | 'fedora' | 'rocky' | 'alma' | 'unknown'
type ImagesGetByIdResponseImageStatusEnum = 'available' | 'creating' | 'unavailable'
type ImagesGetByIdResponseImageTypeEnum = 'system' | 'app' | 'snapshot' | 'backup' | 'temporary'
