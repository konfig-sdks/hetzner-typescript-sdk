 ...
 * @export
 * @interface FloatingIPsUpdateDescriptionLabelsResponseFloatingIpHomeLocation
 */
export interface FloatingIPsUpdateDescriptionLabelsResponseFloatingIpHomeLocation {
    /**
     * Description of the Location
     * @type {string}
     * @memberof FloatingIPsUpdateDescriptionLabelsResponseFloatingIpHomeLocation
     */
    'description': string;
    /**
