...
import { FirewallPropertyAppliedToInner } from './firewall-property-applied-to-inner';
import { Rule3 } from './rule3';

/**
 * 
 * @export
 * @interface FirewallProperty
 */
export interface FirewallProperty {
    /**
     * 
     * @type {Array<FirewallPropertyAppliedToInner>}
     * @memberof FirewallProperty
     */
    'applied_to': Array<FirewallPropertyAppliedToInner>;
    /**
