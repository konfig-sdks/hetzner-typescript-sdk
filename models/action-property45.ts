...
import { ActionProperty45Error } from './action-property45-error';
import { ActionProperty45ResourcesInner } from './action-property45-resources-inner';

/**
 * 
 * @export
 * @interface ActionProperty45
 */
export interface ActionProperty45 {
    /**
     * Command executed in the Action
     * @type {string}
     * @memberof ActionProperty45
     */
    'command': string;
    /**
     * 
     * @type {ActionProperty45Error}
     * @memberof ActionProperty45
     */
    'error': ActionProperty45Error | null;
    /**
     ...
     * @type {Array<ActionProperty45ResourcesInner>}
     * @memberof ActionProperty45
     */
    'resources': Array<ActionProperty45ResourcesInner>;
    /**
     ...
     * @memberof ActionProperty45
     */
    'status': ActionProperty45StatusEnum;
}

type ActionProperty45StatusEnum = 'success' | 'running' | 'error'
