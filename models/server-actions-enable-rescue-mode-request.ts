 ...
 * 
 * @export
 * @interface ServerActionsEnableRescueModeRequest
 */
export interface ServerActionsEnableRescueModeRequest {
    /**
     * Array of SSH key IDs which should be injected into the rescue system.
     * @type {Array<number>}
     * @memberof ServerActionsEnableRescueModeRequest
     */
     ...
     * @memberof ServerActionsEnableRescueModeRequest
     */
    'type'?: ServerActionsEnableRescueModeRequestTypeEnum;
}

type ServerActionsEnableRescueModeRequestTypeEnum = 'linux64'
