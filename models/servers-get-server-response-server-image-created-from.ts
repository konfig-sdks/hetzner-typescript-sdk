 ...
 * @export
 * @interface ServersGetServerResponseServerImageCreatedFrom
 */
export interface ServersGetServerResponseServerImageCreatedFrom {
    /**
     * ID of the Server the Image was created from
     * @type {number}
     * @memberof ServersGetServerResponseServerImageCreatedFrom
     */
    'id': number;
    /**
