...
import { Action6 } from './action6';
import { ListMetaProperty7 } from './list-meta-property7';

/**
 * 
 * @export
 * @interface FirewallActionsGetAllActionsResponse
 */
export interface FirewallActionsGetAllActionsResponse {
    /**
     * 
     * @type {Array<Action6>}
     * @memberof FirewallActionsGetAllActionsResponse
     */
    'actions': Array<Action6>;
    /**
     * 
     * @type {ListMetaProperty7}
     * @memberof FirewallActionsGetAllActionsResponse
     */
    'meta'?: ListMetaProperty7;
}
