...
import { NetworksUpdatePropertiesResponseNetworkProtection } from './networks-update-properties-response-network-protection';
import { NetworksUpdatePropertiesResponseNetworkRoutesInner } from './networks-update-properties-response-network-routes-inner';
import { NetworksUpdatePropertiesResponseNetworkSubnetsInner } from './networks-update-properties-response-network-subnets-inner';

/**
 * 
 * @export
 * @interface NetworksUpdatePropertiesResponseNetwork
 */
export interface NetworksUpdatePropertiesResponseNetwork {
    /**
     * Array of IDs of Servers attached to this Network
     * @type {Array<number>}
     * @memberof NetworksUpdatePropertiesResponseNetwork
     */
    ...
    /**
     * 
     * @type {NetworksUpdatePropertiesResponseNetworkProtection}
     * @memberof NetworksUpdatePropertiesResponseNetwork
     */
    'protection': NetworksUpdatePropertiesResponseNetworkProtection;
    /**
     * Array of routes set in this Network
     * @type {Array<NetworksUpdatePropertiesResponseNetworkRoutesInner>}
     * @memberof NetworksUpdatePropertiesResponseNetwork
     */
    'routes': Array<NetworksUpdatePropertiesResponseNetworkRoutesInner>;
    /**
     * Array subnets allocated in this Network
     * @type {Array<NetworksUpdatePropertiesResponseNetworkSubnetsInner>}
     * @memberof NetworksUpdatePropertiesResponseNetwork
     */
    'subnets': Array<NetworksUpdatePropertiesResponseNetworkSubnetsInner>;
}
