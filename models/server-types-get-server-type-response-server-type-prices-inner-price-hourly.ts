 ...
 * @export
 * @interface ServerTypesGetServerTypeResponseServerTypePricesInnerPriceHourly
 */
export interface ServerTypesGetServerTypeResponseServerTypePricesInnerPriceHourly {
    /**
     * Price with VAT added
     * @type {string}
     * @memberof ServerTypesGetServerTypeResponseServerTypePricesInnerPriceHourly
     */
    'gross': string;
    /**
     * Price without VAT
