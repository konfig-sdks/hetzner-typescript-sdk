...
import { ActionProperty12 } from './action-property12';

/**
 * 
 * @export
 * @interface FloatingIpActionsUnassignIpResponse
 */
export interface FloatingIpActionsUnassignIpResponse {
    /**
     * 
     * @type {ActionProperty12}
     * @memberof FloatingIpActionsUnassignIpResponse
     */
    'action': ActionProperty12;
}
