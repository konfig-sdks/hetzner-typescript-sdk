 ...
 * @export
 * @interface PlacementGroupNullableProperty2
 */
export interface PlacementGroupNullableProperty2 {
    /**
     * Array of IDs of Servers that are part of this Placement Group
     * @type {Array<number>}
     * @memberof PlacementGroupNullableProperty2
     */
     ...
     * @memberof PlacementGroupNullableProperty2
     */
    'type': PlacementGroupNullableProperty2TypeEnum;
}

type PlacementGroupNullableProperty2TypeEnum = 'spread'
