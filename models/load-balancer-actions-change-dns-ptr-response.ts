...
import { ActionProperty23 } from './action-property23';

/**
 * 
 * @export
 * @interface LoadBalancerActionsChangeDnsPtrResponse
 */
export interface LoadBalancerActionsChangeDnsPtrResponse {
    /**
     * 
     * @type {ActionProperty23}
     * @memberof LoadBalancerActionsChangeDnsPtrResponse
     */
    'action': ActionProperty23;
}
