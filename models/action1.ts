...
import { Action1Error } from './action1-error';
import { Action1ResourcesInner } from './action1-resources-inner';
...
export interface Action1 {
     ...
     * @type {Array<Action1ResourcesInner>}
     * @memberof Action1
     */
    'resources': Array<Action1ResourcesInner>;
    /**
     ...
     * @memberof Action1
     */
    'status': Action1StatusEnum;
}

type Action1StatusEnum = 'success' | 'running' | 'error'
