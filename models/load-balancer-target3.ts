...
import { LoadBalancerTargetHealthStatusPropertyInner6 } from './load-balancer-target-health-status-property-inner6';
import { LoadBalancerTargetIPProperty5 } from './load-balancer-target-ipproperty5';
import { LoadBalancerTargetLabelSelectorProperty3 } from './load-balancer-target-label-selector-property3';
import { LoadBalancerTargetServerProperty6 } from './load-balancer-target-server-property6';
import { LoadBalancerTargetTarget3 } from './load-balancer-target-target3';

/**
 * 
 * @export
 * @interface LoadBalancerTarget3
 */
export interface LoadBalancerTarget3 {
    /**
     * List of health statuses of the services on this target. Only present for target types \"server\" and \"ip\".
     * @type {Array<LoadBalancerTargetHealthStatusPropertyInner6>}
     * @memberof LoadBalancerTarget3
     */
    'health_status'?: Array<LoadBalancerTargetHealthStatusPropertyInner6>;
    /**
     * 
     * @type {LoadBalancerTargetIPProperty5}
     * @memberof LoadBalancerTarget3
     */
    'ip'?: LoadBalancerTargetIPProperty5;
    /**
     * 
     * @type {LoadBalancerTargetLabelSelectorProperty3}
     * @memberof LoadBalancerTarget3
     */
    'label_selector'?: LoadBalancerTargetLabelSelectorProperty3;
    /**
     * 
     * @type {LoadBalancerTargetServerProperty6}
     * @memberof LoadBalancerTarget3
     */
    'server'?: LoadBalancerTargetServerProperty6;
    /**
     * List of resolved label selector target Servers. Only present for type \"label_selector\".
     * @type {Array<LoadBalancerTargetTarget3>}
     * @memberof LoadBalancerTarget3
     */
    'targets'?: Array<LoadBalancerTargetTarget3>;
    /**
     * Type of the resource
     * @type {string}
     * @memberof LoadBalancerTarget3
     */
    'type': LoadBalancerTarget3TypeEnum;
    /**
...
type LoadBalancerTarget3TypeEnum = 'server' | 'label_selector' | 'ip'
