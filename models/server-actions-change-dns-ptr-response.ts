...
import { ActionProperty54 } from './action-property54';

/**
 * 
 * @export
 * @interface ServerActionsChangeDnsPtrResponse
 */
export interface ServerActionsChangeDnsPtrResponse {
    /**
     * 
     * @type {ActionProperty54}
     * @memberof ServerActionsChangeDnsPtrResponse
     */
    'action': ActionProperty54;
}
