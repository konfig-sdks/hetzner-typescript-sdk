...
import { ServerTypesGetServerTypeResponseServerTypePricesInnerPriceHourly } from './server-types-get-server-type-response-server-type-prices-inner-price-hourly';
import { ServerTypesGetServerTypeResponseServerTypePricesInnerPriceMonthly } from './server-types-get-server-type-response-server-type-prices-inner-price-monthly';

/**
 * 
 * @export
 * @interface ServerTypesGetServerTypeResponseServerTypePricesInner
 */
export interface ServerTypesGetServerTypeResponseServerTypePricesInner {
    /**
     * Name of the Location the price is for
     * @type {string}
     * @memberof ServerTypesGetServerTypeResponseServerTypePricesInner
     */
    'location': string;
    /**
     * 
     * @type {ServerTypesGetServerTypeResponseServerTypePricesInnerPriceHourly}
     * @memberof ServerTypesGetServerTypeResponseServerTypePricesInner
     */
    'price_hourly': ServerTypesGetServerTypeResponseServerTypePricesInnerPriceHourly;
    /**
     * 
     * @type {ServerTypesGetServerTypeResponseServerTypePricesInnerPriceMonthly}
     * @memberof ServerTypesGetServerTypeResponseServerTypePricesInner
     */
    'price_monthly': ServerTypesGetServerTypeResponseServerTypePricesInnerPriceMonthly;
}
